...
<header class="wrapper bg-soft-primary" style="display:none;">
    <nav class="navbar navbar-expand-md classic transparent navbar-light">
        <div class="container pe-1 px-0 flex-lg-row flex-nowrap align-items-center">
            <div class="row align-items-baseline align-items-md-center">
                <div class="col-auto">
            ...
            <div class="navbar-other ms-md-4">
                <ul class="navbar-nav flex-row align-items-center">
                    ...
                    <li class="nav-item me-2 d-md-none">
                        <a href="<?= base_url(); ?>about-us" class="btn btn-danger btn_new_css px-3" style="font-size: 0.8rem;">About Us</a>
                    </li>
