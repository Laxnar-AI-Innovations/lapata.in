            ...
            <div class="card mb-3 bg-light">
                <div class="card-body px-2 pt-0">
                    <div class="row align-items-center px-0 mx-0 justify-content-center">
                        ...
                        <div class="col-7 px-0">
                            ...
                            <?php if($row['Age'] != '' || $row['Age'] != NULL){ ?>
                                <p class="card-title text-start py-0 fs-6 mb-0"><b style="color:black;font-size:.8rem!important;font-weight:500;">Age Band - </b><b style="font-size:.8rem!important;color:black;"><?php echo $row['Age']??"--"?></b></p>
                            <?php } ?>
                        </div>
                    </div>
                    <?php if($row['aadharNumber'] != '' || $row['aadharNumber'] != NULL){ ?>
                        <div class="row col-6 px-2">
                            <h6 class="card-title text-center py-0 mb-0"><b style="color:black;font-size:1rem!important;font-weight:500;"><?php echo substr_replace($row['aadharNumber'],'xxxxxxxx',0,8);?></b></h6>
                        </div>
                    <?php } ?>
                    ...
                    <div class="row w-100 mx-0 align-items-center">
                        ...
                        ?>
                        <div class="col-12">
                            <b style="font-size:.8rem!important;color:black;font-weight:500;">Contact To: - </b><b style="color:black;font-size:.8rem!important;"><?php echo $getUserDetail[0]['aadharname']; ?></b>
                        </div>
                        <div class="col-12 text-center">
                            <a href="javascript:void(0)" onclick="showLogin()" class="btn btn-circle btn-sm btn-police1" ><i class="fa fa-phone"></i> </a>
                        </div>
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 px-0 px-md-2 col-12 col-search pb-2" >
            <div class="card mb-3 shiva_height bg-light">
                <div class="card-body px-0 pt-0">
                    ...
                    <div class="row w-100 mx-0 align-items-center" style="height:50px">
                        <div class="col-12 text-start">
                             <p class="my-2"><b style="color:black;font-size:.8rem!important;font-weight:500;">Uploaded By :- </b><b style="color:red;font-size:.8rem!important">SAMAJSEVI - </b>
                             <b style="color:black;text-transform:capitalize;font-size:.8rem!important"><?php echo $getUserDetail[0]['aadharname'].' ,'; ?> 
                             <?php echo $getUserDetail[0]['district'].' - '; ?><?php echo $getUserDetail[0]['state']; ?></b></p>
                        </div>
                    </div>
