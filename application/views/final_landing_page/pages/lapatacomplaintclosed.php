                        ...
                        <div class="card-body p-0">
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center border border-danger p-3">
                                    <h4 class="text-danger text-uppercase mb-0" style="font-weight:bold;"><span class="text-success">लापता Complain is</span> Closed!</h4>
                                </div>
                                <?php }else{ ?>
                                    <div class="col-md-12 text-center border border-danger p-3">
                                        <h4 class="text-danger text-uppercase mb-0" style="font-weight:bold;">लापता Complain not found!</h4>
                                    </div>
                                <?php } ?>
                            </div>
                            <div class="row">
