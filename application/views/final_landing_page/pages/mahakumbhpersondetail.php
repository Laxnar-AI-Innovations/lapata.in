                        ...
                        <div class="col-md-6 col-sm-12 col-lg-6 px-0">
                            <div id="carouselExampleControls" class="carousel slide" data-bs-interval="2000" data-bs-ride="carousel">
                                <div class="carousel-inner" id="photosspan">
                                    ...
                                    <?php } ?>
                                    <?php
                                        $getLatestUserPhotos = $this->db->query('select * from mahakumbhPhotos where familyId='.$familyperson[0]['id'])->result_array();
                    ...
                    <div class="row mx-0 justify-content-center">
                        <div class="col-lg-6 col-md-6 col-12 px-0" style="top:-50px!important;background:white;height:auto;min-height:150px;">
                            ...
                            <div class="row align-items-center mx-0">
                                <div class="col-6">
                                    <button type="button" style="color: white;background:#616161;width:100%;"><b><?php echo ($familyperson[0]['Gender'] == 'boy' ? 'Male' : 'Female'); ?></b></button>
                                </div>
                                <div class="col-6">
                                    <button type="button" style="color: white;background:#616161;width:100%;padding:0.4rem 1rem;"><b><?php echo $familyperson[0]['Age']; ?> YEARS</b></button>
                                </div>
                            </div>
                            <?php 
                                if($familyperson[0]['isKyc'] == 1)
                                {
                                    $getUserDetail = $this->db->query('select * from user where uid='.$familyperson[0]['parentId'])->result_array();   
                                }else{
                                    $getUserDetail = $this->db->query('select * from nonKycUser where uid='.$familyperson[0]['parentId'])->result_array();
                                }
                            ?>
                            <?php 
                            ...
                            ?>
                            <?php 
                                if($familyperson[0]['well1'] != NULL || $familyperson[0]['well2'] != NULL || $familyperson[0]['well3'] != NULL)
                                {
                            ?>
                            ...
                            <?php }else{ 
                                $mobile = '';
                                if($familyperson[0]['policeId'] != NULL)
                                {
