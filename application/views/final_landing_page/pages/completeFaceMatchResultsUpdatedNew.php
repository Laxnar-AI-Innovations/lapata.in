    ...
    <div class="container-fluid px-1 px-md-2">
        <div class="row align-items-center my-3 mx-2" style="justify-content:space-around;">
            ...
            <div class="col-lg-auto col-sm-12 col-md-auto text-end my-1">
                <button type="button" onclick='location.href=`<?= base_url(); ?>unknown-facematch-before`' class="btn mt-0 btn-style-grey btn-dark disabled-on-loading"> <i class="fa fa-arrow-circle-left"></i></button>
            </div>
        </div>
        ...
        ?>
        <div class="card px-0">
            <div class="card-body bg-gradient-sky p-1">
                <div class="row">
                    <?php 
        ...
        <div class="card px-0 my-4">
            <div class="card-body bg-gradient-sky p-3">
                <div class="row">
                    <?php 
        ...
        <?php }else{ ?>
        <?php 
            $getFaceMatchResults = $this->db->query('select * from searchfacehistory where Id='.$_SESSION['searchFaceId'])->result_array();
        ...
        <div class="card px-0 my-4">
            ...
            <div class="card-body bg-gradient-sky">
                <?php 
                    $explode = array_unique(explode(',',$getFaceMatchResults[0]['matchedUnknownIds']));
                    $photos = array();
                ...
                <?php }else{ ?>
                <h5 class="payDiv text-center card-titlenew mb-0 pb-0">To View Details <br> Please Login</h5>
                <?php } ?>
                    ...
                    <div class="col-sm-12 col-lg-6 col-md-6">
                        <div class="row justify-content-center payDiv">
                            <div class="form-group col-12 col-md-4 col-lg-6 mt-1 text-center">
                                ...
                                <?php }else{ ?>
                                <button type="button" class="mx-0 btn btn-style-five disabled-on-loading w-100" style="padding: 0.6rem!important;" onclick="showLoginAccordingly()"> Click Here <i class="fa fa-hand-pointer-o"></i></button>
                                <?php } ?>
                            </div>
                        </div>
        ...
        <div class="card px-0 mb-4">
            <div class="card-body bg-gradient-sky p-1 pt-4">
                <?php 
        ...
        <?php 
            foreach($familyperson as $k=>$row)
            {
                if(isset($row[0]))
                {
                    $row = $row[0];
        ?>
        <input type="hidden" id="firstFamilyId" value="<?= $row[0]['id']; ?>">
