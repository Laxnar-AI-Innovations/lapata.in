...
<section class="section register d-flex flex-column align-items-center justify-content-center pb-0">
    ...
    <div class="container">
        <div class="row ">
            <div class="col-lg-6">
                <div class="px-md-15 px-lg-3 mobile_image_center_shiva_sir">
                    <picture class="mb-6">
                          <source srcset="<?php echo base_url(); ?>assets_landing_page/img/idcard.png" type="image/png">
                          <img src="<?php echo base_url(); ?>assets_landing_page/img/idcard.png" class="img-fluid mobile_image_shiva_sir" alt="idcard">
                    </picture>
                </div>
            </div>
            <div class="col-lg-4 px-0 col-md-6 d-flex flex-column align-items-center justify-content-center">
                <div class="card mb-0 pb-1 pt-1 w-100">
                    <div class="card-body pb-0">
                        <form class="row g-3 needs-validation <?php if($pn != 2){ echo "d-none"; } ?>" method="post" action="<?php echo base_url(); ?>landing/checkPersonUpdated/step2" novalidate id="step2Form">
                            <?php 
                              $csrf = array(
...
<script type="text/javascript">
    ...
    function redirectToStep2(type,id)
    {
        if(type)
        {
            ...
            window.open('<?php echo base_url(); ?>check-step-2-updated','_blank');
        }
    }
    ...
    $('#step2CheckAadhar').click(function()
    {
        ...
        if(count == 0)
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>landing/checkPersonIdUpdated',
                data:data,
                timeout: 60000,
                processData:false,
                cache:false,
