...
<style>
    ...
    .btn_new_css:hover{
        background-image:linear-gradient(93deg, green, red)!important;
        border:none!important;
        font-size:1rem!important;
        color:white!important;
    }
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 text-center">
                                <?php 
                                    ...
                                    {
                                ?>
                                <h6 class="text-center">To view complete details</h6>
                                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#appealModal" class="btn btn-style-red">Click Here</a>
                                <?php }else{ ?>
                                <h6 class="text-center">Please login to view details</h6>
                                <a href="javascript:void(0)" onclick="showLoginAccordingly()" class="btn btn-style-red">Click Here</a>
                                <?php } ?>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-6 text-center form-group">
                    <img src="<?= $v; ?>" class="img-fluid" style="height: 100px;">
                </div>
                <?php } } ?>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn_new_css disabled-on-loading" onclick="payNow(this)"> Pay Now </button>
            </div>
        </div>
    </div>
</div>
