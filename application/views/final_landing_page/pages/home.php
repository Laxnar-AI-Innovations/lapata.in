...
<style>
    ...
    .slider-style{
        animation-name: slideInDown; animation-duration: 700ms; animation-timing-function: ease; animation-delay: 1200ms; animation-direction: normal; animation-fill-mode: both;
    }
    .hfour-style{
        animation-name: slideInDown; animation-duration: 700ms; animation-timing-function: ease; animation-delay: 600ms; animation-direction: normal; animation-fill-mode: both;
    }
    .new_style{
        animation-name: slideInDown; animation-duration: 700ms; animation-timing-function: ease; animation-delay: 0ms; animation-direction: normal; animation-fill-mode: both;
    }
</style>
      ...
      <div class="container pt-7 pt-md-11 pb-8">
        <div class="row gx-0 gy-10 align-items-center">
          <div class="col-lg-7" data-cues="slideInDown" data-group="page-title" data-delay="600" data-disabled="true">
            <h4 class="text-white mb-4 hfour-style" data-cue="slideInDown" data-group="page-title" data-delay="600" data-show="true" >
            Khoji focuses on <br><span class="typer text-primary" data-delay="100" data-words="Reuniting Missing Person, Identify Unknown Person, Uploading Missing Person Details, Uploading Unknown Person Details, Search Person By Face Photo,Search Person By Identity, Search Vehicle Detail" style="color: black;"> Search Devices</span><span class="cursor text-primary" 
            data-owner="typer" style="transition: all 0.1s ease 0s; opacity: 1;">|</span></h4>
          
            
            <div data-cue="slideInDown" data-group="page-title" data-delay="600" data-show="true" class="slider-style">
                <div class="row">
                    <div class="col-lg-6">
                        <?php 
                        ...
                        <a class="btn btn-lg btn-secondary rounded m-1 p-1 proper_width" href="<?php echo base_url(); ?>check-person-face">
                            <div class="row btn btn-lg btn-secondary rounded m-1 p-0 proper_width">
                                <div class="col-3">
                                    <img src="<?php echo base_url(); ?>assets/images/faceicon.webp" class="width-100-percentage">
                                </div>
                                <div class="col-9">
                    ...
                    <div class="col-lg-6">
                        <a class="btn btn-lg btn-danger rounded m-1 p-1 proper_width" href="javascript:void(0)" onclick="showLoginAccordingly('missing')">
                            <div class="row btn btn-lg btn-danger rounded m-1 p-0 proper_width">
                                <div class="col-3">
                                    <img src="<?php echo base_url(); ?>assets_landing_page/img/missinglanding.png" alt="Khoji" class="width-100-percentage">
                                </div>
                                <div class="col-9">
                    ...
                    <div class="col-lg-6">
                        <a class="btn btn-lg btn-primary rounded m-1 p-1 proper_width" href="javascript:void(0)" onclick="showLoginAccordingly('unknown')">
                            <div class="row btn btn-lg btn-primary rounded m-1 p-0 proper_width">
                                <div class="col-3">
                                    <img src="<?php echo base_url(); ?>assets_landing_page/img/missingunknown.png" alt="Khoji" class="width-100-percentage">
                                </div>
                                <div class="col-9">
          ...
          <div class="col-lg-4 offset-lg-1 mb-n118" data-cues="slideInDown" data-disabled="true">
            <div class="position-relative new_style" data-cue="slideInDown" data-show="true" >
              <figure class="rounded shadow-lg"><img src="assets/images/khoji_1.webp"  alt="khoji"></figure>
            </div>
            <!-- /div -->
          </div>
          <!-- /column -->
    ...
    <section class="wrapper bg-gradient-primary wrapper-border">
      <div class="container py-5">
        <h3 class="text-center mb-8">Affiliations and Partnerships</h3>
        <div class="swiper-container clients mb-0" data-margin="30" data-dots="false" data-loop="true" data-autoplay="true" data-autoplaytime="1" data-drag="false" data-speed="3000" data-items-xxl="4" data-items-xl="3" data-items-lg="3" data-items-md="2" data-items-xs="1">
          <div class="swiper">
            <div class="swiper-wrapper ticker">
              <div class="swiper-slide px-5"><img src="<?= base_url(); ?>assets_landing_page/logos/digilocker.webp" alt="" /></div>
              <div class="swiper-slide px-5"><img src="<?= base_url(); ?>assets_landing_page/logos/aim.webp" alt="" /></div>
              <div class="swiper-slide px-5"><img src="<?= base_url(); ?>assets_landing_page/logos/incubation.webp" alt="" /></div>
              <div class="swiper-slide px-5"><img src="<?= base_url(); ?>assets_landing_page/logos/rru.webp" alt="" /></div>
            </div>
            <!--/.swiper-wrapper -->
          </div>
          <!-- /.swiper -->
      ...
      <div class="container pt-19 pt-md-12 pb-16 pb-md-10">
        <div class="row text-center">
          <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
            <h2 class="fs-16 text-uppercase text-primary mb-3">Who We are?</h2>
            <h3 class="display-6 mb-10 px-xxl-10">We are One-Click Reuniting System, Identifying Unknown Person and we also Reunite Missing Emotions of Families</h3>
          </div>
          <!-- /column -->
        </div>
        <!-- /.row -->
        <div class="row gx-lg-8 gx-xl-12 gy-11 px-xxl-5 text-center d-flex align-items-center">
          <div class="col-lg-4">
            <div class="px-md-15 px-lg-3">
              <figure class="mb-6"><img class="img-fluid" src="assets_landing_page/img/illustrations/i31.webp" srcset="assets_landing_page/img/illustrations/i31.webp 2x" alt=""></figure>
              <h3>Create New Account with a Secured Digilocker Verification</h3>
          ...
          <div class="col-lg-4">
            <div class="px-md-15 px-lg-3">
              <figure class="mb-6"><img class="img-fluid" src="assets_landing_page/img/illustrations/i30.webp" srcset="assets_landing_page/img/illustrations/i30.webp 2x" alt=""></figure>
              <h3>Search Person & Vehicle Details</h3>
          ...
          <div class="col-lg-4">
            <div class="px-md-15 px-lg-3">
              <figure class="mb-6"><img class="img-fluid" src="assets_landing_page/img/illustrations/i14.webp" srcset="assets_landing_page/img/illustrations/i14.webp 2x" alt=""></figure>
              <h3>Upload Details of Missing / Unknown Person, Self and Vehicles</h3>
    ...
    <section class="section-frame overflow-hidden">
      <div class="container-card ">
        <div class="card image-wrapper bg-full bg-image bg-overlay bg-overlay-light-500 mt-2 mb-5" data-image-src="assets_landing_page/img/photos/bg22.webp" style="background-image: url(&quot;assets_landing_page/img/photos/bg22.webp&quot;);">
          <div class="card-body py-2 px-0">
            <div class="container">
              <div class="row gx-md-8 gx-xl-12 gy-10 align-items-center text-center text-lg-start">
                ...
                <!--/column -->
                <div class="col-lg-4">
                  <img class="img-fluid mb-n1h8" src="assets_landing_page/img/illustrations/3d6.webp" srcset="assets_landing_page/img/illustrations/3d6.webp 2x" data-cue="fadeIn" data-delay="300" alt="" data-show="true" style="animation-name: fadeIn; animation-duration: 700ms; animation-timing-function: ease; animation-delay: 300ms; animation-direction: normal; animation-fill-mode: both;">
                </div>
                <!--/column -->
              </div>
              <!-- /.row -->
  ...
  <!-- /.content-wrapper -->
  <link href="<?= base_url(); ?>assets_landing_page/css/rcbrand.css" rel="stylesheet" type="text/css" />
  <script type="text/javascript" src="<?= base_url(); ?>assets_landing_page/js/jquery.rcbrand.js"></script>
  <script>
    $(".slides").rcbrand({
        visibleItems: 1,
        itemsToScroll: 1,
