                ...
                <form class="row g-3 needs-validation justify-content-center" method="post" action="<?php echo base_url(); ?>user/step2/do_register" novalidate id="registerForm">
                    <?php 
                      $csrf = array(
                        ...
                        $getLabelSettings = $this->db->query('select * from settings where name="detailLabels"')->result_array();
                        $decode = json_decode($getLabelSettings[0]['value'],true);
                        ...
                        $getLabelSettings = $this->db->query('select * from settings where name="aadharWatermarkLabels"')->result_array();
                        ...
                        $decode4 = json_decode($getLabelSettings[0]['value'],true);
                    ?>
                                ...
                                <div id="carouselExampleControls" class="carousel slide" data-bs-interval="2000" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            ...
                                            <div class="carousel-caption" style="bottom:0;padding-bottom:0;top:50px;transform:skewY(<?= $decode['rotate']; ?>);padding-top:0;left:0.5rem;right:unset;font-family:<?= $decode['font-family']; ?>">
                                                <<?= $decode['font-size']; ?> style="color:<?= $decode['color']; ?>;">Aadhar Photo</<?= $decode['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:0;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>;">
                                                <<?= $decode1['font-size']; ?> style="color:<?= $decode1['color']; ?>;">Aadhar Photo</<?= $decode1['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:52%;right:10%;left:unset;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>;opacity:0.2;">
                                                <<?= $decode1['font-size']; ?> style="color:white;"><?= $decode2['top']; ?></<?= $decode1['font-size']; ?>>
                                            </div>
                                        ...
                                        <div class="carousel-item">
                                            ...
                                            <div class="carousel-caption" style="bottom:0;padding-bottom:0;top:50px;transform:skewY(<?= $decode['rotate']; ?>);padding-top:0;left:0.5rem;right:unset;font-family:<?= $decode['font-family']; ?>">
                                                <<?= $decode['font-size']; ?> style="color:<?= $decode['color']; ?>;">Face Photo 1</<?= $decode['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:0;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>">
                                                <<?= $decode1['font-size']; ?> style="color:<?= $decode1['color']; ?>;">Face Photo 1</<?= $decode1['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:52%;right:10%;left:unset;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>;opacity:0.2;">
                                                <<?= $decode1['font-size']; ?> style="color:white;"><?= $decode3['top']; ?> 1</<?= $decode1['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:52%;right:unset;left:10%;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>;opacity:0.2;">
                                                <<?= $decode1['font-size']; ?> style="color:white;"><?= $decode3['top']; ?> 1</<?= $decode1['font-size']; ?>>
                                            </div>
                                        ...
                                        <?php } ?>
                                        <?php 
                                            if($persondetail[0]['facematchphoto1'] != NULL)
                                            {
                                        ?>
                                        <div class="carousel-item">
                                            <a href="<?php echo base_url(); ?><?php echo $persondetail[0]['facematchphoto1']; ?>"  data-lightbox="roadtrip">
                                                <img src="<?php echo base_url().''.$persondetail[0]['facematchphoto1']; ?>" style="width:100%;height:300px;max-width:100%!important;" class="d-block w-100" alt="...">
                                            </a>
                                            <div class="carousel-caption" style="bottom:0;padding-bottom:0;top:50px;transform:skewY(<?= $decode['rotate']; ?>);padding-top:0;left:0.5rem;right:unset;font-family:<?= $decode['font-family']; ?>">
                                                <<?= $decode['font-size']; ?> style="color:<?= $decode['color']; ?>;">Face Photo 2</<?= $decode['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:0;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>">
                                                <<?= $decode1['font-size']; ?> style="color:<?= $decode1['color']; ?>;">Face Photo 2</<?= $decode1['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:52%;right:10%;left:unset;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>;opacity:0.2;">
                                                <<?= $decode1['font-size']; ?> style="color:white;"><?= $decode3['top']; ?> 2</<?= $decode1['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:52%;right:unset;left:10%;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>;opacity:0.2;">
                                                <<?= $decode1['font-size']; ?> style="color:white;"><?= $decode3['top']; ?> 2</<?= $decode1['font-size']; ?>>
                                            </div>
                                        ...
                                        <?php } ?>
                                        <?php 
                                            if($persondetail[0]['facematchphoto2'] != NULL)
                                            {
                                        ?>
                                        <div class="carousel-item">
                                            <a href="<?php echo base_url(); ?><?php echo $persondetail[0]['facematchphoto2']; ?>"  data-lightbox="roadtrip">
                                                <img src="<?php echo base_url().''.$persondetail[0]['facematchphoto2']; ?>" style="width:100%;height:300px;max-width:100%!important;" class="d-block w-100" alt="...">
                                            </a>
                                            <div class="carousel-caption" style="bottom:0;padding-bottom:0;top:50px;transform:skewY(<?= $decode['rotate']; ?>);padding-top:0;left:0.5rem;right:unset;font-family:<?= $decode['font-family']; ?>">
                                                <<?= $decode['font-size']; ?> style="color:<?= $decode['color']; ?>;">Face Photo 3</<?= $decode['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:0;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>">
                                                <<?= $decode1['font-size']; ?> style="color:<?= $decode1['color']; ?>;">Face Photo 3</<?= $decode1['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:52%;right:10%;left:unset;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>;opacity:0.2;">
                                                <<?= $decode1['font-size']; ?> style="color:white;"><?= $decode3['top']; ?> 3</<?= $decode1['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:52%;right:unset;left:10%;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>;opacity:0.2;">
                                                <<?= $decode1['font-size']; ?> style="color:white;"><?= $decode3['top']; ?> 3</<?= $decode1['font-size']; ?>>
                                            </div>
                                        ...
                                        <div class="carousel-item">
                                            ...
                                            <div class="carousel-caption" style="bottom:0;padding-bottom:0;top:50px;transform:skewY(<?= $decode['rotate']; ?>);padding-top:0;left:0.5rem;right:unset;font-family:<?= $decode['font-family']; ?>">
                                                <<?= $decode['font-size']; ?> style="color:<?= $decode['color']; ?>;">General Photo <?= $k + 1; ?></<?= $decode['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:0;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>">
                                                <<?= $decode1['font-size']; ?> style="color:<?= $decode1['color']; ?>;">General Photo <?= $k + 1; ?></<?= $decode1['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:52%;right:10%;left:unset;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>;opacity:0.2;">
                                                <<?= $decode1['font-size']; ?> style="color:white;"><?= $decode4['top']; ?> <?= $k + 1; ?></<?= $decode1['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:52%;right:unset;left:10%;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>;opacity:0.2;">
                                                <<?= $decode1['font-size']; ?> style="color:white;"><?= $decode4['top']; ?> <?= $k + 1; ?></<?= $decode1['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:22%;right:unset;left:10%;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>;opacity:0.2;">
                                                <<?= $decode1['font-size']; ?> style="color:white;"><?= $decode4['bottom']; ?></<?= $decode1['font-size']; ?>>
                                            </div>
                                            <div class="carousel-caption" style="bottom:22%;right:10%;left:unset;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>;opacity:0.2;">
                                                <<?= $decode1['font-size']; ?> style="color:white;"><?= $decode4['bottom']; ?></<?= $decode1['font-size']; ?>>
                                            </div>
                                    ...
                                    <a class="carousel-control-prev" href="javascript:void(0)" data-bs-target="#carouselExampleControls" data-bs-slide="prev">
                                      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                      <span class="visually-hidden">Previous</span>
                                    </a>
                                    <a class="carousel-control-next" href="javascript:void(0)" data-bs-target="#carouselExampleControls" data-bs-slide="next">
                    ...
                    <?php 
                        ...
                        {
                    ?>
                    <div class="row mt-2 p-1 align-items-center">
                        <div class="col-md-6 col-sm-12 col-6 col-lg-6 text-end">
                    ...
                    <div class="row mt-2 p-1 align-items-center">
                        ...
                        <div class="col-md-6 col-sm-12 col-lg-6 col-6 text-left">
                            <h6 style="color: green;text-transform:uppercase;font-size:0.9em;"><?php echo ((count($getSpouseDetail) > 0) ? ($getSpouseDetail[0]['aadharname'].','.$getSpouseDetail[0]['vtc'].','.$getSpouseDetail[0]['state']) : '-'); ?></h6>
                        </div>
                    </div>
                    <hr style="margin-bottom: 0.4rem;margin-top: 0.4rem;">
                    <div class="row mt-1 p-1 align-items-center">
                        <div class="col-lg-12 col-sm-12 col-md-12 text-center">
                            <button type="button" class="btn btn-success save disabled-on-loading" onclick="viewSpouse(this,'<?php echo $getSpouseDetail[0]['aadhar_id']; ?>')" style="background:green!important;color:white!important;"> View Spouse Info</button> 
                        </div>
                    </div>
                    <hr style="margin-bottom: 0.4rem;margin-top: 0.4rem;">
                    <?php } ?>
                        ...
                        <div class="col-md-12 text-center border border-dark p-3">
                            <h6 class="text-dark">
                                ...
                                <a href="tel:<?php echo $persondetail[0]['well1']; ?>" id="contactspan" style="width:max-content;" class="phone btn btn-primary btn-style-green mt-2">
                                    <?php 
                                        if($persondetail[0]['wellrel1'] != 23)
                                        {
                                    ?>
                                    <i class="fa fa-phone"></i> CALL to <?php echo ($persondetail[0]['wellrel1'] != 0 ? ($getRelation[0]['relationName']) : 'Family Member'); ?>
                                    <?php }else{ ?>
                                    <i class="fa fa-phone"></i> CALL to <?php echo ($persondetail[0]['otherrelationname1'] != NULL ? ($persondetail[0]['otherrelationname1']) : 'Family Member'); ?>
                                    <?php } ?>
                                </a>
                                <?php } if($persondetail[0]['wellrel2'] != NULL){ 
                                ...
                                <a href="tel:<?php echo $persondetail[0]['well2']; ?>" id="contactspan" style="width:max-content;" class="phone btn btn-primary btn-style-green mt-2">
                                    <?php 
                                        if($persondetail[0]['wellrel2'] != 23)
                                        {
                                    ?>
                                    <i class="fa fa-phone"></i> CALL to <?php echo ($persondetail[0]['wellrel2'] != 0 ? $getRelation[0]['relationName'] : 'Family Member'); ?>
                                    <?php }else{ ?>
                                    <i class="fa fa-phone"></i> CALL to <?php echo ($persondetail[0]['otherrelationname2'] != NULL ? ($persondetail[0]['otherrelationname2']) : 'Family Member'); ?>
                                    <?php } ?>
                                </a>
                                <?php }if($persondetail[0]['wellrel3'] != NULL){ 
                                ...
                                <a href="tel:<?php echo $persondetail[0]['well3']; ?>" id="contactspan" style="width:max-content;" class="phone btn btn-primary btn-style-green mt-2">
                                    <?php 
                                        if($persondetail[0]['wellrel3'] != 23)
                                        {
                                    ?>
                                    <i class="fa fa-phone"></i> CALL to <?php echo ($persondetail[0]['wellrel3'] != 0 ? $getRelation[0]['relationName'] : 'Family Member'); ?>
                                    <?php }else{ ?>
                                    <i class="fa fa-phone"></i> CALL to <?php echo ($persondetail[0]['otherrelationname3'] != NULL ? ($persondetail[0]['otherrelationname3']) : 'Family Member'); ?>
                                    <?php } ?>
                                </a>
                                <?php } ?>
                            </h6>
                            ...
                            <h6 class="text-dark mb-0">
                                ...
                                <a href="javascript:void(0)" onclick="showLogin()" style="width:max-content;background:white!important;color:black!important;" class="phone btn btn-primary btn-style-four mt-3 mt-md-0">
                                    ...
                                    <path d="M64.5,78.2c1.7-1.9,3.6-3.6,5.4-5.4c2.6-2.7,2.7-5.9,0-8.6c-3.1-3.2-6.3-6.3-9.4-9.4
                                    							c-2.6-2.6-5.8-2.6-8.4,0c-2,1.9-3.9,3.9-5.9,5.9c-0.1,0.1-0.2,0.2-0.4,0.2l-1.3,1.3c-0.4,0.2-0.7,0.2-1.2,0
                                    							c-1.3-0.7-2.6-1.2-3.8-2c-5.7-3.6-10.5-8.2-14.7-13.4c-2.1-2.6-4-5.3-5.3-8.4c-0.2-0.5-0.2-0.9,0.1-1.3l1.3-1.3
                                    							c0.1-0.1,0.1-0.2,0.2-0.2c0.6-0.6,1.2-1.1,1.8-1.7c1.4-1.3,2.7-2.7,4.1-4.1c2.7-2.7,2.7-5.9,0-8.6c-1.5-1.5-3.1-3.1-4.6-4.6
                                    							c-1.6-1.6-3.2-3.2-4.8-4.8c-2.6-2.5-5.8-2.5-8.4,0c-2,1.9-3.9,3.9-5.9,5.9c-1.9,1.8-2.8,3.9-3,6.5c-0.2,4.1,0.7,8,2.1,11.8
...
<script type="text/javascript">
    ...
    function saveCallingId(logintype)
    {
        ...
        {
            location.href="<?= base_url(); ?>landing/login";
        }else{
    ...
    function viewSpouse(ele,aadhar)
    {
        $(ele).attr('disabled','disabled');
        $.ajax({
            url:'<?php echo base_url(); ?>landing/viewSpouseDetail',
            data:{Id:aadhar,'_token':'<?php echo $this->security->get_csrf_hash(); ?>'},
            type:'post',
            success:function(res)
            {
                let parse = JSON.parse(res);
