                    ...
                    <div class="card-body pt-3 table-responsive">
                        ...
                        <table class="table table-bordered datatable">
                           ...
                           <tbody>
                            ...
                            <?php 
                                $getfaqs = $this->db->query('select * from missingvehicle')->result_array();
                                if(count($getfaqs) > 0)
                                {
                                    $i = 0;
                                    foreach($getfaqs as $k=>$v)
                                    {
                                        ...
                                        <tr>
                                            <td><?= $i; ?></td>
                                            <td >
                                                <a href="<?php echo base_url();?>admin/missing_report_detail/missing_report_vehicle_detail/<?= $v['Id']; ?>" class="submitButton">
                                                <?= $v['ownerName']; ?>
                                                </a>
                                            </td>
                                            ...
                                            <td><?= $v['vehicleType']?></td>
                                            <td >
                                                <a class="badge bg-success" href="<?php echo base_url();?>admin/missing_report_detail/missing_report_vehicle_detail/<?= $v['Id']; ?>" class="submitButton">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                            </td>
