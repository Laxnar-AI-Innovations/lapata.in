                    ...
                    <div class="card-body pt-3 table-responsive">
                        <div class="row justify-content-right mb-3">
                            ...
                            <div class="col-lg-6 col-sm-6 text-end">
                                <a href="<?php echo base_url(); ?>admin/create_religion" class="btn btn-dark">Create Religion</a>
                            </div>
                        </div>
                        <hr>
                        <form id="addDl" action="<?php echo base_url(); ?>admin/updateReligion" method="post">
                            <?php 
                                $csrf = array(
                            ...
                            <div class="row mb-3">
                                <label for="relationName" class="col-md-6 col-lg-6 col-form-label">Enter Religion Name</label>
                                <div class="col-md-6 col-lg-6">
                                    <input type="text" class="form-control" id="relationName" value="<?= $relation[0]['religionName']; ?>" name="religionName" placeholder="Enter Religion Name" required>
                                </div>
                            </div>
