<p style="padding:15px">
    <br>
    Dialworker privacy policy has been compiled to better serve customers who are concerned with how their 'Personally Identifiable Information' (PII) is being used online. PII is information that can be used on its own or with other information to identify, contact, or locate a single person, or to identify an individual in context. Please read our privacy policy carefully to get a clear understanding of how we collect, use, protect or otherwise handle your Personally Identifiable Information in accordance with our website. If you do not agree to the policy, please do not use the Dialworker website or our mobile application.
...
<br>1.	To personalize user experience and to allow us to deliver the type of content and product offerings in which you are most interested.
<br>2.	To allow us to better service you in responding to your customer service requests.
<br>3.	To administer a contest, promotion, survey, or other platform features.
<br>4.	To quickly process your transactions.
<br><br>How do we protect visitor information?
...
<br><br>We use cookies to:
<br>1.	Help remember and process the items in the shopping cart.
<br>2.	Understand and save user's preferences for future visits.
<br>3.	Compile aggregate data about site traffic and site interactions in order to offer better site experiences and tools in the future. We may also use trusted third-party services that track this information on our behalf.
You can choose to have your computer warn you each time a cookie is being sent, or you can choose to turn off all cookies. You do this through your browser (such as Internet Explorer or Chrome) settings. Each browser is a little different, so look at your browser's Help menu to learn the correct way to modify your cookies.
If you disable cookies, some features may be disabled. It won't affect the user experience however may disable some actions that makes your site experience more efficient and some of our services may not function optimally. However, you will still be able to place orders.
