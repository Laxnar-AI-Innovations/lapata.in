                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                        <div class="form-group mb-3">
                            ...
                            <label for="type1" class="mx-1">Search By Identity</label>
                        </div>
                        <div class="form-group mb-3">
                            <input type="radio" data-bs-toggle="tooltip" data-bs-placement="top"  id="type2" name="type" class="form-check-input" value="3">
                            <label for="type2" data-bs-toggle="tooltip" data-bs-placement="top"  class="mx-1">Search By Biometric</label>
                        </div>
                         <div class="form-group mb-3">
                            <input type="radio" data-bs-toggle="tooltip" data-bs-placement="top"  id="type3" name="type" class="form-check-input" value="3">
                            <label for="type3" data-bs-toggle="tooltip" data-bs-placement="top"  class="mx-1">Search By QR Code</label>
                        </div>
                        <div class="form-group mb-3">
                            <!--<input type="radio" id="type3" name="type" class="form-check-input" value="4">-->
                            <input type="radio"  data-bs-toggle="tooltip" data-bs-placement="top"  id="type4" name="type" class="form-check-input" value="3">
                            <label for="type4" class="mx-1">Search Person By Filter</label>
                        </div>
        ...
        <div class="col-xl-8 px-0 <?php if($pn != 3){ echo "d-none"; } ?>">
          ...
          <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                        <h4 class="text-danger mb-0">Search by Identity</h4>
                    </div>
                </div>
                <hr>
                <div class="row">
                <?php 
                    if(isset($_SESSION['searchId']))
                    {
                        ...
                        {
                            $missingperson = $this->db->query('select * from missingperson where Id='.$getDetails[0]['missingId'])->result_array();
                        }else{
                            $missingperson = array();
                        }
        ...
        function showAccordingly()
        {
            ...
            if(choice == undefined)
            {
                ...
                if(choice != 3)
                {
                    ...
                    toastr.warning('This Service Will Coming Soon');
                }
            }
        }
  </script>