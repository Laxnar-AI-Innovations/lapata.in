...
<script type="text/javascript">
    ...
    function showLogin()
    {
        Swal.fire({
          ...
          html:
            '<div class="form-group mb-2 row justify-content-center mx-0"><div class="col-lg-auto col-sm-12 col-md-auto mb-3"><a href="<?php echo base_url(); ?>landing/login?id=<?php echo $id; ?>" class="w-100 save btn">Login</a></div><div class="col-lg-auto col-sm-12 col-md-auto"><a href="<?php echo base_url(); ?>landing/unknownregister?id=<?php echo $id; ?>" class="w-100 next btn">Signup</a></div></div></div>',
