...
<main id="main" class="main">
    ...
    <section class="section profile">
      <div class="row justify-content-center">
                ...
                <?php          
                    ...
                    ?>
                        <div class="col-lg-12 col-md-12 col-sm-12 d-flex flex-column">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-auto col-lg-auto col-sm-12 mt-2">
                                    <a href="<?php echo base_url(); ?>user/search_person_details" class="btn btn-primary next w-100"><i class="fa fa-search"></i> Search Another</a>
                                </div>
                            </div>
                        </div>
                        <?php }else{ 
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 d-flex flex-column">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-auto col-lg-auto col-sm-12 mt-2">
                                    <a href="<?php echo base_url(); ?>user/search_person_details" class="btn btn-primary next"><i class="fa fa-search"></i> Search Another</a>
                                </div>
                            </div>
                        </div>
                        <?php       
        ...
        <div class="row align-items-center justify-content-center <?php if($pn != 6){ echo "d-none"; } ?>">
            <?php 
            ...
            ?>
            <hr class="mb-0">
                <h5 class="text-center text-danger my-3">Missing Persons</h5>
            <hr>
            <div class="row">
                <?php 
...
<script type="text/javascript" src="https://www.viralpatel.net/demo/jquery/jquery.shorten.1.0.js"></script>
  <script type="text/javascript">
        ...
        $('#filterForm').on('submit',function(e)
        {
            ...
            $.ajax({
                ...
                success:function(res)
                {
                    ...
                    if(parse.count > 0)
                    {
                        location.href="<?php echo base_url(); ?>user/search_person_details?pn=6";   
                    }else{
    ...
    {
        window.open('<?php echo base_url(); ?>user/search_person_details?pn=3','_blank');
    }
        ...
        function showAccordingly()
        {
            ...
            if(choice == undefined)
            {
                ...
                if(choice != 3)
                {
                    if(choice != 4)
                    {
                        location.href="<?php echo base_url(); ?>user/search_person_details?pn="+choice;         
                    }else{
                        location.href="<?php echo base_url(); ?>user/search_person_details?pn=5";      
                    }
                }else{
                    if(choice != 4)
                    {
