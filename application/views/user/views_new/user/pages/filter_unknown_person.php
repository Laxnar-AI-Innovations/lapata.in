                    ...
                    <div class="card-body pt-3">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                ...
                                <form class="row g-3 mx-0 needs-validation" method="post" action="<?php echo base_url(); ?>user/filterUnknownPerson" novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 col-lg-3 mt-2 text-center px-3">
                                <div class="w-100 card" style="cursor:pointer;" data-bs-toggle="modal" data-bs-target="#Modal<?php echo $v['Id']; ?>">
