                            ...
                            <div class="card mb-3 shiva_height" >
                                <div class="card-body px-0">
                                    <div class="row align-items-center px-0 mx-0 justify-content-center">
                                        ...
                                        <div class="col mb-2">
                                            <div class="row">
                                                <div class="col col-md-auto col-lg col-xl-6 mt-3">
                                                    <div class="form-check form-switch">
                                                      ...
                                                      <label class="form-check-label" for="<?= $row['id']; ?>"><b id="statusColor<?= $row['id']; ?>" class="<?php echo ($isActive == '' ? 'text-danger' : 'text-success'); ?>">Complaint Status- <?php echo ($isActive == '' ? 'Inactive' : 'Active'); ?></b></label>
                                                    </div>  
                                                </div>
...
function showColorAccordingly(ele,id,appNo)
{
    if(ele.checked)
    {
        Swal.fire({
