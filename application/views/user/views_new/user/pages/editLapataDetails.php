            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 1){ echo "d-none"; } ?>">
                        <div class="card mb-3 w-100">
                            <div class="card-body mt-0">
                                <div class="pt-0 pb-0">
                                    <h5 class="card-title text-center pb-0 fs-4 mb-0">Edit लापता Person Details</h5>
                                </div>
                                <div>
                                    <!--Success message-->
                                    <?php 
                                ...
                                <div class="card-body mt-0 pb-0">
                                    <div class="row align-items-center justify-content-center">
                                        ...
                                        <div class="my-3 col-12 col-md-auto" id="aadharcleardiv">
                                            <button type="button" onclick="backToDashboard(this)" style="background:white!important;color:red!important;" class="btn w-100 btn-style-red text-center disabled-on-loading"> Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="step3" class="<?php if($pn != 3){ echo "d-none"; } ?>">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-0 pb-0">Add/update लापता person contact number</h5>
                                <?php 
                            ...
                            <div class="card-body py-3">
                                <div class="px-0 col-lg-10 col-md-12 col-sm-12 d-flex flex-column mx-lg-auto">
                                    ...
                                    <div class="row text-center justify-content-center">
                                        ...
                                        <div class="col-lg-auto mt-3 col-md-auto col-sm-12">
                                            <a href="<?php echo base_url(); ?>user/lapata_login" class="btn-style-green btn btn-primary d-block">Add More लापता Person</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $('#btn3Dashboard').click(function(){
        $(this).attr('disabled','disabled');
        $.ajax({
            url:'<?php echo base_url(); ?>user/updateContact?id=<?= $data[0]['id']; ?>',
            type:'get',
            success:function(res)
            {
