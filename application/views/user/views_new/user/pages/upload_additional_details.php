                              ...
                              <form id="addVoter" action="<?php echo base_url(); ?>user/addVoter" method="post">
                                  ...
                                  <div class="row mb-3">
                                      ...
                                      <div class="col-md-8 col-lg-6">
                                          <input type="text" class="form-control" id="voterNumber" name="voterNumber" placeholder="Enter Voter Number" required>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-md-12">
                            ...
                            <?php 
                              ...
                              <div class="row mb-3">
                                  ...
                                  <div class="col-md-8 col-lg-7">
                                      <input type="text" class="form-control" id="dlNumber" name="dlNumber" placeholder="Enter D.L Number" required>
                                  </div>
                              </div>
                                <div class="row mb-1">
                        ...
                        <div class="card-body pt-0">
                          ...
                          <form id="addPan" action="<?php echo base_url(); ?>user/addNewPan" method="post">
                              ...
                              <div class="row mb-3">
                                  ...
                                  <div class="col-md-8 col-lg-6">
                                      <input type="text" class="form-control" id="panNumber" name="panNumber" placeholder="Enter PAN Number" required>
                                  </div>
                              </div>
                              <div class="text-center">
            ...
            success:function(res)
            {
                 ...
                 if(parse.status == 'success')
                 {
                    Swal.fire({
                     ...
                     Swal.fire({
                        title: '<strong class="text-danger" style="font-size:20px;">PAN Error</strong>',
                        icon: 'error',
                        allowOutsideClick:false,
                        html:
                            '<div class="form-group mt-3"><label class="form-label" style="font-size:17px!important;">'+parse.message+'</label></div>',
                        showCloseButton: true,
                        showCancelButton: false,
                        focusConfirm: false,
                        showConfirmButton:false
            ...
            success:function(res)
            {
                 ...
                 if(parse.status == 'success')
                 {
                    Swal.fire({
                     ...
                     Swal.fire({
                        title: '<strong class="text-danger" style="font-size:20px;">Driving License Error</strong>',
                        icon: 'error',
                        allowOutsideClick:false,
                        html:
                            '<div class="form-group mt-3"><label class="form-label" style="font-size:17px!important;">'+parse.message+'</label></div>',
            ...
            success:function(res)
            {
                 ...
                 if(parse.status == 'success')
                 {
                    Swal.fire({
                     ...
                     Swal.fire({
                        title: '<strong class="text-danger" style="font-size:20px;">Voter Id Error</strong>',
                        icon: 'error',
                        allowOutsideClick:false,
                        html:
                            '<div class="form-group mt-3"><label class="form-label" style="font-size:17px!important;">'+parse.message+'</label></div>',
