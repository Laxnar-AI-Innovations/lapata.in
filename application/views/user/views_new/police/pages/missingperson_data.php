...
<main id="main" class="main">
    <div class="pagetitle">
      <h1>Search Missing Person By Filter</h1>
    </div>
    ...
    <div class="<?php if($pn != 2){ echo "d-none"; } ?>">
        ...
        <div class="container-fluid px-0">
        	...
        	<div class="side-bar" >
                ...
                <div class="row d-none mt-3" id="facePreviewDiv">
                    <div class="col-12">
                        <img id="facePreview" style="width:100%;height:150px;">
                    </div>
                </div>
                <div class="row">
            ...
            <div class="gallery px-0">
                <div class="image-container row">
                    <?php
                        ...
                        {
                    ?>
                    <div class="col-lg-4 col-md-6 px-0 px-md-2 col-12 col-search pb-2" data-imageId="<?php echo $row['imageId']??"-" ?>" data-cat="<?php echo $row['missingdl']??"-" ?>" data-gender="<?php echo $row['missinggender']??"" ?>" data-aadhar="<?php echo $row['missingaadhar']??"" ?>" data-pan="<?php echo $row['missingpan']??"" ?>" data-voter="<?php echo $row['missingvoter']??"" ?>" data-dl="<?php echo $row['missingdl']??"" ?>" data-state="<?php echo $row['fatherstate']??"" ?>" data-district="<?php echo $row['fatherdistrict']??"" ?>" data-city="<?php echo $row['fathercity']??"" ?>" data-personname="<?php echo $row['missingname']??"" ?>"  data-search="<?php echo $row['missingdl']; ?><?php echo $row['missingaadhar']; ?><?php echo $row['missingpan']; ?><?php echo $row['missingname']; ?><?php echo $row['otherDetail']; ?>" >
                                ...
                                <div class="card-body px-0">
                                    <div class="row align-items-center px-0 mx-0 justify-content-center">
                                        ...
                                        <div class="col-12 text-end mb-2">
                                            <button type="button" class="btn btn-dark" onclick="share(this,'<?php echo $row['Id']; ?>')" style="background:black!important;color:white!important;padding:10px 15px;"><i class="fa fa-share-alt"></i></button>
                                            <button type="button" class="btn btn-primary" onclick="view(this,'<?php echo $row['Id']; ?>')" style="background:darkblue!important;color:white!important;padding:10px 15px;"><i class="fa fa-eye"></i></button>
                                        </div>
                                        <div class="col-10">
                                        ...
                                        <div class="col-7 px-0">
                                            <?php if($row['missingname'] != '' || $row['missingname'] != NULL){ ?>
                                                <p class="card-title text-start py-0 fs-6"><b style="color:black;font-weight:600;">Name - </b><span style="color:grey;"><?php echo $row['missingname']??"--" ?></span></p>
                                                <p class="card-title text-start py-0 fs-6"><b style="color:black;font-weight:600;">Gender - </b><span style="color:grey;"><?php echo (ucfirst($row['missinggender'])); ?></span></p>
                                            <?php }else{ ?>
                                                <p class="card-title text-start py-0 fs-6"><b style="color:black;font-weight:600;">Gender - </b><span style="color:grey;"><?php echo (ucfirst($row['missinggender'])); ?></span></p>
                                            <?php } ?>
                                        <?php if($row['fatherstate'] != '' || $row['fatherstate'] != NULL){ ?>
                                                <p class="card-title text-start py-0 fs-6"><b style="color:black;font-weight:600;">Address - </b><span style="color:grey;"><?php echo ($row['fatherstate']) ?> , <?php echo ($row['fatherdistrict']) ?> - <?php echo ($row['fathercity']); ?></span></p>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <?php if($row['otherDetail'] != '' || $row['otherDetail'] != NULL){ ?>
                                    <div class="row col-12 px-4 pt-2" style="max-height:100px">
                                       <p class="card-title text-start py-0 fs-6"><b style="color:black;font-weight:600;">Other Details :- </b><br><span style="color:grey;" class="message"><?php echo $row['otherDetail']??"--"?></span></p> 
                                    </div>
                                    <?php } ?>
                                    <style>
...
function search(ele)
{
    ...
    if($('#facematchfilter').get(0).files.length > 0)
    {
        ...
        $.ajax({
            url:'<?php echo base_url(); ?>police/searchMissingByImage',
            type:'post',
            processData:false,
            contentType:false,
            cache:false,
...
document.querySelector('.reset-btn .btn').onclick = () => {
	window.location.href="<?php echo base_url(); ?>police/missing_person_filter";
};
