                        ...
                        <table class="table table-bordered datatable">
                           ...
                           <tbody>
                            ...
                            $thana_id=$this->session->userdata('police_id');
                                $getfaqs = $this->db->query('select * from criminals where type="wanted" and policeThanaId='.$thana_id)->result_array();
                                if(count($getfaqs) > 0)
                                {
                                    $i = 0;
                                    foreach($getfaqs as $k=>$v)
                                    {
                                        ...
                                        <tr>
                                            <td><?= $i; ?></td>
                                            <td >
                                                <a href="<?php echo base_url();?>police/thana_report_detail/wanted_detail/<?= $v['Id']; ?>" class="submitButton">
                                                <?= $v['personName']; ?>
                                                </a>
                                            </td>
                                            ...
                                            <td><?= $v['state']?></td>
                                            <td >
                                                <a class="badge bg-success" href="<?php echo base_url();?>police/thana_report_detail/wanted_detail/<?= $v['Id']; ?>" class="submitButton">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                            </td>
