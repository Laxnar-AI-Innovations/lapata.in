            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="<?php echo base_url('admin/faq/do_add'); ?>" enctype="multipart/form-data">
                           
                            <div class="form-row">
                            <div class="form-group col-md-4">
                            <label>Question</label>
                            <input type="text" name="txtquestion" class="form-control">
                            </div>
    ...
    <button name="btnsubmit" class="btn btn-primary">Save the details</button>
                        ...
                        <div class="col-md-12">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $i;?></td>
                                   <td><?php echo $bd['question'] ?></td>
                                   <td><?php echo $bd['answer'] ?></td>
                                    <td><?php echo $bd['status'] ?></td>
                                   
                                   
                                   <td><a class="btn btn-danger" href="<?php echo base_url('admin/faq/do_delete/'.$bd['id']); ?>">Delete</a></td>
