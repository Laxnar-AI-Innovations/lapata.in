 ...
 <div class="card shadow mb-1">
                        <div class="card-header py-3">
                            <!-- <h6 class="m-0 font-weight-bold text-primary">Community</h6> -->
                             <a href="<?php echo base_url('admin/events'); ?>" class="btn btn-primary purple" style="float:right;"> + Add Event</a>
                        </div>
            <div class="card">
                <div class="card-body">
                         ...
                         <div class="col-md-12">
                            ...
                            <tbody>
                                <?php
                                $i = 0;
                                    foreach($events as $bd){
                                        $i=$i+1;
                                ?>
                                <tr>
                                    <!-- <td><?php echo $i;?></td> -->
                                   <td><?php echo $bd['eventtitle'] ?></td>
                                   <td><?php echo $bd['community'] ?></td>
                                    ...
                                    <td><a class="btn btn-danger" href="<?php echo base_url('admin/events/do_delete/'.$bd['id']); ?>">Delete</a></td>

                                     <td><a class="btn btn-success" href="<?php echo base_url('admin/events/do_edit/'.$bd['id']); ?>">Edit/View</a></td>
