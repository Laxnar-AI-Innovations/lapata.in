...
<main id="main" class="main">
    <div class="pagetitle">
      <h1>Search Unknown Person By Filter</h1>
    </div>
                    ...
                    <form action="">
                        ...
                        <div class="row align-items-center">
                            <div class="form-group col-12 col-md-4 col-lg-6 mt-3 form-floating">
                                <input type="date" id="startFormDate" value="<?php echo ($_GET['type'] == 'user' ? date('Y-m-d',strtotime('-3 month')) :''); ?>" max="<?php echo date('Y-m-d'); ?>" class="form-control" name="startFormDate" required>
                                <label for="startFormDate" class="ms-2">From Date <b class="text-danger">*</b></label>
                            </div>
                            <div class="form-group col-12 col-md-4 col-lg-6 mt-3 form-floating">
                                <input type="date" id="endFormDate" value="<?php echo ($_GET['type'] == 'user' ? date('Y-m-d') :''); ?> max="<?php echo date('Y-m-d'); ?>" class="form-control" name="endFormDate" required>
...
document.querySelector('.reset-btn .btn').onclick = () => {
	window.location.href="<?php echo base_url(); ?>ngo/unknown_person_filter?type="+$('#type').val();
};
