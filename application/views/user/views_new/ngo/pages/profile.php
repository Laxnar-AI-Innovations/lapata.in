            ...
            <div class="card-body w-100">
              ...
              <div class=" pb-2">
                ...
                <div class="tab-content">
                    <?php $getProfileDetail = $this->db->query('select * from ngo where Id='.$_SESSION['ngo_id'])->result_array(); ?>
                    <div class="tab-pane fade profileTab active show" id="profileTab">
                       
                        <hr class="mb-4">
                        <form class="row g-3" method="post" action="<?php echo base_url(); ?>ngo/step2/do_register" id="registerForm">
                    <?php 
                      $csrf = array(
                    ...
                    <?php }else{ ?>
                        ...
                        <div class="row mb-3 d-none" id="other1div">
                            ...
                            <div class="form-group col-8" style="margin-top: 0.5rem;">
                                <button class="btn btn-primary disabled-on-loading" id="btnOtp1" onclick="sendOtp(1)" type="button"> Send OTP</button>
                            </div>
                            <div class="col-12">
                                <div class="row d-none" id="otp1div" style="text-align: center;margin-top: 0.5rem;">
                                    <div class="form-group col-12 text-right">
                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-10">
                            ...
                            <input readonly value="<?php echo $getProfileDetail[0]['alternate_mobile3']; ?>" type="text" name="alternatemob3" class="form-control mb-2" id="alternatemob3">
                        </div>
                        <div class="col-2 mb-2">
                            ...
                            <div class="row d-none" id="otp3div" style="text-align: center;margin-top: 0.5rem;">
                                <div class="form-group col-12 text-right">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-auto col-6 col-sm-12">
                                            <button class="btn btn-primary btn-style-five d-none disabled-on-loading" id="btnResendOtp3" onclick="resendOtp(this,3)" type="button">Resend OTP</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-sm-12 col-md-auto col-lg-auto mt-3">
                          <button class="btn btn-primary w-100 next" type="button" onclick="location.href='<?php echo base_url(); ?>ngo'">Go To Dashboard</button>
                        </div>
                        <!--<div class="col-sm-12 col-md-auto col-lg-auto mt-3">-->
...
<script type="text/javascript">
    ...
    function verifyDeleteOtp(ele,index)
    {
        ...
        if(otp != '')
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>ngo/deleteAlternateMobile',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
    ...
    function resendDeleteOtp(ele,index)
    {
        ...
        $.ajax({
            url:'<?php echo base_url(); ?>ngo/sendDeleteProfileOtp',
            data:otpdata,
            contentType: false,
            cache: false,
            processData:false,
    ...
    function verifyOtp(ele,index)
    {
        if($('#otp'+index).val() != '')
        {
            ...
            $.ajax({
              url:'<?php echo base_url(); ?>ngo/verifyProfileMobileOtp',
              data:data,
              contentType: false,
              cache: false,
              processData:false,
    ...
    function sendOtp(index)
    {
        if($('#othermob'+index).val() != '')
        {
            if($('#othermob'+index).val().length == 10)
            {
                ...
                $.ajax({
                  url:'<?php echo base_url(); ?>ngo/sendProfileMobileOtp',
                  data:data,
                  contentType: false,
                  cache: false,
                  processData:false,
