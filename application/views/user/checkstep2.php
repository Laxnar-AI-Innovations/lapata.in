        ...
        <div class="px-0 col-lg-10 col-xl-8 col-md-12 col-sm-12 d-flex flex-column align-items-center justify-content-center">
          ...
          <div class="card mb-3 w-100">
            ...
            <div class="card-body p-3">
              <div class="pb-2">
                <h5 class="card-title text-center pb-0 fs-4 pt-2">Person Details</h5>
              </div>
              <?php 
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 d-flex flex-column">
                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-md-auto col-lg-auto col-sm-12 mt-2">
                        ...
                        <?php }else{ ?>
                            <a href="<?php echo base_url(); ?>user/checkperson" class="btn btn-primary next w-100" style="width:max-content;"><i class="fa fa-search"></i> Search Another</a>
                        <?php } ?>
                    </div>
                    <div class="col-md-auto col-lg-auto col-sm-12 mt-2">
