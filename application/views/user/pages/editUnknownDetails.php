            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 1){ echo "d-none"; } ?>">
                        ...
                        <form id="loginForm" action="<?php echo base_url(); ?>user/uploadUnknown" method="post" class="row g-3 needs-validation1"  enctype="multipart/form-data">
                            <?php 
                                $csrf = array(
                                ...
                                <div class="card-body mt-0">
                                    <div class="row align-items-center ">
                                        <div class="form-floating col-12 col-md-2">
                                            ...
                                            <input type="date" class="form-control mt-2" name="rescueDate" id="rescueDate" value="<?= $data[0]['rescueDate'] != NULL ? date('Y-m-d',strtotime($data[0]['rescueDate'])) : ''; ?>" max="<?= date('Y-m-d') ?>">
                                        </div>
                                                ...
                                                <?php 
                                                    ...
                                                    if(count($state)>0)
                                                    {
                                                        ...
                                                        ?>
                                                            ...
                                                            <option value="<?php echo $row['ageBand'] ?>" <?php echo ($data[0]['Age'] == $row['ageBand'] ? 'selected' : ''); ?>><?php echo $row['ageBand']?></option>
                                                        <?php
                                                        }
                                                    }
                                                    else
                    ...
                    <div class="col-lg-12 col-md-12 d-flex px-0 flex-column align-items-center justify-content-center <?php if($pn != 2){ echo "d-none"; } ?>">
                        <div class="card mb-3 w-100">
                            <div class="card-body mt-0">
                                <div class="pt-0 pb-0">
                        ...
                        <form id="step2Form" method="post" class="row g-1 needs-validation1 w-100"  enctype="multipart/form-data">
                            ...
                            <?php } } ?>
                            <div class="card">
                                <div class="card-body mt-0 pb-0 px-1">
                                    <div class="row align-items-center justify-content-start">
                                        <div class="col-lg-auto col-md-auto my-3 col-6 pe-0">
                                            <button class="btn btn-dark w-100 btn-style-grey disabled-on-loading" id="btn2Back" type="button"> Back</button>
                                        </div>
                                        <div class="col-lg-auto col-md-auto my-3 col-6 ps-1">
                    ...
                    <div id="step3" class="<?php if($pn != 3){ echo "d-none"; } ?>">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-0 pb-0">Add/update your contact number</h5>
                            </div>
                        </div>
                        <?php 
                            for($i=1;$i<=3;$i++)
                        ...
                        <?php 
                            ...
                            {
                                $getIfAlready = $this->db->query('select * from uploadtransactions where type="unknown" and isKyc=1 and userId='.$_SESSION['user_id'].' and idNumber="'.$getPersonDetail[0]['Application_no'].'" and expiryDate >="'.date('Y-m-d').'"')->result_array();   
                            }else{ 
                                $getIfAlready = array();
                            }
                        ?>
                        <?php 
                            if($data[0]['isFromUpload'] == 1)
                            {
                        ?>
                        <div class="card">
                                    ...
                                    <div class="px-0 col-lg-12 col-md-12 col-sm-12 d-flex flex-column mx-lg-auto">
                                        ...
                                        <div class="row mx-0 justify-content-center">
                                            <div class="col-lg-6 col-md-6 col-12 px-0" style="top:-50px!important;background:white;height:auto;min-height:150px;">
                                                ...
                                                <?php } ?>
                                                <?php
                                                    $getProfileDetail = $this->db->query('select * from user where uid='.$unknownperson[0]['userId'])->result_array();
                                                ?>
                                                <div class="row align-items-center mt-3 mx-0">
                                                    <div class="col-lg-12 col-sm-12 col-md-12 text-center">
                                    ...
                                    <div class="col-md-12 text-center text-danger px-1 pb-3 p-3" style="font-weight:bold;">
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-lg-auto mb-3 col-sm-12 col-md-5">
                                                <button type="button" class="btn-style-red btn btn-primary d-block w-100 disabled-on-loading" style="background:black!important;padding:12px 10px!important" onclick="share('with','<?= $unknownperson[0]['Application_no']; ?>')"> Share Unknown Person Details <i class="fa fa-share-alt"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    function payNow(ele,count)
    {
        ...
        if($('#terms').is(':checked'))
        {
            ...
            location.href='<?php echo base_url(); ?>user/showUnknownPaymentModels?id=<?= $data[0]['id']; ?>';
        }else{
    ...
    $('#btn3Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>user/editUnknownDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=2";
    })
    ...
    $('#btn3Dashboard').click(function(){
        ...
        $.ajax({
            ...
            success:function(res)
            {
                ...
                setTimeout(function()
                {
                    location.href="<?php echo base_url(); ?>user/editUnknownDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=4";
                },2000);      
            }
        })
    })
    ...
    $('#btn2Next').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>user/editUnknownDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=3";
    })
    
    $('#btn2Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>user/editUnknownDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=1";
    })
