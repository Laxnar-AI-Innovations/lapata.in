        ...
        <div class="card-header py-1">
            <div class="row align-items-center">
                ...
                <div class="col ps-0 text-end">
                    <button type="button" onclick="location.href='<?= base_url(); ?>user/search_person_details?pn=7&type=unknown'" class="btn btn-style-grey disabled-on-loading" style="padding:8px 19px!important;"> <i class="fa fa-arrow-circle-left"></i></button>  
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-12 col-lg-6 col-md-6">
                    ...
                    <div class="row justify-content-center d-none" id="viewResultDiv">
                        <div class="text-center col-12 col-md-4 col-lg-6 mt-1">
                            <a href="<?= base_url(); ?>user/completeFaceMatchResults?type=unknown" style="padding: 0.6rem!important;" class="mx-0 btn btn-style-green disabled-on-loading w-100">View All Results Here...</a>
                        </div>
                    </div>  
                </div>
            </div>
            ...
            success:function(res)
            {
                ...
                var options = {
                    ...
                    "handler": function (response) {
                        $.ajax({
                            url:'<?php echo base_url(); ?>user/savePersonalUnknownPayment',
                            type:'get',
                            success:function(res)
                            {
                                Swal.fire({
