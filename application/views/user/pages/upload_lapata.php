                            ...
                            <div class="card-body px-1 mt-0">
                                <div class="row pt-0 pb-0" style="align-items:center;justify-content:space-between;">
                                    <div class="col-12 col-md-6 my-3">
                                        <h6 class="card-title pb-0 fs-6 text-center text-md-start">Add Missing Person Details <img src="<?= base_url(); ?>assets/img/missingblackicon.jpg" style="width:43px;height:50px;"></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body px-0 mt-0">
                                    <div class="row align-items-center mt-3" id="labelDiv">
                                        <div class="col-12 col-md-12 text-start">
                                            <div class="row align-items-center mx-0">
                                                <div class="form-group col-12 col-md-4 px-0" id="withDiv">
                                                    <div class="row mx-0 align-items-baseline">
                                                        <div class="col-md-auto col-1">
                                                            <input type="radio" name="selectType" class="form-check-input" checked id="newWith" onclick="selectRadio('with')">  
                                                        </div>
                                                        <div class="col-md-auto col-9">
                                                            <label for="newWith" onclick="selectRadio('with')">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="form-floating mt-3 col-12 col-md-auto hiddendiv d-none">
                                            <select class="form-control" style="font-weight:600;" name="Gender" id="Gender" >
    ...
    $('#btn3Dashboard').click(function(){
        ...
        $.ajax({
            ...
            success:function(res)
            {
                ...
                <?php } ?>
                $.ajax({
                    url:'<?php echo base_url(); ?>user/searchPersonFace',
                    data:data,
                    contentType: false,
                    cache: false,
                    processData:false,
                    ...
                    success:function(res)
                    {
                        ...
                        if(parse.finalCount > 0)
                        {
                            $.ajax({
                                ...
                                success:function(res)
                                {
                                    location.href="<?php echo base_url(); ?>user/view_expiry_lapata";  
                                }
                            })
                        }else{
                            location.href="<?php echo base_url(); ?>user/lapata_login?pn=4";  
