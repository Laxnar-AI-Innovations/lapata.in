...
function showColorAccordingly(isExpired,ele,id,appNo)
{
    if(ele.checked)
    {
        if(!isExpired)
        {
            ...
            location.href="<?php echo base_url(); ?>user/editFamilyDetails?id="+id;
        }else{
            Swal.fire({
...
function checkApp(ele)
{
	...
	if(value != '')
	{
	    location.href="<?= base_url(); ?>user/manageDraft?appNo="+value;   
	}else{
	    location.href="<?= base_url(); ?>user/manageDraft";
	}
}
