...
<main id="main" class="main">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-auto col-sm-12 col-lg-auto mt-4 text-center">
                                    <button type="button" class="btn btn-secondary d-block disabled-on-loading btn-style-grey disabled w-100" id="btnPay"> Procced to Pay</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-auto col-lg-auto col-sm-12 text-center mt-4">
                                        <button type="button" class="btn btn-secondary disabled d-block disabled-on-loading btn-style-grey disabled w-100" id="btnOtherPay"> Procced to Pay</button>
                                    </div>
                                </div>
                            </div>
                        </div>
  ...
  <script type="text/javascript">
    ...
    function updateAmount()
    {
        ...
        if(totalAmount > 0)
        {
            $('#btnPay').removeClass('btn-secondary btn-style-grey disabled').addClass('btn-success btn-style-green');
        }else{
            $('#btnPay').addClass('btn-secondary btn-style-grey disabled').removeClass('btn-success btn-style-green');
        }
    ...
    function updateOtherAmount()
    {
        ...
        if(totalAmount > 0)
        {
            $('#btnOtherPay').removeClass('btn-secondary btn-style-grey disabled').addClass('btn-success btn-style-green');
        }else{
            $('#btnOtherPay').addClass('btn-secondary btn-style-grey disabled').removeClass('btn-success btn-style-green');
        }
