                            ...
                            <div class="card-body mt-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 d-none">
                                        <h6 class="text-center pb-0 mt-4 mb-0" style="font-size:1.2rem;">Free Credits Left : - <?= $data[0]['isFree'] == 1 ? '1' : '0'; ?></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body mt-0">
                                    <div class="row align-items-center ">
                                        ...
                                        <div class="form-floating col-12 col-md-2">
                                            ...
                                            <input type="date" required id="dateCreated" max="<?= date('Y-m-d') ?>" name="dateCreated" class="form-control mt-2" value="<?= $data[0]['missingDate'] != NULL ? date('Y-m-d',strtotime($data[0]['missingDate'])) : ''; ?>">
                                        </div>
                                        ...
                                        <div class="form-floating col-12 col-md-2">
                                            ...
                                            <?php } ?>
                                            <input type="date" class="form-control mt-2" <?= ($data[0]['dob'] != NULL) ? '' : ''  ?> id="dob" name="dob" value="<?= $data[0]['dob']; ?>" onchange="getAgeBand(this.value)" max="<?= date('Y-m-d') ?>">
                                        </div>
...
<script>
    ...
    function payNow(ele)
    {
        ...
        if($('#terms').is(':checked'))
        {
            ...
            $.ajax({
                url:'<?= base_url(); ?>user/saveUniqueAadhar',
                data:uniqueData,
                type:'post',
                processData:false,
                contentType:false,
