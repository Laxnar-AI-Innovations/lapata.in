    ...
    <div class="container-fluid px-0">
        <div class="row justify-content-center">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="row align-items-center mx-1 mb-3 p-1" style="justify-content:space-around;">
                                        <div class="col-lg-auto col-sm-12 col-md-auto text-start my-1 border border-danger text-center <?= (count($lapataperson) > 0) ? '' : 'd-none'; ?>">
                                            <a target="_blank" href="<?= base_url(); ?>user/searchFaceResults" class="text-danger" style="text-decoration:none;font-weight:bold;">Missing - <?php echo (count($lapataperson) > 1 ? count($lapataperson) : count($lapataperson)); ?></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12 text-md-end text-center mb-3 mb-md-0">
                                    <a href="<?= base_url(); ?>user/searchFaceResults" target="_blank" class="btn btn-primary btn-style-five">View Results</a>
                                </div>
                            </div>
            ...
            <?php
                ...
                $getLastTransaction = $this->db->query('select * from uploadtransactions where isKyc=1 and type="unknown" and userId='.$_SESSION['user_id'].' and idNumber="'.$getUnknownDetail[0]['Application_no'].'" order by Id desc')->result_array();
