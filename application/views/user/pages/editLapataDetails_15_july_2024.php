    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row mb-3" id="oldPhotoDiv">
                    <div class="col-md-12 col-sm-12 col-lg-12 text-center form-floating">
                        <select class="form-control" id="oldPhotoOption">
                            <option value="">Choose option</option>
                            <option value="Few Months Before">Few Months Before</option>
                            <option value="Between 1 to 2 Years">Between 1 to 2 Years</option>
                            <option value="Between 2 to 3 Years">Between 2 to 3 Years</option>
                            <option value="Between 3 to 4 Years">Between 3 to 4 Years</option>
                            <option value="Between 4 to 5 Years">Between 4 to 5 Years</option>
                            <option value="More Than 5 Years Before">More Than 5 Years Before</option>
                        </select>
                        <label for="oldPhotoOption" class="ms-3">Uploaded Missing person photo (Approx) is:- </label>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 1){ echo "d-none"; } ?>">
                        <div class="card mb-3 w-100">
                            <div class="card-body mt-0">
                                <div class="pt-0 pb-0">
                                    <h5 class="card-title text-center pb-0 fs-4 mb-0">Edit Missing Person Details</h5>
                                </div>
                            </div>
                        </div>
                        <?php 
                            ...
                            $isActive = '';
                            $status = 'Inactive';
                            if($data[0]['aadharNumber'] != NULL)
                            {
                                $getLastTransaction = $this->db->query('select * from uploadtransactions where userId='.$_SESSION['user_id'].' and idNumber="'.$data[0]['aadharNumber'].'" order by Id desc')->result_array();
                                if(count($getLastTransaction) > 0)
                                {
                                    ...
                                    if(strtotime(date('d-m-Y')) <= strtotime(date('d-m-Y',strtotime('+3 months',strtotime($data[0]['dateCreated'])))))
                                    {
                                        $isExpired = 1;
                                    }
                                }
                                ...
                                $getLastTransaction = $this->db->query('select * from uploadWithoutTransactions where userId='.$_SESSION['user_id'].' and idNumber="'.$data[0]['Application_no'].'" order by Id desc')->result_array();
                                if(count($getLastTransaction) > 0)
                                {
                                    if(strtotime(date('d-m-Y')) <= strtotime(date('d-m-Y',strtotime($getLastTransaction[0]['expiryDate']))))
                                    {
                            ...
                            if($data[0]['dob'] == NULL)
                            {
                                $getFromUsers = $this->db->query('select * from user where aadhar_id="'.($data[0]['aadharNumber'] ?? 0).'"')->result_array();
                                if(count($getFromUsers) > 0)
                                {
                                    $age = calculateAge($getFromUsers[0]['dob']);
                                    $updateData = array(
                                        'dob' => $getFromUsers[0]['dob'],
                                        'Age' => $age
                                    );
                                    $this->db->where('id',$data[0]['id']);
                                    $this->db->update('unknown_person',$updateData);
                                    $data = $this->db->query('select * from unknown_person where id='.$data[0]['id'])->result_array();
                                }
                            }
                            $age = calculateAge($data[0]['dob']);
                        ?>
                        <div class="card mb-3 w-100 align-items-center justify-content-center">
                            <div class="card-body mt-0 w-100 p-2">
                                <div class="pt-0 pb-0">
                                    <div class="row justify-content-center align-items-center">
                                        <div class="col my-2">
                                            <h6 class="text-center mb-0" style="color:black;"><b>Application No.:- <br></b><?php echo $data[0]['Application_no']; ?></h6>
                                        </div>
                                        <?php 
                                            if($data[0]['isFinalSubmitted'] == 1)
                                            {
                                        ?>
                                        <div class="col my-2">
                                            <h6 class="text-center border border-danger px-4 py-2 mb-0" style="color:black;width:fit-content;"><b>Missing Status:- <br></b><b class="<?php echo ($isActive == '' ? 'text-red' : 'text-green'); ?>"><?php echo ($isActive == '' ? 'In-active' : 'Active'); ?></b></h6>
                                        </div>
                                        <div class="col my-2">
                                            <h6 class="text-center mb-0" style="color:black;"><b>Valid From:- <br></b><?php echo date('d-m-Y',strtotime($data[0]['dateCreated'])); ?></h6>
                                        </div>
                                        <?php 
                                            if(count($getLastTransaction) > 0)
                                            {
                                        ?>
                                        <div class="col my-2">
                                            <h6 class="text-center mb-0" style="color:black;"><b>Valid Till :- <br></b><?php echo date('d-m-Y',strtotime($getLastTransaction[0]['expiryDate'])); ?></h6>
                                        </div>
                                        <?php }else{ ?>
                                        <div class="col my-2">
                                            <h6 class="text-center mb-0" style="color:black;"><b>Valid Till :- <br></b>-- / -- / ----</h6>
                                        </div>
                                        <?php } ?>
                                        <?php } ?>
                                    </div>
                        ...
                        <form id="loginForm" action="<?php echo base_url(); ?>user/lapatawith" method="post" class="row g-3 needs-validation1"  enctype="multipart/form-data">
                            ...
                            <?php 
                                $getDetail = $this->db->query('select * from missingFaceMatchPayment where unknownId='.$data[0]['id'].' order by Id desc')->result_array();
                                $isFirst = 0;
                                if(count($getDetail) == 0)
                                {
                                    $isFirst = 1;
                                    $isFirstUploaded = 'unlock';
                                    ...
                                    {
                                        $firstCount++;
                                        $isSecondUploaded = 'unlock';
                                    }
                                    if($data[0]['Photo2'] != '')
                                    {
                                        $firstCount++;
                                        $isThirdUploaded = 'unlock';
                                    }
                                    $insertData = array(
                                        'unknownId' => $data[0]['id'],
                                        'paymentStatus' => 1,
                                        'imageCount' => $firstCount,
                                        'image1Status' => $isFirstUploaded,
                                        'image2Status' => $isSecondUploaded,
                                        'image3Status' => $isThirdUploaded,
                                    );
                                    $this->db->insert('missingFaceMatchPayment',$insertData);
                                }
                                $getDetail = $this->db->query('select * from missingFaceMatchPayment where imageCount != 3 and paymentStatus = 1 and unknownId='.$data[0]['id'].' order by Id desc')->result_array();
                                $firstCount = 1;
                                $isFirstUploaded = 'unlock';
                                $isSecondUploaded = 'lock';
                                $isThirdUploaded = 'lock';
                                ...
                                if(count($getDetail) > 0)
                                {
                                    $remainingCount = (3 - $getDetail[0]['imageCount']);
                                    if(count($getDetail) == 2)
                                    {
                                        $remainingCount += $getDetail[1]['imageCount'];
                                    }
                                }
                            ?>
                            <input type="hidden" id="remainingCount" name="remainingCount" value="<?= $remainingCount; ?>">
                            <input type="hidden" id="isFirstUploaded" name="isFirstUploaded" value="<?= $isFirstUploaded; ?>">
                            <input type="hidden" id="isSecondUploaded" name="isSecondUploaded" value="<?= $isSecondUploaded; ?>">
                            <input type="hidden" id="isThirdUploaded" name="isThirdUploaded" value="<?= $isThirdUploaded; ?>">
                            <input type="hidden" name="applicationNo" value="<?= $data[0]['Application_no']; ?>">
                            <input type="hidden" name="howoldfacematch" id="howoldfacematch" value="<?= $data[0]['howoldfacematch'] != NULL ? $data[0]['howoldfacematch'] : ''; ?>">
                            <input type="hidden" name="howoldfacematch1" id="howoldfacematch1" value="<?= $data[0]['howoldfacematch1'] != NULL ? $data[0]['howoldfacematch2'] : ''; ?>">
                            <input type="hidden" name="howoldfacematch2" id="howoldfacematch2" value="<?= $data[0]['howoldfacematch2'] != NULL ? $data[0]['howoldfacematch2'] : ''; ?>">
                            <div class="card">
                                <div class="card-body mt-0">
                                    <div class="row align-items-center ">
                                        ...
                                        <div class="form-floating my-3 col-12 col-md-2">
                                            <input type="number" readonly class="form-control" value="<?php echo ($data[0]['aadharNumber'] == '' ? '' : $data[0]['aadharNumber']); ?>" name="aadharNumber" onkeydown="limit(this,'aadhar');" onkeyup="limit(this,'aadhar');" id="aadharNumber"  placeholder="Aadhar Number">
                                        ...
                                        <div class="form-floating col-12 col-md-2">
                                            ...
                                            <input type="text" class="form-control mt-2" readonly value="<?= $data[0]['missingDate'] != NULL ? date('d-m-Y',strtotime($data[0]['missingDate'])) : date('d-m-Y',strtotime($data[0]['dateCreated'])); ?>">
                                        </div>
                                        <div class="form-floating my-3 col-12 col-md-4">
                                         ...
                                         <div class="form-floating my-3 col-12 col-md-2">
                                            <select class="form-control" style="font-weight:bold;" name="Gender" disabled id="Gender" required>
                                        ...
                                        <div class="form-floating col-12 col-md-2">
                                            ...
                                            <?php } ?>
                                            <input type="date" class="form-control mt-2" <?= ($data[0]['dob'] != NULL) ? 'readonly' : ''  ?> id="dob" name="dob" value="<?= $data[0]['dob']; ?>" onchange="getAgeBand(this.value)" max="<?= date('Y-m-d') ?>">
                                        </div>
                                ...
                                <div class="card-body mt-0">
                                    <div class="row align-items-center ">
                                        <div class="form-floating my-3 col-12 col-md-3">
                                            <input type="text" class="form-control text-uppercase" maxlength="10" name="PAN"   id="PAN"  placeholder="Aadhar Number" value="<?php echo ($data[0]['PAN'] == '' ? '' : $data[0]['PAN']); ?>">
                                            <label for="PAN" class="ms-3">PAN No.</label>
                                        </div>
                                        <div class="form-floating my-3 col-12 col-md-3">
                                            <input type="text" class="form-control text-uppercase" name="DL_no" maxlength="15"  id="DL_no"  placeholder="Aadhar Number" value="<?php echo ($data[0]['DL_no'] == '' ? '' : $data[0]['DL_no']); ?>">
                                            <label for="DL_no" class="ms-3">DL No.</label>
                                        </div>
                                        <div class="form-floating my-3 col-12 col-md-3">
                                            <input type="text" class="form-control text-uppercase" name="voter_id"   id="voter_id"  placeholder="Aadhar Number" value="<?php echo ($data[0]['voter_id'] == '' ? '' : $data[0]['voter_id']); ?>">
                                            <label for="voter_id" class="ms-3">Voter ID No.</label>
                                        </div>
                                        <div class="form-floating my-3 col-12 col-md-3">
                                            <input type="text" class="form-control text-uppercase" name="vehicle_no"   id="vehicle_no"  placeholder="Aadhar Number" value="<?php echo ($data[0]['vehicle_no'] == '' ? '' : $data[0]['vehicle_no']); ?>">
                            ...
                            <div class="card mb-3 w-100">
                                ...
                                <div class="card-body mt-0 pb-0" id="goldDetail">
                                    ...
                                    <?php }else{ ?>
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12 col-md-12 text-end my-3" id="addMoreDiv">
                                            <button type="button" class="btn btn-style-red disabled-on-loading" style="border-radius:0!important;background:black!important;" id="addMore" onclick="addMoreGold()"> Add More</button>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    <?php }else{ ?>
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12 col-md-12 text-end d-none my-3" id="addMoreDiv">
                                            <button type="button" class="btn btn-style-red disabled-on-loading" style="border-radius:0!important;background:black!important;" id="addMore" onclick="addMoreGold()"> Add More</button>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <div class="row align-items-center justify-content-start justify-content-md-center">
                                        <div class="col-lg-auto col-10 col-md-auto col-sm-12 mt-2 form-floating">
                                        ...
                                        <div class="col-lg-auto col-md-auto col-sm-12 col-10 my-3 form-floating">
                                            ...
                                            <label for="goldHUIDNumber<?= $i; ?>" class="ms-2">Enter Gold HUID Number</label>
                                        </div>
                                        <div class="col-lg-auto col-md-auto col-sm-12 col-2 my-3">
                                            <button type="button" onclick="removeGold(this,'old',<?= $i; ?>)" class="btn btn-danger disabled-on-loading" style="background:white!important;color:red!important;"> <i class="fa fa-trash"></i></button>
                                        </div>
                                    </div>
                                    <?php } } ?>
                                </div>
                            ...
                            <div class="card mb-3 w-100">
                                 <div class="pt-0 pb-0">
                                    <h5 class="card-title text-center pb-0 fs-4 mb-0">Address Of Missing Person</h5>
                                </div>
                                <div class="card-body mt-0 pb-0">
                                    <div class="row align-items-center justify-content-center">
                                        ...
                                        <div class="mb-3 col-12 col-md-4">
                                            <label class="mb-2 d-block">List of citites </label>                            
                            ...
                            <div class="card">
                                <div class="card-body mt-0 pb-0">
                                    <div class="row align-items-center justify-content-center">
                                        <div class="my-3 col-12 col-md-auto" id="aadharcleardiv">
                            ...
                            <div class="card">
                                <div class="card-body mt-0 pb-0 px-0">
                                    <div class="row align-items-center justify-content-start">
                                        <div class="col-lg-auto col-md-auto my-3 col-6">
                    ...
                    <div id="step3" class="px-0 <?php if($pn != 3){ echo "d-none"; } ?>">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h6 class="text-dark mb-0"><b>Edit your reward amount</b></h6>
                            </div>
                            <?php 
                            ...
                            <div class="card-body p-2">
                                <div class="row align-items-center d-none" id="rewardEditdiv">
                                    <div class="form-group form-floating col-md-auto col-10 col-lg-3">
                                        <input type="text" oninput="numberOnly(this.id);" class="form-control" maxlength="5" name="rewardAmount" onKeyUp="showRewardAccordingly(this.value)" id="rewardAmount"  placeholder="Reward Amount" value="<?php echo ($getPersonDetail[0]['rewardamount'] != NULL ? $getPersonDetail[0]['rewardamount'] : 0) ?>">
                                    ...
                                    <div class="form-group col-md-auto col-2 ps-1 col-lg-auto">
                                        <button type="button" onclick="checkReward(this)" id="rewardBtn" style="border-radius:5px 5px!important;padding: 9px 15px!important" class="btn btn-style-grey disabled text-center disabled-on-loading"> <i class="fa fa-check-circle"></i></button>
                                    </div>
                                </div>
                                <div class="row align-items-center" id="rewardDeletediv">
                                    <div class="form-group form-floating col-md-auto col-7 col-lg-3">
                                        <input type="text" oninput="numberOnly(this.id);" class="form-control" readonly maxlength="5" name="rewardAmount" onKeyUp="showRewardAccordingly(this.value)" id="rewardAmount"  placeholder="Reward Amount" value="<?php echo ($getPersonDetail[0]['rewardamount'] != NULL ? $getPersonDetail[0]['rewardamount'] : 0) ?>">
                        ...
                        <?php 
                            ...
                            {
                                $getIfAlready = $this->db->query('select * from uploadtransactions where type="lapata" and isKyc=1 and userId='.$_SESSION['user_id'].' and idNumber="'.$getPersonDetail[0]['aadharNumber'].'" and expiryDate >="'.date('Y-m-d').'"')->result_array();   
                            }else{
                                $getIfAlready = $this->db->query('select * from uploadWithoutTransactions where type="lapata" and isKyc=1 and userId='.$_SESSION['user_id'].' and idNumber="'.$getPersonDetail[0]['Application_no'].'" and expiryDate >="'.date('Y-m-d').'"')->result_array();                                
                            }
                        ?>
                        <?php }else{ 
                            $getIfAlready = array();
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="form-group col-md-auto col-sm-12 col-lg-auto">
                                        ...
                                        <label for="terms" class="radio-custom-label">I Agree to Terms & Conditions <a href="<?php echo base_url(); ?>missing-terms" target="_blank" style="text-decoration:underline;color:#4154f1;"><b>View</b></a></label>      
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="col-md-12 text-center text-danger px-1 pb-3 p-3" style="font-weight:bold;">
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-lg-4 mb-3 col-sm-12 col-md-4">
                                                        <button type="button" class="btn-style-red btn btn-primary d-block w-100 disabled-on-loading" style="background:black!important" onclick="showLink()"> Share <i class="fa fa-share-alt"></i></button>
                                                    </div>
                                                </div>
                                                <div class="row justify-content-center" style="display:none;" id="shareDiv">
                                                    <div class="ps-0 col-md col-sm-12 mb-3">
                                                        <button type="button" style="padding:0.5rem!important;" class="btn-style-four btn btn-primary d-block w-100 disabled-on-loading" onclick="share('without','<?= $getPersonDetail[0]['Application_no']; ?>')"> 
                                                    ...
                                                    <div class="col-md col-sm-12 mb-3">
                                                        <button type="button" style="padding:0.5rem!important;" class="btn-style-five btn btn-primary d-block w-100 disabled-on-loading" onclick="share('with','<?= $getPersonDetail[0]['Application_no']; ?>')"> 
...
<script>
    ...
    function payNow(ele)
    {
        ...
        $.ajax({
            url:'<?php echo base_url(); ?>user/saveReward',
            type:'post',
            processData:false,
            contentType:false,
            data:data,
            ...
            success:function(res)
            {
                setTimeout(function()
                {
                    location.href='<?php echo base_url(); ?>user/showPaymentModels?type=missing&id=<?= $data[0]['id']; ?>';
                },2000);      
            }
        })
    }
    ...
    $('#btn3Next').click(function(){
        ...
        $.ajax({
            ...
            success:function(res)
            {
                ...
                setTimeout(function()
                {
                    location.href="<?php echo base_url(); ?>user/editLapataDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=4";
                },2000);      
            }
        })
    })
    ...
    {
        $(ele).attr('disabled',true);
        location.href="<?php echo base_url(); ?>user/manage_lapata";
    }
    ...
    $('.crop_image').click(function(event){
        $image_crop.croppie('result', {
          ...
          quality:0.5,
            ...
            if(type == 'facematch')
            {
                if($('#oldPhotoOption').val() != '')
                {
                    $('#howoldfacematch'+index).val($('#oldPhotoOption').val());
                    if(index != '')
                    {
                        if($('#facematch').val() != '')
                        {
                            ...
                            $.ajax({
                                ...
                                success:function(res)
                                {
                                    ...
                                    {
                                        $('#remainingCount').val(parseInt($('#remainingCount').val()) - 1);
                        ...
                        if($('#facematch1').val() != '')
                        {
                            ...
                            if($('#facematch2').val() != '')
                            {
                                ...
                                $('#facematch'+index).val(response);
                                let profile=document.getElementById('profile-pic'+index);
                                $('#crossIcon'+index).addClass('d-none'); 
                                $('#uploadimageModal').modal('hide');
                                profile.src=response;   
                            }
                        }
                    ...
                    toastr.error('Select how old the selected is.');
                    $('#oldPhotoOption').addClass('input-border-red');
                }
            }else{
        ...
        if(type == 'facematch')
        {
            if($('#input-file'+i)[0].files.length > 0)
            {
                ...
                if(isImage)
                {
                    ...
                    $('#oldPhotoOption').val('');
                    $('#oldPhotoOption').removeClass('input-border-red');
    ...
    function deleteReward(ele)
    {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url:'<?php echo base_url(); ?>user/saveReward',
                    data:{id:<?php echo $data[0]['id']; ?>,rewardAmount:null,'_token':'<?php echo $this->security->get_csrf_hash(); ?>'},
                    type:'post',
                    success:function(res)
                    {
    ...
    function checkReward(ele)
    {
        ...
        $.ajax({
            url:'<?php echo base_url(); ?>user/saveReward',
            data:{id:<?php echo $data[0]['id']; ?>,rewardAmount:$('#rewardAmount').val(),'_token':'<?php echo $this->security->get_csrf_hash(); ?>'},
            type:'post',
            success:function(res)
            {
    ...
    $('#btn3Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>user/editLapataDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=2";
    })
    
    $('#btn2Next').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>user/editLapataDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=3";
    })
    
    $('#btn2Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>user/editLapataDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=1";
    })
    ...
    $('#my-button').click(function(){
        <?php 
            if($_SESSION['aadhar_id'] == '534471189527' || $_SESSION['aadhar_id'] == '407174335143')
            {
        ?>
        if($('#remainingCount').val() > 0)
        {
            $('#input-file').val('');
            $('#input-file').click();
        }
        else
        {
            Swal.fire({
                ...
                allowOutsideClick:false,
                html:
                    '<h5 class="mb-0"><b style="color:black;">If you want to change the images, You have to pay Rs. <?= $payAmount; ?></b></h5>',
                showCloseButton: true,
                showCancelButton: true,
                focusConfirm: true,
                reverseButtons:true,
                    ...
                    var options = {
                    	...
                    	"handler": function (response) {
                    		...
                    		$.ajax({
                    		    ...
                    		    {
                    		        Swal.fire({
                    		            title:'<strong style="font-size:1rem;color:black;">Payment Completed Successfully. Now you can edit the photos.</strong>',
                    		            icon:'success',
                    		            customClass:{
                    		                actions:'mt-0'
                    		            },
                ...
                if(result.isDismissed){
                    ...
                    var options = {
                    	...
                    	modal:{
                    	    ...
                    	    {
                                toastr.error('Payment Cancelled');
                                $('#my-button1').removeAttr('disabled');        
                    	    }
                    	},
                    	"prefill": {
                    		"name": "<?php echo $_SESSION['aadharName']; ?>", // pass customer name
                ...
                if(result.isDismissed){
                    ...
                    var options = {
                    	...
                    	modal:{
                    	    ...
                    	    {
                                toastr.error('Payment Cancelled');
                                $('#my-button2').removeAttr('disabled');        
                    	    }
                    	},
                    	"prefill": {
                    		"name": "<?php echo $_SESSION['aadharName']; ?>", // pass customer name
