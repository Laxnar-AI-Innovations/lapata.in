...
<main id="main" class="main px-2">
    <div class="pagetitle">
      <h5>Welcome, <b class="text-success"><?= $_SESSION['aadharName']; ?>!</b></h5>
    </div><!-- End Page Title -->
    ...
    <section class="section profile">
      <div class="row mx-0">
        <div class="col-xl-12 px-0">
          ...
          <div class="<?php if($pn !=5 && $pn !=3 && $pn !=6){ echo "card"; } ?>">
            <div class="<?php if($pn !=5 && $pn !=3 && $pn !=6){ echo "card-body"; } ?>">
                    ...
                    <div class="floatingButtonWrap">
                        <div class="floatingButtonInner">
                            ...
                            <ul class="floatingMenu">
                                ...
                                <li>
                                    <a href="<?php echo base_url(); ?>user/upload_personal_details?pn=3">Add Contact Numbers</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>user/upload_personal_details?pn=4">Marital Details</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>user/upload_personal_details?pn=7">Add Vehicle Details</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>user/upload_personal_details?pn=8">Add Gold HUID Details</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>user/upload_personal_details?pn=5">Add Face Match Photo</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>user/upload_personal_details?pn=6">Add Latest Photos</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade show active profile-edit pt-0" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                    <div id="step1" class="<?php if($pn != 1){ echo "d-none"; } ?>">
                        <form id="step1Form">
                            <h5 class="card-title pt-2 mb-0">Thanks for Registering. Now let's build your profile</h5>
                            <hr class="my-0">
                            <div class="row mb-3">
                                <div class="col-md-4 col-lg-3 form-group">
                                    <label for="aadharNumber" class="col-form-label">Aadhar Number</label>
                                    <input type="text" class="form-control" id="aadharNumber" value="<?php echo substr_replace($userdetail[0]['aadhar_id'],'XXXXXXXX',0,8); ?>" readonly>
                                </div>
                               <div class="col-md-4 col-lg-3 form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-lg-auto col-md-auto mb-3">
                                    <button type="submit" id="btn1" class="next w-100 btn btn-primary disabled-on-loading"> Next</button>
                                </div>
                            </div>
                    ...
                    <div id="step2" class="<?php if($pn != 2){ echo "d-none"; } ?>">
                        <form id="step2Form">
                            <h5 class="card-title pt-2 mb-0">Aadhar Address</h5>
                            <hr class="my-0">
                            <div class="row mb-0">
                            ...
                            <?php
                                ...
                                if($userdetail[0]['isSame'] != 1)
                                {
                                    ...
                                    $isSameCity = 0;
                                    $isSamePincode = 0;
                                    $curAddress = (($userdetail[0]['landmark'] != '') ? $userdetail[0]['landmark'].',' : '').''.(($userdetail[0]['locality'] != '') ? $userdetail[0]['locality'] : '');
                                    if($userdetail[0]['curaddress'] == $curAddress)
                                    {
                                        $isSameAddress = 1;
                                    }
                                    if($userdetail[0]['state'] == $userdetail[0]['curstate'])
                                    {
                                        $isSameState = 1;
                                    }
                                    if($userdetail[0]['district'] == $userdetail[0]['curdistrict'])
                                    {
                                        $isSameDistrict = 1;
                                    }
                                    if($userdetail[0]['vtc'] == $userdetail[0]['curcity'])
                                    {
                                        $isSameCity = 1;
                                    }
                                    if($userdetail[0]['pincode'] == $userdetail[0]['curpincode'])
                                    {
                                        $isSamePincode = 1;
                                    }
                                    if($iSameAddress == 1 && $isSameState == 1 && $isSameDistrict == 1 && $isSameCity == 1 && $isSamePincode == 1)
                                    {
                                        $isSame = 1;
                                    }
                                }else{
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-12 col-lg-auto col-md-4 mt-2">
                                    <input type="checkbox" class="form-check-input" id="isSame" name="isSame" <?php if($isSame == 1){ echo "checked"; } ?>>
                                    <label for="isSame" class="d-inline text-dark">Current Address is same as Aadhar Address</label>
                                </div>
                                <div class="col-sm-12 col-lg-auto col-md-4 mt-2">
                                    <input type="checkbox" id="editAddress" class="form-check-input" onclick="enableEdit(this)">
                                    <label for="editAddress" class="d-inline text-dark">Want to edit current Address?</label>
                                </div>
                            </div>
                            <hr class="my-2">
                            <div id="samediv" class="<?php if($isSame != 1){ echo 'd-none'; } ?>">
                                <div class="row mb-3">
                                    <div class="col-md-6 col-lg-6 form-group">
                                        <label for="address" class="col-form-label">Address</label>
                                        <input type="text" class="form-control" <?php if($isSame == 1){ ?> name="curaddress" required <?php } ?> id="cursameaddress" readonly value="<?php echo (($userdetail[0]['curaddress'] != '') ? $userdetail[0]['curaddress'] : ''); ?>">
                                    </div>
                                    <div class="col-md-6 col-lg-6 form-group">
                                        <label for="state" class="col-form-label">State</label>
                                        <input type="text" <?php if($isSame == 1){ ?> name="curstate" required <?php } ?> class="form-control" id="cursamestate" readonly value="<?php echo $userdetail[0]['curstate']; ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-4 col-lg-4 form-group">
                                        <label for="district" class="col-form-label">District</label>
                                        <input type="text" <?php if($isSame == 1){ ?> name="curdistrict" required <?php } ?> class="form-control" readonly id="cursamedistrict" value="<?php echo $userdetail[0]['curdistrict']; ?>">
                                    </div>
                                    <div class="col-md-4 col-lg-4 form-group">
                                        <label for="curcity" class="col-form-label">City</label>
                                        <input type="text" class="form-control" <?php if($isSame == 1){ ?> name="curcity" required <?php } ?> readonly id="cursamecity" value="<?php echo $userdetail[0]['curcity']; ?>">
                                    </div>
                                    <div class="col-md-4 col-lg-4 form-group">
                                        <label for="pincode" class="col-form-label">Pincode</label>
                                        <input type="text" <?php if($isSame == 1){ ?> name="curpincode" required <?php } ?> class="form-control" readonly id="cursamepincode" value="<?php echo $userdetail[0]['curpincode']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div id="notsamediv" class="<?php if($isSame != 0){ echo 'd-none'; } ?>">
                                <div class="row mb-3">
                                    <div class="col-md-6 col-lg-6 form-group">
                                        <label for="address" class="col-form-label">Address</label>
                                        <input type="text" class="form-control" <?php if($isSame == 0){ ?> name="curaddress" disabled required <?php } ?>  id="curnotsameaddress" value="<?php echo (($userdetail[0]['curaddress'] != '') ? $userdetail[0]['curaddress'] : ''); ?>">
                                    </div>
                                    <div class="col-md-6 col-lg-6 form-group">
                                        <label for="state" class="col-form-label">State</label>
                                        <select <?php if($isSame == 0){ ?> name="curstate" disabled required <?php } ?> id="curnotsamestate" class="form-control select2">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4 col-lg-4 form-group">
                                        <label for="district" class="col-form-label">District</label>
                                        <select <?php if($isSame == 0){ ?> name="curdistrict" disabled required <?php } ?> id="curnotsamedistrict" class="form-control select2">
                                            <option value="">Select District</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 col-lg-4 form-group">
                                        <label for="curcity" class="col-form-label">City</label>
                                        <input type="text" class="form-control" <?php if($isSame == 0){ ?> name="curcity" disabled required <?php } ?> id="curnotsamecity" value="<?php echo $userdetail[0]['curcity']; ?>">
                                    </div>
                                    <div class="col-md-4 col-lg-4 form-group">
                                        <label for="pincode" class="col-form-label">Pincode</label>
                                        <input type="text" name="curpincode" <?php if($isSame == 0){ ?> name="curpincode" disabled required <?php } ?> class="form-control" id="curnotsamepincode" value="<?php echo $userdetail[0]['curpincode']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12 col-5 px-1 col-md-auto col-lg-auto mt-3">
                                ...
                                <div class="col-sm-12 col-7 ps-1 pe-0 col-md-auto col-lg-auto mt-3">
                                    <button type="submit" id="btn2" class="next btn btn-primary w-100 px-4 disabled-on-loading"> Save & Next</button>
                                </div>
                            </div>
                        </form><!-- End Profile Edit Form -->
                    </div>
                    <div id="step4" class="<?php if($pn != 6){ echo "d-none"; } ?>">
                        <form id="step4Form">
                                                ...
                                                <div class="col-lg-12 col-sm-12 col-md-12">
                                                    <div class="row mt-3 mx-0" id="reUploadDiv<?php echo $i; ?>">
                                                        <div class="col-md-12 col-sm-12 col-lg-12 px-0">
                                                            ...
                                                            <input type="file" class="form-control" name="photo<?php echo $i; ?>" accept="image/*;capture=camera" id="photoupload<?php echo $i; ?>" onchange="cropPhoto('latest',<?= $i; ?>)">
                                                        </div>
                                                    </div>
                                                    <div class="row mt-3">
                                                        <div class="col-lg-12 col-sm-12 col-md-12">
                                            ...
                                            <div class="modal-body px-3 px-md-5 pt-0">
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-lg-12 col-sm-12 col-md-12">
                                                        ...
                                                        <div class="row mt-3 mx-0 d-none" id="reUploadDiv<?php echo $i; ?>">
                                                            <div class="col-md-12 col-sm-12 col-lg-12 px-0">
                                                                <input type="file" class="form-control" accept="image/*;capture=camera" id="photoupload<?php echo $i; ?>" onchange="cropPhoto('latest',<?= $i; ?>)">
                                                            </div>
                                                        </div>
                                                        <div class="row mt-3">
                                                            <div class="col-lg-12 col-sm-12 col-md-12">
                            ...
                            <div class="card">
                                <div class="card-body p-3">
                                    <div class="row text-start justify-content-start">
                                        <div class="col-lg-auto col-md-auto col-sm-12 col-auto px-1">
                                            <button type="button" id="btn6Back" class="btn-style-grey btn btn-primary d-block w-100 disabled-on-loading"> Back</button>
                                        </div>
                                        <div class="col-lg-auto col-md-auto col-sm-12 col-7 ps-1 pe-0">
                                            <button type="button" onclick="goToDashboard(this)" style="padding:12px 9px!important;" class="btn-style-five btn btn-primary d-block w-100 disabled-on-loading"> Go to Dashboard</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="step7" class="<?php if($pn != 7){ echo "d-none"; } ?>">
                        <?php $this->load->view('user/pages/add_vehicle_details.php'); ?>
                    </div>
                    <div id="step8" class="<?php if($pn != 8){ echo "d-none"; } ?>">
                        <?php $this->load->view('user/pages/add_gold_details.php'); ?>
                    </div>
                    <div id="step5" class="<?php if($pn != 3){ echo "d-none"; } ?>">
                        <?php 
                        ...
                        <?php } ?>
                        <?php 
                            if($_SERVER['HTTP_REFERER'] == base_url().'user/upload_details' || $_SERVER['HTTP_REFERER'] == base_url().'user-dashboard' || $_SERVER['HTTP_REFERER'] == base_url().'user')
                            {
                        ?>
                        <div class="card">
                            <div class="card-body py-3">
                                <div class="row mb-0 align-items-center">
                                    <div class="col-sm-12 col-6 px-1 col-md-auto col-lg-auto mt-1 mb-1">
                                        <button type="button" id="btn3Back" data-redirect="save" class="btn btn-dark disabled-on-loading w-100 save" style="background:black!important;"> Back</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <?php }else{ ?>
                            <div class="card">
                                <div class="card-body py-3">
                                    <div class="row mb-0 align-items-center">
                                        <div class="col-sm-12 col-6 px-1 col-md-auto col-lg-auto mt-1 mb-1">
                                            <button type="button" id="btn3Back" data-redirect="next" class="btn btn-dark disabled-on-loading w-100 save" style="background:black!important;"> Back</button>
                                        </div>
                                        <div class="col-lg-auto col-6 ps-1 pe-0 col-md-auto col-sm-12 mt-1 mb-1">
                                            <button type="button" id="btn3Next" class="next w-100 btn btn-primary disabled-on-loading"> Next</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="step6" class="<?php if($pn != 4){ echo "d-none"; } ?>">
                        <form id="step6Form">
                            <h5 class="card-title pt-2 mb-0 text-danger">Marital Details</h5>
                            <hr class="my-0 mb-1">
                            <?php 
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-auto col-5 px-1 col-lg-auto mt-3" >
                                ...
                                <?php 
                                    ...
                                    {
                                ?>
                                <div class="col-sm-12 col-md-auto col-7 col-lg-auto mt-3">
                                ...
                                <?php }else{ ?>
                                    <div class="col-lg-auto col-sm-12 col-7 ps-1 pe-0 col-md-auto mt-3">
                                        <button type="submit" class="btn btn-primary px-4 next w-100 disabled-on-loading" id="btn6"> Save & Next</button>
                                    </div>
                                <?php } ?>
                                ...
                                <!--    <button type="submit" class="btn btn-primary next w-100 disabled-on-loading" id="btn6"> Next</button>-->
                                <!--</div>-->
                                <!--<div class="col-lg-auto col-sm-12 col-md-auto mt-3">-->
                    ...
                    <div id="step7" class="<?php if($pn != 5){ echo "d-none"; } ?>">
                        <?php 
                            $getIfAlready = $this->db->query('select * from uploadtransactions where userId='.$_SESSION['user_id'].' and type="personal" and idNumber="'.$getUserDetail[0]['aadhar_id'].'" and expiryDate >="'.date('Y-m-d').'"')->result_array();
                        ?>
                        <?php
                        ...
                        ?>
                        <?php 
                            $getIfAlloted = $this->db->query('select * from allotedPersonalPackages where userType="Kyc" and userId='.$_SESSION['user_id'].' and dateCreated >= "'.date('Y-m-d').'"')->result_array();
                            if(count($getIfAlloted) > 0)
                            {
                        ?>
                                                <form id="step3Form" class="card">
                            <div class="card-body">
                                <div class="row" style="align-items:baseline;justify-content:space-between;">
                                    <div class="col-lg-auto col-6 col-sm-12 col-md-6 mt-3 mb-0 mt-md-3 text-center text-md-start">
                                        <h5 class="card-title pt-0 mb-0">
                                            <span style="color:black;font-weight:600;font-size:1rem;">
                                            Your Aadhaar Photo
                                            </span>
                                        </h5>  
                                    </div>
                                    <div class="col-auto my-3">
                                        <img src="<?php echo base_url(); ?><?php echo $getProfileDetail[0]['aadharphoto']; ?>" style="height:125px;">
                                    </div>
                                </div>
                                <hr class="my-0">
                                <div class="row">
                                    <div class="col-lg-auto ms-auto col-sm-12 col-md-5 mt-3 mb-0 text-center text-lg-center" style="background:limegreen!important;padding:1rem!important;">
                                        <h5 class="mb-0"><b style="color:white;">Plan Expiring on Date:- </b><b style="color:white;"><?php echo date('d-m-Y',strtotime($getIfAlloted[0]['dateCreated'])); ?></b></h5>
                                    </div>
                                </div>
                                <div class="row mt-2 mb-3 align-items-start text-center">
                                    <?php 
                                    ...
                                    <?php } ?>
                                    <div class="col-md-auto col-lg-12 px-0 form-group">
                                        <input type="hidden" name="oldphoto" id="oldphoto" value="<?php echo $getProfileDetail[0]['facematchphoto']; ?>">
                                        <input type="hidden" name="oldphoto1" id="oldphoto1" value="<?php echo $getProfileDetail[0]['facematchphoto1']; ?>">
                                        <input type="hidden" name="oldphoto2" id="oldphoto2" value="<?php echo $getProfileDetail[0]['facematchphoto2']; ?>">
                                        ...
                                        <div class="row" style="position:relative;justify-content:space-evenly;">
                                            <?php 
                                                if($getProfileDetail[0]['facematchphoto'] != NULL)
                                                {
                                            ?>
                                            <div class="col-lg-auto col-sm-12 col-md-auto mt-3 h-100">
                                                <div class="row border border-secondary mx-0 py-3 px-2 px-md-3" style="border-radius:15px;border-color:lightgrey!important;">
                                                    <div class="col-lg-auto col-auto px-0">
                                                        <div class="row">
                                                            <div class="col-lg-12 col-sm-12 col-md-12">
                                                                <h6><b>File Uploaded</b></h6>
                                                ...
                                                <div class="row mt-3 mx-0 d-none" id="reUploadFaceDiv">
                                                    <div class="col-md-12 col-sm-12 col-lg-12 px-0">
                                                        <label class="form-label">Re-upload image</label>
                                                        <input type="file" class="form-control" accept="image/*;capture=camera" name="uploadPhoto" id="uploadPhoto" onchange="cropPhoto('facematch','')">
                                                    </div>
                                                </div>
                                            </div>
                                            <?php }else{ ?>
                                                <div class="col-lg-auto h-100 col-sm-12 mt-3 col-md-auto border border-secondary py-3 px-2 px-md-3 text-center" style="border-radius:15px;border-color:lightgrey!important;">
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                                            <h6>PNG, JPEG or JPG formats only</h6>
                                                        </div>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body px-3 px-md-5 pt-0">
                                                                <div class="row">
                                                                    <div class="col-lg-12 col-sm-12 col-md-12">
                                                                        <h4 class="modal-title text-center">Upload Face Match Photo</h4>
                                                                    </div>
                                                                </div>
                                                                <div class="row mt-0">
                                                                    <div class="col-lg-12 col-sm-12 col-md-12">
                                            ...
                                            <?php 
                                                if($getProfileDetail[0]['facematchphoto'] != NULL)
                                                {
                                                    if($getProfileDetail[0]['facematchphoto1'] != NULL)
                                                    {
                                            ?>
                                            <div class="col-lg-auto h-100 col-sm-12 mt-3 col-md-auto">
                                                <div class="row border border-secondary mx-0 py-3 px-2 px-md-3" style="border-radius:15px;border-color:lightgrey!important;">
                                                    <div class="col-lg-auto col-auto px-0">
                                                        <div class="row">
                                                            <div class="col-lg-12 col-sm-12 col-md-12">
                                                        ...
                                                        <?php 
                                                            $split = explode('upload/profile/facematch/',$getProfileDetail[0]['facematchphoto1']);
                                                        ?>
                                                        <div class="row" style="margin-top:10px;">
                                                            <div class="col-lg-12 col-sm-12 col-md-12">
                                                                <a title="Preview" href="<?php echo base_url(); ?><?php echo $getProfileDetail[0]['facematchphoto1']; ?>" data-lightbox="facematch" style="color:#fff!important;border:0px solid #0d6efd;padding:10px;border-radius:50%;background:#0d6efd;"><i class="fa fa-eye"></i></a>
                                                                <a title="Re-upload" href="javascript:void(0)" style="color:#fff!important;border:0px solid #ffb309;padding:10px;border-radius:50%;background:#ffb309;margin-left:7px;" onclick="showFaceMatchReUpload(1)"><i class="fa fa-edit"></i></a>
                                                                <a title="Delete" href="javascript:void(0)" style="color:white!important;border:1px solid red;padding:10px;border-radius:50%;background:red;margin-left:7px;" onclick="deleteFaceMatch(this,1)"><i class="fa fa-trash"></i></a>
                                                            </div>
                                                        </div>  
                                                    </div>
                                                    <div class="col px-0 text-end">
                                                ...
                                                <div class="row mt-3 mx-0 d-none" id="reUploadFaceDiv1">
                                                    <div class="col-md-12 col-sm-12 col-lg-12 px-0">
                                                        <label class="form-label">Re-upload image</label>
                                                        <input type="file" class="form-control" accept="image/*;capture=camera" name="uploadPhoto1" id="uploadPhoto1" onchange="cropPhoto('facematch',1)">
                                                    </div>
                                                </div>
                                            </div>
                                            <?php }else{ ?>
                                                <div class="col-lg-auto h-100 col-sm-12 mt-3 col-md-auto border border-secondary py-3 px-2 px-md-3 text-center" style="border-radius:15px;border-color:lightgrey!important;">
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                                            <button type="button" data-bs-toggle="modal" data-bs-target="#reUploadFaceModal1" class="btn btn-style-upload w-100"> <i class="fa fa-cloud-upload"></i> Upload File</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div id="reUploadFaceModal1" class="modal" role="dialog">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header" style="border:0;padding-bottom:0;padding-top:0;">
                                                                <button type="button" class="btn btn-default ms-auto py-0" data-bs-dismiss="modal" style="color: darkgrey;background: transparent!important;font-size: xx-large;">&times;</button>
                                                            ...
                                                            <div class="modal-body px-3 px-md-5 pt-0">
                                                                ...
                                                                <div class="row mt-0">
                                                                    <div class="col-lg-12 col-sm-12 col-md-12">
                                                                        <div class="row mt-3 mx-0" id="reUploadFaceDiv1">
                                                                            <div class="col-md-12 col-sm-12 col-lg-12 px-0 text-start">
                                                                                <label class="form-label">Upload image</label>
                                                                                <input type="file" class="form-control" accept="image/*;capture=camera" name="uploadPhoto1" id="uploadPhoto1" onchange="cropPhoto('facematch',1)">
                                                                            </div>
                                            ...
                                            <?php
                                                if($getProfileDetail[0]['facematchphoto1'] != NULL)
                                                {
                                                    if($getProfileDetail[0]['facematchphoto2'] != NULL)
                                                    {
                                            ?>
                                            <div class="col-lg-auto h-100 col-sm-12 mt-3 col-md-auto">
                                                <div class="row border border-secondary mx-0 py-3 px-2 px-md-3" style="border-radius:15px;border-color:lightgrey!important;">
                                                    <div class="col-lg-auto col-auto px-0">
                                                        ...
                                                        <?php 
                                                            $split = explode('upload/profile/facematch/',$getProfileDetail[0]['facematchphoto2']);
                                                        ?>
                                                        <div class="row" style="margin-top:10px;">
                                                            <div class="col-lg-12 col-sm-12 col-md-12">
                                                                <a title="Preview" href="<?php echo base_url(); ?><?php echo $getProfileDetail[0]['facematchphoto2']; ?>" data-lightbox="facematch" style="color:#fff!important;border:0px solid #0d6efd;padding:10px;border-radius:50%;background:#0d6efd;"><i class="fa fa-eye"></i></a>
                                                                <a title="Re-upload" href="javascript:void(0)" style="color:#fff!important;border:0px solid #ffb309;padding:10px;border-radius:50%;background:#ffb309;margin-left:7px;" onclick="showFaceMatchReUpload(2)"><i class="fa fa-edit"></i></a>
                                                                <a title="Delete" href="javascript:void(0)" style="color:white!important;border:1px solid red;padding:10px;border-radius:50%;background:red;margin-left:7px;" onclick="deleteFaceMatch(this,2)"><i class="fa fa-trash"></i></a>
                                                            </div>
                                                        </div>  
                                                    </div>
                                                    <div class="col px-0 text-end">
                                                ...
                                                <div class="row mt-3 mx-0 d-none" id="reUploadFaceDiv2">
                                                    <div class="col-md-12 col-sm-12 col-lg-12 px-0">
                                                        <label class="form-label">Re-upload image</label>
                                                        <input type="file" class="form-control" accept="image/*;capture=camera" name="uploadPhoto2" id="uploadPhoto2" onchange="cropPhoto('facematch',2)">
                                                    </div>
                                                </div>
                                            </div>
                                            <?php }else{ ?>
                                                <div class="col-lg-auto h-100 col-sm-12 mt-3 col-md-auto border border-secondary py-3 px-2 px-md-3 text-center" style="border-radius:15px;border-color:lightgrey!important;">
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                                            <button type="button" data-bs-toggle="modal" data-bs-target="#reUploadFaceModal2" class="btn btn-style-upload w-100"> <i class="fa fa-cloud-upload"></i> Upload File</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div id="reUploadFaceModal2" class="modal" role="dialog">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header" style="border:0;padding-bottom:0;padding-top:0;">
                                                                <button type="button" class="btn btn-default ms-auto py-0" data-bs-dismiss="modal" style="color: darkgrey;background: transparent!important;font-size: xx-large;">&times;</button>
                                                            ...
                                                            <div class="modal-body px-3 px-md-5 pt-0">
                                                                ...
                                                                <div class="row mt-0">
                                                                    <div class="col-lg-12 col-sm-12 col-md-12">
                                                                        <div class="row mt-3 mx-0" id="reUploadFaceDiv2">
                                                                            <div class="col-md-12 col-sm-12 col-lg-12 px-0 text-start">
                                                                                <label class="form-label">Upload image</label>
                                                                                <input type="file" class="form-control" accept="image/*;capture=camera" name="uploadPhoto2" id="uploadPhoto2" onchange="cropPhoto('facematch',2)">
                                                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-auto col-lg-auto mb-3">
                                        <button type="button" onclick="goToLatestPhotos(this)" class="btn btn-default disabled-on-loading w-100 save" style="background:crimson!important;"> <i class="fa fa-user"></i> Add Your Other Photos For Free</button>
                                    </div>
                                    <div class="col-sm-12 col-md-auto col-lg-auto mb-3">
                                        <button type="button" onclick="goToDashboard(this)" class="btn btn-primary disabled-on-loading w-100 save" style="background:blue!important;"> Go to Dashboard</button>
                                    </div>
                                </div>
                            </div>
                        </form><!-- End Profile Edit Form -->
                        ...
                        <form id="step7Form">
                                ...
                                <div class="card-body p-3">
                                    <div class="form-group mb-3">
                                        <div class="row justify-content-center">
                                            <div class="col-md-2 col-6 mx-auto me-md-auto">
                                                <img src="<?php echo base_url(); ?>assets/images/faceicon.png" style="width:100%;height:100px;">
                                            </div>
                                            <?php 
                                                $getSettings = $this->db->query('select * from settings where name="personalFaceAmount"')->result_array();
                                            ?>
                                            <div class="col-md-9 col-lg-10 col-sm-12 mx-md-auto text-center text-md-start">
                                                <h5><b>Do You Want to Upload Your Face Match Photo ?</b></h5>
                                                <h4 class="ms-md-5"><b style="color:dodgerblue;">(Paid Service = Rs.<?php echo $getSettings[0]['value'];  ?>/Year)</b></h4>
                                                <div class="text-center col-lg-6 col-md-10">
                                                    <input type="radio" class="radio-custom" <?php echo ($getUserDetail[0]['facematchphoto'] != NULL) ? 'checked' : 'checked'; ?> name="faceopt" value="yes" id="yes">
                                                    <label for="yes" class="radio-custom-label">Yes</label>
                                                    <input type="radio" class="radio-custom" name="faceopt" <?php echo ($getUserDetail[0]['facematchphoto'] == NULL) ? '' : ''; ?> value="no" id="no">
                                                    <label for="no" class="radio-custom-label">No</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4 yesDiv">
                                        <h6><b style="color:red;">Note:- You can Upload Your Face Photo After Payment.</b></h6>
                                    </div>
                                    <div class="row">
                                        <div class="form-group border border-secondary px-0 px-md-4 py-2 col-md-auto col-sm-12 col-lg-auto px-0">
                            ...
                            <div class="card">
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-auto col-auto px-1 col-lg-auto mt-3 mt-md-0" >
                                            <button type="button" id="btn5Back" class="btn btn-dark disabled-on-loading w-100 btn-style-green" style="background:black!important;"> Back</button>
                                        </div>
                                        <div class="col-sm-12 col-auto pe-0 col-md-auto col-auto ps-1 col-lg-auto mt-3 mt-md-0 yesDiv <?php echo ($getUserDetail[0]['facematchphoto'] == NULL) ? '' : ''; ?>" id="payNowDiv">
                                            <button type="button" style="padding:0.8rem!important;" id="payNowBtn" onclick="payNow(this)" class="btn btn-dark disabled-on-loading w-100 btn-style-grey disabled"> <i class="bi bi-cash"></i> Pay Now</button>
                                        </div>
                                        <div class="col-sm-12 col-auto pe-0 col-auto ps-1 col-md-auto col-lg-auto mt-3 mt-md-0 noDiv <?php echo ($getUserDetail[0]['facematchphoto'] != NULL) ? 'd-none' : 'd-none'; ?>" id="finalBtnDiv">
                                            <button type="button" style="padding:0.8rem!important;" id="finalBtn" onclick="finalSubmit(this)" class="btn btn-dark disabled-on-loading w-100 btn-style-grey disabled"> Final Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form id="step3Form" class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-auto ms-auto col-sm-12 col-md-5 mt-3 mb-0 text-center text-lg-center" style="background:limegreen!important;padding:1rem!important;">
                                        <h5 class="mb-0"><b style="color:white;">Plan Expiring on Date:- </b><b style="color:white;"><?php echo date('d-m-Y',strtotime($getIfAlready[0]['expiryDate'])); ?></b></h5>
                                    </div>
                                </div>
                                <div class="row mt-2 mb-3 align-items-start text-center">
                                    <?php 
            ...
            <div class="modal-body">
                <form action="<?php echo base_url(); ?>user/updateSinglePhoto" id="updatePhotoForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" id="editInput" accept="image/*;capture=camera" name="photo" class="form-control" required>
                    </div>
        ...
        <div class="modal-body pt-0">
          <div class="row">
            ...
            <div class="col-6 text-start">
                <button class="btn btn-success crop_image save disabled-on-loading"> OK</button>
            </div>
        </div>
        </div>
     </div>
...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  <script type="text/javascript">
    ...
    $('input[name="faceopt"]').click(function()
    {
        $('#terms').prop('checked',false);
        $('#payNowBtn').removeClass('btn-style-green btn-success').addClass('btn-style-grey btn-dark');
        $('#payNowBtn').addClass('disabled');
        $('#finalBtn').removeClass('btn-style-green btn-success').addClass('btn-style-grey btn-dark');
        $('#finalBtn').addClass('disabled');
        if($(this).val() == 'yes')
        {
            $('.yesDiv').removeClass('d-none');
            $('.noDiv').addClass('d-none');
        }else{
            $('.yesDiv').addClass('d-none');
            $('.noDiv').removeClass('d-none');
        }
    })
    
    function deleteFaceMatch(ele,index)
    {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url:'<?php echo base_url(); ?>user/deleteFaceMatchFromProfile',
                    data:data,
                    contentType: false,
                    cache: false,
                    processData:false,
    ...
    function finalSubmit(ele)
    {
        $(ele).attr('disabled','disabled');
        Swal.fire({
            title:'<strong style="font-size:15px;color:green;">Your Profile <i class="fa fa-user"></i> Completed Without Face Match Facility !</strong>',
            customClass:{
                title:'lh-1',
                htmlContainer:'mx-2'
            },
            icon: 'success',
            allowOutsideClick:false,
            html:'<div class="row justify-content-center mx-0"><div class="col-sm-12 col-md-8 px-0 col-lg-8 mb-3"><button type="button" onclick="goToLatestPhotos(this)" class="btn btn-default disabled-on-loading w-100 save" style="background:crimson!important;padding:0.6rem!important;"> <i class="fa fa-user"></i> Add Your Other Photos For Free</button></div><div class="col-sm-12 col-md-8 col-lg-8 mb-3"><button type="button" onclick="goToDashboard(this)" class="btn btn-primary disabled-on-loading w-100 save" style="background:blue!important;padding:0.6rem!important;"> Go to Dashboard</button></div></div>',
    ...
    {
        let wantToUpload = $('input[name="faceopt"]:checked').val();
        if(wantToUpload == 'yes')
        {
            if($('#terms').is(':checked'))
            {
                $('#payNowBtn').removeClass('btn-style-grey btn-dark').addClass('btn-style-green btn-success');
            ...
            if($('#terms').is(':checked'))
            {
                $('#finalBtn').removeClass('btn-style-grey btn-dark').addClass('btn-style-green btn-success');
    ...
    function payNow(ele)
    {
        location.href='<?php echo base_url(); ?>user/personalPayment';
    }
    
    function goToLatestPhotos(ele)
    {
        $(ele).attr('disabled','disabled');
    ...
    {
        $(this).attr('disabled','disabled');
        if($(this).attr('data-redirect') == 'save')
        {
    ...
    function uploadLatestPhoto(ele,index)
    {
        if($('#latestPhoto'+index).val() == '')
        {
            ...
            toastr.info("Please wait files are being uploaded");   
            $.ajax({
    ...
    function cropPhoto(type,i)
    {
        if(type == 'facematch')
        {
            if($('#uploadPhoto'+i)[0].files.length > 0)
            {
                var isImage = $('#uploadPhoto'+i)[0].files[0].type.startsWith("image/");
                if(isImage)
                {
                    toastr.remove();
                    ...
                    reader.readAsDataURL($('#uploadPhoto'+i)[0].files[0]);
                    $('#uploadimageModal').modal('show');   
                    $('#uploadimageModal').data('index',i);
            ...
            if($('#photoupload'+i)[0].files.length > 0)
            {
                var isImage = $('#photoupload'+i)[0].files[0].type.startsWith("image/");
                if(isImage)
                {
                    toastr.remove();
                    var reader = new FileReader();
                    ...
                    reader.readAsDataURL($('#photoupload'+i)[0].files[0]);
                    $('#uploadimageModal').modal('show');   
                    $('#uploadimageModal').data('index',i);
                    $('#uploadimageModal').data('type',type);
                }else{
                    ...
                    if (res.status === "success") {
                        ...
                        $image_crop.croppie('result', {
                          ...
                          quality: parseFloat(qualityVal)
                            ...
                            let index = $('#uploadimageModal').data('index');
                            let type = $('#uploadimageModal').data('type');
                            if(type == 'facematch')
                            {
                                ...
                                $.ajax({
                                    ...
                                    success:function(res)
                                    {
                                        ...
                                        if(parse.status == 'success')
                                        {
                                            ...
                                            Swal.fire({
                                                iconHtml: '<img src="'+response+'" style="height:100%;">',
                                                title: '<strong style="font-size:1rem;color:red;"><span style="color:black;">Face Not Matched</span></strong>',
                                                customClass: {
                                                    icon: 'no-border',
                                                    htmlContainer:'px-0',
                                                    actions:'mt-0',
                                                ...
                                                allowOutsideClick:false,
                                                html:
                                                    '<div class="form-group"><label class="form-label text-danger">'+parse.message+'</label></div>',
                                                showCloseButton: true,
                                                showCancelButton: false,
                                                focusConfirm: false,
                                                showConfirmButton:true
    ...
    {
        $('#editAddress').prop('checked',false);
        if($(this).is(':checked'))
        {
            $('#samediv').removeClass('d-none');
            $('#notsamediv').addClass('d-none');
            $('#cursamecity').attr('readonly',true);
            $('#cursamepincode').attr('readonly',true);
            $('#cursamedistrict').attr('readonly',true);
            $('#cursameaddress').attr('readonly',true);
            $('#cursamestate').attr('readonly',true);
    ...
    function enableEdit(ele)
    {
        ...
        $('#samediv').addClass('d-none');
        $('#notsamediv').removeClass('d-none');
        $('#curnotsamestate').attr('readonly',false);
        $('#cursamestate').val('').trigger('change');  
        $('#cursamedistrict').val('').trigger('change');  
        $('#cursamecity').attr('readonly',false);
        $('#cursamepincode').attr('readonly',false);
        $('#cursamedistrict').attr('readonly',false);
        $('#cursameaddress').attr('readonly',false);
        $('#cursamestate').attr('readonly',false);
        $('#cursamecity').val('');
        $('#cursamepincode').val('');
        $('#cursameaddress').val('');
        if(ele.checked)
        {
            $('#cursamecity').prop('required',false);
            $('#cursamepincode').prop('required',false);
            $('#cursamedistrict').prop('required',false);
            $('#cursameaddress').prop('required',false);
            $('#cursamestate').prop('required',false);
            $('#curnotsamestate').attr('name','curstate');
            $('#curnotsamecity').attr('name','curcity');
            $('#curnotsamepincode').attr('name','curpincode');
            $('#curnotsamedistrict').attr('name','curdistrict');
            ...
            $('#curnotsamedistrict').removeAttr('name');
            $('#curnotsameaddress').removeAttr('name');
            $('#cursamecity').prop('required',true);
            $('#curnotsamecity').attr('required',false);
            $('#curnotsamepincode').attr('required',false);
            $('#curnotsamedistrict').attr('required',false);
            $('#curnotsameaddress').attr('required',false);
            $('#cursamepincode').prop('required',true);
            $('#cursamedistrict').prop('required',true);
            $('#cursameaddress').prop('required',true);
            $('#cursamestate').prop('required',true);
    ...
    function showFaceMatchReUpload(i)
    {
        $('#reUploadFaceBtnDiv'+i).toggleClass('d-none');
        $('#reUploadFaceDiv'+i).toggleClass('d-none');
    }
