    ...
    <section class="section register d-flex flex-column align-items-center justify-content-center py-4">
        <div class="container px-0">
            <div class="row justify-content-center align-items-center">
                    ...
                    <div class="card-body p-3">
                        <div class="pb-0">
                            <?php 
                                ...
                                if(count($getHotelEntryDetail) >0)
                                {
                                    $getTotalBooking = $this->db->query('select * from hotelEntry where bookingId='.$getHotelEntryDetail[0]['bookingId'])->result_array();   
                                }else{
                                    $getTotalBooking = array();
                                }
                                if(count($getTotalBooking) > 0)
                                {
                            ?>
                            <h5 class="card-title mb-0 text-center pb-0 pt-0 text-danger text-uppercase">MISSING PERSON - <?= $getUserDetail[0]['missingname']; ?>(<?= $getUserDetail[0]['missingId']; ?>)</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-12 col-md-4 mt-4 align-items-center">
                    <img src="<?php echo base_url(); ?><?php echo ($getUserDetail[0]['facematchphoto'] != NULL) ? $getUserDetail[0]['facematchphoto'] : 'assets/img/hotel.png'; ?>" style="width:100%;heigh:200px;">
                </div>
                ...
                <?php }else{ ?>
                <h5 class="card-title mb-0 text-center text-danger">Hotel Booking Closed</h5>
                <?php } ?>
            </div>
        </div>
