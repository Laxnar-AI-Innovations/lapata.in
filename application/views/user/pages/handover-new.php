                ...
                <div class="row justify-content-center">
                    ...
                    <div class="card col-lg-4">
                        <div class="card-header my-0">
                            <h5 class="card-title text-center py-0 mb-0">Capture Person Photo</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row mt-3 justify-content-center" id="uploadBtnDiv">
                                <div class="col-lg-10 col-md-6 text-center">
                                    <button type="button" class="btn w-100 btn-primary btn-style-grey disabled" id="uploadPhotoBtn" onclick="capturePhoto()">Capture Photo <i class="fa fa-camera"></i></button>
                                </div>
                            </div>
                            <div class="row mt-4 mb-3 justify-content-center">
                                <div class="col-6 px-1 d-none" id="retakebtndiv">
                                    <button type="button" class="btn w-100 btn-primary btn-style-yellow" id="retakePhotoBtn" onclick="restartWebcam()">Retake <i class="fa fa-upload"></i></button>
                                </div>
...
<script>
    ...
    <script>
        ...
        var webcam = '';
        const modelPath = baseurl+'/assets/models';
        let currentStream;
        let displaySize;
        let canvas;
        let faceDetection;
        ...
        function startDetection(){
          faceDetection = setInterval(async () => {
            ...
            if(resizedDetections[0]['_classScore'] >= 0.7)
            {
                $('#uploadPhotoBtn').removeClass('btn-style-grey disabled').addClass('btn-style-four');
            }else{
                $('#uploadPhotoBtn').addClass('btn-style-grey disabled').removeClass('btn-style-four');
            }
