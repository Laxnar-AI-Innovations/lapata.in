...
<main id="main" class="main">
    ...
    ?>
    <div class="pagetitle">
      <h1 class="text-center"><span><img src="<?php echo base_url(); ?>assets/icons/unknown.webp" style="width:50px;height:50px;"></span><b class="ms-3 text-danger">Enter </b>- <?php echo 'Missing'; ?> Person Details</h1>
    </div>
    <?php }else{ ?>
    <div class="pagetitle">
      <h1 class="text-start">Search <?php echo 'Missing'; ?> Person By Filter</h1>
    </div>
    <?php } ?>
    <div class="container-fluid px-0 <?php if($pn != 1){ echo "d-none"; } ?>">
        <div class="row justify-content-center">
            <div class="col-sm-12 col-lg-6 card py-0">
                    ...
                    <form action="">
                        ...
                        <div class="row align-items-center">
                            <div class="form-group col-12 col-md-4 col-lg-6 mt-3 form-floating">
                                <input type="date" id="startFormDate" value="<?php echo date('Y-m-d',strtotime('-3 months')); ?>" max="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d',strtotime('-3 months')); ?>" class="form-control" name="startFormDate" required>
                                <label for="startFormDate" class="ms-2">From Date <b class="text-danger">*</b></label>
                            </div>
                            <div class="form-group col-12 col-md-4 col-lg-6 mt-3 form-floating">
                                <input type="date" id="endFormDate" value="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d',strtotime('-3 months')); ?>" max="<?php echo date('Y-m-d'); ?>" class="form-control" name="endFormDate" required>
        ...
        <div class="container-fluid px-0">
        	...
        	<div class="side-bar pt-1" >
             ...
             <!--   </div>-->
                ...
                <!--<hr>-->
        	    <div class="row">
        	        <h6><b class="text-danger">Enter - </b><b style="font-size:0.98rem;">Missing Person Details</b></h6>
                    ...
                    <div class="col-12 mt-3 form-floating">
    	                ...
    	                <label for="personName" class="ms-2">Enter Missing Person Name</label>
    	            </div>
            ...
            border-color: var(--bs-btn-hover-border-color);
                                    ...
                                    <div class="row w-100 mx-0 align-items-center">
                                        <div class="col-12 ">
                                            <b style="font-size:.8rem!important;color:black;font-weight:500;">Contact To: - NGO </b>
                                        </div>
                                        <div class="col-12 ">
                                    ...
                                    <div class="row w-100 mx-0 align-items-center">
                                        <div class="col-12 ">
                                            <b style="font-size:.8rem!important;color:black;font-weight:500;">Contact To: - POLICE THANA</b>
                                        </div>
                                        <div class="col-12 ">
                                    ...
                                    <div class="row w-100 mx-0 align-items-center">
                                        <div class="col-12 ">
                                            <b style="font-size:.8rem!important;color:black;font-weight:500;">Contact : - </b></b>
                                        </div>
                                        <div class="col-12 ">
                                            <?php if($row['well1']!='' || $row['well1']!=null) { ?>
...
<script>
	...
	{
	    $.ajax({
	        url:'<?php echo base_url(); ?>user/checkFacePayment?type=lapata',
	        type:'get',
	        success:function(res)
	        {
	            ...
	            if(parse.status == 'success')
	            {
	               ...
	               //location.href="<?php echo base_url(); ?>user/search_person_details?pn=7&type=missing";
		                        ...
		                        success:function(rzpRes)
		                        {
		                            ...
		                            var options = {
		                            	...
		                            	"handler": function (response) {
		                            		$.ajax({
		                            		    url:'<?php echo base_url(); ?>user/saveFaceMatchPayment',
...
document.querySelector('.reset-btn .btn').onclick = () => {
	window.location.href="<?php echo base_url(); ?>user/lapta_person_after_login";
};
