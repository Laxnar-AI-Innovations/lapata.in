...
<main id="main" class="main">
    <div class="pagetitle row align-items-center">
        ...
        <div class="col-sm-12 text-end col-md-6 mb-3">
            <a href="<?= base_url(); ?>user/manageGallery?type=unknown" class="btn btn-primary next text-light d-none" style="padding:12px 35px!important;">Search Person By Face Photo</a>
            <a href="<?= base_url(); ?>user/manageDraft?type=missing" class="btn btn-primary save py-3">Manage Draft</a>
        </div>
