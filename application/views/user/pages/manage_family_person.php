...
<main id="main" class="main">
    <div class="pagetitle row align-items-center">
        <div class="col-sm-12 col-md-6 mb-3">
            <h1 class="text-center text-md-start" style="font-size: 1.1rem;">Manage Family Member Details</h1>
        </div>
        <div class="col-sm-12 text-end col-md-6 mb-3">
            <a href="<?= base_url(); ?>user/manageDraft?type=family" class="btn btn-primary save py-3">Manage Draft</a>
        </div>
    </div>
    <div>
                                ...
                                <div class="card-body px-0">
                                    <div class="row align-items-center px-0 mx-0 justify-content-center">
                                        ...
                                        <div class="col-12 mb-2">
                                            <div class="row">
                                            	<div class="col-7 px-1 col-md-6 col-lg col-xl-6 mt-3">
                                                ...
                                                <div class="col-5 col-md-6 col-lg col-xl-6 ms-auto mt-1 text-center text-md-end">
                                                    <button type="button" class="btn btn-dark" onclick="edit(this,'<?php echo $row['id']; ?>')" style="background:black!important;color:white!important;padding:0.5rem 0.6rem;"><i class="fa fa-edit"></i></button>
                                                    ...
                                                    <button type="button" class="btn btn-primary" onclick="view(this,'<?php echo $row['id']; ?>')" style="background:darkblue!important;color:white!important;padding:0.5rem 0.6rem;"><i class="fa fa-eye"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-5 ">
                                    ...
                                    <div class="row col-12 px-1 mx-0 pt-2 text-light" style="max-height:auto;background:green;">
                                        ...
                                        <p><b style="font-weight:500;">Want to upgrade your plan- <a href="<?php echo base_url(); ?>user/showFamilyPaymentModels?id=<?php echo $row['id']; ?>" class="text-white" style="text-decoration:underline;">Click here</a></b></p>
                                    </div>
                                    <?php }else{ ?>
                                        <div class="row col-12 px-1 mx-0 pt-2 text-light" style="max-height:auto;background:red;">
                                            ...
                                            <p><b style="font-weight:500;">Want to Renew Your Plan- <a href="<?php echo base_url(); ?>user/showFamilyPaymentModels?id=<?php echo $row['id']; ?>" class="text-white" style="text-decoration:underline;">Click here</a></b></p>
                                        </div>
                                    <?php } ?>
                                    <style>
...
function showColorAccordingly(isExpired,ele,id,name)
{
    if(ele.checked)
    {
        if(!isExpired)
        {
            ...
            location.href="<?php echo base_url(); ?>user/showFamilyPaymentModels?id="+id;
        }else{
            Swal.fire({
                title: '<strong class="text-danger" style="font-size:20px;">Member Activate- '+name+'</strong>',
                icon: 'info',
                allowOutsideClick:false,
                html:
                    '<div class="form-group mt-3"><label class="form-label" style="font-size:17px!important;">Are you sure you want to activate this member again?</label></div>',
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url:'<?php echo base_url(); ?>user/reactivateFamilyMember',
                        data:data,
                        contentType: false,
                        cache: false,
                        processData:false,
                        ...
                        {
                            toastr.success('family member activated successfully');
                            setTimeout(function()
                            {
                                location.reload();
                            },2000);
        ...
        Swal.fire({
            title: '<strong class="text-danger" style="font-size:20px;">Member Deactivate- '+name+'</strong>',
            icon: 'info',
            allowOutsideClick:false,
            html:
                '<div class="form-group mt-3"><label class="form-label" style="font-size:17px!important;">Are you sure you want to deactivate this member?</label></div>',
            showCloseButton: true,
            showCancelButton: true,
            confirmButtonText:'Yes',
            cancelButtonText:'No',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    success:function(res)
                    {
                        toastr.success('family member deactivated successfully');
                        setTimeout(function()
                        {
                            location.reload();
                        },2000);
    ...
    $(ele).attr('disabled','disabled');
     Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            data.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
            $.ajax({
                url:'<?php echo base_url(); ?>user/deleteFamilyMember',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
...
{
    window.open('<?php echo base_url(); ?>find-family-person?id='+id,'_blank');
}

function edit(ele,appNo)
{
    $(ele).attr('disabled','disabled');
    location.href="<?php echo base_url(); ?>user/editFamilyDetails?id="+appNo;
}
...
function checkApp(ele)
{
	...
	if(value != '')
	{
	    location.href="<?= base_url(); ?>user/manage_lapata?appNo="+value;   
	}else{
	    location.href="<?= base_url(); ?>user/manage_lapata";
	}
}
        ...
        <div class="container-fluid px-0">
            ...
            <div class="row align-items-end" style="justify-content:space-between">
                ...
                <div class="col-lg-4 col-xl-3 col-sm-12 mt-3 col-10 mt-md-0 col-md-5 text-end pe-lg-0">
                    <input type="text" class="form-control col-xl-auto col-12" placeholder="Search by application number..." id="search-box" value="<?= isset($_GET['appNo']) ? strtoupper($_GET['appNo']) : ''; ?>">
                </div>
                <div class="col-lg col-xl-1 col-sm-12 mt-3 mt-md-0 col-2 col-md-1 text-end ps-lg-0">
                    <button type="button" onclick="checkApp(this)" style="border-radius:5px 5px!important;padding: 9px 15px!important" class="btn btn-style-green text-center disabled-on-loading"> <i class="fa fa-check-circle"></i></button>
                </div>
            </div>
            <div class="gallery px-0">
                <div class="image-container row">
                    <?php
                        foreach($data as $row)
                        {
                            ...
                            {
                                $getLastTransaction = $this->db->query('select * from uploadtransactions where userId='.$_SESSION['user_id'].' and idNumber="'.$row['aadharNumber'].'" order by Id desc')->result_array();
                                ...
                                $getLastTransaction = $this->db->query('select * from uploadWithoutTransactions where userId='.$_SESSION['user_id'].' and idNumber="'.$row['Application_no'].'" order by Id desc')->result_array();
                                if(count($getLastTransaction) > 0)
                                {
                                    $isPaymentDone = 1;
                                    if(strtotime(date('d-m-Y')) <= strtotime(date('d-m-Y',strtotime($getLastTransaction[0]['expiryDate']))))
                            ...
                            <div class="card mb-3" >
                                <div class="card-body px-0">
                                        ...
                                        <div class="col mb-2">
                                            <div class="row">
                                                <div class="col col-md-6 col-lg col-xl-6 mt-3">
                                                    <div class="form-check form-switch">
                                                      <input class="form-check-input" type="checkbox" onclick="showColorAccordingly(<?= $isExpired; ?>,this,<?= $row['id']; ?>,'<?= $row['Application_no']; ?>')" id="<?= $row['id']; ?>" <?= $isActive; ?>>
                                                ...
                                                <div class="col col-md-6 col-lg col-xl-6 ms-auto mt-1">
                                                    <button type="button" class="btn btn-dark" onclick="showShare('<?php echo $row['Application_no']; ?>','<?php echo $row['Photo']; ?>')" style="background:black!important;color:white!important;padding:0.5rem 0.6rem;"><i class="fa fa-share-alt"></i></button>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                        <div class="row col-12 px-1 mx-0 pt-2 text-light" style="max-height:auto;background:green;">
                                            <p class="mb-1"><b style="font-weight:500;">Plan Expiring on Date- <?php echo date('d/m/Y',strtotime($getLastTransaction[0]['expiryDate'])); ?></b></p>
                                            <p><b style="font-weight:500;">Want to upgrade your plan- <a href="<?php echo base_url(); ?>user/showPaymentModels?id=<?php echo $row['id']; ?>" class="text-white" style="text-decoration:underline;">Click here</a></b></p>
                                        </div>
                                        <?php }else{ ?>
                                        <div class="row col-12 px-1 mx-0 pt-2 text-light" style="max-height:auto;background:red;">
                                            <p class="mb-1"><b style="font-weight:500;">Plan Already Expired on- <?php echo date('d/m/Y',strtotime($getLastTransaction[0]['expiryDate'])); ?></b></p>
                                            <p><b style="font-weight:500;">Want to Renew Your Plan- <a href="<?php echo base_url(); ?>user/showPaymentModels?id=<?php echo $row['id']; ?>" class="text-white" style="text-decoration:underline;">Click here</a></b></p>
                                        </div>
                                        <?php } ?>
                                    <?php }else{ ?>
                                        <?php 
                                        ...
                                        ?>
                                        <div class="row col-12 px-1 mx-0 pt-2 text-light" style="max-height:auto;background:green;">
                                            <p class="mb-1"><b style="font-weight:500;">Plan Expiring on Date- <?php echo date('d/m/Y',strtotime('+3 months',strtotime($row['dateCreated']))); ?></b></p>
                                            <p><b style="font-weight:500;">Want to upgrade your plan- <a href="<?php echo base_url(); ?>user/showPaymentModels?id=<?php echo $row['id']; ?>" class="text-white" style="text-decoration:underline;">Click here</a></b></p>
                                        </div>
                                        <?php }else{ ?>
                                            <div class="row col-12 px-1 mx-0 pt-2 text-light" style="max-height:auto;background:red;">
                                                <p class="mb-1"><b style="font-weight:500;">Plan Already Expired on- <?php echo date('d/m/Y',strtotime('+3 months',strtotime($row['dateCreated']))); ?></b></p>
                                                <p><b style="font-weight:500;">Want to Renew Your Plan- <a href="<?php echo base_url(); ?>user/showPaymentModels?id=<?php echo $row['id']; ?>" class="text-white" style="text-decoration:underline;">Click here</a></b></p>
                                            </div>
                                        <?php } ?>
                                    <?php } ?>
...
function showColorAccordingly(isExpired,ele,id,appNo)
{
    if(ele.checked)
    {
        ...
        {
            $(ele).prop('checked',false);
            location.href="<?php echo base_url(); ?>user/showPaymentModels?id="+id;
        }else{
            Swal.fire({
...
{
    $(ele).attr('disabled','disabled');
    location.href="<?php echo base_url(); ?>user/editLapataDetails?id="+appNo;
}
