...
<main id="main" class="main px-2">
    ...
    <section class="section profile">
                ...
                <div class="card mb-3 shiva_height" >
                    <div class="card-body px-0 pt-0">
                        ...
                        <div class="row col-12 px-3 mt-2 mb-1 mx-0">
                           <p class="card-title text-start py-0 border border-danger text-center px-0"><b style="color:red;">Message:- </b><b style="color:black;" class="message"><?php echo $row['otherDetail']??"--"?></b></p> 
                        </div>
                        <?php } ?>
                        <hr class="my-0">
                        <?php 
            ...
            <div class="col-lg-4 col-xl-4 col-md-6 px-0 px-md-2 col-12 col-search pb-2" >
                <div class="card mb-3 shiva_height">
                    <div class="card-body px-0 pt-0">
                        ...
                        <div class="row col-12 px-3 mt-2 mb-1 mx-0">
                            <p class="card-title text-start py-0 border border-danger text-center px-0"><b style="color:red;">Message:- </b><b style="color:black;" class="message"><?php echo $row['Message']??"--"?></b></p> 
                        </div>
                        <?php } ?>
                        <hr class="my-0">
                        <?php 
        ...
        ?>
        <div class="col-lg-4 col-xl-3 col-md-6 px-0 px-md-2 col-12 col-search pb-2" >
            <div class="card mb-3 shiva_height" style="height: auto;">
                <div class="card-body px-0 pt-0">
                    <div class="row align-items-center px-0 mx-0 justify-content-center">
                        <?php
                            if($row['Photo'] != '' || $row['Photo'] != NULL)
                        ...
                        <div class="col-12">
                            <p ><b style="color:black;font-size:.8rem!important">Uploaded Date :- </b><b style="color:black;font-size:.8rem!important"><?php echo date('d-m-Y H:i A',strtotime($row['finalSubmitTime'])); ?></b></p>
                        </div>
                        <div class="col-5 ">
                            <a href="<?php echo base_url().$row['Photo']?>" data-lightbox="roadtrip">
                                <img class="w-100" id="profile-pic" src="<?php echo base_url().$row['Photo']?>" style="height: 100px !important;border: 1px solid;" alt="">
                    ...
                    <div class="row w-100 mx-0 align-items-center" style="height:50px">
                        <div class="col-12 text-start">
                             <p class="my-2"><b style="color:black;font-size:.8rem!important">Added By :- </b><b style="color:<?= $row['isKyc'] == 0 ? 'blue' : 'green'; ?>;font-size:.8rem!important"><?= $name; ?> - </b>
                             <b style="color:black;text-transform:capitalize;font-size:.8rem!important"><?php echo $getUserDetail[0]['aadharname'].' ,'; ?> 
                             <?php echo $getUserDetail[0]['district'].' - '; ?><?php echo $getUserDetail[0]['state']; ?></b></p>
                        </div>
                    </div>
...
<script type="text/javascript">
	...
	function back(ele)
	{
	    ...
	    <?php 
	        ...
	        if(strpos($previousUrl,'manageGallery') !== false)
	        {
	    ?>
	    ...
	    <?php 
	        ...
	        {
	    ?>
	    location.href="<?= base_url(); ?>user/search_person_details?pn=7&type=<?= $_GET['type']; ?>";
	    <?php }else{ ?>
	    location.href="<?= base_url(); ?>user/search_person_details?pn=7";
	    <?php } ?>
	    <?php } ?>
	}
