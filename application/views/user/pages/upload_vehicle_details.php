        ...
        <div class="col-xl-12">
            <div class="card mb-3">
                <div class="card-body pt-2 pb-4">
                    <ul class="nav nav-pills nav-tabs-bordered">
                        <li class="nav-item">
                          <button class="nav-link active" role="tab" data-bs-toggle="pill" data-bs-target="#profile-edit">Add Vehicle</button>
                        </li>
                        <li class="nav-item">
                          <button class="nav-link" role="tab" data-bs-toggle="pill" data-bs-target="#profile-overview">All Vehicles</button>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="tab-pane fade profile-overview" id="profile-overview">
                    <div class="card">
                        <div class="card-body py-3">
                            ...
                            <div class="accordion" id="accordionExample">
                              ...
                              <div class="accordion-item">
                                <h2 class="accordion-header" id="heading<?php echo $k; ?>">
                                  <a class="accordion-button text-uppercase" href="javascript:void(0)" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $k; ?>" aria-expanded="true" aria-controls="collapse<?php echo $k; ?>">
                                    <?php echo $v['rcNumber']; ?>
                                  </a>
                                </h2>
                                <div id="collapse<?php echo $k; ?>" class="accordion-collapse collapse show" aria-labelledby="heading<?php echo $k; ?>" data-bs-parent="#accordionExample">
                                  <div class="accordion-body">
                                        ...
                                        <?php 
                                            ...
                                            {
                                        ?>
                                        <!--<h6 class="text-left"><b class="text-danger">Note:-</b> OTP will be sent during deletion to the logged in number.</h6>-->
                                        <!--<hr>-->
                                        <?php } ?>
                                        <div class="row text-end mb-2">
                                            <div class="col-12">
                                                
                                                <!--<button type="button" onclick="deleteVehicle(this,<?php echo $v['Id']; ?>,<?php echo $getSettings[0]['value']; ?>)" style="background:white!important;color:red!important;" class="btn btn-danger disabled-on-loading"> <i class="fa fa-trash"></i></button>      -->
                                                <button type="button" onclick="editVehicle(this,<?php echo $v['Id']; ?>)" class="btn btn-primary disabled-on-loading" style="background:white!important;color:blue!important;"> <i class="fa fa-edit"></i></button>      
                                            </div>
                                        </div>
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label ">Person Name</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['personname']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Present Address</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['present_address']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Permanent Address</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['permanent_address']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Issue Date</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['issue_date']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Rc Expiry Date</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['expiry_date']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Registered At</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['registered_at']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Tax End Date</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['tax_end_date']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Policy Number</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['policy_number']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Insurance Company</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['company']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Insurance Expriy Date</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['expiry_date']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Vehicle Category</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['category']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Category Description</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['category_description']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Chassis Number</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['chassis_number']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Engine Number</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['engine_number']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Maker Description</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['maker_description']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Maker Model</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['maker_model']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Fuel Type</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['fuel_type']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Vehicle Color</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['color']; ?></div>
                                      </div>
        
                                      <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Mobile</div>
                                        <div class="col-lg-9 col-md-8"><?php echo $v['mobile']; ?></div>
                                      </div>
                          ...
                          <?php }else{ ?>
                              <h5 class="text-danger mt-3 text-center" style="font-weight:bold;opacity: 0.8;">No Vehicles Available</h5>
                          <?php } ?>  
                        </div>
                    </div>
                </div>

                <div class="tab-pane show active fade" id="profile-edit">

                  <!-- Profile Edit Form -->
                  <form action="<?php echo base_url(); ?>user/create_vehicle" id="rcform" class="<?php if($pn != 1){ echo "d-none"; } ?>" method="post">
                      <?php 
                        $csrf = array(
                        ...
                        <div class="card-body py-4">
                            ...
                            <div class="row">
                                <div class="form-floating col-md-6 col-sm-12 col-lg-3 mb-3">
                                    <input type="text" class="text-success form-control" style="font-weight:bold;" value="<?php echo strtoupper($getUserDetail[0]['aadharname']); ?>" id="ownerName" name="ownerName" placeholder="Enter Owner Name" readonly>
                                    <label for="ownerName" class="col-form-label mx-2">Owner Name</label>
                                </div>
                                <div class="form-floating col-md-6 col-sm-12 col-lg-3 mb-3">
                                    <select name="vehicleType" style="appearance:none!important;" class="form-select" id="vehicleType" required>
                                ...
                                <!--<div class="form-floating col-md-6 col-sm-12 col-lg-3 mb-3">-->
                                <!--    <input type="date" class="form-control" id="issueDate" name="issueDate" placeholder="Enter Issue Date" >-->
                                <!--    <label for="issueDate" class="col-form-label mx-2">Select Issue Date</label>-->
                                <!--</div>-->
                                <div class="form-floating col-md-6 col-sm-12 col-lg-3 mb-3">
                                    <input type="text" class="form-control text-uppercase" onkeyup="showStep1Btn(this.value)" id="rcNumber" maxlength="10" name="rcNumber" placeholder="Enter Vehicle Number" required>
                                    <label for="rcNumber" class="col-form-label mx-2">Enter Vehicle No.</label>
                                </div>
                            </div>
                          ...
                          <div class="row mb-2">
                            <div class="col-md-8 col-lg-9">
                              ...
                              <label for="terms" class="d-inline">I provide consent to process the shared information.</label>
                            </div>
                          </div>
    
                          <div class="text-center">
                            <button id="btnSubmit" type="submit" class="btn btn-primary disabled-on-loading btn-style-grey disabled"> Continue</button>
                          </div>
                        </div>
                    </div>
                    </form><!-- End Profile Edit Form -->
                    <div id="vehiclePhotos" class="row mb-3 <?php if($pn != 2){ echo "d-none"; } ?>">
                        <form id="vehiclePhotoForm" class="col-lg-12" action="<?php echo base_url(); ?>user/saveVehiclePhoto">
                            <?php 
                                $getVehicleDetails = $this->db->query('select * from vehicles where Id="'.(isset($_SESSION['vehicleId']) ? $_SESSION['vehicleId'] : 0).'"')->result_array();
                                $decode = array();
                                if($getVehicleDetails[0]['vehiclePhoto'] != NULL)
                                {
                                    $decode = json_decode($getVehicleDetails[0]['vehiclePhoto'],true);
                                }
                            ?>
                            <div class="card">
                            ...
                            <div class="card">
                                ...
                                <div class="col-lg-12 col-sm-12 col-md-12">
                                    <input type="hidden" id="isUploaded<?php echo $i; ?>" value="<?php echo ($getVehicleDetails[0]['vehiclePhoto'] != NULL ? (isset($decode[$i]) ? $decode[$i]: 0) : 0) ?>">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-auto col-sm-12 col-md-auto text-center">
                                            ...
                                            <a href="<?php echo base_url(); ?><?php echo $decode[$i]; ?>"  data-lightbox="roadtrip1" class="btn btn-outline-info mt-3"><i class="fa fa-eye"></i></a>
                                        </div>
                                        <?php } } ?>
                                    </div>
                                </div>
                                ...
                                <div class="card-body py-4">
                                    <div class="row">
                                        <div class="col-lg-auto col-md-auto col-auto">
                                            <button class="btn btn-dark text-light mt-3 w-100 btn-style-green disabled-on-loading" type="button" id="btn2Save"> Next</button>  
                                        </div>
                                        <?php 
                                            ...
                                            {
                                        ?>
                                        <input type="hidden" name="imagecount" id="imagecount" value="<?php echo ($getVehicleDetails[0]['vehiclePhoto'] != NULL ? count($decode) : 0) ?>">
                                        <?php }else{ ?>
                    ...
                    <div id="vehicleDoc" class="row mb-3 <?php if($pn != 3){ echo "d-none"; } ?>">
                        <form id="vehicleDocForm" class="col-lg-12" action="<?php echo base_url(); ?>user/saveVehicleDoc">
                            ...
                            <?php 
                                if(count($getDocumentName) > 0)
                                {
                                    ...
                                    {
                                        $getVehicleDocs = $this->db->query('select * from newVehicleDocs where documentName='.$v['Id'].' and vehicleId='.(isset($_SESSION['vehicleId']) ? $_SESSION['vehicleId'] : 0))->result_array();
                                ...
                                <div class="card-body">
                                    <div class="row mt-3" style="align-items: self-end;">
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 mb-3">
                                            <label for="documentName<?php echo $k; ?>" class="col-form-label">Document Name <?php echo ($getSections[0]['sectionPermission'] == 1) ? '':'(optional)'; ?></label>
                                            <select name="documentName<?php echo $k; ?>" style="padding:0.5rem;" class="form-control" id="documentName<?php echo $k; ?>" aria-label="Enter Document Name">
                                        ...
                                        <div class="col-lg-auto col-sm-12 mb-3 col-md-auto text-center">
                                            ...
                                            <a href="<?php echo base_url(); ?><?php echo $getVehicleDocs[0]['documentFile']; ?>"  data-lightbox="roadtrip2" class="btn btn-outline-info"><i class="fa fa-eye"></i></a>
                                        </div>
                                        <?php } ?>
                                    </div>
                                        </div>
                                ...
                                <div class="card-body pt-4 pb-2">
                                    <div class="row">
                                        ...
                                        <?php 
                                            ...
                                            if($getSections[0]['sectionPermission'] == 1)
                                            {
                                                $getVehicleDocs = $this->db->query('select * from newVehicleDocs where vehicleId='.(isset($_SESSION['vehicleId']) ? $_SESSION['vehicleId'] : 0))->result_array();
                                        ?>
                    ...
                    <div id="vehiclePay" class="row mb-3 <?php if($pn != 5){ echo "d-none"; }?>">
                        <form id="vehiclePayForm" class="col-lg-12" action="<?php echo base_url(); ?>user/savePayment">
                            <?php 
                            ...
                            <div class="card">
                                <div class="card-body py-4">
                                    <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
                                    <div class="row mb-3">
                                      <label for="fullName" class="col-md-auto col-lg-auto col-form-label">Total Payment</label>
                                      <div class="col-md-auto col-lg-auto col-sm-12">
                                        <input type="number" class="form-control" id="payment" name="payment" readonly value="<?php echo $getSettings[0]['value']; ?>">
                                      </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-auto col-md-auto col-6 px-0 mt-3">
                                            <button class="btn btn-dark text-light w-100 btn-style-grey disabled-on-loading" type="button" id="btn5Back"> Back</button>  
                                        </div>
                                        <div class="col-lg-auto col-md-auto col-6 mt-3" style="padding-right:0;">
                                            <button class="btn btn-danger btn-style-five disabled-on-loading w-100" id="btnPay"> Pay</button>
                                        </div>
                                    </div>  
                                </div>
                            </div>
                                ...
                                <div class="card-body py-4">
                                    <div class="row justify-content-center">
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            <h5 class="text-success text-center"><i class="fa fa-check-circle fa-1x"></i> Payment Successful</h5>  
                                            <hr>
                                            <h6 class="text-dark text-center"><b>Congratulations, you have added vehicle successfully. You can manage your visibility in next page.</b></h6>                                        
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body py-4">
                                    <h5 class="text-center mb-0"><b>Vehicle Details</b></h5>
                                    <hr>
                                    <div class="row justify-content-center">
                                        <div class="col-md-12 col-sm-12 col-lg-6">
                                            <div class="row justify-content-space-around text-center">
                                                <div class="col-lg-6 col-sm-12 mb-3 col-md-6">
                                                    ...
                                                    <label class="d-block text-success"><?php echo $getVehicleDetails[0]['present_address']; ?></label>
                                                </div>
                                                <div class="col-lg-6 col-sm-12 mb-3 col-md-6">
                                                    <label class="form-label">Permanent Address</label>
                                                    <label class="d-block text-success"><?php echo $getVehicleDetails[0]['permanent_address']; ?></label>
                                                </div>
                                                <hr>
                                                <div class="col-lg-6 col-sm-12 mb-3 col-md-6">
                                                    <label class="form-label">Vehicle Number</label>
                                                    <label class="d-block text-success"><?php echo $getVehicleDetails[0]['rcNumber']; ?></label>
                                                </div>
                                                <div class="col-lg-6 col-sm-12 mb-3 col-md-6">
                                                    <label class="form-label">Chassis Number</label>
                                                    <label class="d-block text-success"><?php echo $getVehicleDetails[0]['chassis_number']; ?></label>
                                                </div>
                                                <hr>
                                                <div class="col-lg-6 col-sm-12 mb-3 col-md-6">
                                                    <label class="form-label">Engine Number</label>
                                                    <label class="d-block text-success"><?php echo $getVehicleDetails[0]['engine_number']; ?></label>
                                                </div>
                                                <div class="col-lg-6 col-sm-12 mb-3 col-md-6">
                                                    <label class="form-label">Company</label>
                                                    <label class="d-block text-success"><?php echo $getVehicleDetails[0]['company']; ?></label>
                                                </div>
                                                <hr>
                                                <div class="col-lg-6 col-sm-12 mb-3 col-md-6">
                                                    <label class="form-label">Vehicle Type</label>
                                                    <label class="d-block text-success"><?php echo $getVehicleDetails[0]['vehicleType']; ?></label>
                                                </div>
                                                <div class="col-lg-6 col-sm-12 mb-3 col-md-6">
                                                    <label class="form-label">Registration Office</label>
                                                    <label class="d-block text-success"><?php echo $getVehicleDetails[0]['registered_at']; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body py-4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-auto col-md-auto col-6 mt-3" style="padding-right:0;">
                                            <button class="btn btn-danger btn-style-five disabled-on-loading w-100" id="btn5Next"> Next</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form id="step6Form">
                            <div class="card">
                                <div class="card-body py-0">
                                    <h5 class="card-title text-danger text-uppercase">Upload photo for face match</h5>        
                                </div>
                            </div>
                            <?php 
                                $getVehicleInactivities = $this->db->query('select * from vehicleFaceMatch where vehicleId='.(isset($_SESSION['vehicleId']) ? $_SESSION['vehicleId'] : 0))->result_array();
                            ?>
                            <?php
                                for($i=0;$i<3;$i++)
                                {
                                ...
                                <div class="card-body py-3">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-auto col-lg-auto my-3" >
                                            <button type="button" id="btn6Back" class="btn btn-dark disabled-on-loading w-100 btn-style-grey"> Back</button>
                                        </div>
                                        <div class="col-lg-auto col-sm-12 col-md-auto my-3">
                                            <button class="btn btn-primary btn-style-five w-100 disabled-on-loading" type="button" id="btn6Next"> Save</button>
                                        </div>
                                    </div>
                                    <?php 
                    ...
                    <div id="step7" class="<?php if($pn != 7){ echo "d-none"; } ?>">
                        <form id="step7Form">
                            <div class="card">
                                <div class="card-body py-0">
                                    <h5 class="card-title text-danger">Manage your privacy settings</h5>        
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body py-3">
                            ...
                            <div class="card">
                                <div class="card-body py-3">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-auto col-lg-auto my-3" >
                                            <button type="button" id="btn7Back" class="btn btn-dark disabled-on-loading w-100 btn-style-grey"> Back</button>
                                        </div>
                                        <div class="col-lg-auto col-sm-12 col-md-auto my-3">
                                            <button type="submit" class="btn btn-primary btn-style-five w-100 disabled-on-loading" id="btn7Next"> Save</button>
                                        </div>
                                        <div class="col-lg-auto col-sm-12 col-md-auto my-3">
...
<div class="floatingButtonWrap">
    <div class="floatingButtonInner">
        ...
        <ul class="floatingMenu">
            <li>
                <a href="<?php echo base_url(); ?>user/upload_vehicle_details?pn=2">Add Vehicle Photo</a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>user/upload_vehicle_details?pn=3">Add Vehicle Documents</a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>user/upload_vehicle_details?pn=4">Add Contact Details</a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>user/upload_vehicle_details?pn=5">Pay Amount</a>
            </li>
            <?php 
                $getVehicleDetails = $this->db->query('select * from vehicles where Id="'.(isset($_SESSION['vehicleId']) ? $_SESSION['vehicleId'] : 0).'"')->result_array();
            ...
            ?>
            <li>
                <a href="<?php echo base_url(); ?>user/upload_vehicle_details?pn=6">Add Face Match Photo</a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>user/upload_vehicle_details?pn=7">Active / In-Active Profile</a>
            </li>
            <?php } }  ?>
        </ul>
    </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/croppie/2.6.5/croppie.min.js" integrity="sha512-Gs+PsXsGkmr+15rqObPJbenQ2wB3qYvTHuJO6YJzPe/dTLvhy0fmae2BcnaozxDo5iaF8emzmCZWbQ1XXiX2Ig==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
  ...
  <script type="text/javascript">
    ...
    function showMobile()
    {
        $('#vehicleMobDiv').removeClass('d-none');
        $('#vehicleDoc').addClass('d-none');
    }

    function showPay()
    {
        $('#vehicleMob').addClass('d-none');
        $('#vehiclePay').removeClass('d-none');   
    }
    
    $('#btn6Back').click(function()
    {
        location.href="<?php echo base_url(); ?>user/upload_vehicle_details?pn=5";
    })
    
    $('#btn7Back').click(function()
    {
        location.href="<?php echo base_url(); ?>user/upload_vehicle_details?pn=6";
    })
    ...
    $('#btn6Next').click(function()
    {
        ...
        {
            location.href="<?php echo base_url(); ?>user/upload_vehicle_details?pn=7";   
        }else{
    ...
    {
        e.preventDefault();
        $('#btn7Next').attr('disabled','disabled');
    ...
    {
        location.href="<?php echo base_url(); ?>user/upload_vehicle_details?pn=4";
    })
    ...
    {
        location.href="<?php echo base_url(); ?>user/upload_vehicle_details?pn=3";
    })
    ...
    {
        location.href="<?php echo base_url(); ?>user/upload_vehicle_details?pn=2";
    })
    ...
    function showVehicleDoc()
    {
        location.href="<?php echo base_url(); ?>user/upload_vehicle_details?pn=2";
    }

    $('#vehiclePayForm').on('submit',function(e)
    {
        e.preventDefault();
        $('#btnPay').attr('disabled','disabled');
        $.ajax({
            url:'<?php echo base_url(); ?>user/getVehicleAmount',
            type:'get',
            success:function(res)
            {
                let rzpData = new FormData();
                rzpData.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
                rzpData.append('amount', (res * 100));
                $.ajax({
                        ...
                        var options = {
                            ...
                            "key": "rzp_live_IS6pmFuBDVlq9p",
                          	...
                          	"handler": function (response) {
                          		$.ajax({
                          		    url:'<?php echo base_url(); ?>user/savePayment',
                          		    data:{payment: res,paymentId:response.razorpay_payment_id,'_token':'<?php echo $this->security->get_csrf_hash(); ?>'},
                          		    type:'post',
                          		    success:function(res)
                          		    {
                          		        Swal.fire({
                          		            title:'Your vehicle information add successfully.',
                          		            icon:'success',
    ...
    function confirmCancel(ele)
    {
        ...
        Swal.fire({
            ...
            allowOutsideClick:false,
            html:
                '<div class="form-group mt-3"><label class="form-label">Are you sure ! You do not want to add vehicle information?</label></div>',
            showCloseButton: true,
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url:'<?php echo base_url(); ?>user/markVehicleAsDeleted',
                    type:'get',
                    success:function(res)
                    {
                         let parse = JSON.parse(res);
                         if(parse.status == 'success')
                         {
                            toastr.success('Vehicle Successfully Cancelled');
                            setTimeout(function()
                            {
                              location.reload();
                            },3000);
                            ...
                            $(ele).removeAttr('disabled');
                            $.ajax({
                                url:'<?php echo base_url(); ?>user/getVehicleHtml',
                                type:'get',
                                success:function(res)
                                {
                                    Swal.fire({
    ...
    function editVehicle(ele,Id)
    {
        $(ele).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>user/editVehicle/"+Id;
    }

    function deleteVehicleById(ele,Id)
    {
        $(ele).attr('disabled','disabled');
        ...
        if(otp != '')
        {
            ...
            data.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
            $.ajax({
                url:'<?php echo base_url(); ?>user/deleteVehicleById',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
                ...
                success:function(res)
                {
                    ...
                    if(parse.status == 'success')
                    {
                        ...
                        setTimeout(function()
                        {
                            location.href="<?php echo base_url(); ?>user/upload_vehicle_details?pn=1";
                        },3000);
                     }else{
                        $(ele).removeAttr('disabled');
                        toastr.error(parse.message);
    ...
    function resendDeleteVehicleOtp(ele,Id)
    {
        $(ele).attr('disabled','disabled');
        ...
        $.ajax({
            url:'<?php echo base_url(); ?>user/sendDeleteVehicleOtp',
            data:otpdata,
            contentType: false,
            cache: false,
            processData:false,
        ...
        $.ajax({
            ...
            success:function(res)
            {
                 ...
                 if(parse.status == 'success')
                 {
                    ...
                    $('#rcform').addClass('d-none');
                 }else{
                    if(parse.status == 'Already Available')
                    {
                        Swal.fire({
                            iconHtml: '<img src="<?php echo base_url(); ?>assets/img/sorry.png" style="width:130px;height:130px;">',
                            customClass: {
                                icon: 'no-border'
                            },
                            allowOutsideClick:false,
    ...
    function deleteVehicle(ele,Id,setting)
    {
        $(ele).attr('disabled','disabled');
        if(setting == 1)
        {
            Swal.fire({
                ...
                allowOutsideClick:false,
                html:
                    '<div class="form-group mt-3"><label class="form-label">Are you sure you want to delete vehicle?</label></div>',
                showCloseButton: true,
                confirmButtonText:'Yes',
                cancelButtonText:'No',
                showCancelButton: true,
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success:function(res)
                        {
                            toastr.success('An OTP has been sent on login number');
                            $(ele).removeAttr('disabled');
                            Swal.fire({
                              title: '<strong>Enter OTP to proceed </strong>',
                              icon: 'success',
                              allowOutsideClick:false,
                              html:
                                '<div class="form-group mb-3"><label class="form-label">Enter OTP</label></div><div class="form-group mb-3"><label class="form-label">Enter OTP</label><input type="number" class="form-control" id="deleteOtpInput"></div><div class="form-group"><button type="button" class="w-100 btn btn-primary save disabled-on-loading" onclick="deleteVehicleById(this,'+Id+')"> Verify OTP</button></div><div class="form-group mt-3 col-lg-6 col-md-6 col-sm-12" style="margin-left:auto;"><button type="button" class="w-100 btn btn-primary btn-style-five disabled-on-loading" onclick="resendDeleteVehicleOtp(this,'+Id+')"> Resend OTP</button></div>',
                              showCloseButton: true,
                              showCancelButton: false,
                              focusConfirm: false,
                              showConfirmButton:false
    ...
    function showStep1Btn(val)
    {
        if(val.length > 6)
        {
            ...
            $('#btnSubmit').removeClass('btn-style-grey').addClass('btn-style-five');
        }else{
            $('#btnSubmit').addClass('disabled');
            $('#btnSubmit').removeClass('btn-style-five').addClass('btn-style-grey');
        }
    }
