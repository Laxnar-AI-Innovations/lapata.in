            ...
            <div class="col-xl-4 col-lg-4 col-sm-12 col-md-8 px-0 <?php if($pn != 1){ echo "d-none"; } ?>">
                <div class="card">
                    <div class="card-body mt-3 py-3 w-100 p-3">
                        <form class="row g-3 needs-validation <?php if($pn != 1){ echo "d-none"; } ?>" method="post" action="<?php echo base_url(); ?>user/checkPerson/step2" novalidate id="step2Form">
                            <?php 
                                $csrf = array(
                            ...
                            <div class="custom-field pb-4">
                                ...
                                <div id="aadharIdentity" class="mt-2 px-0">
                                    <div class="form-floating mt-3 pr-2 row mx-0">
                                        <input type="number" class="form-control text-uppercase" name="aadhar_id" max="12" min="12" onkeydown="limit(this,'aadhar');" onInput="limit(this,'aadhar');" onkeyup="limit(this,'aadhar');" id="aadharNumber" required placeholder="Aadhar Number" aria-describedby="step2CheckAadhar">
                                    ...
                                    <div class="row mt-3 mx-0" style="justify-content:space-evenly;text-align:center;">
                                        ...
                                        <div class="col-6 px-0">
                                            <button class="btn btn-secondary w-auto disabled-on-loading btn-style-grey disabled" id="step2CheckAadhar" type="button"> Search</button>  
                                        </div>
                                    </div>
                                </div>
                                <div id="panIdentity" class="mt-2 px-0 d-none">
                                    <div class="form-floating mt-3 pr-2 row mx-0">
                                        <input type="text" maxlength="10" class="form-control text-uppercase" onkeydown="limit(this,'pan');" onkeyup="limit(this,'pan');" onInput="limit(this,'pan');" id="panNumber" required placeholder="PAN Number" aria-describedby="step2CheckPan">
                                    ...
                                    <div class="row mt-3" style="justify-content:space-evenly;text-align:center;">
                                        ...
                                        <div class="col-6 px-0">
                                            <button class="btn btn-secondary w-auto disabled-on-loading btn-style-grey disabled" id="step2CheckPan" type="button"> Search</button>  
                                        </div>
                                    </div>
                                </div>
                                <div id="voterIdentity" class="mt-2 px-0 d-none">
                                    <div class="form-floating mt-3 pr-2 row mx-0">
                                        <input type="text" class="form-control text-uppercase" id="voterId" onkeydown="limit(this,'voter');" onkeyup="limit(this,'voter');" onInput="limit(this,'voter');" required placeholder="Voter Number" aria-describedby="step2CheckVoter">
                                    ...
                                    <div class="row mt-3" style="justify-content:space-evenly;text-align:center;">
                                        ...
                                        <div class="col-6 px-0">
                                            <button class="btn btn-secondary w-auto disabled-on-loading btn-style-grey disabled" id="step2CheckVoter" type="button"> Search</button>  
                                        </div>
                                    </div>
                                </div>
                                <div id="dlIdentity" class="mt-2 px-0 d-none">
                                    <div class="form-floating mt-3 pr-2 row mx-0">
                                        <input type="text" maxlength="15" class="form-control text-uppercase" max="12" min="12" onkeydown="limit(this,'dl');" onInput="limit(this,'dl');" onkeyup="limit(this,'dl');" id="dlNumber" required placeholder="Driving License Number" aria-describedby="step2CheckDl">
                                    ...
                                    <div class="row mt-3" style="justify-content:space-evenly;text-align:center;">
                                        ...
                                        <div class="col-6 px-0">
                                            <button class="btn btn-secondary w-auto disabled-on-loading btn-style-grey disabled" id="step2CheckDl" type="button"> Search</button>  
                                        </div>
                                    </div>
                                </div>
                                <div id="goldIdentity" class="mt-2 px-0 d-none">
                                    <div class="form-floating mt-3 pr-2 row mx-0">
                                        <input type="text" maxlength="6" class="form-control text-uppercase" id="huIdNumber" onkeydown="limit(this,'gold');" onInput="limit(this,'gold');" onkeyup="limit(this,'gold');" required placeholder="Driving License Number" aria-describedby="step2CheckGold">
                                        <label for="huIdNumber" id="huidLabel" class="pl-2">Enter Gold Jewellery HUID No</label>
                                    </div>
                                    <div class="row mt-3" style="justify-content:space-evenly;text-align:center;">
                                        <div class="col-6 px-0">
                                            <button class="btn btn-secondary w-auto disabled-on-loading btn-style-grey disabled" id="step2CheckGold" type="button"> Search</button>  
                                        </div>
                                    </div>
                                </div>
                                <div id="vehicleIdentity" class="mt-2 px-0 d-none">
                                    <div class="form-floating mt-3 pr-2 row mx-0">
                                        <input type="text" maxlength="10" class="form-control text-uppercase" onkeydown="limit(this,'vehicle');" onkeyup="limit(this,'vehicle');" onInput="limit(this,'vehicle');" id="vehicleNumber" required placeholder="Driving License Number" aria-describedby="step2CheckVehicle">
                                        <label for="vehicleNumber" id="vehicleLabel" class="pl-2">Enter Vehicle No</label>
                                    </div>
                                    <div class="row mt-3" style="justify-content:space-evenly;text-align:center;">
                                        <div class="col-6 px-0">
                                            <button class="btn btn-secondary w-auto disabled-on-loading btn-style-grey disabled" id="step2CheckVehicle" type="button"> Search</button>  
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-xl-12 px-0 <?php if($pn != 2){ echo 'd-none'; } ?>">
                <div class="row mx-0 justify-content-center">
                        ...
                        if(isset($_SESSION['searchId']))
                        {
                            ...
                            switch($checkDetail[0]['Idtype']){
                                ...
                                case 'gold' :
                                    ...
                                    break;
                                case 'vehicle' :
                                    $getMissingDetails = $this->db->query('select Id from missingperson where isFound=0 and isdeleted=0 and vehicleNumber like "%'.$checkDetail[0]['IdNumber'].'%"')->result_array();
                                    if(count($getMissingDetails) > 0)
                                    {
                                        foreach($getMissingDetails as $k=>$v)
                                        {
                                    ...
                                    $getLapataDetails = $this->db->query('select id from unknown_person where isFound=0 and expiryDate >="'.date('Y-m-d H:i:s A').'" and awsEventName= "All" and vehicle_no like "%'.$checkDetail[0]['IdNumber'].'%"')->result_array();
                                    if(count($getLapataDetails) > 0)
                                    {
                                        foreach($getLapataDetails as $k=>$v)
                                        {
                                    ...
                                    $getUnknownDetails = $this->db->query('select id from unknown_person where isFound=0 and awsEventName != "All" and vehicle_no like "%'.$checkDetail[0]['IdNumber'].'%"')->result_array();
                                    if(count($getUnknownDetails) > 0)
                                    {
                                        foreach($getUnknownDetails as $k=>$v)
                                        {
                    ...
                    <div class="row align-items-center justify-content-center px-3">
                                ...
                                <div class="card-body px-0 pt-0">
                                        ...
                                        <div class="col-6 px-1 text-center mb-2">
                                            ...
                                            <?php if($row['rewardamount'] != '' && $row['rewardamount'] != NULL && $row['rewardamount'] != 0){ ?>
                                                <div class="row col-12 mx-0 p-0" style="border:1px solid red;">
                                                    <h6 class="card-title text-center px-1 py-0 mb-0" style="font-size:16px;"> <b style="color:red;font-weight:500;">Reward - </b><b style="color:black;font-size:.8rem!important;">Rs. <?php echo $row['rewardamount']??"--"?></b></h6>
                                                 </div>
                                            <?php } ?>
                                        </div>
                                    ...
                                    <div class="row w-100 mx-0 align-items-center">
                                        ...
                                        <div class="col-12 text-center">
                                            ...
                                            ?>
                                                <?php if($row['well1']!='' || $row['well1']!=null) { ?>
                                                <button type="button" href="tel:<?= $row['well1']; ?>" onclick="sendMsg(this,'<?= $row['Application_no']; ?>')" class="btn btn-circle btn-sm btn-police1 disabled-on-loading"> <i class="fa fa-phone"></i></button>
                                                <?php } if($row['well2']!='' || $row['well2']!=null) { ?>
                                                <button type="button" href="tel:<?= $row['well2']; ?>" onclick="sendMsg(this,'<?= $row['Application_no']; ?>')" class="btn btn-circle btn-sm btn-police2 disabled-on-loading"> <i class="fa fa-phone"></i></button>
                                                <?php }
                                                if($row['well3']!='' || $row['well3']!=null) { ?>
                                                  <button type="button" href="tel:<?= $row['well3']; ?>" onclick="sendMsg(this,'<?= $row['Application_no']; ?>')" class="btn btn-circle btn-sm btn-police3 disabled-on-loading"> <i class="fa fa-phone"></i></button>
                                                <?php } ?>
                                            <?php }else{ ?>
                        ...
                        ?>
                        <div class="col-lg-4 col-xl-3 col-md-6 px-0 px-md-2 col-12 col-search pb-2" >
                            <div class="card mb-3 shiva_height1 bg-light">
                                <div class="card-body px-0 pt-0">
                                    <div class="row align-items-center px-0 mx-0 justify-content-center">
                                        <?php
                                            if($row['Photo'] != '' || $row['Photo'] != NULL)
                        ...
                        <div class="col-lg-4 col-xl-3 col-md-6 px-0 px-md-2 col-12 col-search pb-2" >
                            <div class="card mb-3 shiva_user_height bg-light">
                                <div class="card-body px-0 pt-0">
                                    <div class="row align-items-center px-0 mx-0 justify-content-center">
                                        <div class="col-8 v-<?=$checkDetail[0]['Idtype']?> img-<?=$checkDetail[0]['Idtype']?>" data-p="<?=$checkDetail[0]['Idtype']?>">
                                    ...
                                    <div class="row align-items-center px-0 mx-0 justify-content-center">
                                        ...
                                        <div class="row col-12">
                                            <h5 class="card-title py-0 fs-6 mb-0"><b style="color:black;"><?php echo substr_replace($row['aadhar_id'],'xxxxxxxx',0,8);?></b></h5>
                                        </div>
                                        <hr class="my-0">
                                        <div class="row w-100 mx-0 align-items-center">
                                            <?php 
                                            ...
                                            ?>
                                            <div class="col-12 ">
                                                <b style="font-size:.8rem!important;color:black;font-weight:500;">Contact To: - </b><b style="color:black;font-size:.8rem!important;">Well Wisher</b>
                                            </div>
                                            <div class="col-12 text-center">
                                                <a href="javascript:void(0)" onclick="showLogin()" class="btn btn-circle btn-sm btn-police1" ><i class="fa fa-phone"></i> </a>
                                            </div>
...
<script type="text/javascript">
    ...
    $('#btnInactiveSave').click(function()
    {
        if($('#mainPhotoSelected').val() != '')
        {
            ...
            if(count == 0)
            {
                ...
                $.ajax({
                    url:'<?php echo base_url(); ?>user/checkInactiveInfoAfterLogin',
                    data:data,
                    contentType: false,
                    cache: false,
                    processData:false,
    ...
    $('#step2CheckAadhar').click(function()
    {
        ...
        if(count == 0)
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>user/checkPersonIdAfterLogin',
                data:data,
                processData:false,
                cache:false,
                contentType:false,
                        ...
                        if(parse.isLapata != 1)
                        {
                                ...
                                if(parse.isCriminal == 1)
                                {
                                    if(parse.isRegistered == 0 && parse.isMissing == 1)
                                    {
                                     ...
                                     }else if(parse.isRegistered == 1 && parse.isMissing == 1)
                                     {
                                        Swal.fire({
                                         ...
                                         html += '<div class="form-group mt-3 '+(parse.isCriminal ? '' : 'd-none')+'"><label style="font-weight:bolder;font-size: 17px!important;color:#D84315!important;border:1px solid;padding:10px;background:lavenderblush;border-radius:20px;" class="text-danger">Criminal Record :- <a href="<?php echo base_url(); ?>user/criminalRecordAfterLogin" class="text-success" style="text-decoration:underline;" target="_blank">View</a></label></div><div class="form-group mb-0"><label style="font-weight:bolder;font-size: 17px!important;color:red!important;" class="text-danger">'+typeLabel+'</label></div>';
                                         if(parse.personName != '')
                                         {
                                    ...
                                    if(parse.isRegistered == 0 && parse.isMissing == 1)
                                    {
                                         ...
                                         if(parse.isVerified == 1)
                                         {
                                             ...
                                             html = '<div class="form-group mt-5"><img src="'+parse.image+'" style="height:200px;width:200px;border: 2px solid #bdbdbd;border-radius:15px;"></div>'+typediv+'<div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><i class="fa fa-check-circle text-danger"></i> <b style="color:black;">Person Name :- </b>'+parse.personName+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Aadhar :- </b>'+parse.aadhar+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;text-transform:capitalize;"><b style="color:black;">Gender :- </b>'+parse.gender+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Age :- </b>'+parse.age+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Address :- </b>'+parse.address+'</label></div><div class="form-group mb-2"><label style="font-weight:bold;color:black;">To get More Details</label></div><div class="form-group mb-2"><button type="button" class="btn btn-primary next disabled-on-loading" onclick="redirectToStep2('+parse.isOnlyUser+','+parse.personId+')"> Click Here</button></div>';
                                         }
                                         Swal.fire({
                                            allowOutsideClick:false,
                                            html: html,
                                ...
                                if(parse.isWanted == 1 || parse.isCriminal == 1)
                                {
                                    if(parse.isRegistered == 0 && parse.isMissing == 1)
                                    {
                                         ...
                                         if(parse.isVerified == 1)
                                         {
                                             ...
                                             html = '<div class="form-group"><img src="'+parse.image+'" style="height:200px;width:200px;border: 2px solid #bdbdbd;border-radius:15px;"></div><div class="form-group mb-0 '+(parse.isCriminal ? '' : 'd-none')+'"><label style="font-weight:bolder;font-size: 17px!important;color:#D84315!important;border:1px solid;padding:10px;background:lavenderblush;border-radius:20px;" class="text-danger">Criminal Record :- <a href="<?php echo base_url(); ?>user/criminalRecordAfterLogin" class="text-success" style="text-decoration:underline;" target="_blank">View</a></label></div><div class="form-group mb-0"><label style="font-weight:bolder;font-size: 17px!important;color:red!important;" class="text-danger">'+typeLabel+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><i class="fa fa-check-circle text-danger"></i> <b style="color:black;">Person Name :- </b>'+parse.personName+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Aadhar :- </b>'+parse.aadhar+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;text-transform:capitalize;"><b style="color:black;">Gender :- </b>'+parse.gender+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Age :- </b>'+parse.age+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Address :- </b>'+parse.address+'</label></div><div class="form-group mb-2"><label style="font-weight:bold;color:black;">To get More Details</label></div><div class="form-group mb-2"><button type="button" class="btn btn-primary next disabled-on-loading" onclick="openCameraPopup()"> Click Here</button></div>';
                                         }
                                         Swal.fire({
                                            allowOutsideClick:false,
                                            html: html,
                            ...
                            let html = '';
                             if(parse.isVerified == 1)
                             {
                                 ...
                                 html = '<div class="form-group mt-5"><img src="'+parse.image+'" style="height:200px;width:200px;border: 2px solid #bdbdbd;border-radius:15px;"></div><div class="form-group mb-0 '+(parse.isCriminal ? '' : 'd-none')+'"><label style="font-weight:bolder;font-size: 17px!important;color:#D84315!important;border:1px solid;padding:10px;background:lavenderblush;border-radius:20px;" class="text-danger">Criminal Record :- <a href="<?php echo base_url(); ?>user/criminalRecordAfterLogin" class="text-success" target="_blank" style="text-decoration:underline;">View</a></label></div><div class="form-group mb-0"><label style="font-weight:bolder;font-size: 17px!important;color:red!important;" class="text-danger">'+typeLabel+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><i class="fa fa-check-circle text-danger"></i> <b style="color:black;">Person Name :- </b>'+parse.personName+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Aadhar :- </b>'+parse.aadhar+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;text-transform:capitalize;"><b style="color:black;">Gender :- </b>'+parse.gender+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Age Band:- </b>'+parse.age+'</label></div><div class="form-group mb-2 '+((parse.address != ',') ? '' : 'd-none')+'"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Address :- </b>'+parse.address+'</label></div><div class="form-group mb-2"><label style="font-weight:bold;color:black;">To get More Details</label></div><div class="form-group mb-2"><button type="button" class="btn btn-primary next disabled-on-loading" onclick="redirectToStep2('+parse.isOnlyUser+','+parse.personId+')"> Click Here</button></div>';
                             }
                             Swal.fire({
                                allowOutsideClick:false,
                                html: html,
        ...
        if(count == 0)
        {
            ...
            $.ajax({
                ...
                success:function(res)
                {
                    ...
                    {   
                        $('#step2CheckVehicle').removeAttr('disabled');
                        window.open('<?php echo base_url(); ?>user/search_person_by_identity?pn=2','_blank');
                    }
                    else
                    {
                        if(parse.status == 'error')
    ...
    function redirectToStep2(type,id)
    {
        if(type)
        {
            ...
            $.ajax({
                url:'<?= base_url(); ?>user/createOverallHistory',
                success:function(res)
                {
                    window.open('<?php echo base_url(); ?>user/search_person_by_identity?pn=2','_blank');      
                }
    ...
    function limit(val,type){
        if(type == 'aadhar')
        {
            ...
            if(val.value.length > max_chars) {
                $('#step2CheckAadhar').removeClass('btn-style-grey').addClass('btn-style-five');
                $('#step2CheckAadhar').removeClass('disabled');
                val.value = val.value.substr(0, (max_chars + 1));
            }else{
                $('#step2CheckAadhar').addClass('btn-style-grey').removeClass('btn-style-five');
            ...
            if(type == 'pan')
            {
                var max_chars = 9;
                if(val.value.length > max_chars) {
                    $('#step2CheckPan').removeClass('btn-style-grey').addClass('btn-style-five');
                    $('#step2CheckPan').removeClass('disabled');
                    val.value = val.value.substr(0, (max_chars + 1));
                }else{
                    $('#step2CheckPan').addClass('btn-style-grey').removeClass('btn-style-five');
                ...
                if(type == 'gold')
                {
                    var max_chars = 5;
                    if(val.value.length > max_chars) {
                        $('#step2CheckGold').removeClass('btn-style-grey').addClass('btn-style-five');
                        $('#step2CheckGold').removeClass('disabled');
                        val.value = val.value.substr(0, (max_chars + 1));
                    }else{
                        $('#step2CheckGold').addClass('btn-style-grey').removeClass('btn-style-five');
                        $('#step2CheckGold').addClass('disabled');
                    }   
                }else{
                    if(type == 'vehicle')
                    {
                        ...
                        if(val.value.length > min_chars) {
                            $('#step2CheckVehicle').removeClass('btn-style-grey').addClass('btn-style-five');
                            $('#step2CheckVehicle').removeClass('disabled');
                        }else{
                            $('#step2CheckVehicle').addClass('btn-style-grey').removeClass('btn-style-five');
                            $('#step2CheckVehicle').addClass('disabled');
                        }   
                    }else{
                        if(type == 'dl')
                        {   
                            var min_chars = 1;
                            if(val.value.length > min_chars) {
                                $('#step2CheckDl').removeClass('btn-style-grey').addClass('btn-style-five');
                                $('#step2CheckDl').removeClass('disabled');
                            }else{
                                $('#step2CheckDl').addClass('btn-style-grey').removeClass('btn-style-five');
                                $('#step2CheckDl').addClass('disabled');
                            }
                        }else{
                            var min_chars = 1;
                            if(val.value.length > min_chars) {
                                $('#step2CheckVoter').removeClass('btn-style-grey').addClass('btn-style-five');
                                $('#step2CheckVoter').removeClass('disabled');
                            }else{
                                $('#step2CheckVoter').addClass('btn-style-grey').removeClass('btn-style-five');
