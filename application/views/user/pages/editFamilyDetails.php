                ...
                <div class="row justify-content-center">
                        ...
                        <div class="card mb-3 w-100">
                            <div class="card-body mt-0">
                                <div class="row align-items-center">
                                    <div class="col-12">
                                        <h5 class="card-title text-center pb-0 fs-4 mb-0">Edit Family Member Details</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <form id="loginForm" action="<?php echo base_url(); ?>user/postFamilyMember" method="post" class="row g-0 needs-validation1"  enctype="multipart/form-data">
                            <?php 
                                $csrf = array(
                                ...
                                <div class="hiddendiv">
                                    <div class="row align-items-center p-3">
                                        ...
                                        <div class="form-floating col-12 col-md-auto">
                                            <label style="margin-left:0.8rem;">Select DOB <b class="text-danger">*</b></label>
                                            <input type="date" value="<?= $data[0]['dob']; ?>" class="form-control mt-2" id="dob" name="dob" onchange="getAgeBand(this.value)" max="<?= date('Y-m-d') ?>">
                                        </div>
                            ...
                            <div class="card px-0 mb-3 w-100">
                                <div class="row mx-0 align-items-center accordion" id="goldAccordion">
                                    <div class="accordion-item px-0">
                                        ...
                                        <div class="accordion-body row align-items-center">
                                            <div class="card-body mt-0 pb-0">
                                                <div class="row align-items-center justify-content-center">
                                                    ...
                                                    <div class="mb-3 col-12 col-md-4">
                                                        <label class="mb-2 d-block"><b>List of citites </b></label>                            
                    ...
                    <div class="col-lg-12 col-sm-12 col-md-12 d-flex flex-column align-items-center justify-content-center <?= ($pn != 2) ? 'd-none' : ''; ?>">
                                ...
                                <div id="latestChild" class="accordion-collapse collapse px-0" aria-labelledby="latestHeading" data-bs-parent="#latestAccordion" style="background:aliceblue;">
                                    <div class="accordion-body py-0 pe-1 row align-items-center">
                                        <form id="step2Form" method="post" class="row g-1 mt-0 needs-validation1 w-100"  enctype="multipart/form-data">
                                            ...
                                            <?php
                                                $getLatestPhotos = $this->db->query('select * from familyPhotos where familyId='.$data[0]['id'])->result_array();
                                                $j=0;
                                                for($i=0;$i<3;$i++)
                                                {
                                                    $j++;
                                ...
                                <div class="card-footer py-0">
                                    <div class="row justify-content-center">
                                        <div class="col-6 my-3 col-md-auto">
                                            <button type="button" onclick="location.href='<?= base_url(); ?>user/editFamilyDetails?pn=1&id=<?= $_GET['id']; ?>'" style="background:black!important;color:white!important;" class="btn w-100 btn-style-grey text-center disabled-on-loading"> Back</button>
                                        </div>
                                        <?php
                                            if($data[0]['Photo'] != NULL)
                                            {
                                        ?>
                                        <div class="col-6 my-3 col-md-auto">
                                            <button class="btn btn-primary w-100 btn-style-green disabled-on-loading" onclick="location.href='<?= base_url(); ?>user/editFamilyDetails?pn=3&id=<?= $_GET['id']; ?>'" type="button" style="background-color:  #05106c !important;">Next</button>
                                        </div>
                                        <?php }else{ ?>
                                        <div class="col-6 my-3 col-md-auto">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="row justify-content-center align-items-center">
                                            <div class="col-lg-3 col-sm-12 col-md-4">
                                                <div id="lottie-animation" style="width: 100%; height: 200px;"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row align-items-center justify-content-center col-12">
                                <div class="card mb-3 w-100">
                                    <div class="card-header text-center">
                                        <h5 class="mb-0 text-center"><b style="color:black;">Choose Your Plan</b></h5>
                                    </div>
                                    <div class="card-body pt-3 pb-0">
                                        <div class="row justify-content-center">
                                            <?php 
                                                $getPackages = $this->db->query('select * from packages where type="family" order by validity asc')->result_array();
                                                foreach($getPackages as $k=>$v)
                                                {
                                                    if($_SESSION['aadhar_id'] == '574353375023' || $_SESSION['aadhar_id'] == '293072604323')
                                                    {
                                                        $v['amount'] = 0;
                                                    }
                                            ?>
                                            <div class="col-sm-12 col-lg-3 col-md-5 me-md-3 mt-0 card px-0">
                                                <?php 
                                                    ...
                                                    {
                                                ?>
                                                <div class="card-header pay-head py-0" id="<?php echo 'color-'.$k; ?>">
                                                <?php }else if($k == 1){ ?>
                                                <div class="card-header pay-head py-0" id="<?php echo 'color-'.$k; ?>">
                                                <?php }else{ ?>
                                                <div class="card-header pay-head py-0" id="<?php echo 'color-'.$k; ?>">
                                                ...
                                                <div class="card-body descDiv p-0 align-items-center my-3 d-flex" id="card-body<?= $k; ?>">
                                                    <ul type="disc" class="mb-0">
                                                        <li>Searcher  can  contact well-wishers of the User. via "Search by Face Photo" and "Search by Identities."</li>      
                                                        <li>Option to activate or deactivate profile status anytime.</li>
                                                        <li>Subscription can be cancelled at anytime.</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <?php } ?>
                                    ...
                                    <div class="card w-100">
                                        ...
                                        <div class="card-footer text-center">
                                            <button type="button" id="payNow" onclick="payNow(this)" class="btn mt-0 btn-style-red disabled-on-loading" style="border-radius:0!important;padding:15px 50px!important;"> Continue</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        function payNow(ele)
                        {
                            if($('#terms').is(':checked'))
                            {
                                ...
                                if(split[1] == 0)
                                {
                                    ...
                                    $.ajax({
                                        url:'<?php echo base_url(); ?>user/saveFamilyPayment',
                                        type:'post',
                                        data:paymentData,
                                        contentType: false,
                                        cache: false,
                    ...
                    <div id="step3" class="px-0 <?php if($pn != 3){ echo "d-none"; } ?>">
                        <?php 
                            $getPersonDetail = $this->db->query('select * from familyMember where id='.$data[0]['id'])->result_array();
                            $mobcount = 0;
                                        ...
                                        <div class="col-md-6 col-sm-12 col-lg-6 px-0">
                                            <div id="carouselExampleControls" class="carousel slide" data-bs-interval="2000" data-bs-ride="carousel">
                                                <div class="carousel-inner" id="photosspan">
                                                    ...
                                                    <?php } ?>
                                                    <?php
                                                        $getLatestUserPhotos = $this->db->query('select * from familyPhotos where familyId='.$getPersonDetail[0]['id'])->result_array();
                                            ...
                                            <div class="col-md-12 text-center text-danger px-1 pb-3 p-3" style="font-weight:bold;">
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-lg-4 mb-3 col-sm-12 col-md-4">
                                                        <button type="button" class="btn-style-green btn btn-primary d-block w-100 disabled-on-loading" onclick="location.href='<?= base_url(); ?>user/add_family_member'"> Add Another Member <i class="fa fa-user-plus"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    $('#btn3Next').click(function(){
        ...
        $.ajax({
            url:'<?php echo base_url(); ?>user/familySubmit',
            type:'post',
            processData:false,
            contentType:false,
            data:data,
            ...
            success:function(res)
            {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        location.href="<?php echo base_url(); ?>user/editFamilyDetails?id=<?php echo $data[0]['id'] ?>&pn=4";
                    }
                })
            }
        })
                                        ...
                                        $.ajax({
                                            ...
                                            success:function(res)
                                            {
                                                ...
                                                if(parse.status == 'success')
                                                {
                                                    ...
                                                    $.ajax({
                                                        url:'<?php echo base_url(); ?>user/addFamilyFaceMatchPhoto',
                                                        data:faceData,
                                                        contentType: false,
                                                        cache: false,
                                                        processData:false,
    ...
    function deletePhoto(crimeId,Id)
    {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                    $.ajax({
                    url:'<?php echo base_url(); ?>user/deleteFamilyPhoto/'+crimeId,
                    type:'get',
                    success:function(res)
                    {
    ...
    function uploadLatestPhoto(ele,index)
    {
        if($('#latestPhoto'+index).val() == '')
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>user/uploadFamilyPhoto',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
        ...
        if(type == 'old')
        {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url:'<?php echo base_url(); ?>user/deleteFamilyGold',
                        data:otpdata,
                        contentType: false,
                        cache: false,
                        processData:false,
    ...
    $('#btn3Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>user/editFamilyDetails?id=<?php echo $data[0]['id'] ?>&pn=2";
    })
    ...
    function verifyDeleteOtp(ele,index,setting)
    {
        ...
        if(otp != '')
        {
            ...
            data.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
            $.ajax({
                url:'<?php echo base_url(); ?>user/deleteFamilyPersonMobile',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
    ...
    function resendDeleteOtp(ele,index)
    {
        ...
        otpdata.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
        $.ajax({
            url:'<?php echo base_url(); ?>user/sendDeleteFamilyPersonOtp',
            data:otpdata,
            contentType: false,
            cache: false,
            processData:false,
    ...
    function deleteFace(ele,index)
    {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                data.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
                $.ajax({
                    url:'<?php echo base_url(); ?>user/deleteFaceMatchFromFamily',
                    data:data,
                    contentType: false,
                    cache: false,
                    processData:false,
    ...
    function verifyOtp(ele,index)
    {
        if($('#otp'+index).val() != '')
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>user/verifyFamilyPersonMobileOtp',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
    ...
    function sendOtp(index)
    {
        ...
        if($('#othermob'+index).val() != '')
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>user/sendFamilyPersonMobileOtp',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
