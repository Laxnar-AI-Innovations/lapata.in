            ...
            <div class="col-xxl-4 col-md-auto">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <a href="<?php echo base_url(); ?>user/upload_personal_details?pn=3" class="text-success" onclick="checkIfFinal(this);return false;"><i class="fa fa-user"></i></a>
                    </div>
                    <div class="ps-3">
                      <a href="<?php echo base_url(); ?>user/upload_personal_details?pn=3" onclick="checkIfFinal(this);return false;" class="text-dark"><p style="font-size: 14px;font-weight: bold;">Add Well Wisher Contact No.</p></a>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xxl-4 col-md-auto">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <a href="<?php echo base_url(); ?>user/upload_personal_details?pn=5" class="text-success" onclick="checkIfFinal(this);return false;"><img src="<?php echo base_url(); ?>assets/images/faceicon.png" style="width:100px;height:100px;padding:1rem;border-radius:50%;"></a>
                    </div>
                    <div class="ps-3">
                      <a href="<?php echo base_url(); ?>user/upload_personal_details?pn=5" onclick="checkIfFinal(this);return false;" class="text-dark"><p style="font-size: 14px;font-weight: bold;">Add Face Photo</p></a>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xxl-4 col-md-auto">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <a href="<?php echo base_url(); ?>user/upload_partner_details" class="text-success" onclick="checkIfFinal(this);return false;"><img src="<?php echo base_url(); ?>assets/icons/spouse.png"></a>
                    </div>
                    <div class="ps-3">
            ...
            <div class="col-xxl-4 col-md-auto">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <a href="<?php echo base_url(); ?>user/add_family_member" class="text-success" onclick="checkIfFinal(this);return false;"><img src="<?php echo base_url(); ?>assets/familyToken.png" style="height: 50px;"></a>
                    </div>
                    <div class="ps-3">
                      <a href="<?php echo base_url(); ?>user/add_family_member" onclick="checkIfFinal(this);return false;" class="text-dark"><p style="font-size: 14px;font-weight: bold;">Add Family Member</p></a>
                    </div>
                  </div>
                </div>
