    ...
    <div class="container-fluid px-0">
        <div class="row justify-content-center">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="row align-items-center mx-1 mb-3 p-1" style="justify-content:space-around;">
                                        <div class="col-lg-auto col-sm-12 col-md-auto text-start my-1 border border-danger text-center <?= (count($unknownperson) > 0) ? '' : 'd-none'; ?>">
                                            <a  target="_blank" href="<?= base_url(); ?>user/searchMissingFace" class="text-danger" style="text-decoration:none;font-weight:bold;">Appeal for Identification - <?php echo (count($unknownperson) > 1 ? count($unknownperson) : count($unknownperson)); ?></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12 text-md-end text-center mb-3 mb-md-0">
                                    <a href="<?= base_url(); ?>user/searchMissingFace" target="_blank" class="btn btn-primary btn-style-five">View Results</a>
                                </div>
                            </div>
            ...
            <?php
                ...
                {
                    $getLastTransaction = $this->db->query('select * from uploadWithoutTransactions where isKyc=1 and type="lapata" and userId='.$_SESSION['user_id'].' and idNumber="'.$getUnknownDetail[0]['aadharNumber'].'" order by Id desc')->result_array();
                }else{
                    $getLastTransaction = $this->db->query('select * from uploadtransactions where isKyc=1 and type="lapata" and userId='.$_SESSION['user_id'].' and idNumber="'.$getUnknownDetail[0]['aadharNumber'].'" order by Id desc')->result_array();
                }
