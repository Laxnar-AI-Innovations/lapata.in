            ...
            <div class="container px-0">
                <div class="row justify-content-center">
                                ...
                                <div class="card-body mt-0">
                                    <div class="row align-items-center ">
                                        <div class="form-floating col-12 col-md-auto">
                                            ...
                                            <input type="date" name="rescueDate" id="rescueDate" required class="form-control mt-2" max="<?= date('Y-m-d') ?>">
                                        </div>
                            ...
                            <div class="card mb-3 w-100">
                                ...
                                <div class="card-body mt-0">
                                    <div class="row align-items-center ">
                                        ...
                                        <div class="form-floating my-3 col-12 col-md-3">
                                            <input type="text" class="form-control text-uppercase" maxlength="10" name="PAN"   id="PAN"  placeholder="Aadhar Number">
                    ...
                    <div id="step3" class="<?php if($pn != 3){ echo "d-none"; } ?>">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-0 pb-0">Add your contact number</h5>
                            </div>
                        </div>
                        <?php
                            for($i=1;$i<=3;$i++)
...
<script>
    ...
    $('#btn3Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>user/upload_unknown_details?pn=2";
    })
                ...
                success:function(res)
                {
                    ...
                    if(parse.status == 'success')
                    {
                        ...
                        setTimeout(function()
                        {
                            let data = new FormData();
                            data.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
                            data.append('mainPhotoSelectedFacematch',$('#facematch').val());
                                ...
                                success:function(res)
                                {
                                    ...
                                    if(parse.finalCount > 0)
                                    {
                                        $.ajax({
                                            ...
                                            success:function(res)
                                            {
                                                location.href="<?php echo base_url(); ?>user/searchFaceResults";      
                                            }
                                        })
                                    }else{
                                        location.href="<?php echo base_url(); ?>user/upload_unknown_details?pn=4";  
                                    }
                                }
                            });
                        },2000);
    ...
    $('#btn3PayNow').click(function()
    {
        ...
        location.href="<?= base_url(); ?>user/showUnknownPaymentModels";
    })
    
    function payNow(ele,count)
    {
        $(ele).attr('disabled',true);
        location.href='<?php echo base_url(); ?>user/showUnknownPaymentModels';
    }
                    ...
                    success:function(res)
                    {
                        ...
                        if(parse.finalCount > 0)
                        {
                            $.ajax({
                                ...
                                success:function(res)
                                {
                                    location.href="<?php echo base_url(); ?>user/view_expiry_unknown";  
                                }
                            })
                        }else{
                            location.href="<?php echo base_url(); ?>user/upload_unknown_details?pn=4";  
    ...
    $('#btn2Next').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>user/upload_unknown_details?pn=3";
    })
