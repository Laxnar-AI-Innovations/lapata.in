            ...
            <div class="card image-wrapper bg-full bg-image bg-overlay bg-overlay-400 theme_bk_color" data-image-src="assets/img/photos/bg2.jpg">
              <div class="card-body p-2 p-xl-2">
                <div class="row align-items-center counter-wrapper gy-2 text-center text-white">
                  <h2 class="fs-12 text-uppercase text-white ">Total Number Of Uploads & Searches</h2>
      ...
      <div class="row gx-md-5 gy-5 text-center">
        <div class="col-md-6 col-xl-4">
          <div class="card shadow-lg service-card box_1"  onclick="toggleActive(this)" >
              ...
              <button type="button" onclick="getRegistered('digilocker')" class="btn btn-default d-block card me-md-0 me-0 px-2 w-100 " style="color:black;justify-content:space-around;text-align: -webkit-center;" id="btnMobileNext">Continue with DigiLocker <br><img class="ms-1 d-block d-md-inline w-auto" src="https://khoji-new.s3.ap-south-1.amazonaws.com/assets_landing_page/logos/digilocker.webp" style="width:100px;height:50px;"></button>
        ...
        <div class="col-md-6 col-xl-4">
          <div class="card shadow-lg service-card box_1" onclick="toggleActive(this)">
            ...
            <button type="button" onclick="location.href='<?= base_url(); ?>create-an-account'" class="btn btn-default d-block card me-md-0 me-0 px-2 w-100 " style="color:black;justify-content:space-around;" id="btnMobileNext">Continue with Direct AADHAAR <br><img class="ms-1 w-auto" src="<?= base_url(); ?>assets_landing_page/img/aadhar.webp" style="width:50px;height:50px;"></button>
        ...
        <div class="col-md-6 col-xl-4">
          <div class="card shadow-lg service-card box_1" onclick="toggleActive(this)">
                    ...
                    <button type="button" onclick="location.href='<?= base_url(); ?>mobile-login'" class="btn btn-default d-block card me-md-0 me-0 px-2 w-100 " style="color:black;justify-content:space-around;" id="btnMobileNext">Continue with Mobile Number<br><img class="ms-1 w-auto" src="<?= base_url(); ?>assets_landing_page/img/mboile.png" style="width:55px;height:50px;"></button>
...
<div class="marquee-container d2 d-none1">
    ...
    border-image: linear-gradient(to right, #283593 0%, #d90f0ffc 100%) 1;" />
        ...
        <a href="<?php echo base_url();?>khoji-success" class="btn btn-danger theme_bk_color" style="border:1px dotted white;" >View All</a> 
...
<!-- end of the code -->
 ...
 <div class="container py-5">
    <div class="col-md-11 col-lg-9 col-xl-8 col-xxl-7 mx-auto position-relative">
            <h2 class="fs-25 mb-3 text-center text-dark">Choose <span class="text-gradient gradient-theme"> Your Plan</span> That Suits You </h2>
                </div>
        <div class="price-card">
            <ul class="nav nav-tabs nav-fill" id="priceTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="three-months-tab" data-bs-toggle="tab" data-bs-target="#three-months" type="button" role="tab" aria-controls="three-months" aria-selected="false">3 Month</button>
                </li>
            </ul>
            <div class="tab-content" id="priceTabContent">
                <div class="tab-pane fade" id="free" role="tabpanel" aria-labelledby="free-tab">
                   
                    <h5 class="text-center fs-30">Active Free for<span class="text-danger "> 7 days </h5>
                    ...
                    <ul class="hindi_divi d-none">
                        <li><img src="<?php echo base_url();?>assets_landing_page/price_icon/1.png" alt="">कोई भी अब आपके लापता व्यक्ती को केवल चेहरे और अपलोडेड जानकारी के ही माध्यम से सर्च करके आपसे संपर्क कर सकता है</li>
                        <li><img src="<?php echo base_url();?>assets_landing_page/price_icon/2.png" alt="">जैसे ही आपके लापता व्यक्ती से संबंधित मैच फाउंड होगा तो तुरंत व्हाट्सएप और एसएमएस नोटिफफकेशन प्राप्त करें।</li>
                        ...
                        <li><img src="<?php echo base_url();?>assets_landing_page/price_icon/4.png" alt="">जब पुलिस, एनजीओ या सोशल वरकर आपके गुमशुदा व्यक्ती की जानकारी पहचान के ललए अपलोड करें, तो आपको अलिच लमलेगा।</li>
                    </ul>
                ...
                <div class="tab-pane fade show active" id="one-month" role="tabpanel" aria-labelledby="one-month-tab">
                    <h5 class="text-center fs-30">Start with just <span class="text-danger "> ₹299/month</h5>
                    <ul class="english_divi">
                       <li ><img src="<?php echo base_url();?>assets_landing_page/price_icon/1.png" alt="">Any one can Search for your missing persons using face photo, identity, or uploaded details.</li>
                        <li><img src="<?php echo base_url();?>assets_landing_page/price_icon/2.png" alt="">Receive instant WhatsApp and SMS notifications when a match is found.</li>
                        <li><img src="<?php echo base_url();?>assets_landing_page/price_icon/3.png" alt="">Easy-to-share link with active/inactive status options. </li>
                ...
                <div class="tab-pane fade" id="three-months" role="tabpanel" aria-labelledby="three-months-tab">
                   <h5 class="text-center fs-30">Start with just <span class="text-danger "> ₹599/month</h5>
                    <ul class="english_divi">
                       <li><img src="<?php echo base_url();?>assets_landing_page/price_icon/1.png" alt="">Any one can Search for your missing persons using face photo, identity, or uploaded details.</li>
                        <li><img src="<?php echo base_url();?>assets_landing_page/price_icon/2.png" alt="">Receive instant WhatsApp and SMS notifications when a match is found.</li>
                        <li><img src="<?php echo base_url();?>assets_landing_page/price_icon/3.png" alt="">Easy-to-share link with active/inactive status options. </li>
