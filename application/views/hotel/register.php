  ...
  <section class="section register d-flex flex-column align-items-center justify-content-center py-4">
    <div class="container px-0">
      <div class="row justify-content-center">
        <div class="col-lg-6 col-xl-4 col-md-8 d-flex flex-column align-items-center justify-content-center">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body p-1">
              ...
              <div class="pt-4 pb-2">
                ...
                <h5 class="card-title text-center pb-0">Creating Account is fast and easy!</h5>
              ...
              <form class="row gy-3 needs-validation justify-content-center" method="post" action="<?php echo base_url(); ?>hotel/register/do_register" id="registerForm">
                    ...
                    <div class="row col-lg-12 justify-content-center text-center">
                        <div class="col-sm-12 col-xl-12 form-floating mt-4">
                ...
                <div class="col-12 mt-3 px-3">
                  <p class="mb-0">Already have an account? <a href="<?php echo base_url(); ?>hotel">Log in</a></p>
                </div>
