 ...
 <div class="card shadow mb-1">
                        <div class="card-header py-3">
                            <!-- <h6 class="m-0 font-weight-bold text-primary">Community</h6> -->
                             <a href="<?php echo base_url('admin/contractor'); ?>" class="btn btn-primary purple" style="float:right;"> + Add Contractor</a>
                        </div>
            <div class="card">
                <div class="card-body">
                         ...
                         <div class="col-md-12">
                            ...
                            <tbody>
                                ...
                                <tr>
                                   ...
                                   <td><?php echo $bd['phonenumber'] ?></td>
                                    <td><?php echo $bd['additional_number'] ?></td>
                                   ...
                                   <td><?php echo $bd['address'] ?></td>
                                    ...
                                    <td><a class="btn btn-danger" href="<?php echo base_url('admin/contractor/do_delete/'.$bd['id']); ?>">Delete</a></td>
                                 </td> 
                                </tr>
                                <?php }?>                     
                            </tbody>
