        ...
        <div class="px-0 col-lg-12 col-xl-8 col-md-12 d-flex flex-column align-items-center justify-content-center">
          ...
          <div class="card w-100">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 px-0" style="top:-50px!important;background:white;height:auto;min-height:150px;">
                            ...
                            <div class="row mx-0 align-items-center justify-content-center">
                                <div class="col-md-12 px-0 col-12 col-sm-12 col-lg-12 text-center">
                                    <h5 class="text-dark text-uppercase mb-3" style="font-size:1.2rem;font-family:initial;"><b>Rescue Date:- </b><b style="color:red;"><?php echo $unknownperson[0]['rescueDate'] != NULL ? date('d-m-Y',strtotime($unknownperson[0]['rescueDate'])) : date('d-m-Y',strtotime($unknownperson[0]['dateCreated'])); ?></b></h5>
                                </div>
                            </div>
                            <?php } ?>
                            ...
                            <?php 
                                ...
                                {
                                    $getPoliceDetail = $this->db->query('select * from police where police_id='.$unknownperson[0]['policeId'])->result_array();
                            ?>
                            <div class="row align-items-center mt-3 mx-0">
                                <div class="col-lg-12 col-sm-12 col-md-12 text-center">
                                    <h6 class="mb-0">Uploaded By: - <?php echo $getPoliceDetail[0]['thanaName'].', '. $getPoliceDetail[0]['state'].', '.$getPoliceDetail[0]['district'];?></h6>
                                </div>
                            </div>
                            <?php }else{ 
                                if($unknownperson[0]['userId'] != NULL)
                                {
                            ...
                            <?php }else{ 
                                $getNgoDetail = $this->db->query('select * from ngo where Id='.$unknownperson[0]['ngoId'])->result_array();
                            ?>
                            <div class="row align-items-center mt-3 mx-0">
                                <div class="col-lg-12 col-sm-12 col-md-12 text-center">
                                    <h6 class="mb-0">Uploaded By: - <?php echo $getNgoDetail[0]['ngoName'].', '. $getNgoDetail[0]['ngoState'].', '.$getNgoDetail[0]['ngoDistrict'];?></h6>
                                </div>
                            </div>
                            <?php } } ?>
                            <div class="row align-items-center mt-3 mx-0">
            ...
            <div class="row justify-content-center">
                <div class="col-auto">
                    <h5 class="text-center d-flex align-items-center mb-0" style="color:red;">अज्ञात व्यक्ति को खोजें khoji.in के साथ . Watch Full Video:- &nbsp;<i class="fa fa-play-circle-o fa-2x" style="cursor:pointer;color:black;" onclick="showVideo()"></i></h5>
                </div>
            </div>
            <hr class="border border-danger my-2">
                ...
                <div class="col-md-12 text-center text-danger px-1 pb-3 p-3" style="font-weight:bold;">
                    <div class="row">
                        <div class="col-lg-8 col-sm-12 col-md-8">
                            इस व्यक्ति के परिजनों को खोजने में मेरी मदद करें। कृपया इस लिंक को अधिक से अधिक लोगों को शेयर करने की कृपा करें।  
                        </div>
                        ...
                        <div class="card-body p-0">
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center border border-danger p-3">
                                    <h5 class="text-danger"><b>Complaint Closed Date: - <span style="color:black;"><?php echo $unknownperson[0]['closedDate'] != NULL ? date('d-m-Y h:i A',strtotime($unknownperson[0]['closedDate'])) : date('d-m-Y h:i A',strtotime($unknownperson[0]['dateCreated'])); ?></span></b></h5>
