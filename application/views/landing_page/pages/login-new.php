  ...
  <section class="section register min-vh-70 d-flex flex-column align-items-center justify-content-center py-2">
    <div class="container px-1">
      <div class="row justify-content-center">
         <div class="col-lg-6 px-0 col-xl-<?= isset($_SESSION['landingMob']) ? '5' : '4' ?> col-6 imgae_display">
            <picture>
        ...
        <div class="px-0 col-lg-6 col-xl-<?= isset($_SESSION['landingMob']) ? '4' : '5' ?> col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="card-body p-1">
              ...
              <div class="form-group row g-3">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-<?= isset($_SESSION['landingMob']) ? 'auto' : '4' ?> text-right mb-3">
                ...
                <div id="usernamediv" class="d-none">
                    <div class="form-floating mb-3 col-auto">
                      <input type="text" class="form-control" style="font-weight:bold;color:black;" onkeydown="limit(this,'user');" onkeyup="limit(this,'user');" name="username" id="username" placeholder="User Name">
                      <label for="username">Enter - User Name</label>
                      <div class="invalid-feedback">Please enter your username.</div>
                    </div>
                    <div class="form-group col-auto">
                        <button type="button" onclick="getRegistered('user')" class="btn btn-default btn-style-grey w-100 disabled" id="btnuserNext">Next  &nbsp;<i class="fa fa-arrow-circle-right"></i></button>
                    </div>
                    <div class="col-auto d-none" id="mobileuserdiv">
                        <div class="form-floating mb-3">
                            <select name="usermobileNumber" style="font-weight:bold;color:black;" class="form-select" id="usermobileNumber" aria-label="Select Mobile Number" onchange="toggleSendOtp(this.value)">
                ...
                <div id="mobilediv" class="d-none">
                    <div class="form-floating mb-3 col-auto">
                      <input type="number" class="form-control" style="font-weight:bold;color:black;" oninput="limit(this,'mobile');" onblur="limit(this,'mobile');" onkeydown="limit(this,'mobile');" onkeyup="limit(this,'mobile');" name="mobile" id="mobile" placeholder="Mobile Number">
                ...
                <div class="form-group col-auto mt-3 d-none" id="otpdiv">
                    <form action="<?php echo base_url(); ?>user/login/do_login" method="post" class="row gy-3 gx-0 needs-validation" novalidate id="loginform">
                        ...
                        <div class="row px-0 mx-0 mt-5" style="justify-content:right;">
                            <div class="col-md-auto col-sm-12 col-6 px-0" style="text-align:right;">
                                <button type="button" onclick="resendOtp(this)" class="btn btn-primary btn-style-five w-100 disabled-on-loading" > Resend OTP &nbsp;<i class="fa fa-arrow-circle-right"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="col-auto mt-2">
                  <p class="mb-2" style="font-size: 0.59rem;">Don't have account? <a href="<?php echo base_url(); ?>complete-your-kyc?clickedOn=missing"><b class="text-gradient gradient-theme" style="font-size: 1rem;"><u style="border-bottom:2px solid black;">Create an account</u></b></a></p>
                </div>
                <?php }else{ ?>
                <div class="col-auto mt-2">
                  <p class="mb-2" style="font-size: 0.59rem;">Don't have account? <a href="<?php echo base_url(); ?>complete-your-kyc"><b class="text-gradient gradient-theme" style="font-size: 1rem;"><u style="border-bottom:2px solid black;">Create an account</u></b></a></p>
                </div>
                <?php } ?>
...
<script type="text/javascript">
    ...
    if (type === 'mobile') {
        // priority: #mobilemobileNumber → #mobile
        mobile = $('#mobilemobileNumber').val() || $('#mobile').val();
    } else {
        mobile = $('#' + type + 'mobileNumber').val();
    }
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (parse.status === 'success') {
                    ...
                    toastr.error(parse.msg || 'Something Went Wrong');
                }
                $(ele).removeAttr('disabled');
            },
                        ...
                        setTimeout(function()
                        {
                            ...
                            if(parse.finalverification == 'success')
                            {
                                if($('#type').val() == 'mobile')
                                {
                                    ...
                                    // })
                                    location.href="<?php echo base_url(); ?>NonKyc/lapata_new_login";   
                                }else{
                                ...
                                if($('#type').val() == 'mobile')
                                {
                                    location.href="<?php echo base_url(); ?>step1-guest";   
                                }else{
                                    location.href="<?php echo base_url(); ?>user/profile";
                                }
                            }
                            <?php }else if(isset($_GET['clickedOn']) && $_GET['clickedOn'] == 'family'){ ?>
                            if(parse.finalverification == 'success')
                            {
                                if($('#type').val() == 'mobile')
                                {
                                    location.href="<?php echo base_url(); ?>NonKyc/add_family_member";   
                                }else{
                                    location.href="<?php echo base_url(); ?>user/add_family_member";   
                                }
                            }else{
                                if($('#type').val() == 'mobile')
                                {
                            ...
                            if(parse.finalverification == 'success')
                            {
                                if(parse.lasturl != 'check-step-2-updated')
                                {
                                    ...
                                    {
                                        if(parse.lasturl.includes('find-missing-person') || parse.lasturl.includes('find-lapata-person') || parse.lasturl.includes('find-general-person') || parse.lasturl.includes('find-family-person'))
                                        {
                                            ...
                                            else if(parse.lasturl.includes('check-person-high-results'))
                                            {
                                                location.href="<?php echo base_url(); ?>check-person-high-results";         
                                            }
                                            else if(parse.lasturl.includes('check-person-results'))
                                            {
                                                location.href="<?php echo base_url(); ?>check-person-results";         
                                            }else if(parse.lasturl.includes('check-person-high-funnel-results'))
                                            {
                                                location.href="<?php echo base_url(); ?>check-person-high-funnel-results";         
                                            }else{
                                                if($('#clickedOn').val() == '')
                                                {
                                                    if($('#type').val() == 'mobile')
                                                    ...
                                                    if($('#type').val() == 'mobile')
                                                    {
                                                        if($('#clickedOn').val() == 'upload')
                                                        {
                                                            location.href="<?php echo base_url(); ?>NonKyc/missing_details";               
                                                        }
                                                        else if($('#clickedOn').val() == 'missing-filter')
                                                        {
                                                        ...
                                                        if($('#clickedOn').val() == 'upload')
                                                        {
                                                            location.href="<?php echo base_url(); ?>user/missing_details";               
                                                        }
                                                        else if($('#clickedOn').val() == 'missing-filter')
                                                        {
                                ...
                                if($('#type').val() == 'mobile')
                                {
                                    if(parse.lasturl == 'check-person-high-results')
                                    {
                                        location.href="<?php echo base_url(); ?>check-person-high-results";   
                                    }else if(parse.lasturl = 'check-person-high-funnel-results')
                                    {
                                       location.href="<?php echo base_url(); ?>check-person-high-funnel-results";          
                                    }else{
                                        location.href="<?php echo base_url(); ?>step1-guest";   
            ...
            $.ajax({
                ...
                error: function (xhr, textStatus, errorThrown) {
                    if (textStatus === 'timeout') {
                        ...
                        toastr.error('Unexpected Error: ' + errorThrown);
                        $(ele).removeAttr('disabled');
                    }
                }
            });
            ...
            if(value.length == 12)
            {
                ...
                $.ajax({
                    ...
                    success:function(res)
                    {
                        ...
                        if(parse.status == 'success')
                        {
                            $('.radio-custom').attr('disabled',true);
                            if(type == 'aadhar')
                            {
                                $('#aadharNumber').attr('readonly',true);
                            }else{
