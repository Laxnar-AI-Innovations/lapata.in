  ...
  <section class="section register min-vh-70 d-flex flex-column align-items-center justify-content-center py-2">
    <div class="container">
      <div class="row justify-content-center">
        ...
        <div class="col-lg-6 col-xl-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="card-body p-1">
              ...
              <div class="form-group row g-3">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6 text-right mb-3">
                ...
                <div class="form-group col-auto mt-3 d-none" id="otpdiv">
                    <form action="<?php echo base_url(); ?>user/login/do_login" method="post" class="row gy-3 gx-0 needs-validation" novalidate id="loginform">
                        ...
                        <div class="form-floating mb-3">
                          <input type="number" onkeydown="limit(this,'otp');" onkeyup="limit(this,'otp');" class="form-control" name="otp" id="otp" placeholder="Enter OTP">
                ...
                <div class="col-auto mt-5">
                  <p class="mb-2">Don't have account? <a href="<?php echo base_url(); ?>create-an-account?clickedOn=missing">Create an account</a></p>
                </div>
                <?php }else{ ?>
                <div class="col-auto mt-5">
                  <p class="mb-2">Don't have account? <a href="<?php echo base_url(); ?>create-an-account">Create an account</a></p>
                </div>
                <?php } ?>
