        ...
        <div class="col-lg-6 col-xl-4 px-0 col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="card-body p-1">
                ...
                <form action="<?php echo base_url(); ?>landing/saveFinalProfileStep" method="post" class="row gy-3 gx-0 needs-validation1" id="loginform">
                    ...
                    <?php 
                        $getSettings = $this->db->query('select * from settings where Id=40')->result_array();
                    ...
                    <div class="row gx-1">
                        ...
                        <!-- Year Dropdown -->
                        <div class="col-4 form-floating mb-3">
                            <select class="form-select" required onchange="getAge()" id="year" name="year">
    ...
    $('#loginform').on('submit',function(e)
    {
        ...
        $.ajax({
            ...
            success:function(res)
            {
                ...
                {
                    Swal.fire({
                        iconHtml:'<img src="<?= base_url(); ?>assets/icons/success-icon.webp" style="width:100%;">',
                        title:'<h6 class="text-center text-success mt-3 px-3"><b>You are registered successfully! </b></h6>',
                        customClass:{
                            popup:'py-0',
                            title:'pt-0 px-2',
                            icon: 'no-border mt-3 mb-0'
                        },
                        allowOutsideClick:false,
                        html:'<div style="position:absolute;top:30px;right:5px;"><img src="<?= base_url(); ?>assets/images/maleColor.avif" style="width:50px;height:50px;border-radius:50%;"></div><div class="form-group mb-2"><h4 style="color:black;">Your Name = '+$('#aadharname').val()+'</h4></div><div class="form-group mb-2"><h4 style="color:black;">Your ID = <?= $_SESSION['landingMob']; ?> (Mob no)</h4></div><div class="form-group mb-2 col-10 mx-auto"><h4 style="color:green;"><?= (isset($_GET['type']) && ($_GET['type'] == 'mahakumbh' || $_GET['type'] == 'special' || $_GET['type'] == 'filter') ? 'You are eligible to Add your family member details.' : 'You are eligible to upload missing & unknown person details!'); ?></h4></div><div class="form-group mb-2 row justify-content-center mx-0"><div class="col-lg-auto col-sm-12 col-md-auto mb-3"><button onclick="redirectAccordingly()" class="w-100 btn-style-green disabled-on-loading btn"> Proceed</button></div></div>',
                    ...
                    Swal.fire({
                        ...
                        allowOutsideClick:false,
                        html:'<div style="position:absolute;top:30px;right:5px;"><img src="<?= base_url(); ?>assets/images/femaleColor.avif" style="width:50px;height:50px;border-radius:50%;"></div><div class="form-group mb-2"><h4 style="color:black;">Your Name = '+$('#aadharname').val()+'</h4></div><div class="form-group mb-2"><h4 style="color:black;">Your ID = <?= $_SESSION['landingMob']; ?> (Mob no)</h4></div><div class="form-group mb-2 col-10 mx-auto"><h4 style="color:green;"><?= (isset($_GET['type']) && ($_GET['type'] == 'mahakumbh' || $_GET['type'] == 'special' || $_GET['type'] == 'filter') ? 'You are eligible to Add your family member details.' : 'You are eligible to upload missing & unknown person details!'); ?></h4></div><div class="form-group mb-2 row justify-content-center mx-0"><div class="col-lg-auto col-sm-12 col-md-auto mb-3"><button onclick="redirectAccordingly()" class="w-100 btn-style-green disabled-on-loading btn"> Proceed</button></div></div>',
                      showCloseButton: false,
                      showCancelButton: false,
                      focusConfirm: false,
                      showConfirmButton:false
