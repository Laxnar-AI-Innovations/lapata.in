                        ...
                        <div class="card-body p-0">
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center border border-danger p-3">
                                    ...
                                    <h5 class="text-danger"><b>Closed Date: - <span style="color:black;"><?php echo $unknownperson[0]['closedDate'] != NULL ? date('d-m-Y h:i A',strtotime($unknownperson[0]['closedDate'])) : date('d-m-Y h:i A',strtotime($unknownperson[0]['dateCreated'])); ?></span></b></h5>
                                </div>
                                <?php }else{ ?>
                                    <div class="col-md-12 text-center border border-danger p-3">
