    ...
    function saveCallingId(logintype)
    {
        if(logintype == 'withoutLogin')
        {
            Swal.fire({
              ...
              allowOutsideClick:false,
              html:
                `<form class="row g-3 mx-0 needs-validation justify-content-center" method="post" action="<?php echo base_url(); ?>landing/checkPersonUpdated/step1" novalidate id="stepCallingForm">
                    <?php 
                      $csrf = array(
                    ...
                    <div class="form-group col-12 mt-3 d-none" id="otpdiv">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <label for="terms" style="display:inline;">By continuing, you agree to the <a href="<?= base_url(); ?>terms-of-use" target="_blank" style="color:blue; text-decoration:underline;">Terms and Conditions</a> ,<a href="<?= base_url(); ?>privacy-policy" target="_blank" style="color:blue; text-decoration:underline;"> Privacy Policy</a>, and all other applicable policies of Khoji.</label>
