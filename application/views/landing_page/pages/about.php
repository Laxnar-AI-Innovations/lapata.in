        ...
        <section id="leader" class="page-section">
            <div class="container">
                ...
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-md-4">
                        <div class="card-custom h-100 text-center">
                            <img src="<?= base_url(); ?>assets_landing_page/img/IMG_2903.png" alt="Aditya Raj">
                            <div class="card-body">
        ...
        <section class="page-section card" id="story">
            ...
            <div class="row text-center mx-0" style="margin-top:.75rem!important;">
                <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2 p-2">
                    <button type="button" class="btn btn-danger theme_bk_color me-3" style="border:1px dotted white;" onclick="window.location.href='<?php echo base_url(); ?>khoji-success';">
