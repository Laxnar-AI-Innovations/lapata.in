    ...
    <div class="container">
      <div class="row justify-content-center">
         <div class="col-lg-6 col-6 imgae_display">
            ...
            <img class="img-fluid" src="assets_landing_page/img/illustrations/search_anything.jpg" srcset="assets_landing_page/img/illustrations/search_anything.jpg 2x" alt="">
          </div>
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              ...
              <div class="pt-4 pb-2">
                ...
                <h2 >Creating Account is fast and easy!</h2>
              ...
              <form class="row g-3 needs-validation" method="post" action="<?php echo base_url(); ?>landing/matchregisternew/do_register" novalidate id="registerForm">
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="aadhar_id" class="form-control" id="aadharNumber" required placeholder="Aadhar Number">
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="registration_mobile" class="form-control" id="mobileNumber" required placeholder="Mobile No. (in Aadhaar)">
