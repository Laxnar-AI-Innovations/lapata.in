    ...
    <div class="container-fluid">
        <div class="row align-items-center" style="justify-content:space-around;">
            ...
            <div class="col-lg-auto col-sm-12 col-md-auto text-end my-1">
                <button type="button" onclick='location.href=`<?= base_url(); ?>check-person-face`' class="btn mt-0 btn-style-grey btn-dark disabled-on-loading"> <i class="fa fa-arrow-circle-left"></i></button>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-xl-3 col-md-6 px-0 px-md-1 col-12 col-search pb-2">
            <div class="card mb-3 shiva_height bg-light" >
                <div class="card-body px-0 pt-0">
                    ...
                    <div class="row col-12 px-2 mt-2 mb-1 mx-0">
        ...
        <?php 
            ...
            {
        ?>
        <h5 class="text-center text-danger text-uppercase">Missing</h5>
        <hr>
        <?php 
        ...
        <?php 
            if(count($unknownperson) > 0)
            {
                if($_SESSION['user_login'] == 'yes')
                {
                    ...
                    {
                        $getTransaction = $this->db->query('select * from unknowntransactions where idNumber="'.$_SESSION['landingMob'].'" and isKyc=0 and userId='.$_SESSION['user_id'])->result_array();
                    }else{
                        $getTransaction = $this->db->query('select * from unknowntransactions where idNumber="'.$_SESSION['aadhar_id'].'" and isKyc=1 and userId='.$_SESSION['user_id'])->result_array();
                    }
                }else{
                ...
                {
        ?>
        <h5 class="text-center text-danger text-uppercase">Appeal For Identification</h5>
        <hr>
        <?php 
                ...
                <div class="col-sm-12 col-lg-6 col-md-6">
                    <div class="row justify-content-center payDiv">
                        <div class="form-group col-12 col-md-4 col-lg-6 mt-1 text-center">
                            ...
                            <?php }else{ ?>
                            <button type="button" class="mx-0 btn btn-style-five disabled-on-loading w-100" style="padding: 0.6rem!important;" onclick="showLoginAccordingly(this)"> <i class="bi bi-cash"></i> Pay Now</button>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="row justify-content-center d-none" id="viewResultDiv">
                        <div class="text-center col-12 col-md-4 col-lg-6 mt-1">
                            <a href="<?= base_url(); ?>check-person-results" style="padding: 0.6rem!important;" class="mx-0 btn btn-style-green disabled-on-loading w-100">View All Results Here...</a>
                        </div>
                    </div>  
                </div>
            </div>
        ...
        ?>
        <hr class="mb-1">
        <h5 class="text-center text-uppercase text-success">Verified</h5>
        <hr>
        <?php 
