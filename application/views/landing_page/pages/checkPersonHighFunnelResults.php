        ...
        <div class="container-fluid px-1 px-md-2">
            <div class="row align-items-center my-3 mx-2" style="justify-content:space-around;">
                ...
                <div class="col-lg-auto col-sm-12 col-md-auto text-end my-1">
                    <button type="button" onclick='location.href=`<?= base_url(); ?>check-person-face-funnel`' class="btn mt-0 btn-style-grey btn-dark disabled-on-loading"> <i class="fa fa-arrow-circle-left"></i></button>
                </div>
            </div>
                        ...
                        <div class="card-body px-0 pt-0">
                            <div class="row align-items-center px-0 mx-0 justify-content-center">
                                ...
                                <div class="col-6 text-end mb-2">
                                    ...
                                    <?php }else{ ?>
                                    <button type="button" class="btn btn-primary" onclick="showLogin('user',<?= $row['uid']; ?>)" style="background:darkblue!important;color:white!important;"><i class="fa fa-eye"></i></button>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="row align-items-center px-0 mx-0 justify-content-center">
                        ...
                        <div class="card-body px-0 pt-0">
                            <div class="row align-items-center px-0 mx-0 justify-content-center">
                                ...
                                <div class="col-6 text-end mb-2">
                                    ...
                                    <?php }else{ ?>
                                    <button type="button" class="btn btn-primary" onclick="showLogin('FunnelMissing',<?= $row['id']; ?>)" style="background:darkblue!important;color:white!important;"><i class="fa fa-eye"></i></button>
                                    <?php } ?>
                                </div>
                                <div class="col-12">
                    ...
                    <div class="card-body px-0 pt-0">
                        <div class="row align-items-center px-0 mx-0 justify-content-center">
                            ...
                            <div class="col-6 text-end">
                                ...
                                <?php }else{ ?>
                                <button type="button" class="btn btn-primary" onclick="showLogin('FunnelFamily',<?= $row['id']; ?>)" style="background:darkblue!important;color:white!important;padding:10px 15px;"><i class="fa fa-eye"></i></button>
                                <?php } ?>
                            </div>
                            <div class="col-5 ">
                                <a href="<?php echo base_url().$row['Photo']?>" data-lightbox="roadtrip">
                        ...
                        <div class="card-body px-0 pt-0">
                            <div class="row align-items-center px-0 mx-0 justify-content-center">
                                ...
                                <div class="col-6 text-end mb-2">
                                    ...
                                    <?php }else{ ?>
                                    <button type="button" class="btn btn-primary" onclick="showLogin('lapata',<?= $row['id']; ?>)" style="background:darkblue!important;color:white!important;"><i class="fa fa-eye"></i></button>
                                    <?php } ?>
                                </div>
                                <div class="col-12">
                                    <p class="mb-1"><b style="color:black;font-size:.7rem!important">Application No :- </b><b style="color:black;font-size:.7rem!important"><?php echo $row['Application_no']; ?></b></p>
                    ...
                    <div class="card-body px-0 pt-0">
                        <div class="row align-items-center px-0 mx-0 justify-content-center">
                            ...
                            <div class="col-6 text-end">
                                ...
                                <?php }else{ ?>
                                <button type="button" class="btn btn-primary" onclick="showLogin('Family',<?= $row['id']; ?>)" style="background:darkblue!important;color:white!important;padding:10px 15px;"><i class="fa fa-eye"></i></button>
                                <?php } ?>
                            </div>
                            <div class="col-5 ">
                                <a href="<?php echo base_url().$row['Photo']?>" data-lightbox="roadtrip">
                        ...
                        <div class="card-body px-0 pt-0">
                            <div class="row align-items-center px-0 mx-0 justify-content-center">
                                ...
                                <div class="col-12 text-end">
                                    ...
                                    <?php }else{ ?>
                                    <button type="button" class="btn btn-primary" onclick="showLogin('mahakumbh',<?= $row['id']; ?>)" style="background:darkblue!important;color:white!important;padding:10px 15px;"><i class="fa fa-eye"></i></button>
                                    <?php } ?>
                                </div>
                                <div class="col-5 ">
                                    <a href="<?php echo base_url().$row['Photo']?>" data-lightbox="roadtrip">
                                            ...
                                            if($row['isFound'] == '0' && $row['awsEventName'] != 'All')
                                            {
                                                ...
                                                if($gender == strtolower($row['Gender']))
                                                {
                                                    if($row['isFinalSubmitted'] == 1)
                                                    {
                                                        ...
                                                        if($_SESSION['user_login'] == 'yes')
                                                        {
                                                            if(isset($_SESSION['searchFaceIdAfterLogin']))
                                                            {
                                                                ...
                                                                if($_SESSION['login_type'] == 'NonKyc')
                                                                {
                                                                    ...
                                                                    {
                                                                        $insertData = array(
                                                                            'idNumber' => $_SESSION['searchFaceId'],
                                                                            'isKyc' => 0,
                                                                            'userId' => $_SESSION['user_id'],
                                                                            'amount' => 49,
                                                                            'type' => 'unknown',
                                                        ...
                                                        {
            ?>
            <input type="hidden" id="firstUnknownId" value="<?= $newUnknownIds[0]; ?>">
                    ...
                    <div class="card-body px-0 pt-0">
                        <div class="row align-items-center px-0 mx-0 justify-content-center">
                            ...
                            <div class="col-6 text-end mb-2">
                                ...
                                <?php }else{ ?>
                                <button type="button" class="btn btn-primary" onclick="showLogin('unknown',<?= $row['id']; ?>)" style="background:darkblue!important;color:white!important;"><i class="fa fa-eye"></i></button>
                                <?php } ?>
                            </div>
                            <div class="col-12">
                                <p class="mb-1"><b style="color:black;font-size:.7rem!important">Application No :- </b><b style="color:black;font-size:.7rem!important"><?php echo $row['Application_no']; ?></b></p>
                    ...
                    <div class="card-body px-0 pt-0">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 text-center">
                                ...
                                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#appealModal" class="btn btn-style-red" style="font-size:1rem!important;">Click Here <i class="fa fa-hand-o-up"></i></a>
                                <?php }else{ ?>
    ...
    function saveCallingId(logintype)
    {
        if(logintype == 'withoutLogin')
        {
            Swal.fire({
              ...
              allowOutsideClick:false,
              html:
                `<div class="form-group mb-2 justify-content-center"><img src="<?= base_url(); ?>assets_landing_page/img/illustrations/13246824_5191079.jpg" style="width:100px;height:75px;"></div><form class="row g-3 mx-0 needs-validation" method="post" action="<?php echo base_url(); ?>landing/checkPersonFaceUpdated/step2" novalidate id="stepCallingForm">
                    <?php 
                      $csrf = array(
                        'name' => $this->security->get_csrf_token_name(),
                        'hash' => $this->security->get_csrf_hash()
