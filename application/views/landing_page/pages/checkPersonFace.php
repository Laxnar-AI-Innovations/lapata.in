                ...
                <form class="row g-3 needs-validation justify-content-center <?php if($pn != 3){ echo "d-none"; } ?>" method="post" action="<?php echo base_url(); ?>landing/checkPersonFace/step3" novalidate id="step3Form">
                    ...
                    <div class="row mb-3 justify-content-center d-none mt-3" id="searchDiv">
                        <div class="col-6 px-1 d-none" id="retakebtndiv">
                            <button type="button" class="btn w-100 btn-primary btn-style-yellow" id="retakePhotoBtn" onclick='location.href=`<?= base_url(); ?>`'>Retake <i class="fa fa-upload"></i></button>
                        </div>
            ...
            if($('input[name="gender"]').is(':checked'))
            {
                ...
                $.ajax({
                    ...
                    success:function(res)
                    {
                        ...
                        {
                            location.href="<?php echo base_url(); ?>landing/completeFaceMatchResults";      
                        }else{
                            Swal.fire({
