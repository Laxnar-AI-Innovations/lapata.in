              ...
              <div class="form-group row g-3">
                ...
                <div class="form-group col-auto mt-3 d-none" id="otpdiv">
                    <form action="<?php echo base_url(); ?>user/login/do_login" method="post" class="row gy-3 gx-0 needs-validation" novalidate id="loginform">
                        ...
                        <input type="hidden" name="basename" value="<?= $lasturl; ?>">
                        ...
                        <button class="btn btn-primary w-100 disabled-on-loading save" id="btnSubmit" type="submit"> Login <i class="bi bi-box-arrow-in-right"></i></button>
                ...
                success:function(res)
                {
                    ...
                    if(parse.status == 'success')
                    {
                        ...
                        setTimeout(function()
                        {
                            ...
                            {
                                location.href="<?php echo base_url(); ?>user/missingpersondetail/<?php echo $_GET['id'] ?>";      
                            }else{
