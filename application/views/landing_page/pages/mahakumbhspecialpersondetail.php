                ...
                <div class="px-0 col-lg-12 col-md-12 col-sm-12 d-flex flex-column mx-lg-auto">
                    <div class="row mx-0 align-items-center" style="background:white;padding:1rem;">
                        <div class="col-lg-12 col-sm-12 col-md-12 text-center">
                            <h1 class="text-center" style="font-size: 0.84rem;">KHOYA PAYA SPECIAL FORM</h1>
                            <h1 class="text-gradient1 mb-0" style="font-size: 1.5rem;"><b>ભાદરવી પૂનમ મહામેળા 2025</b></h1>
                        </div>
                    </div>
                    <?php 
                        if($familyperson[0]['Photo'] != NULL)
                        {
                    ?>
                            ...
                            <div id="carouselExampleControls" class="carousel slide" data-bs-interval="2000" data-bs-ride="carousel">
                                <div class="carousel-inner" id="photosspan">
                                    <div class="carousel-item active">
                                        <a href="<?php echo base_url(); ?><?php echo $familyperson[0]['Photo']; ?>"  data-lightbox="roadtrip">
                                            <img src="<?php echo base_url().''.$familyperson[0]['Photo']; ?>" style="width:100%;height:300px;max-width:100%!important;" class="d-block w-100" alt="...">
                                        </a>
                                    ...
                                    <?php 
                                        if($familyperson[0]['Photo1'] != NULL)
                                        {
                                    ?>
                                    <div class="carousel-item">
                                        <a href="<?php echo base_url(); ?><?php echo $familyperson[0]['Photo1']; ?>"  data-lightbox="roadtrip">
                                            <img src="<?php echo base_url().''.$familyperson[0]['Photo1']; ?>" style="width:100%;height:300px;max-width:100%!important;" class="d-block w-100" alt="...">
                                        </a>
                                        <div class="carousel-caption" style="bottom:0;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>">
                                    ...
                                    <?php } ?>
                                    <?php 
                                        if($familyperson[0]['Photo2'] != NULL)
                                        {
                                    ?>
                                    <div class="carousel-item">
                                        <a href="<?php echo base_url(); ?><?php echo $familyperson[0]['Photo2']; ?>"  data-lightbox="roadtrip">
                                            <img src="<?php echo base_url().''.$familyperson[0]['Photo2']; ?>" style="width:100%;height:300px;max-width:100%!important;" class="d-block w-100" alt="...">
                                        </a>
                                        <div class="carousel-caption" style="bottom:0;padding-bottom:0;padding-top:0;font-family:<?= $decode1['font-family']; ?>">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 px-0" style="top:-50px!important;background:white;height:auto;min-height:150px;">
                            <div class="row mx-0 align-items-center justify-content-center">
                                <div class="col-md-12 px-0 col-12 mt-1 col-sm-12 col-lg-12 text-center">
                                    <h4 class="text-dark text-uppercase mb-0"><b id="personname">Name:- <?php echo ($familyperson[0]['person_name'] != '' ? $familyperson[0]['person_name'] : 'UNKNOWN'); ?></b></h4>
                                </div>
                            </div>
                            <div class="row align-items-center mx-0">
                                <div class="col-6">
                                    <button type="button" style="color: white;background:#616161;width:100%;"><b><?php echo ($familyperson[0]['Gender'] == 'Male' ? 'Male' : 'Female'); ?></b></button>
                                </div>
                                <div class="col-6">
                                    <button type="button" style="color: white;background:#616161;width:100%;padding:0.4rem 1rem;"><b><?php echo $familyperson[0]['AgeBand']; ?> YEARS</b></button>
                                </div>
                            </div>
                            <?php 
                                if($familyperson[0]['Message'] != '')
                                {
                            ?>
                            <div class="row align-items-center mt-3 mx-0 border border-danger">
                                <div class="col-lg-12 col-sm-12 col-md-12 text-center">
                                    <p class="mb-0"><b style="color:red;">Message:- </b><b style="color:black;"><?php echo $familyperson[0]['Message'] ?></b></p>
                                </div>
                            </div>
                            <?php } ?>
                            <?php
                                if($familyperson[0]['uploadType'] == 'general')
                                {
                            ?>
                            <div class="row align-items-center mt-3 mx-0">
                                <div class="col-lg-12 col-sm-12 col-md-12 text-center">
                                    <h6 class="mb-1" style="font-family:initial;font-size:1.2rem;color:black;"><b>Uploaded Date: - <span style="color:grey;"><?php echo date('d-m-Y h:i A',strtotime($familyperson[0]['dateCreated']));?></span></b></h6>
                                </div>
                            </div>
                            <?php }else if($familyperson[0]['uploadType'] == 'missing'){ ?>
                            <div class="row align-items-center mt-3 mx-0">
                                <div class="col-lg-12 col-sm-12 col-md-12 text-center">
                                    <h6 class="mb-1" style="font-family:initial;font-size:1.2rem;color:black;"><b>Uploaded Date: - <span style="color:grey;"><?php echo date('d-m-Y h:i A',strtotime($familyperson[0]['dateCreated']));?></span></b></h6>
                                </div>
                            ...
                            <div class="row mx-0 align-items-center justify-content-center">
                                <div class="col-md-12 px-0 col-12 mt-3 col-sm-12 col-lg-12 text-center">
                                    <h5 class="text-dark text-uppercase mb-0" style="font-size:1.2rem;font-family:initial;"><b>Missing Date:- </b><b style="color:red;"><?= $familyperson[0]['missingDate'] != '0000-00-00' ? date('d-m-Y',strtotime($familyperson[0]['missingDate'])) : date('d-m-Y',strtotime($familyperson[0]['dateCreated'])); ?></b></h5>
                                </div>a
                            </div>
                            <?php }else{ ?>
                            <div class="row align-items-center mt-3 mx-0">
                            ...
                            <div class="row mx-0 align-items-center justify-content-center">
                                <div class="col-md-12 px-0 col-12 mt-3 col-sm-12 col-lg-12 text-center">
                                    <h5 class="text-dark text-uppercase mb-0" style="font-size:1.2rem;font-family:initial;"><b>Rescue Date:- </b><b style="color:red;"><?= $familyperson[0]['missingDate'] != '0000-00-00' ? date('d-m-Y',strtotime($familyperson[0]['missingDate'])) : date('d-m-Y',strtotime($familyperson[0]['dateCreated'])); ?></b></h5>
                                </div>
                            </div>
                            <?php } ?>
                            <?php 
                                $getUserDetail = $this->db->query('select * from nonKycUser where uid='.$familyperson[0]['userId'])->result_array();
                            ?>
                            <div class="row align-items-center mx-0 mt-3 justify-content-center" style="position:relative;">
                                <div class="col-md-12 text-center">
                                    <h6 class="text-dark">
                                        <?php 
                                            if($familyperson[0]['well1'] != NULL)
                                            {
                                        ?>
                                        <a href="tel:<?php echo $familyperson[0]['well1']; ?>" class="btn btn-circle btn-sm btn-police1 mt-2">
                                            <i class="fa fa-phone"></i>
                                        </a>
                                        <?php }
                                            if($familyperson[0]['well2'] != NULL){ 
                                        ?>
                                        <a href="tel:<?php echo $familyperson[0]['well2']; ?>" class="btn btn-circle btn-sm btn-police2 mt-2">
                                            <i class="fa fa-phone"></i>
                                        </a>
                                        <?php }
                                            if($familyperson[0]['well3'] != NULL){ 
                                        ?>
                                        <a href="tel:<?php echo $familyperson[0]['well3']; ?>" class="btn btn-circle btn-sm btn-police3 mt-2">
                                            <i class="fa fa-phone"></i>
                                        </a>
                                        <?php } ?>
                                    </h6>
                ...
                <div class="col-lg-5 col-md-6 d-flex flex-column align-items-center justify-content-center">
                    <div class="card mb-2 px-4 py-2">
                        <div class="card-body p-0">
                            <div class="row">
                                <?php 
                                    if(count($familyperson) > 0)
                                    {
                                ?>
                                <div class="col-md-12 text-center border border-danger p-3">
                                    <h4 class="text-danger text-uppercase mb-0" style="font-weight:bold;"><span class="text-success">Profile Status is</span> Closed!</h4>
                                </div>
                                <?php }else{ ?>
                                    <div class="col-md-12 text-center border border-danger p-3">
                                        <h4 class="text-danger text-uppercase mb-0" style="font-weight:bold;">Profile Status not found!</h4>
                                    </div>
                                <?php } ?>
                            </div>
                            <div class="row">
