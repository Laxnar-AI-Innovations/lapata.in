    ...
    <div class="<?php if($pn != 4){ echo "container"; }else{ echo "container-fluid"; } ?>">
      ...
      <div class="row justify-content-center align-items-center">
        ...
        <div class="px-0 <?php if($pn == 1){ echo "col-lg-12"; }else{ if($pn != 4){ echo "col-lg-4 col-md-6"; }else{ echo "col-lg-6"; } } ?> col-md-12 d-flex flex-column align-items-center justify-content-center">
            ...
            <form class="row g-3 mt-1 needs-validation <?php if($pn != 1){ echo "d-none"; } ?>" method="post" action="<?php echo base_url(); ?>landing/mahakumbhFaceMatch/step1" id="step1Form">
                <?php 
                  $csrf = array(
          ...
          <div class="card mb-3 py-1 px-0 w-100 <?php if($pn == 1){ echo "d-none"; } ?>">
            ...
            <div class="card-body py-0">
              ...
              <!--</div>-->
                <form class="row g-3 needs-validation <?php if($pn != 2){ echo "d-none"; } ?>" method="post" action="<?php echo base_url(); ?>landing/mahakumbhFaceMatch/step2" novalidate id="step2Form">
                    <?php 
                      $csrf = array(
                        'name' => $this->security->get_csrf_token_name(),
                        'hash' => $this->security->get_csrf_hash()
                ...
                <form class="row g-3 needs-validation justify-content-center <?php if($pn != 3){ echo "d-none"; } ?>" method="post" action="<?php echo base_url(); ?>landing/mahakumbhFaceMatch/step3" novalidate id="step3Form">
                    <?php 
                      $csrf = array(
                        'name' => $this->security->get_csrf_token_name(),
                        'hash' => $this->security->get_csrf_hash()
                ...
                <form class="row g-3 p-3 align-items-center justify-content-center <?php if($pn != 4){ echo "d-none"; } ?>" method="post" action="<?php echo base_url(); ?>landing/mahakumbhFaceMatch/step4" id="step4Form">
                    <?php 
                      $csrf = array(
                        'name' => $this->security->get_csrf_token_name(),
                        'hash' => $this->security->get_csrf_hash()
...
<script type="text/javascript">
    ...
    $('#btn4Back').click(function()
    {
        ...
        location.href="<?php echo base_url(); ?>landing/mahakumbhFaceMatch?pn=1";
    })
            ...
            if($('input[name="gender"]').is(':checked'))
            {
                ...
                $.ajax({
                    ...
                    success:function(res)
                    {
                        ...
                        {
                            location.href="<?php echo base_url(); ?>check-mahakumbh-results";      
                        }else{
        ...
        if(count == arr.length)
        {
            ...
            $.ajax({
                ...
                success:function(res)
                {
                    ...
                    if(parse.status == 'success')
                    {
                        location.href="<?php echo base_url(); ?>landing/mahakumbhFaceMatch?pn=3";   
                    }else{
                ...
                $.ajax({
                    ...
                    success:function(res)
                    {
                        ...
                        if(parse.isMobileAvailable)
                        {
                            ...
                            location.href="<?php echo base_url(); ?>landing/mahakumbhFaceMatch?pn=2";
                        }
                    },
                    error: function(xhr, textStatus, errorThrown) {
                        if (textStatus == 'timeout') {
