        ...
        <div class="row ">
            <div class="col-lg-6">
                <div class="px-md-15 px-lg-3">
                    ...
                    <?php }else{ ?>
                    <figure class="mb-6"><img class="img-fluid" src="assets_landing_page/img/idcard.png" srcset="assets_landing_page/img/idcard.png" alt=""></figure>
                    <?php } ?>
                </div>
            </div>
            <div class="col-lg-4 px-0 col-md-6 d-flex flex-column align-items-center justify-content-center">
                <div class="card mb-0 pb-1 pt-1 w-100">
                    <div class="card-body pb-0">
                        <form class="row g-3 p-0 needs-validation <?php if($pn != 1){ echo "d-none"; } ?>" style="border:0px solid black;" method="post" action="<?php echo base_url(); ?>landing/checkPersonFaceNew/step1" novalidate id="step1Form">
                            <?php 
                                $csrf = array(
                        ...
                        <form class="row g-3 needs-validation <?php if($pn != 2){ echo "d-none"; } ?>" method="post" action="<?php echo base_url(); ?>landing/checkPersonFaceNew/step2" novalidate id="step2Form">
                            <?php 
                              $csrf = array(
                                'name' => $this->security->get_csrf_token_name(),
                                'hash' => $this->security->get_csrf_hash()
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row mb-0 mb-md-3 justify-content-center" id="videodiv" style="position:relative;">
                    <div class="col-lg-12 col-sm-12 col-md-12 text-center">
                        <video id="video" width="100%" height="320" autoplay style="width:175px;height:175px;border-radius:50%;"></video>  
                        <img src="<?php echo base_url(); ?>assets/images/mask.png" id="videoImage" style="">
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-sm-12 col-md-auto text-center" id="clickdiv">
                        <button id="click-photo" class="w-100 btn btn-dark btn-style-grey disabled">Capture Photo</button>
                    </div>
                </div>
                <input type="file" hidden id="fileMobInput" capture="camera">
                <div class="row justify-content-center d-none" id="canvasdiv">
                    <div class="col-lg-12 col-sm-12 col-md-12 text-center">
                        <canvas id="canvas" width="175" height="175" style="border-radius:50%;"></canvas>
                    </div>
                </div>
                ...
                <div class="row justify-content-center mx-0">
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-6 text-center mb-3 d-none" id="searchDiv">
...
<script>
    ...
    video.addEventListener("play", () => {
        let convas;
        let faceDetection;
        convas = faceapi.createCanvasFromMedia(video);
        convas.setAttribute('id','overlay');
        $('#videodiv .col-sm-12').append(convas);
        faceapi.matchDimensions(convas, displaySize);
        faceDetection = setInterval(async () => {
            const detections = await faceapi.detectAllFaces(video, new faceapi.TinyFaceDetectorOptions()).withFaceLandmarks().withFaceExpressions()
            const resizedDetections = await faceapi.resizeResults(detections, displaySize);
            if(resizedDetections.length > 0)
            {
                if(resizedDetections[0]['detection']['_score'] > 0.8)
                {
                    $('#click-photo').removeClass('btn-dark btn-style-grey disabled').addClass('btn-style-five btn-primary');
                }else{
                    $('#click-photo').addClass('btn-dark btn-style-grey disabled').removeClass('btn-style-five btn-primary');
                }   
            }else{
                $('#click-photo').addClass('btn-dark btn-style-grey disabled').removeClass('btn-style-five btn-primary');
            }
            convas.getContext('2d').clearRect(0, 0, convas.width, convas.height)
            // faceapi.draw.drawDetections(convas, resizedDetections)
            // faceapi.draw.drawFaceLandmarks(convas, resizedDetections)
            // faceapi.draw.drawFaceExpressions(convas, resizedDetections)
        }, 10)
    });
...
<script type="text/javascript">
    ...
    function redirectToStep2(type,id)
    {
        if(type)
        {
            ...
            window.open('<?php echo base_url(); ?>landing/checkstep2New','_blank');
        }
    }
                                ...
                                if(parse.isCriminal == 1)
                                {
                                    if(parse.isRegistered == 0 && parse.isMissing == 1)
                                    {
                                         ...
                                         Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                location.href="<?php echo base_url(); ?>landing/checkstep2New";
                                            }else if(result.isDismissed)
                                            {
                                                location.reload();
                                            }
                        ...
                        if(parse.status == 'error')
                        {
                            ...
                            $('#mobileNumber').attr('readonly',false);
                                ...
                                if(parse.status == 'unknown')
                                {
                                    ...
                                    {
                                        Swal.fire({
                                            title: '<strong style="font-size:20px;color:red;">'+(textMessage + '- ' + $('#aadharNumber').val())+'<br> - <span style="color:black;">Oops! No Record Found</span></strong>',
                                            icon: 'info',
                                            allowOutsideClick:false,
                                            showCloseButton: true,
                                            showCancelButton: false,
                    ...
                    {   
                        ...
                        if(parse.status == 'error')
                        {
                            ...
                            if(parse.status == 'unknown')
                            {
                                ...
                                {
                                    Swal.fire({
                                        title: '<strong style="font-size:20px;color:red;">'+(textMessage + '- ' + ($('#dlNumber').val()).toUpperCase())+'<br> - <span style="color:black;">Oops! No Record Found</span></strong>',
                                        icon: 'info',
                                        allowOutsideClick:false,
                                        showCloseButton: true,
                                        showCancelButton: false,
                    ...
                    {   
                        ...
                        if(parse.status == 'error')
                        {
                            ...
                            if(parse.status == 'unknown')
                            {
                                ...
                                {
                                    Swal.fire({
                                        title: '<strong style="font-size:20px;color:red;">'+(textMessage + '- ' + ($('#voterId').val()).toUpperCase())+'<br> - <span style="color:black;">Oops! No Record Found</span></strong>',
                                        icon: 'info',
                                        allowOutsideClick:false,
                                        showCloseButton: true,
                                        showCancelButton: false,
                    ...
                    {   
                        ...
                        if(parse.status == 'error')
                        {
                            ...
                            if(parse.status == 'unknown')
                            {
                                ...
                                {
                                    Swal.fire({
                                        title: '<strong style="font-size:20px;color:red;">'+(textMessage + '- ' + ($('#panNumber').val()).toUpperCase())+'<br> - <span style="color:black;">Oops! No Record Found</span></strong>',
                                        icon: 'info',
                                        allowOutsideClick:false,
                                        showCloseButton: true,
                                        showCancelButton: false,
        ...
        if(count == arr.length)
        {
            ...
            $.ajax({
                ...
                success:function(res)
                {
                    ...
                    if(parse.status == 'success')
                    {
                        location.href="<?php echo base_url(); ?>landing/checkPersonFaceNew?pn=2";   
                    }else{
                        toastr.error(parse.message);
                        $('#otp').val('');
                    ...
                    {   
                        ...
                        if(parse.status == 'error')
                        {
                            ...
                            if(parse.status == 'unknown')
                            {
                                ...
                                {
                                    Swal.fire({
                                        title: '<strong style="font-size:20px;color:red;">'+(textMessage + '- ' + ($('#vehicleNumber').val()).toUpperCase())+'<br> - <span style="color:black;">Oops! No Record Found</span></strong>',
                                        icon: 'info',
                                        allowOutsideClick:false,
                                        showCloseButton: true,
                                        showCancelButton: false,
                    ...
                    {   
                        ...
                        if(parse.status == 'error')
                        {
                            ...
                            if(parse.status == 'unknown')
                            {
                                ...
                                {
                                    Swal.fire({
                                        title: '<strong style="font-size:20px;color:red;">'+(textMessage + '- ' + ($('#huidNumber').val()).toUpperCase())+'<br> - <span style="color:black;">Oops! No Record Found</span></strong>',
                                        icon: 'info',
                                        allowOutsideClick:false,
                                        showCloseButton: true,
                                        showCancelButton: false,
