...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="<?php echo base_url(); ?>" class=" d-flex align-items-center">
            <img class="logo-dark logo-img-height" src="<?php echo base_url(); ?>assets/images/khoji.webp" style="height:75px;" srcset="<?php echo base_url(); ?>assets/images/khoji.webp" alt="Khoji"  />
            <img class="logo-light logo-img-height" src="<?php echo base_url(); ?>assets/images/khoji.webp" style="height:75px;" srcset="<?php echo base_url(); ?>assets/images/khoji.webp" alt="Khoji"   />
        </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url(); ?>ngo/profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url(); ?>ngo/logout">
