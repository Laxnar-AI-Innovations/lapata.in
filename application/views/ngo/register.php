  ...
  <section class="section register d-flex flex-column align-items-center justify-content-center py-4">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 col-xl-6 col-md-12 d-flex flex-column align-items-center justify-content-center">
          ...
          <div class="card my-3">
            ...
            <div class="card-body p-3">
              ...
              <div class="pb-2">
                <h5 class="card-title text-center pb-0">Creat a New Account of NGO</h5>
              ...
              <form id="registerForm" action="<?php echo base_url(); ?>ngo/register/do_register" method="post" class="row g-3 needs-validation">
                ...
                <div class="col-12 mt-3 px-3">
                  <p class="mb-0">Already have an account? <a href="<?php echo base_url(); ?>ngo">Log in</a></p>
                </div>
            </div>
          </div>
