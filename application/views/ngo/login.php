  ...
  <section class="section register d-flex flex-column align-items-center justify-content-center py-2">
    <div class="container px-0">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-xl-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
          ...
          <div class="card my-3 p-0 p-lg-3 w-100">
            ...
            <div class="card-body p-1">
              ...
              <div class="form-group row g-3 justify-content-center text-center">
                ...
                <div class="form-group col-auto mt-3 d-none" id="otpdiv">
                    <form action="<?php echo base_url(); ?>ngo/login/do_login" method="post" class="row gy-3 gx-0 needs-validation" novalidate id="loginform">
                        <?php 
                          $csrf = array(
                ...
                <div class="col-auto mt-5">
                  <p class="mb-0">Don't have account? <a href="<?php echo base_url(); ?>ngo/register">Create an account</a></p>
                </div>
...
<script type="text/javascript">
    ...
    function resendOtp(ele)
    {
        ...
        if($('#'+$('#type').val()+'mobileNumber').val() != '')
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>ngo/sendLoginOtp',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
                        ...
                        setTimeout(function()
                        {
                            if(parse.finalverification == 'success')
                            {
                                if(parse.lasturl != 'checkStep2')
                                {
                                    ...
                                    location.href="<?php echo base_url(); ?>ngo/checkstep2";   
                                }
                            }else{
    ...
    function getRegistered(type)
    {
        ...
        if(type == 'aadhar')
        {
            if(value.length == 12)
            {
                ...
                $.ajax({
                    url:'<?php echo base_url(); ?>ngo/getMobileDetails',
                    data:data,
                    contentType: false,
                    cache: false,
                    processData:false,
