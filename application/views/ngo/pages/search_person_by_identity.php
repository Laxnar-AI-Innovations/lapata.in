            ...
            <div class="col-xl-4 col-lg-4 col-sm-12 col-md-8 px-0 <?php if($pn != 1){ echo "d-none"; } ?>">
                <div class="card">
                    <div class="card-body mt-3 py-3 w-100 p-3">
                        <form class="row g-3 needs-validation <?php if($pn != 1){ echo "d-none"; } ?>" method="post" action="<?php echo base_url(); ?>ngo/checkPerson/step2" novalidate id="step2Form">
                            <?php 
                                $csrf = array(
        ...
        if(count == 0)
        {
            ...
            $.ajax({
                ...
                success:function(res)
                {
                    ...
                    {   
                        $('#step2CheckVehicle').removeAttr('disabled');
                        window.open('<?php echo base_url(); ?>ngo/search_person_by_identity?pn=2','_blank');
                    }
                    else{
                        if(parse.status == 'error')
                        {
