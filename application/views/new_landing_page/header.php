    ...
    <nav class="navbar navbar-expand-lg classic transparent navbar-light">
        <div class="container flex-lg-row flex-nowrap align-items-center">
            <div class="row align-items-center">
                <div class="col-auto pe-1 px-0">
                    <div class="navbar-brand w-100 pb-0 pt-2" style="cursor: pointer;" onclick="location.href='<?= base_url(); ?>'">
                        <picture>
                ...
                <div class="col-auto d-lg-none <?= $_SESSION['user_login'] == 'yes' ? 'd-none' : ''; ?>">
                    <?php 
            ...
            <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
                ...
                <div class="offcanvas-body ms-lg-auto px-3 d-flex flex-column h-100">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item dropdown me-2 mb-2 mb-md-0 w-100">
                            <a class="nav-link dropdown-toggle border border-1 p-1" href="javascript:void(0);" data-bs-toggle="dropdown">
                            <i class="fa fa-lg fa-user-plus ps-0 pe-2 text-center fnt_size_1rem" aria-hidden="true"></i>
                            Sign Up &nbsp;&nbsp;</a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="nav-item dropdown w-100">
                            <a class="nav-link dropdown-toggle border border-1 p-1" href="javascript:void(0);" data-bs-toggle="dropdown">
                            <i class="fa fa-lg fa-user ps-0 pe-2 text-center fnt_size_1rem" aria-hidden="true"></i>
                            Login &nbsp;&nbsp;</a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="nav-item dropdown pe-3">
                            ...
                            ?>
                            <span class="nav-link nav-profile d-none d-lg-flex align-items-center pe-0" data-bs-toggle="dropdown">
                                <img src="<?php echo base_url(); ?><?php echo $getUserDetail[0]['aadharphoto']; ?>" alt="Profile" class="rounded-circle aadhar-img-header">
                                <span class="d-none d-lg-block dropdown-toggle ps-2"><?php echo $_SESSION['aadharName']; ?></span>
                            ...
                            <?php }else if($_SESSION['login_type'] == 'police'){ 
                            ?>    
                            <span class="nav-link nav-profile d-none d-lg-flex align-items-center pe-0" href="javascript:void(0)" data-bs-toggle="dropdown">
                                <img src="<?php echo base_url(); ?>assets/img/criminal.png" alt="Profile" class="rounded-circle aadhar-img-header">
                                <span class="d-none d-lg-block dropdown-toggle ps-2"><?php echo $_SESSION['thanaName']; ?></span>
                            </span><!-- End Profile Iamge Icon -->
                            <ul class="py-1 dropdown-menu dropdown-menu-end dropdown-menu-arrow profile list-shiva" >
                                <li>
                                    <a class="dropdown-item px-0 justify-content-center d-flex align-items-center" href="<?php echo base_url(); ?>police">
                            ...
                            <span class="nav-link nav-profile d-none d-lg-flex align-items-center pe-0" href="javascript:void(0)" data-bs-toggle="dropdown">
                                ...
                                <?php } ?>
                                <span class="d-none d-lg-block dropdown-toggle ps-2"><?php echo substr_replace($_SESSION['landingMob'],'XXXXXXX',0,7); ?></span>
                            </span><!-- End Profile Iamge Icon -->
                            <ul class="dropdown-menu py-1 dropdown-menu-end dropdown-menu-arrow profile list-shiva">
                                <li>
                                    <a class="dropdown-item px-0 justify-content-center d-flex align-items-center" href="<?php echo base_url(); ?>NonKyc">
                            ...
                            <span class="nav-link nav-profile d-none d-lg-flex align-items-center pe-0" href="javascript:void(0)" data-bs-toggle="dropdown">
                                ...
                                <span class="d-none d-lg-block dropdown-toggle ps-2"><?php echo $_SESSION['name']; ?></span>
                            </span><!-- End Profile Iamge Icon -->
                            <ul class="dropdown-menu py-1 dropdown-menu-end dropdown-menu-arrow profile list-shiva">
                                <li>
            ...
            <!-- /.navbar-collapse -->
            <div class="navbar-other ms-lg-4 me-2">
                <ul class="navbar-nav flex-row align-items-center">
                    ...
                    <li class="nav-item me-2 d-lg-none">
                        <a href="<?php echo base_url(); ?>complete-your-kyc"class="btn btn-danger btn_new_css px-2" style="font-size:0.7rem;">Signup / Login</a>
                    </li>
                    <?php } ?>
                    <li class="mx-0 nav-item d-lg-none">
                    ...
                    <li class="nav-item dropdown pe-0">
                        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="javascript:void(0)" data-bs-toggle="dropdown">
                            ...
                            <img src="<?php echo base_url(); ?>assets/img/find_mobile.jpg" alt="Profile" class="rounded-circle aadhar-img-header">
                            <?php } ?>
                        <span class="d-none d-lg-none dropdown-toggle ps-2"><?php echo substr_replace($_SESSION['landingMob'],'XXXXXXX',0,7); ?></span>
                        ...
                        <li class="nav-item dropdown pe-3">
                            <?php 
                                if($_SESSION['login_type'] == 'user')
                                {
                                    $getUserDetail = $this->db->query('select * from user where uid='.$_SESSION['user_id'])->result_array();
                            ?>
                            <span class="nav-link nav-profile d-flex d-lg-none align-items-center pe-0" data-bs-toggle="dropdown">
                                <img src="<?php echo base_url(); ?><?php echo $getUserDetail[0]['aadharphoto']; ?>" alt="Profile" class="rounded-circle aadhar-img-header">
                                <span class="d-none d-lg-block dropdown-toggle ps-2"><?php echo $_SESSION['aadharName']; ?></span>
                            </span><!-- End Profile Iamge Icon -->
                            <ul class="py-1 dropdown-menu dropdown-menu-end dropdown-menu-arrow profile list-shiva" >
                            ...
                            <?php }else if($_SESSION['login_type'] == 'police'){ 
                            ?>    
                            <span class="nav-link nav-profile d-flex d-lg-none align-items-center pe-0" href="javascript:void(0)" data-bs-toggle="dropdown">
                                <img src="<?php echo base_url(); ?>assets/img/criminal.png" alt="Profile" class="rounded-circle aadhar-img-header">
                                <span class="d-none d-lg-block dropdown-toggle ps-2"><?php echo $_SESSION['thanaName']; ?></span>
                            </span><!-- End Profile Iamge Icon -->
                            <ul class="py-1 dropdown-menu dropdown-menu-end dropdown-menu-arrow profile list-shiva" >
