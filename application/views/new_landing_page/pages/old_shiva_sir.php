...
@media (max-width: 767px)
 ...
 <section class="wrapper bg-dark desk-view">
      <div class="swiper-container swiper-hero dots-over" data-margin="0" data-autoplay="true" data-autoplaytime="70000" data-nav="true" data-dots="true" data-items="1">
        <div class="swiper">
          <div class="swiper-wrapper">
            
            

            <div class="swiper-slide bg-overlay bg-overlay-400 bg-dark bg-image" data-image-src="assets/img/photos/mobile_1.jpg">
              <div class="container h-100">
                <div class="row h-100">
                  <div class="col-md-10 offset-md-1 col-lg-7 offset-lg-0 col-xl-6 col-xxl-5 text-center text-lg-start justify-content-center align-self-center align-items-start">
                     <h4 class="display-1 fs-50 mb-4 text-white animate__animated animate__slideInDown animate__delay-1s">India's first One Click Solution for finding Missing Persons.</h4>
                    <p class="lead fs-20 lh-sm mb-7 text-white animate__animated animate__slideInRight animate__delay-2s">An easy-to-use collaborative platform for Police, NGOs, Social Workers, and families to get instant search results. Families are automatically notified when missing loved ones are found, ensuring a seamless and efficient process.</p>
                    <div class="animate__animated animate__slideInUp animate__delay-3s"><a href="#" class="btn btn-lg btn-outline-white rounded-pill">Sign UP Now</a></div> 
                  </div>
                </div>
              ...
              <div class="container h-100">
                <div class="row h-100">
                  <div class="col-md-6 text-center text-lg-start justify-content-center align-self-center align-items-start">
                     <h4 class="display-1 fs-50 mb-4 text-white animate__animated animate__slideInDown animate__delay-1s">India's first One Click Solution for finding Missing Persons.</h4>
                    <p class="lead fs-20 lh-sm mb-7 text-white animate__animated animate__slideInRight animate__delay-2s">An easy-to-use collaborative platform for Police, NGOs, Social Workers, and families to get instant search results. Families are automatically notified when missing loved ones are found, ensuring a seamless and efficient process.</p>
                    <div class="animate__animated animate__slideInUp animate__delay-3s"><a href="#" class="btn btn-lg btn-outline-white rounded-pill">Sign UP </a></div> 
                    <br>
                  </div>
                  <div class="col-md-6 " >
                     <img src="assets/img/photos/mobile_1.jpg" alt="" style="border-radius:50%; border: 2px solid white;"/>
                </div>
                </div>
            ...
            <!--end -->
             ...
             <!--single photo or text ke liye -->
              ...
              <div class="container h-100">
                <div class="row h-100">
                   <div class="col-md-6 " >
                     <img src="assets/img/photos/mobile_2.jpg" alt="" style="border-radius:50%; border: 2px solid white;"/>
                </div>
                  
                  <div class="col-md-6 text-center text-lg-start justify-content-center align-self-center align-items-start">
                     <h4 class="display-1 fs-50 mb-4 text-white animate__animated animate__slideInDown animate__delay-1s">Search Person by Face photo.</h4>
                    <p class="lead fs-20 lh-sm mb-7 text-white animate__animated animate__slideInRight animate__delay-2s">Search by face photo to get the best possible results  providing you with accurate and similar matched results.</p>
                    <div class="animate__animated animate__slideInUp animate__delay-3s"><a href="#" class="btn btn-lg btn-outline-white rounded-pill">Sign UP Now</a></div> 
                    <br>
                  </div>
            ...
            <!--end -->
              ...
              <!--/.swiper-slide -->
            <div class="swiper-slide bg-overlay bg-overlay-400 bg-dark bg-image" data-image-src="assets/img/photos/mobile_2.jpg">
              <div class="container h-100">
                <div class="row h-100">
                  <div class="col-md-11 col-lg-8 col-xl-7 col-xxl-6 mx-auto text-center justify-content-center align-self-center">
                     <h4 class="display-1 fs-56 mb-4 text-white animate__animated animate__slideInDown animate__delay-1s">Search Person by Face photo</h4>
                    <p class="lead fs-23 lh-sm mb-7 text-white animate__animated animate__slideInRight animate__delay-2s">Search by face photo to get the best possible results  providing you with accurate and similar matched results.</p>
                    <div class="animate__animated animate__slideInUp animate__delay-3s"><a href="#" class="btn btn-lg btn-outline-white rounded-pill">Sign UP Now</a></div> 
                  </div>
    ...
    <div class="swiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          ...
          Families are automatically notified when missing loved ones are found, ensuring a seamless and efficient process.
          </p>
          <a href="#" class="btn btn-danger mb-2">Add Your Missing Person</a>
          
          <div class="w-100">
            <img src="assets/img/photos/mobile_1.jpg" alt="">
          </div>
        </div>
        
        <div class="swiper-slide">
          <h2 class="text-justify p-2 mt-3 pb-1">Search Person by Face photo</h2>
           <p class="text-justify p-2 pt-1 pb-0">A Search by face photo to get the best possible results  providing you with accurate and similar matched results.</p>
          <div class="w-100">
            <img src="assets/img/photos/mobile_2.jpg" alt="">
  ...
  <div class="container">
    ...
    <div class="row">
      <marquee behavior="" direction="">
        <img src="https://khoji.in/assets_landing_page/logos/digilocker.webp" alt="" title="Digilocker"/>
        <img src="https://khoji.in/assets_landing_page/logos/aim.webp" alt="" />
        
        <img src="./assets/img/photos/rru.png" alt="" />
        <img src="https://khoji.in/assets_landing_page/logos/incubation.webp" alt="" />
      </marquee>
    </div>
  </div>
</section>
    ...
    <div class="row row-cols-2 row-cols-md-3 row-cols-xl-5 gx-lg-6 gy-6 justify-content-center">
      ...
      <div class="col">
        <div class="card  card-border-end border-soft-purple h-100 align-items-center">
          <div class="card-body align-items-center d-flex px-3 py-6 p-md-8">
            <figure ><img src="https://khoji.in/assets_landing_page/logos/digilocker.webp" alt="" /></figure>
          </div>
          <!--/.card-body -->
        </div>
        <!--/.card -->
      ...
      <div class="col">
        <div class="card card-border-end border-soft-leaf h-100 align-items-center">
          <div class="card-body align-items-center d-flex px-3 py-6 p-md-8">
            <figure ><img src="https://khoji.in/assets_landing_page/logos/incubation.webp" alt="" /></figure>
          </div>
          <!--/.card-body -->
        </div>
        <!--/.card -->
      ...
      <div class="col">
        <div class="card card-border-end border-soft-purple h-100 align-items-center">
          <div class="card-body align-items-center d-flex px-3 py-6 p-md-8">
            <figure ><img src="https://khoji.in/assets_landing_page/logos/aim.webp" alt="" /></figure>
          </div>
          <!--/.card-body -->
        </div>
        <!--/.card -->
      ...
      <div class="col-xl-12 mx-auto">
        <div class="card image-wrapper bg-full bg-image bg-overlay bg-overlay-400" data-image-src="./assets/img/photos/bg2.jpg">
          <div class="card-body p-6 p-md-11 d-lg-flex flex-row align-items-lg-center justify-content-md-between text-center text-lg-start">
            ...
            <a href="#" class="btn btn-white rounded-pill mb-0 text-nowrap fs-12">🔍 Search By Face Photo</a>
          </div>
...
<!-- why choose us  -->
 <!-- /section -->
    <section class="wrapper " style="background-color: #eeeeee !important;">
              ...
              <div class="swiper-wrapper">
               ...
               <div class="swiper-slide">
                  <article>
                    <div class="card shadow-lg">
                      <figure class="card-img-top overlay overlay-1">
                          <iframe width="410" height="315" src="https://www.youtube.com/embed/RjEadj44XkQ?si=vDkCWjow4mxMI_MM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<section class="wrapper bg-light">
  <div class="container py-8 py-md-8">
    ...
    <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
      ...
      <!--/column -->
      <div class="col-lg-6">
        <h2 class="display-4 mb-3">Create Your Account Using <mark>DigiLocker</mark> & <mark> Direct Aadhaar</mark></h2>
        <p class="lead fs-lg">Nowadays, most people are familiar with DigiLocker. If you already have a DigiLocker account, you can watch the provided video to learn how to create your account using this method.
          <br>
        <a href="#" class="mt-4 btn btn-navy rounded-pill"> Sign Up &nbsp; <i class="fa fa-sign-in"></i></a>
        </p>
