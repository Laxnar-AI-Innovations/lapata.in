        ...
        <div>
            ...
            <div class="form-group mt-2 row justify-content-center mx-0">
                <div class="col-lg-auto col-sm-12 col-md-auto mt-3">
                    <button onclick="redirectAccordingly('upload')" style="padding:10px!important;font-size:0.9rem!important;" class="w-100 btn-style-red disabled-on-loading btn"> Upload Missing Person Detail  <img src="<?= base_url(); ?>assets_landing_page/people_13805124.png" class="ms-2" style="width: 30px;height: 30px;"></button>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    {
        location.href="<?= base_url(); ?>payment-page?type="+type;
    }
</script>