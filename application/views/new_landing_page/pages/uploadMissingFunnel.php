    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header p-2">
                <h4 class="modal-title" style="font-size:1rem;">Face photo is compulsory to find lapata person</h4>
                <button type="button" class="btn btn-dark close1 me-2" data-dismiss="modal" style="color:white;">&times;</button>
            </div>
            <div class="modal-body p-0">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-12 text-center mb-3">
...
<main id="main" class="main px-0">
    <div class="container-fluid px-0">
        <section class="section register d-flex min-vh-70 my-5 flex-column align-items-center justify-content-center">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 1){ echo "d-none"; } ?>">
                        <div class="card mb-3 w-100">
                            <div class="card-body mt-0 py-2">
                                <div class="row pt-0 pb-0" style="justify-content:space-between;">
                                    <div class="col-12 col-md-6 my-3">
                                        <h5 class="card-title pb-0 mb-0">Add Missing Person Details</h5>
                                    </div>
                                    <div class="col-12 col-md-6 text-end mt-3 notaadhardiv clickdiv">
                                        <b>Don't have aadhar number?</b><a href="javascript:void(0)" onclick="showDivAccordingly('show')"> Click Here</a>
                                    </div>
                                    <div class="col-12 col-md-6 text-end mt-3 hiddendiv clickdiv d-none">
                                        <b>Have aadhar number?</b><a href="javascript:void(0)" onclick="showDivAccordingly('hide')"> Click Here</a>
                                    </div>
                                </div>
                                <div>
                                    <!--Success message-->
                        ...
                        ?>
                        <form id="loginForm" action="<?php echo base_url(); ?>landing/lapatawith" method="post" class="row g-3 w-100 needs-validation1"  enctype="multipart/form-data">
                            <?php 
                                $csrf = array(
                            ...
                            <div class="card">
                                <div class="card-body mt-0">
                                    <div class="row align-items-center notaadhardiv" id="labelDiv">
                                        <div class="col-10 col-md-3 text-center">
                                            <label><b class="text-danger">Missing Person Aadhaar No.</b></label>
                                        </div>
                                    </div>
                                    <div class="row align-items-center aadharRow notaadhardiv">
                                        <div class="form-floating col-10 col-md-3">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="form-floating mt-3 col-12 col-md-4 hiddendiv d-none">
                                        ...
                                        <div class="form-floating col-12 col-md-auto hiddendiv d-none">
                                            ...
                                            <input type="date" class="form-control mt-2" id="dob" name="dob" onchange="getAgeBand(this.value)" max="<?= date('Y-m-d') ?>">
                                        </div>
                                        <div class="form-floating col-12 col-md-1 hiddendiv d-none">
                            ...
                            <div class="card mb-3 w-100 hiddendiv d-none">
                                <div class="pt-0 pb-0 mt-3">
                                    <h5 class="card-title text-center pb-0 mb-0">Upload Face Match Photo & Type Message </h5>
                                </div>
                            ...
                            <div class="card mb-3 w-100 hiddendiv d-none">
                                 <div class="pt-0 pb-0 mt-3">
                                    <h5 class="card-title text-center pb-0 mb-0">Add Identification Details</h5>
                                </div>
                                <div class="card-body mt-0 py-0">
                                    <div class="row align-items-center ">
                            ...
                            <div class="card mb-3 w-100 hiddendiv d-none">
                                <div class="pt-0 pb-0 mt-3">
                                    <h5 class="card-title text-center pb-0 mb-0">Add Gold Jewellery HUID Number</h5>
                                </div>
                                <div class="card-body mt-0 py-0" id="goldDetail">
                            ...
                            <div class="card mb-3 w-100 hiddendiv d-none">
                                 <div class="pt-0 pb-0 mt-3">
                                    <h5 class="card-title text-center pb-0 mb-3">Address Of Missing Person</h5>
                                </div>
                                <div class="card-body mt-0 py-0">
                                    <div class="row align-items-center justify-content-center">
                            ...
                            <div class="card hiddendiv d-none" style="box-shadow:0px 0px 0px 0px;background:none">
                                <div class="card-body mt-0 pb-0">
                                    <div class="row align-items-center justify-content-center">
                                        ...
                                        <div class="my-3 col-12 col-md-auto d-none" id="aadharcleardiv">
                                            <button type="button" onclick="clearAadhar(this)" id="btnaadharClear" style="background:white!important;color:red!important;" class="btn w-100 btn-style-red text-center disabled-on-loading"> Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 2){ echo "d-none"; } ?>">
                        <div class="card mb-3 w-100">
                            <div class="card-body mt-0 py-2">
                                <div class="pt-0 pb-0">
                                    <h5 class="card-title text-center pb-0 mb-0"><span class="text-danger">Upload- Missing Person</span> Photos</h5>
                                </div>
                            </div>
                        </div>
                        <form id="step2Form" method="post" class="row g-1 needs-validation1 w-100"  enctype="multipart/form-data">
                            ...
                            <?php 
                                if(isset($_SESSION['funnelId']))
                                {
                                    
                            ?>
                            <?php
                                $getLatestPhotos = $this->db->query('select * from funnelphotos where funnelId='.$_SESSION['funnelId'])->result_array();
                                $j=0;
                                for($i=0;$i<3;$i++)
                                {
                                    $j++;
                                                ...
                                                <div class="col-lg-12 col-sm-12 col-md-12">
                                                    <div class="row mt-3 mx-0" id="reUploadDiv<?php echo $i; ?>">
                                                        <div class="col-md-12 col-sm-12 col-lg-12 px-0">
                                                            ...
                                                            <input type="file" accept="image/*" class="form-control" id="latestFile<?php echo $i; ?>" onchange="cropPhoto('latest',<?= $i; ?>)">
                                                        </div>
                                                    </div>
                                                    <div class="row mt-3">
                                                        <div class="col-lg-12 col-sm-12 col-md-12">
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-md-6 px-0">
                                            <div class="row border border-secondary mx-0 p-3" style="border-radius:15px;border-color:lightgrey!important;">
                                                ...
                                                <div class="col-lg-auto col px-0">
                                                    ...
                                                    <?php 
                                                        $split = explode('upload/funnel/',$getLatestPhotos[$i]['photourl']);
                                                    ?>
                                                    <div class="row">
                                                        <div class="col-lg-12 col-sm-12 col-md-12">
                    ...
                    <div id="step3" class="<?php if($pn != 3){ echo "d-none"; } ?>">
                        <?php 
                            $getPersonDetail = $this->db->query('select * from funnel_missing where id='.(isset($_SESSION['funnelId']) ? $_SESSION['funnelId'] : 0))->result_array();
                        ?>
                        <?php 
                        ...
                        <div class="card">
                            <div class="card-body py-3">
                                <div class="row align-items-center" id="defaultContactDiv<?= $i; ?>">
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-auto text-center <?= ($i == 1 ? 'd-none' : ''); ?>">
                                        <input type="checkbox" class="radio-custom" id="editContact<?= $i; ?>" name="editContact<?= $i; ?>" onclick="editContact(<?= $i; ?>,this)">
                                        <label for="editContact<?= $i; ?>" class="radio-custom-label"><b>Want to <?php echo ($profileDetail[0]['alternate_mobile'.$i] != NULL) ? 'change ' : 'add ' ?>contact?</b></label>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-3">
                                <div class="row" id="rewarddiv">
                                    <div class="form-group form-floating col-md-auto col-sm-12 col-lg-auto">
                                        <input type="number" value="<?php echo ($getPersonDetail[0]['rewardamount'] != NULL ? $getPersonDetail[0]['rewardamount'] : 0) ?>" min="<?php echo ($getPersonDetail[0]['rewardamount'] != NULL ? $getPersonDetail[0]['rewardamount'] : 0) ?>" class="form-control" id="rewardAmount" name="rewardAmount" placeholder="Reward Amount">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="form-group col-md-auto col-sm-12 col-lg-auto">
                                        ...
                                        <label for="terms" class="radio-custom-label">I Agree to Terms & Conditions <a href="<?php echo base_url(); ?>before-missing-terms" target="_blank" style="text-decoration:underline;color:#4154f1;"><b>View</b></a></label>      
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body py-3">
                                <div class="row mb-0 align-items-center">
                                    ...
                                    <div class="col-sm-12 col-md-auto col-lg-auto mt-1 mb-1">
                                        <button type="button" id="btn3Dashboard" class="btn btn-dark disabled-on-loading w-100 btn-style-grey disabled"> Final Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="col-md-12 text-center text-danger px-1 pb-3 p-3" style="font-weight:bold;">
                                                ...
                                                <div class="row justify-content-center" style="display:none;" id="shareDiv">
                                                    <div class="col-md col-sm-12 mb-3">
                                                        <button type="button" style="padding:0.5rem!important;" class="btn-style-four btn btn-primary d-block w-100 disabled-on-loading" onclick="share('without','<?= (isset($_SESSION['funnelId']) ? $getPersonDetail[0]['Application_no'] : 0); ?>')"> Share missing person detail's link without photo</button>
                                                    </div>
                                                    <div class="col-md col-sm-12 mb-3">
                                                        <button type="button" style="padding:0.5rem!important;" class="btn-style-five btn btn-primary d-block w-100 disabled-on-loading" onclick="share('with','<?= (isset($_SESSION['funnelId']) ? $getPersonDetail[0]['Application_no'] : 0); ?>')"> Share missing person detail's link with photo</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    Swal.fire({
        ...
        location.href="<?php echo base_url(); ?>new-landing-page";
    })
    <?php } ?>
    ...
    {
        navigator.clipboard.writeText('<?php echo base_url(); ?>find-funnel-person?id='+Id+'&type='+type);
    ...
    $('#btn1Submit').click(function()
    {
        ...
        }else if($('#Age').val() == '')
        {
            ...
            $(this).removeAttr('disabled');
        }else if($('#facematch').val() == '')
        {
            toastr.error('Please upload Photo');
            $(this).removeAttr('disabled');
        }else if($('#dateCreated').val() == '')
        {
    ...
    $('#btn3Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>upload-missing-funnel?pn=2";
    })
    ...
    $('#btn3Dashboard').click(function(){
        ...
        $.ajax({
            ...
            success:function(res)
            {
                ...
                setTimeout(function()
                {
                    location.href="<?php echo base_url(); ?>upload-missing-funnel?pn=4";  
                },2000);      
            }
        })
    })
    ...
    $('#btn2Next').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>upload-missing-funnel?pn=3";
    })
                    ...
                    if(parse.status == 'already')
                    {
                        if(parse.isFound == "0")
                        {
                            Swal.fire({
                                ...
                                html:'<div class="form-group mb-2 word"><b style="color:black;line-height:2rem;">You have already file the complaint of '+parse.personName + '(' + parse.aadharNumber + ')' +'.</b></div>',
                                allowOutsideClick:true,
                                showCloseButton: true,
                                showCancelButton: true,
                                reverseButtons: true,
                                ...
                                if (result.isConfirmed) {
                                    window.open('<?php echo base_url(); ?>user/editLapataDetails?id='+parse.appNo,'_blank');
                                }else{
                                    location.reload();
                                }
                            })   
                            ...
                            if(parse.status == 'inactive')
                            {
                                ...
                                if(parse.isRegistered == 1)
                                {
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            location.href="<?php echo base_url(); ?>user/editLapataDetails?id="+parse.appNo;
                                            $('#personImage img').attr('src',parse.popupPhoto);
                                            $('#personImage').removeClass('d-none');
                                            $('#aadharNumber').attr('readonly',true);
                                            $('#aadharcleardiv').removeClass('d-none');
                                ...
                                if(parse.status == 'planexpire')
                                {
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            location.href="<?php echo base_url(); ?>user/showPaymentModels?id="+parse.id;
                                            $('#personImage img').attr('src',parse.popupPhoto);
                                            $('#personImage').removeClass('d-none');
                                            $('#aadharNumber').attr('readonly',true);
                                            $('#aadharcleardiv').removeClass('d-none');
    ...
    function showDivAccordingly(type)
    {
        ...
        {
            $('#type').val('without');
            $('.notaadhardiv').addClass('d-none');
            $('.hiddendiv').removeClass('d-none');
            $('.clickdiv').addClass('d-none');
        }else{
            $('#type').val('with');
            $('.notaadhardiv').removeClass('d-none');
            $('.hiddendiv').addClass('d-none');
            $('.clickdiv').addClass('d-none');
        }
    }
