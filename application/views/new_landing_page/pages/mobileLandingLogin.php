...
<section class="section register min-vh-70 d-flex flex-column align-items-center justify-content-center py-2">
    <div class="container">
        <h6 class="card-title text-center fs-20 text-gradient1 mb-0">Mahakumbh Special 2025</h6>
                    ...
                    <div class="card-body p-1">
                        ...
                        <div id="mobilediv">
                            <div class="input-group mb-3 col-auto">
                                <span class="input-group-text px-2" style="border:2px solid black;" id="mobile-addon1">+91</span>
                    ...
                    success:function(res)
                    {
                        ...
                        if(parse.status == 'success')
                        {
                            ...
                            setTimeout(function()
                            {
                                ...
                                {
                                    location.href="<?php echo base_url(); ?>NonKyc/add_mahakumbh_member_special";   
                                }else{
                                    location.href="<?php echo base_url(); ?>step1-guest?type=special";   
                                }
                                <?php  }else{ 
                                    if($_GET['type'] == 'filter')
                                    {
                                ...
                                if(parse.finalverification == 'success')
                                {
                                    ...
                                    location.href="<?php echo base_url(); ?>step1-guest?type=filter";   
                                }
                                <?php }else{ ?>
                                if(parse.finalverification == 'success')
                                {
                                    location.href="<?php echo base_url(); ?>NonKyc/add_mahakumbh_member";   
                                }else{
                                    location.href="<?php echo base_url(); ?>step1-guest?type=mahakumbh";   
                                }
                                <?php } ?>
                                <?php } ?>
                            },2000);
