                ...
                <div class="row h-100">
                  ...
                  <div class="col-md-6 ">
                      <picture>
                          ...
                          <img src="https://khoji-new.s3.ap-south-1.amazonaws.com/assets/img/photos/mobile_1.webp" class="foto-border" alt="Banner 1" loading="lazy">
                      </picture>
                </div>
                </div>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  ...
                  <div class="w-100">
                    <picture>
                        <source srcset="https://khoji-new.s3.ap-south-1.amazonaws.com/assets/img/photos/mobile_1.webp" type="image/jpg">
                        <img src="https://khoji-new.s3.ap-south-1.amazonaws.com/assets/img/photos/mobile_1.webp" alt="Add Your Missing Person" loading="lazy">
                    </picture>
                  </div>
                </div>
                <div class="swiper-slide">
...
<section class="section1 d-lg-block d-none">
  ...
  <div class="image-row">
    <div class="img-col">
      <img src="https://khoji-new.s3.ap-south-1.amazonaws.com/assets/img/photos/hh-new.jpg" alt="Image 1" />
    </div>
    <div class="img-col">
      <img src="https://khoji-new.s3.ap-south-1.amazonaws.com/assets/img/photos/Jp.jpg" alt="Image 2" />
    </div>
    <div class="img-col">
      <img src="https://khoji-new.s3.ap-south-1.amazonaws.com/assets/img/photos/GG-new.jpg" alt="Image 3" />
    </div>
  </div>
</section>
...
<script>
  ...
  lottie.loadAnimation({
   ...
   lottie.loadAnimation({
    ...
    path: 'assets_landing_page/Notifications-1.json', // JSON file ka path
  });
   ...
   lottie.loadAnimation({
    ...
    path: 'assets_landing_page/data.json', // JSON file ka path
  });
   ...
   lottie.loadAnimation({
    ...
    path: 'assets_landing_page/family.json', // JSON file ka path
  });
    ...
    <div class="container px-md-5 px-lg-any">
            ...
            <div class="col-12 px-0">
                ...
                <div class="row" style="position:absolute;z-index: 2;bottom: 30px;height: 500px;right: 0;">
                    <div class="col-12 text-end">
                        <img src="https://khoji-new.s3.ap-south-1.amazonaws.com/mobilescreens/2.png" style="height: 700px;width: 100%;">
                    </div>
                </div>  
            </div>
        </div>
        <div class="row position-relative" style="background-color:rgb(252, 245, 238);margin-top: 10rem!important;border-radius: 25px;">
            <div class="col-12 px-0">
                <div class="row" style="position:absolute;z-index: 2;bottom: 30px;height: 500px;left: 0;">
                    <div class="col-12 text-end">
                        <img src="https://khoji-new.s3.ap-south-1.amazonaws.com/mobilescreens/4.png" style="height: 700px;width: 100%;">
                    </div>
                </div>  
        ...
        <div class="row position-relative" style="background-color:rgb(243, 245, 254);margin-top: 10rem!important;border-radius: 25px;">
            <div class="col-12 px-0">
                ...
                <div class="row" style="position:absolute;z-index: 2;bottom: 30px;height: 500px;right: 0;">
                    <div class="col-12 text-end">
                        <img src="https://khoji-new.s3.ap-south-1.amazonaws.com/mobilescreens/3.png" style="height: 700px;width: 100%;">
                    </div>
                </div>  
            </div>
        </div>
        <div class="row position-relative" style="background-color:rgb(252, 245, 238);margin-top: 10rem!important;margin-bottom: 7rem!important;border-radius: 25px;">
            <div class="col-12 px-0">
                <div class="row" style="position:absolute;z-index: 2;bottom: 30px;height: 500px;left: 0;">
                    <div class="col-12 text-end">
                        <img src="https://khoji-new.s3.ap-south-1.amazonaws.com/mobilescreens/1.png" style="height: 700px;width: 100%;">
                    </div>
                </div>  
                <div class="row align-items-center flex-md-row-reverse justify-content-md-between" style="padding:24px 48px;">
                    <div class="col-md-7 col-12">
