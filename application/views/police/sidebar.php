<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link " href="<?php echo base_url();?>police/lapata_person_filter">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed"  href="<?php echo base_url();?>police/unknown_person_filter">
              <i class="fas fa-search"></i><span>Search Unknown Person</span><i class="fa fa-knife ms-auto"></i>
            </a>
        </li>
        
        <li class="nav-item">
            <a class="nav-link collapsed" href="<?php echo base_url(); ?>police/notification_history">
        ...
        <!--      <i class="fas fa-search"></i><span>Search Missing Person</span><i class="fa fa-knife ms-auto"></i>-->
        <!--    </a>-->
        <!--</li>-->
        <!--<li class="nav-item">-->
