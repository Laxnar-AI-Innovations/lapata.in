      ...
      <section class="section register d-flex flex-column justify-content-center my-5">
        <div class="container px-0">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-xl-4 px-2 col-md-7 d-flex flex-column align-items-center justify-content-center">

              <div class="card mb-3 p-0 w-100">
                <div class="card-body px-3 py-0">
                    <div class="pb-0">
                    <h5 class="card-title mb-0 text-center pb-0 fs-4 pt-0" style="font-size:1.2rem!important"><span style="font-size:1.2rem!important;font-weight:500;color:#63b881">Login</span> to Your Account</h5>
                  </div>
                    
                    <div class="form-group mb-1 row g-6 text-center">
                        <div class="col-sm-12 col-6 col-md-6 col-lg-6 px-0">
                            <input class="radio-custom" type="radio" name="logintype" id="loginmobile" checked value="mobile">
                            <label class="radio-custom-label" for="loginmobile">
                              C.U.G Mobile No.
                            </label>
                        </div>
                        <div class="col-sm-12 col-6 col-md-6 col-lg-6 text-right px-0">
                    ...
                    <div id="mobilediv">
                        <div class="form-floating mb-3 col-auto">
                          <input type="number" class="form-control" onkeydown="limit(this,'mobile');" onkeyup="limit(this,'mobile');" name="mobileNumber" id="mobileNumber" required placeholder="Mobile Number">
                          <label for="mobileNumber">Mobile Number</label>
                          <div class="invalid-feedback">Please enter your Mobile number.</div>
                        </div>
                        <div class="form-group mb-0 col-auto">
                            <button type="button" onclick="getRegistered('mobile')" class="btn btn-dark btn-style-grey disabled w-100" id="btnmobileNext"> Next <i class="fa fa-arrow-circle-right"></i></button>
                        </div>
                    </div>
                    <div id="usernamediv" class="d-none">
                        ...
                        <div class="form-group mb-0 col-auto">
                            <button type="button" onclick="getRegistered('user')" class="btn btn-dark btn-style-grey w-100 disabled" id="btnuserNext"> Next <i class="fa fa-arrow-circle-right"></i></button>
                        </div>
                    ...
                    <div class="form-group col-auto mt-3 d-none" id="otpdiv">
                        <form action="<?php echo base_url(); ?>police/login/do_login" method="post" class="row gy-3 gx-0 needs-validation" novalidate id="loginform">
                            <?php 
                              $csrf = array(
                    ...
                    <div class="col-auto my-2">
                          <p class="mb-0">Don't have account? <a href="<?php echo base_url(); ?>police/register">Create an account</a></p>
                        </div>
                </div>
              </div>
            </div>
...
<script type="text/javascript">
    ...
    function limit(val,type){
        if(type == 'mobile')
        {
            ...
            if(val.value.length >= max_chars) {
                ...
                val.value = val.value.substr(0, (max_chars));
            }else{
    ...
    function resendOtp(ele)
    {
        ...
        if(type == 'mobile')
        {
            if($('#mobileNumber').val() != '')
            {
                ...
                $.ajax({
                    url:'<?php echo base_url(); ?>police/sendLoginOtp',
                    data:data,
                    contentType: false,
                    cache: false,
                    processData:false,
    ...
    $('#loginform').on('submit',function(e)
    {
        ...
        if(arr[2].value == '')
        {
            toastr.error('Please Enter Mobile/ Username Value');
            return false;
        }
        else if(arr[3].value == '')
        {
    ...
    function getRegistered(type)
    {
        ...
        if(type == 'mobile')
        {
            if(value.length == 10)
            {
                ...
                $.ajax({
                    url:'<?php echo base_url(); ?>police/getMobileDetails',
                    data:data,
                    contentType: false,
                    cache: false,
                    processData:false,
