        ...
        <div class="col-lg-6 col-md-8 d-flex flex-column align-items-center justify-content-center">
          ...
          <div class="card my-2 p-0">
            ...
            <div class="card-body p-2">
              ...
              <div class="pb-2">
                <h5 class="card-title text-center pb-0">Create a New Account of <b class="text-danger">POLICE DEPARTMENT</b></h5>
              ...
              <form id="registerForm" action="<?php echo base_url(); ?>police/register/do_register" method="post" class="row g-3 needs-validation justify-content-center align-items-center">
                <?php 
                  $csrf = array(
                ...
                <div class="col-lg-4 col-md-4 col-12" id="btnsubmitdiv">
                  <button class="btn btn-dark btn-style-grey disabled w-100 disabled-on-loading" id="btnSubmit" type="submit" > Register</button>
                </div>
              </form>
                <div class="col-12 mt-3 px-3">
                  <p class="mb-0">Already have an account? <a href="<?php echo base_url(); ?>police">Log in</a></p>
                </div>
            </div>
          </div>
