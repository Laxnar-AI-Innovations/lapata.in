                            ...
                            <div class="card-body py-3">
                                <div class="px-0 col-lg-10 col-md-12 col-sm-12 d-flex flex-column mx-lg-auto">
                                    ...
                                    <div class="row text-center justify-content-center">
                                        ...
                                        <div class="col-lg-auto mt-3 col-md-auto col-sm-12">
                                            <a href="<?php echo base_url(); ?>police/upload_detail" class="btn-style-green btn btn-primary d-block">Add More Unknown Person</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $('#btn3Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>police/upload_detail?pn=2";
    })
    ...
    $('#btn3Dashboard').click(function(){
        $(this).attr('disabled','disabled');
        $.ajax({
            url:'<?php echo base_url(); ?>police/updateContact',
            type:'get',
            success:function(res)
            {
    ...
    $('#btn2Next').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>police/upload_detail?pn=3";
    })
