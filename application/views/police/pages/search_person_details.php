...
<script type="text/javascript">
    ...
    function showAccordingly()
    {
        ...
        if(choice == undefined)
        {
            ...
            if(choice == 'unknown')
            {
                location.href="<?php echo base_url(); ?>police/unknown_person_filter_after_login";
            }else if(choice == 'lapata')
            {
                location.href="<?php echo base_url(); ?>police/lapta_person_after_login";
            }else if(choice == 'vehicle')
            {
                location.href="<?php echo base_url(); ?>police/search_vehicle_details";
                ...
                if(choice != 3)
                {
                    if(choice != 4)
                    {
                        if(choice != 5)
                        {
                            if(choice == 2)
                            {
                                location.href="<?php echo base_url(); ?>police/search_person_by_identity";         
                            }else{
