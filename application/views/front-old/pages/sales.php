  ...
  <div class="row">
    ...
    <div class="col-md-4 mb-3">
      <div class="card h-100">
        ...
        <a href="#">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdIjrM-Uj_P9iGPEDmvvWi-TnGttERHaLqSA&usqp=CAU" class="card-img-top" alt="Product">
        </a>
        <div class="card-body px-2 pb-2 pt-1">
          <div class="d-flex justify-content-between">
            <div>
              <p class="h4 text-primary">Rs 129,99</p>
            </div>
            <div>
          ...
          <div class="d-flex mb-3 justify-content-between">
            ...
            <div class="text-right">
              ...
              <p class="mb-0 small"><b>MSRP: </b> Rs 119.99</p>
              <p class="mb-0 small"><b>REG: </b> Rs 19.99</p>
              <p class="mb-0 small text-primary">
                <span class="font-weight-bold">Save</span> Rs 20.00 (16%)
              </p>
            </div>
          </div>
          <div class="d-flex justify-content-between">
    ...
    <div class="col-md-4 mb-3">
      <div class="card h-100">
        ...
        <a href="#">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTnKPDMiDRT4D2IBvPij2c37DPV3JlHm5Fk3Q&usqp=CAU" class="card-img-top" alt="Product">
        </a>
        <div class="card-body px-2 pb-2 pt-1 d-flex flex-column">
          <div class="d-flex justify-content-between">
            <div>
              <p class="h4 text-primary">Rs 53,000</p>
            </div>
            <div>
              <a href="#" class="text-secondary lead" data-toggle="tooltip" data-placement="left" title="Compare">
                <i class="fa fa-line-chart" aria-hidden="true"></i>
    ...
    <div class="col-md-4 mb-3">
      <div class="card h-100">
        ...
        <div class="card-body px-2 pb-2 pt-1">
          <div class="d-flex justify-content-between">
            <div>
              <p class="h4 text-primary">Rs 55,020</p>
            </div>
            <div>
              <a href="#" class="text-secondary lead" data-toggle="tooltip" data-placement="left" title="Compare">
                <i class="fa fa-line-chart" aria-hidden="true"></i>
