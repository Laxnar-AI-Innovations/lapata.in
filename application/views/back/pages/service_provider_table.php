 ...
 <div class="card shadow mb-1">
                        <div class="card-header py-3">
                            <!-- <h6 class="m-0 font-weight-bold text-primary">Community</h6> -->
                             <a href="<?php echo base_url('admin/service_provider'); ?>" class="btn btn-primary purple" style="float:right;"> + Add Service Provider</a>
                        </div>
            <div class="card">
                <div class="card-body">
                         ...
                         <div class="col-md-12">
                            ...
                            <tbody>
                                <?php
                                $i = 0;
                                    foreach($service_provider as $bd){
                                        $i=$i+1;
                                ?>
                                <tr>
                                    <!-- <td><?php echo $i;?></td> -->
                                 <td><?php echo $bd['servicename'] ?></td>
                                  <td><?php echo $bd['companyname'] ?></td>
                                  <td><?php echo $bd['ownername'] ?></td>
                                   <td><?php echo $bd['description'] ?></td>
                                  <td><?php echo $bd['gstnumber'] ?></td>
                                  <td><?php echo $bd['phone_number'] ?></td>
                                  <td><?php echo $bd['any_id_proof'] ?></td>
                                   <td><?php echo $bd['additional_phone_number'] ?></td>
                                  <td><?php echo $bd['landline_number'] ?></td>
                                   <td><?php echo $bd['address'] ?></td>
                                    ...
                                    <td><a class="btn btn-danger" href="<?php echo base_url('admin/service_provider/do_delete/'.$bd['id']); ?>">Delete</a></td>
                                 </td> 
                                </tr>
                                <?php }?>                     
                            </tbody>
