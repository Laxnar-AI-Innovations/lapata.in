        ...
        <div class="container-fluid px-0">
            <div class="row align-items-center mx-1 mb-3 p-1" style="justify-content:space-around;box-shadow:0px 1px 2px grey;background:white;">
                ...
                <div class="col-lg-auto col-sm-12 col-md-auto text-end my-1">
                    <button type="button" onclick="back(this)" class="btn mt-0 btn-dark disabled-on-loading" style="background:black!important;"> <i class="fa fa-arrow-circle-left"></i></button>
                </div>
            </div>
...
<script type="text/javascript">
	...
	function back(ele)
	{
	    ...
	    location.href="<?= base_url(); ?>admin/search_history";
	}
