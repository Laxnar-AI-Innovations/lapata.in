            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 1){ echo "d-none"; } ?>">
                        ...
                        <form id="loginForm" action="<?php echo base_url(); ?>NonKyc/uploadUnknown" method="post" class="row g-3 needs-validation1"  enctype="multipart/form-data">
                            <?php 
                                $csrf = array(
...
<script>
    ...
    $('#btn3Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>NonKyc/editUnknownDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=2";
    })
    ...
    function payNow(ele,count)
    {
        ...
        if($('#terms').is(':checked'))
        {
            ...
            location.href='<?php echo base_url(); ?>NonKyc/showUnknownPaymentModels?id=<?= $data[0]['id']; ?>';
        }else{
    ...
    $('#btn3Dashboard').click(function(){
        ...
        $.ajax({
            ...
            success:function(res)
            {
                ...
                setTimeout(function()
                {
                    location.href="<?php echo base_url(); ?>NonKyc/editUnknownDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=4";
                },2000);      
            }
        })
    })
    ...
    $('#btn2Next').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>NonKyc/editUnknownDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=3";
    })
    
    $('#btn2Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>NonKyc/editUnknownDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=1";
    })
