                ...
                <div class="row justify-content-center">
                            ...
                            <div class="card">
                                                ...
                                                <div class="form-group col-12 col-md-6 col-lg-auto px-0" id="withDiv">
                                                    <div class="row mx-0 align-items-baseline">
                                                        ...
                                                        <div class="col-md-auto col-8">
                                                            <label for="newWith">
                                                                <label id="aadharLabel"><b class="text-dark">With Aadhaar No.</b></label>
                                ...
                                <div class="hiddendiv d-none">
                                    <div class="row align-items-center">
                                        <div class="form-floating col-12 col-md-auto hiddendiv d-none" style="display:none !important;">
                                            <label style="margin-left:0.8rem;">Missing Date *</label>
                                            <input type="date" name="dateCreated" id="dateCreated" required class="form-control mt-2 md1" max="<?= date('Y-m-d') ?>">
                                        </div>
                                        ...
                                        <div class="form-floating mt-3 col-12 col-md-5 hiddendiv d-none">
                                        ...
                                        <div class="form-floating col-12 col-md-auto hiddendiv d-none" style="display:none !important;">
                                            ...
                                            <input type="date" class="form-control mt-2 md2" id="dob" name="dob" onchange="getAgeBand(this.value)" max="<?= date('Y-m-d') ?>">
                                        </div>
                                        ...
                                        <div class="form-floating col-3 col-md-1 hiddendiv d-none">
                    ...
                    <div class="col-lg-12 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 2){ echo "d-none"; } ?>">
                        <div class="card mb-3 w-100">
                            <div class="card-body mt-0 py-2">
                                <div class="pt-0 pb-0">
                                    <h5 class="card-title text-center py-0 fs-4 mb-0"><span class="text-danger fs-4">Upload- Missing Person</span> Photos</h5>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row mx-0 justify-content-center">
                                        <div class="col-lg-6 col-md-6 col-12 px-0" style="top:-50px!important;background:white;height:auto;min-height:150px;">
                                            ...
                                            <div class="row align-items-center mt-3 mx-0">
                                                <div class="col-lg-12 col-sm-12 col-md-12 text-center">
                                                    <?php 
                                                        if($getUserDetail[0]['district'] != NULL)
                                                        {
                                                    ?>
                                                    ...
                                                    <?php }else{ ?>
                                                    <h6 class="mb-2" style="font-family:initial;font-size:1.2rem;color:black;"><b>Uploaded By: - <?php echo $getUserDetail[0]['aadharname']; ?></b></h6>
                                                    <?php } ?>
                                                </div>
                                            </div>
