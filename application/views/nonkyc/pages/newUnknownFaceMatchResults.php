          ...
          <section class="section register d-flex flex-column align-items-center justify-content-center bg-soft-primary">
            <div class="container-fluid px-1 px-md-2">
                <div class="row align-items-center my-3 mx-0 p-2" style="justify-content:space-around;box-shadow:0px 1px 2px grey;background:white;">
                    ...
                    <div class="col-lg-auto col-sm-12 col-md-auto text-start my-1 border border-danger text-center <?= (count($familyperson) > 0) ? '' : 'd-none'; ?>">
                        <a href="javascript:void(0)" style="color:green;text-decoration:none;font-weight:bold;">General - <?php echo (count($familyperson) > 1 ? count($familyperson).' Records' : count($familyperson).' Record'); ?></a>
                    </div>
                    ...
                    <div class="col-lg-auto col-sm-12 col-md-auto text-end my-1">
                        <button type="button" onclick='location.href=`<?= base_url(); ?>NonKyc/newSearchPerson`' class="btn mt-0 btn-style-grey btn-dark disabled-on-loading"> <i class="fa fa-arrow-circle-left"></i></button>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body px-0">
                        <h5 class="mb-0" style="text-align: center;color:red;"><b style="color:#00c000;">Some Similar Matches Found !</b></h5>
                    </div>
                </div>
                            ...
                            <?php 
                                foreach($lapataperson as $k=>$row)
                                {
                                    if(isset($row[0]))
                                    {
                                        $row = $row[0];
                            ?>
                            <input type="hidden" id="firstLapataId" value="<?= $lapataperson[0][0]['id']; ?>">
                ...
                <div class="card px-0 my-4">
                    <div class="card-body bg-white p-3">
                        <div class="row">
                            ...
                            ?>
                            <div class="col-lg-4 col-xl-3 col-md-6 px-0 px-md-2 col-12 col-search pb-2" >
                                <div class="card mb-3 shiva_height bg-light1" style="height: auto;">
                                    <div class="card-body px-0 pt-0">
                                        <div class="row align-items-center px-0 mx-0 justify-content-center">
                                            <?php
                                                if($row['Photo'] != '' || $row['Photo'] != NULL)
                ...
                <div class="card px-0 my-4">
                    <div class="card-header bg-white">
                        <h6 class="mb-0" style="text-align: center;color:red;"><b>APPEAL FOR IDENTIFICATION (<?= count($explode); ?>)</b></h6>
                    </div>
                    <div class="card-body bg-white">
                        ...
                        ?>
                        <h5 class="payDiv text-center card-titlenew mb-0 pb-0">To View Complete Details <br><u style="color: #d82124;">Pay Rs. <?= $getSettings[0]['value']; ?> Only</u></h5>
                        <div class="row justify-content-center mt-1">
                            <div class="col-sm-12 col-lg-6 col-md-6">
                                <div class="row justify-content-center payDiv">
                                    <div class="form-group col-12 col-md-4 col-lg-6 mt-1 text-center">
                                        <button type="button" class="mx-0 btn btn-style-five disabled-on-loading w-100" style="padding: 0.6rem!important;" onclick="payNow(this)"> Pay Now <i class="fa fa-money"></i></button>
                                    </div>
                                </div>
                                <div class="row justify-content-center d-none" id="viewResultDiv">
                                    <div class="text-center col-12 col-md-4 col-lg-6 mt-1 mb-3">
                                        <button onclick="location.href='<?= base_url(); ?>check-person-new-results'" style="padding: 0.6rem!important;" class="mx-0 btn btn-style-green disabled-on-loading w-100">View All Results Here...</button>
                                    </div>
                                </div>  
                            </div>
                        </div>
                ...
                <div class="card px-0 mb-4">
                    <div class="card-body bg-white p-1 pt-4">
                        <?php 
                ...
                ?>
                <div class="card px-0 mb-4">
                    <div class="card-body bg-white p-3 pt-2">
                        <div class="row">
                            <?php 
                                foreach($familyperson as $k=>$row)
                                {
                                    if(isset($row[0]))
                                    {
                                        $row = $row[0];
                            ?>
                            <input type="hidden" id="firstFamilyId" value="<?= $familyperson[0][0]['id']; ?>">
                            <input type="hidden" id="isFirstFamilySent" value="0">
                            <input type="hidden" id="isFamilyNotificationSent_<?= $row['id']; ?>" value="0">
                            <div class="col-lg-4 col-xl-3 col-md-6 px-0 px-md-2 col-12 col-search pb-2 p-2">
                                <div class="card mb-3 shiva_height1 bg-light" style="height: auto;">
                                    <div class="card-body px-0 pt-0">
                                        <div class="row align-items-center px-0 mx-0 justify-content-center">
                                            <?php
                                                if($row['Photo'] != '' || $row['Photo'] != NULL)
                ...
                <div class="card px-0 mb-4">
                    <div class="card-body bg-white p-3 pt-2">
                        <div class="row">
                            <?php 
                                foreach($mahakumbhperson as $k=>$row)
                                {
                                    if(isset($row[0]))
                                    {
                                        $row = $row[0];
                            ?>
                            <input type="hidden" id="firstMahakumbhId" value="<?= $mahakumbhperson[0][0]['id']; ?>">
                            <input type="hidden" id="isFirstMahakumbhSent" value="0">
                            <input type="hidden" id="isMahakumbhNotificationSent_<?= $row['id']; ?>" value="0">
                            <div class="col-lg-4 col-xl-3 col-md-6 px-0 px-md-2 col-12 col-search pb-2 p-2">
                                <div class="card mb-3 shiva_height1" style="height: auto;">
                                    <div class="card-header" style="background-color: white;border: 2px solid lightgrey;">
                                        <div class="row justify-content-between align-items-baseline">
                                            ...
                                            <div class="col-4 px-0">
                                                <h6 class="text-center text-gradient1 mb-1 fs-20" style="font-size: 0.6rem;">SPECIAL MAHAKUMBH 2025</h6>
                                            </div>
                                            <div class="col-4">
                                                <img src="<?= base_url(); ?>assets/mhakhumbh-removebg-preview.png" style="width: 100%;height: 75px;">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body px-0 pt-0">
                ...
                ?>
                <?php 
                    foreach($specialperson as $k=>$row)
                    {
                        if(isset($row[0]))
                        {
                            $row = $row[0];
                ?>
                <input type="hidden" id="firstSpecialId" value="<?= $specialperson[0][0]['id']; ?>">
                ...
                <div class="col-lg-4 col-xl-3 col-md-6 px-0 px-md-2 col-12 col-search pb-2" >
                    <div class="card mb-3 shiva_height bg-light" style="height: auto;">
                        ...
                        <div class="card-body px-0 pt-0">
                            <div class="row align-items-center px-0 mx-0 justify-content-center">
                                <div class="col-5 px-1 text-start mb-2">
                                    <?php 
                                ...
                                <?php }else{ ?>
                                <div class="col-12">
                                    <p class="mb-1"><b style="color:black;font-size:.7rem!important">Application No :- </b><b style="color:black;font-size:.7rem!important"><?php echo 'MAH'.sprintf('%03d',$row['id']); ?></b></p>
                                </div>
                                <?php } ?>
                                <?php
                                    if($row['uploadType'] == 'general')
                                ...
                                <?php }else{ ?>
                                <div class="col-5 ">
                                    <img class="w-100" id="profile-pic" src="<?php echo base_url(); ?>assets/img/noimage.webp" style="height: 100px !important;border: 1px solid;" alt="">
                                </div>
                                <?php } ?>
                                <div class="col-7 px-0">
                                    <?php if($row['person_name'] != '' || $row['person_name'] != NULL){ ?>
