                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 1){ echo "d-none"; } ?>">
                        ...
                        <?php 
                            ...
                            $isActive = '';
                            $status = 'Inactive';
                            if(strtotime(date('d-m-Y')) <= strtotime(date('d-m-Y',strtotime($data[0]['expiryDate']))))
                            {
                                $isExpired = 1;
                            }
                            if((!$data[0]['isFound']))
                            ...
                            <div class="card-body mt-0 w-100 p-2">
                                <div class="pt-0 pb-0">
                                    <div class="row justify-content-center align-items-center">
                                        ...
                                        ?>
                                        <div class="col my-2">
                                            <h6 class="text-center mb-0" style="color:black;"><b>Valid Till :- <br></b><?php echo date('d-m-Y',strtotime($data[0]['expiryDate'])); ?></h6>
                                        </div>
                                        <?php }else{ ?>
                                        <div class="col my-2">
                        ...
                        <form id="loginForm" action="<?php echo base_url(); ?>landing/lapatawith" method="post" class="row w-100 g-3 needs-validation1"  enctype="multipart/form-data">
                            <?php 
                                $csrf = array(
                            ...
                            <?php 
                                $getDetail = $this->db->query('select * from missingfunnelfacematchpayment where funnelId='.$data[0]['id'].' order by Id desc')->result_array();
                                $isFirst = 0;
                                ...
                                $getDetail = $this->db->query('select * from missingfunnelfacematchpayment where paymentStatus = 1 and funnelId='.$data[0]['id'].' order by Id desc')->result_array();
                                $isFirstUploaded = $getDetail[0]['image1Status'];
                                $isSecondUploaded = $getDetail[0]['image2Status'];
                                $isThirdUploaded = $getDetail[0]['image3Status'];
                            ?>
                            ...
                            <div class="card">
                                <div class="card-body mt-0">
                                    <div class="row align-items-center ">
                                        ...
                                        <?php } ?>
                                        <div class="form-floating col-12 col-md-2 d-none">
                                            <label style="margin-left:0.8rem;">Missing Date</label>
                                            <input type="date" max="<?= date('Y-m-d') ?>" class="form-control mt-2 md1" name="dateCreated" id="dateCreated" value="<?= $data[0]['missingDate'] != NULL ? date('Y-m-d',strtotime($data[0]['missingDate'])) : ''; ?>">
                                        </div>
                                        <?php
                                            if($data[0]['missingDate'] != NULL)
                                            {
                                                $d1=date('d',strtotime($data[0]['missingDate']));
                                                $d2=date('m',strtotime($data[0]['missingDate']));
                                                $d3=date('Y',strtotime($data[0]['missingDate']));
                                            }
                                            else
                                            {
                                                $d1=$d2=$d2=0;
                                        ...
                                        ?>
                                        <div class="cd col-md-2 col-6 form-control my-2 pb-md-1 pb-3 cus_date" >
                                        ...
                                        <div class="form-floating my-3 col-12 col-md-4">
                                         ...
                                         <div class="form-floating my-3 col-12 col-md-2">
                                            <select class="form-control" style="font-weight:bold;" name="Gender" id="Gender" required>
                                        ...
                                        <div class="form-floating col-12 col-md-2 d-none">
                                            ...
                                            <?php } ?>
                                            <input type="date" class="form-control mt-2 md2" <?= ($data[0]['dob'] != NULL) ? '' : ''  ?> id="dob" name="dob" value="<?= $data[0]['dob']; ?>" onchange="getAgeBand(this.value)" max="<?= date('Y-m-d') ?>">
                                        </div>
                                        <?php
                                            if($data[0]['dob'] != NULL)
                                            {
                                                $do1=date('d',strtotime($data[0]['dob']));
                                                $do2=date('m',strtotime($data[0]['dob']));
                                                $do3=date('Y',strtotime($data[0]['dob']));
                                            }
                                            else
                                            {
                                                $do1=$do2=$do3=0;
                                        ...
                                        ?>
                                        <div class="cd col-md-2 col-6 form-control mt-md-3 my-2 pb-md-1 pb-3 cus_date_edit" >
                            ...
                            <div class="card">
                                <div class="card-body mt-0 px-0 pb-0">
                                    <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-12 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 2){ echo "d-none"; } ?>">
                        ...
                        <form id="step2Form" method="post" class="row g-1 needs-validation1 w-100"  enctype="multipart/form-data">
                            ...
                            <?php
                                $getLatestPhotos = $this->db->query('select * from funnelphotos where funnelId='.$data[0]['id'])->result_array();
                                $j=0;
                                for($i=0;$i<3;$i++)
                                {
                                    $j++;
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-lg-4 col-sm-12 col-md-6 px-0">
                                            ...
                                            <div class="row mt-3 d-none justify-content-center" id="reUploadBtn<?php echo $i; ?>">
                                                ...
                                                <div class="col-lg-auto col-sm-12 col-md-auto mt-3 col-auto pe-0">
                    ...
                    <div id="step3" class="px-0 <?php if($pn != 3){ echo "d-none"; } ?>">
                        <?php 
                            $getPersonDetail = $this->db->query('select * from funnel_missing where id='.$data[0]['id'])->result_array();
                            $mobcount = 0;
                        ...
                        <div class="card">
                            <div class="card-body py-3">
                                <div class="row align-items-center" id="defaultContactDiv<?= $i; ?>">
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-auto text-center mb-3">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h6 class="text-dark mb-0"><b style="color:black;">Add Reward Amount (</b><b style="color:red;">Max Five Digit</b><b style="color:black;">).</b></h6>
                            </div>
                            <?php
                                if(!isset($getPersonDetail[0]['rewardamount']) || $getPersonDetail[0]['rewardamount'] == 0)
                                {
                            ...
                            <div class="card-body p-2">
                                <div class="row align-items-center d-none" id="rewardEditdiv">
                                    <div class="form-group form-floating col-md-auto col-10 col-lg-3">
                                        ...
                                        <label for="rewardAmount" class="col-md-4 col-lg-3 col-form-label mx-2" style="color:grey!important;">Enter Amount</label>      
                                    </div>
                        ...
                        <?php
                            if(strtotime($data[0]['expiryDate']) < strtotime(date('Y-m-d')))
                            {
                        ?>
                        <div class="card">
                        ...
                        <div class="card">
                            <div class="card-body py-3">
                                <div class="row mb-0 align-items-center">
                                    ...
                                    <?php }else{ ?>
                                    <div class="col-sm-12 col-6 px-1 col-md-auto px-0 col-lg-auto mt-1 mb-1">
                                        <button type="button" id="btn3Back" class="btn btn-dark disabled-on-loading w-100 btn-style-green" style="background:black!important;"> Back</button>
                                    </div>
                                    <div class="col-sm-12 col-6 ps-1 pe-0 pe-0 col-md-auto col-lg-auto mt-1 mb-1">
                                        <button type="button" style="padding:0.8rem!important;" id="payNowBtn" onclick="payNow(this)" class="btn btn-success disabled-on-loading w-100 btn-style-green"> Continue</button>
                                    </div>
                                    <?php } ?>
                                </div>
                            </div>
                                ...
                                <div class="px-0 col-lg-12 col-md-12 col-sm-12 d-flex flex-column mx-lg-auto">
                                        ...
                                        <div class="col-md-6 col-sm-12 col-lg-6 px-0">
                                            <div id="carouselExampleControls" class="carousel slide" data-bs-interval="2000" data-bs-ride="carousel">
                                                <div class="carousel-inner" id="photosspan">
                                                    ...
                                                    <?php } ?>
                                                    <?php
                                                        $getLatestUserPhotos = $this->db->query('select * from funnelphotos where funnelId='.$getPersonDetail[0]['id'])->result_array();
                                    ...
                                    <div class="row mx-0 justify-content-center">
                                        <div class="col-lg-6 col-md-6 col-12 px-0" style="top:-50px!important;background:white;height:auto;min-height:150px;">
                                            ...
                                            <?php } ?>
                                            <?php 
                                                $getUserDetail = $this->db->query('select * from nonKycUser where uid='.$getPersonDetail[0]['userId'])->result_array();
                                            ?>
                                            <div class="row align-items-center mt-3 mx-0">
                                                <div class="col-lg-12 col-sm-12 col-md-12 text-center">
...
<script>
    ...
    function payNow(ele)
    {
        ...
        {
            $(ele).attr('disabled',true);
            location.href='<?php echo base_url(); ?>NonKyc/showFunnelPaymentModels?id=<?= $data[0]['id']; ?>';
        }else{
    ...
    $('#btn3Next').click(function(){
        ...
        $.ajax({
            url:'<?php echo base_url(); ?>landing/updateContact',
            type:'post',
            processData:false,
            contentType:false,
            data:data,
            ...
            success:function(res)
            {
                ...
                setTimeout(function()
                {
                    location.href="<?php echo base_url(); ?>NonKyc/editFunnelMissingDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=4";
                },2000);      
            }
        })
    })
    ...
    {
        navigator.clipboard.writeText('<?php echo base_url(); ?>find-funnel-person?id='+Id);
    ...
    {
        $(ele).attr('disabled',true);
        location.href="<?php echo base_url(); ?>NonKyc/manage_funnel_missing";
    }
                                ...
                                if(index != '')
                                {
                                    ...
                                    if($('#facematch1').val() != '')
                                    {
                                        ...
                                        if($('#facematch2').val() != '')
                                        {
                                            ...
                                            let data = new FormData();
                                            data.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
                                            data.append('image1','<?= $data[0]['Photo']; ?>');
    ...
    function deletePhoto(crimeId,Id)
    {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                    $.ajax({
                    url:'<?php echo base_url(); ?>landing/deleteUnknownPhoto/'+crimeId,
                    type:'get',
                    success:function(res)
                    {
    ...
    function deleteReward(ele)
    {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url:'<?php echo base_url(); ?>landing/saveReward',
    ...
    {
        Swal.fire({
            iconHtml: '<i class="fa fa-rupee-sign" style="color:black;"></i>',
            customClass:{
                actions:'mt-1',
                title:'pt-1',
                htmlContainer:'pt-2'
            },
            html:'<div class="form-group mb-0" style="line-height:1.8rem;color:black;font-weight:bold;font-size:20px;">Are you sure you want to add <b style="color:red;text-transform:capitalize;">Rs. '+ $('#rewardAmount').val() + '(' + convertToWords($('#rewardAmount').val()) + ')' +'</b> as a reward?</div>',
            allowOutsideClick:true,
            cancelButtonText:'Back',
            showCloseButton: true,
    ...
    function uploadLatestPhoto(ele,index)
    {
        if($('#latestPhoto'+index).val() == '')
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>landing/uploadLapataPhoto',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
        ...
        if(type == 'old')
        {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url:'<?php echo base_url(); ?>landing/deleteUnknownGold',
                        data:otpdata,
                        contentType: false,
                        cache: false,
                        processData:false,
    ...
    $('#btn3Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>NonKyc/editFunnelMissingDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=2";
    })
    
    $('#btn2Next').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>NonKyc/editFunnelMissingDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=3";
    })
    
    $('#btn2Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>NonKyc/editFunnelMissingDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=1";
    })
    ...
    function deleteFace(ele,index)
    {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                data.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
                $.ajax({
                    url:'<?php echo base_url(); ?>landing/deleteFaceMatchFromLapata',
                    data:data,
                    contentType: false,
                    cache: false,
                    processData:false,
        ...
        if(setting == 1)
        {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    otpdata.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
                    $.ajax({
                        url:'<?php echo base_url(); ?>landing/deleteUnknownPersonMobile',
                        data:otpdata,
                        contentType: false,
                        cache: false,
                        processData:false,
    ...
    function verifyOtp(ele,index)
    {
        if($('#otp'+index).val() != '')
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>landing/verifyUnknownPersonMobileOtp',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
    ...
    function sendOtp(index)
    {
        ...
        if($('#othermob'+index).val() != '')
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>landing/sendUnknownPersonMobileOtp',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
        ...
        if($('#isFirstUploaded').val() != 'unlock')
        {
            Swal.fire({
                ...
                if(result.isDismissed){
                    ...
                    rzpData.append('amount', (<?= $payAmount; ?> * 100));
                    $.ajax({
                        ...
                        success:function(rzpRes)
                        {
                            ...
                            var options = {
                            	...
                            	"handler": function (response) {
                                    ...
                                    data.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
                            		$.ajax({
                            		    url:'<?php echo base_url(); ?>landing/saveMissingFaceMatchPayment',
                            		    data:data,
                                        contentType: false,
                                        cache: false,
                                        processData:false,
    ...
    $('#my-button1').click(function(){
        if($('#isSecondUploaded').val() != 'unlock')
        {
            Swal.fire({
                icon: 'question',
                customClass:{
    ...
    $('.cus_date select').change(function(){
        updateMonthOptionsFromDay('missingday','missingmonth','missingyear');
        updateDateInput('missingday','missingmonth','missingyear','md1');
        var d1=$('#dobday').val();
        var d2=$('#dobmonth').val();
        var d3=$('#dobyear').val();
