                        ...
                        <form id="step1Form">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-lg-auto col-md-auto mb-3">
                                    <button type="submit" id="btn1" class="next w-100 btn btn-primary disabled-on-loading"> Save & Next</button>
                                </div>
                            </div>
                    ...
                    <div id="step2" class="<?php if($pn != 2){ echo "d-none"; } ?>">
                        <form id="step2Form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-auto col-lg-auto mt-3">
                                    <button type="submit" id="btn2" class="next btn btn-primary w-100 disabled-on-loading"> Save & Next</button>
                                </div>
                            </div>
                        </form><!-- End Profile Edit Form -->
                    </div>
                                                ...
                                                <div class="col-lg-12 col-sm-12 col-md-12">
                                                    <div class="row mt-3 mx-0" id="reUploadDiv<?php echo $i; ?>">
                                                        <div class="col-md-12 col-sm-12 col-lg-12 px-0">
                                                            ...
                                                            <input type="file" class="form-control" name="photo<?php echo $i; ?>" accept="image/*" id="photoupload<?php echo $i; ?>" onchange="cropPhoto('latest',<?= $i; ?>)">
                                                        </div>
                                                    </div>
                                                    <div class="row mt-3">
                                                        <div class="col-lg-12 col-sm-12 col-md-12">
                                            ...
                                            <div class="modal-body px-3 px-md-5 pt-0">
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-lg-12 col-sm-12 col-md-12">
                                                        ...
                                                        <div class="row mt-3 mx-0 d-none" id="reUploadDiv<?php echo $i; ?>">
                                                            <div class="col-md-12 col-sm-12 col-lg-12 px-0">
                                                                <input type="file" class="form-control" accept="image/*" id="photoupload<?php echo $i; ?>" onchange="cropPhoto('latest',<?= $i; ?>)">
                                                            </div>
                                                        </div>
                                                        <div class="row mt-3">
                                                            <div class="col-lg-12 col-sm-12 col-md-12">
                            ...
                            <div class="card">
                                <div class="card-body p-3">
                                    <div class="row text-start justify-content-start">
                                        ...
                                        <div class="col-lg-auto col-md-auto col-sm-12 col-6">
                                            <button type="button" onclick="goToDashboard(this)" class="btn-style-five btn btn-primary d-block w-100 disabled-on-loading"> Go to Dashboard</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <?php }else{ ?>
                                    <div class="col-lg-auto col-sm-12 col-md-auto mt-3">
                                        <button type="submit" class="btn btn-primary next w-100 disabled-on-loading" id="btn6"> Save & Next</button>
                                    </div>
                                <?php } ?>
                    ...
                    <div id="step7" class="<?php if($pn != 5){ echo "d-none"; } ?>">
                        ...
                        <form id="step7Form">
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-md-9 col-lg-10 col-sm-12 mx-md-auto text-center text-md-start">
                                                ...
                                                <div class="text-center col-lg-6 col-md-10">
                                                    <input type="radio" class="radio-custom" <?php echo ($getUserDetail[0]['facematchphoto'] != NULL) ? 'checked' : ''; ?> name="faceopt" value="yes" id="yes">
                                                    <label for="yes" class="radio-custom-label">Yes</label>
                                                    <input type="radio" class="radio-custom" name="faceopt" <?php echo ($getUserDetail[0]['facematchphoto'] == NULL) ? 'checked' : ''; ?> value="no" id="no">
                            ...
                            <div class="card">
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-auto col-lg-auto mt-3 mt-md-0" >
                                        ...
                                        <div class="col-sm-12 col-12 pe-0 col-md-auto col-lg-auto mt-3 mt-md-0 yesDiv <?php echo ($getUserDetail[0]['facematchphoto'] == NULL) ? 'd-none' : ''; ?>" id="payNowDiv">
                                        ...
                                        <div class="col-sm-12 col-12 pe-0 col-md-auto col-lg-auto mt-3 mt-md-0 noDiv <?php echo ($getUserDetail[0]['facematchphoto'] != NULL) ? 'd-none' : ''; ?>" id="finalBtnDiv">
...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
  <script type="text/javascript">
    ...
    function finalSubmit(ele)
    {
        $(ele).attr('disabled','disabled');
        $.ajax({
            url:'<?php echo base_url(); ?>user/updateFacePhoto',
            type:'get',
            success:function(res)
            {
                Swal.fire({
