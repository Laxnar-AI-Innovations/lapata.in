...
<main id="main" class="main">
    <div class="pagetitle row align-items-center">
        <div class="col-sm-12 col-md-6 mb-3">
            <h1 class="text-center text-md-start" style="font-size: 1.1rem;">Manage Khoya Paya Details</h1>
        </div>
    </div>
    <div>
        <div class="container-fluid px-0">
            ...
            <div class="row align-items-end" style="justify-content:space-between">
	            ...
	            <div class="row align-items-end" style="justify-content:space-between">
	                ...
	                <div class="col-lg-4 col-xl-3 px-0 col-sm-12 mt-3 col-10 mt-md-0 col-md-5 text-end pe-lg-0">
                        ...
                        foreach($data as $row)
                        {
                            ...
                            if($row['uploadType'] == 'missing')
                            {
                            	...
                            	if($row['uploadType'] == 'general')
                                {
                                    ...
                                    $complaintType = 'APPEAL FOR IDENTIFICATION';
                                } 
                            }
                          ?>
                            ...
                            <div class="card mb-3" >
                                <div class="card-body px-0">
                                    <div class="row align-items-center px-0 mx-0 justify-content-center">
                                            ...
                                            <div class="row">
                                            	<div class="col-7 px-1 col-md-6 col-lg col-xl-6 mt-3">
                                                    <div class="form-check form-switch">
                                                      <input class="form-check-input" type="checkbox" onclick="showColorAccordingly(this,<?= $row['id']; ?>,'<?= $row['person_name']; ?>')" id="<?= $row['id']; ?>" <?= $isActive; ?>>
                                                      <label class="form-check-label" for="<?= $row['id']; ?>"><b class="text-red"><?= $complaintType; ?></b><br><b class="text-black">Status-</b><b id="statusColor<?= $row['id']; ?>" class="<?php echo ($isActive == '' ? 'text-red' : 'text-green'); ?>"><?php echo ($isActive == '' ? 'In-active' : 'Active'); ?></b></label>
                                                    </div>  
                                                </div>
				                        ...
				                        ?>
				                        <div class="col-12">
				                            <p ><b style="color:black;font-size:.8rem!important">Uploaded Date :- </b><b style="color:black;font-size:.7rem!important"><?php echo date('d-m-Y H:i A',strtotime($row['dateCreated'])); ?></b></p>
				                        </div>
                                        ...
                                        <div class="col-7 px-0">
                                            ...
                                            <?php }else{ ?>
                                            	<p class="card-title text-start py-0 fs-6"><b style="color:black;font-size:.8rem!important;font-weight:500;">Name - </b><b style="font-size:.8rem!important;color:black;">Unknown</b></p>
                                                <p class="card-title text-start py-0 fs-6"><b style="color:black;font-size:.8rem!important;font-weight:500;">Gender - </b><b style="font-size:.8rem!important;color:black;"><?php echo ($row['Gender'] == 'Male' ? 'Male':'Female'); ?></b></p>
                                            <?php } ?>
            ...
            <div class="card col-md-6 col-12 mx-auto">
                ...
                <div class="card-body pb-0 text-center d-block d-md-none">
                    <h5 class="text-danger mb-0"><b>No Family Member Special data</b></h5>
                </div>
...
function checkApp(ele)
{
	...
	if(value != '')
	{
	    location.href="<?= base_url(); ?>NonKyc/manage_mahakumbh_person_special?appNo="+value;   
	}else{
	    location.href="<?= base_url(); ?>NonKyc/manage_mahakumbh_person_special";
	}
}
...
function showColorAccordingly(ele,id,name)
{
    if(ele.checked)
    {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url:'<?php echo base_url(); ?>NonKyc/reactivateSpecialFamilyMember',
                    data:data,
                    contentType: false,
                    cache: false,
                    processData:false,
    ...
    $(ele).attr('disabled','disabled');
     Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            data.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
            $.ajax({
                url:'<?php echo base_url(); ?>NonKyc/deleteMahakumbhSpecialMember',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
...
{
    $(ele).attr('disabled','disabled');
    location.href="<?php echo base_url(); ?>NonKyc/editSpecialMahakumbhDetails?id="+appNo;
}
