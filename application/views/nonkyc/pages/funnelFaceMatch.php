...
<main id="main" class="main">
    ...
    <div>
        <div class="container-fluid px-0">
            <form class="row g-3 needs-validation justify-content-center" method="post" action="<?php echo base_url(); ?>NonKyc/searchPersonFunnelUnknownFace" novalidate id="step7Form">
                <?php 
                    $csrf = array(
                    ...
                    <div class="card-body mt-3">
                        <div class="row justify-content-center">
                            <div class="col-auto form-group text-center">
                                <label class="text-danger mb-2">Select Gender <b>*</b></label>
                                <br>
                ...
                $.ajax({
                    ...
                    success:function(res)
                    {
                        ...
                        if(parse.status == 'success')
                        {
                            ...
                            {
                                location.href="<?php echo base_url(); ?>NonKyc/newFunnelFaceMatchResults";
                            }else{
                                $("#ajaxloader").addClass('d-none');
                                $('body').css('background-color','#fff');
                                $('body').css('visibility','visible');
