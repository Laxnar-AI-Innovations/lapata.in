                                ...
                                <div class="pt-0 pb-0">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-6 d-none">
                                            ...
                                            ?>
                                            <h6 class="text-center pb-0 mt-4 mb-0" style="font-size:1.2rem;">Free Credits Left : - <?= $freeCredit; ?></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body mt-0">
                                    <div class="row align-items-center ">
                                        <div class="form-floating col-12 col-md-2 d-none">
                                            ...
                                            <input type="date" class="form-control mt-2 md2" name="rescueDate" id="rescueDate" value="<?= $data[0]['rescueDate'] != NULL ? date('Y-m-d',strtotime($data[0]['rescueDate'])) : ''; ?>" max="<?= date('Y-m-d') ?>">
                                        </div>
                                        <?php
                                            if($data[0]['rescueDate'] != NULL)
                                            {
                                                $do1=date('d',strtotime($data[0]['rescueDate']));
                                                $do2=date('m',strtotime($data[0]['rescueDate']));
                                                $do3=date('Y',strtotime($data[0]['rescueDate']));
                                            }
                                            else
                                            {
                                                $do1=$do2=$do3=0;
                                        ...
                                        ?>
                                        <div class="cd col-md-1 col-6 form-control mt-md-3 my-2 pb-md-1 pb-3 cus_date_edit" >
...
<script>
    ...
    $('#btn3Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>NonKyc/editUnknownDetailsNew?id=<?php echo $data[0]['Application_no'] ?>&pn=2";
    })
    ...
    function payNow(ele,count)
    {
        ...
        if($('#terms').is(':checked'))
        {
            ...
            location.href='<?php echo base_url(); ?>NonKyc/showUnknownPaymentModelsNew?id=<?= $data[0]['id']; ?>';
        }else{
    ...
    $('#btn3Dashboard').click(function(){
        ...
        $.ajax({
            ...
            success:function(res)
            {
                toastr.success('Details Updated Successfully - <?php echo $data[0]['Application_no'] ?>');
                setTimeout(function()
                {
                    location.href="<?php echo base_url(); ?>NonKyc/editUnknownDetailsNew?id=<?php echo $data[0]['Application_no'] ?>&pn=4";
                },2000);      
            }
        })
    })
    ...
    $('#btn2Next').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>NonKyc/editUnknownDetailsNew?id=<?php echo $data[0]['Application_no'] ?>&pn=3";
    })
    
    $('#btn2Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>NonKyc/editUnknownDetailsNew?id=<?php echo $data[0]['Application_no'] ?>&pn=1";
    })
    ...
    function deleteFace(ele,index)
    {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                data.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
                $.ajax({
                    url:'<?php echo base_url(); ?>NonKyc/deleteFaceMatchFromLapata',
                    data:data,
                    contentType: false,
                    cache: false,
                    processData:false,
