              ...
              <div class=" pb-2">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade profileTab active show" id="profileTab">
                        ...
                        <hr class="mb-4">
                        <form class="row g-3" method="post" action="<?php echo base_url(); ?>NonKyc/step2/do_register" id="registerForm">
                    <?php 
                      $csrf = array(
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
                          ...
                          <input type="text" name="registration_mobile" readonly class="form-control" id="registration_mobile" required value="<?php echo $_SESSION['landingMob']; ?>">
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
                          <label for="aadharname" class="form-label">Enter Name</label>
                          <input type="text" name="aadharname" class="form-control" id="aadharname" value="<?php echo $getProfileDetail[0]['aadharname']; ?>">
                          <div class="invalid-feedback">Please enter a valid Name</div>
                        </div>
                        <div class="form-floating col-12 col-md-2 d-none">
                            <?php 
                                if($getProfileDetail[0]['dob'] == NULL)
                                {
                            ?>
                            ...
                            <?php } ?>
                            <input type="date" class="form-control mt-2 md2" id="dob" name="dob" value="<?= $getProfileDetail[0]['dob']; ?>" onchange="getAgeBand(this.value)" max="<?= date('Y-m-d') ?>">
                        </div>
                        <?php
                            if($getProfileDetail[0]['dob'] != NULL)
                            {
                                $do1=date('d',strtotime($getProfileDetail[0]['dob']));
                                $do2=date('m',strtotime($getProfileDetail[0]['dob']));
                                $do3=date('Y',strtotime($getProfileDetail[0]['dob']));
                            }
                            else
                            {
                                $do1=$do2=$do3=0;
                            ...
                            $age = calculateAge($getProfileDetail[0]['dob']);
                        ?>
                        ...
                        <div class="form-floating col-8 col-md-3 mt-2">
                            <select class="form-control" style="font-weight:bold;" name="gender" id="gender" required>
                                <option value="" <?php echo ($getProfileDetail[0]['gender'] == '' ? 'selected' : ''); ?>>Select Gender *</option>
                                <option value="Male" <?php echo ($getProfileDetail[0]['gender'] == 'Male' ? 'selected' : ''); ?>>Male </option>
                                <option value="Female" <?php echo ($getProfileDetail[0]['gender'] == 'Female' ? 'selected' : ''); ?>>Female </option>
                                <option value="Other" <?php echo ($getProfileDetail[0]['gender'] == 'Other' ? 'selected' : ''); ?>>Other </option>
                    ...
                    <div class="row my-2 align-items-center ">
                        <div class="col-lg-6 col-sm-12 col-md-12">
                                ...
                                <div class="col-12">
                                    <div class="row d-none" id="otp1div" style="text-align: center;margin-top: 0.5rem;">
                                        <div class="form-group col-12 text-right">
                                            <div class="row">
                                                <div class="col-md-3 col-lg-2 col-sm-12 mb-3">
                                                    <input type="number" style="padding:0.8rem;" class="form-control mb-2" id="otp1" placeholder="Enter OTP">
                                                </div>
                                                <div class="col-md-4 col-lg-auto col-sm-12 col-6 mb-3">
                                                ...
                                                <div class="col-md-4 col-lg-auto col-6 col-sm-12 mb-3">
                            ...
                            <?php }else{ ?>
                                ...
                                <div class="row mb-3 d-none" id="other1div">
                                    ...
                                    <div class="form-group col-md-auto col-12" style="margin-top: 0.5rem;">
                                        <button class="btn btn-primary w-100 disabled-on-loading btn-style-grey disabled" id="btnOtp1" onclick="sendOtp(1)" type="button"> Send OTP</button>
                                    </div>
                                    <div class="col-12">
                                        <div class="row d-none" id="otp1div" style="text-align: center;margin-top: 0.5rem;">
                                            <div class="form-group col-12 text-right">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-lg-auto col-sm-12 mb-3">
                                                        <button type="button" class="btn-style-green w-100 btn btn-success d-block disabled-on-loading" id="btnVerify1" onclick="verifyOtp(this,1)"> Verify</button>      
                                                    </div>
                                                    <div class="col-md-4 col-lg-auto col-sm-12 mb-3">
                                                        <button class="btn btn-primary d-none w-100 btn-style-five disabled-on-loading" id="btnResendOtp1" onclick="resendOtp(this,1)" type="button">Resend OTP</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row d-none" id="otp2div" style="text-align: center;margin-top: 0.5rem;">
                                        <div class="form-group col-12 text-right">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-lg-auto col-sm-12 mb-3">
                                                    <button type="button" class="btn-style-green w-100 btn btn-success d-block disabled-on-loading" id="btnVerify2" onclick="verifyOtp(this,2)"> Verify</button>      
                                                </div>
                                                <div class="col-md-4 col-lg-auto col-sm-12 mb-3">
                                                    <button class="btn btn-primary btn-style-five w-100 d-none disabled-on-loading" id="btnResendOtp2" onclick="resendOtp(this,2)" type="button">Resend OTP</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-sm-12 col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" disabled value="<?= $getProfileDetail[0]['state']; ?>">
                            </div>
                            <div class="form-group mb-3">
                                <label><b>District</b></label>
                                <input type="text" class="form-control" disabled value="<?= $getProfileDetail[0]['district']; ?>">
                            </div>
                        </div>
                    </div>
                    <hr class="mb-0">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-sm-12 col-md-auto col-lg-auto mt-3">
                          <button class="btn btn-primary w-100 next" type="button" onclick="location.href='<?php echo base_url(); ?>NonKyc'">Go To Dashboard</button>
                        </div>
                        <!--<div class="col-sm-12 col-md-auto col-lg-auto mt-3">-->
...
<script type="text/javascript">
    ...
    function verifyDeleteOtp(ele,index)
    {
        ...
        if(otp != '')
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>NonKyc/deleteAlternateMobile',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
    ...
    function resendDeleteOtp(ele,index)
    {
        ...
        $.ajax({
            url:'<?php echo base_url(); ?>NonKyc/sendDeleteProfileOtp',
            data:otpdata,
            contentType: false,
            cache: false,
            processData:false,
    ...
    function verifyOtp(ele,index)
    {
        ...
        if($('#otp'+index).val() != '')
        {
            ...
            $.ajax({
              url:'<?php echo base_url(); ?>NonKyc/verifyProfileMobileOtp',
              data:data,
              contentType: false,
              cache: false,
              processData:false,
    ...
    function sendOtp(index)
    {
        ...
        if($('#othermob'+index).val() != '')
        {
            if($('#othermob'+index).val().length == 10)
            {
                ...
                $.ajax({
                  url:'<?php echo base_url(); ?>NonKyc/sendProfileMobileOtp',
                  data:data,
                  contentType: false,
                  cache: false,
                  processData:false,
    ...
    function showSaveAccordingly(val)
    {
        if(val == '')
        {
            $('#btnSubmit').parent().addClass('d-none');
        }else{
            $('#btnSubmit').parent().removeClass('d-none');
        }
    }
