    ...
    <div class="container-fluid px-0">
        <div class="row justify-content-center">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="row align-items-center mx-1 mb-3 p-1" style="justify-content:space-around;">
                                        <div class="col-lg-auto col-sm-12 col-md-auto text-start my-1 border border-danger text-center <?= (count($lapataperson) > 0) ? '' : 'd-none'; ?>">
                                            <a target="_blank" href="<?= base_url(); ?>NonKyc/searchFaceResults" class="text-danger" style="text-decoration:none;font-weight:bold;">Missing - <?php echo (count($lapataperson) > 1 ? count($lapataperson) : count($lapataperson)); ?></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12 text-md-end text-center mb-3 mb-md-0">
                                    <a href="<?= base_url(); ?>NonKyc/searchFaceResults" target="_blank" class="btn btn-primary btn-style-five">View Results</a>
                                </div>
                            </div>
            ...
            <?php
                ...
                $getLastTransaction = $this->db->query('select * from uploadtransactions where isKyc=0 and type="unknown" and userId='.$_SESSION['user_id'].' and idNumber="'.$getUnknownDetail[0]['Application_no'].'" order by Id desc')->result_array();
            ...
            <div class="col-sm-12 col-lg-4 col-md-5 me-md-3 mt-0 card px-0">
                ...
                <div class="card-body p-0 align-items-center my-3">
                    ...
                    <div class="row mt-2 px-2 align-items-end" style="justify-content:space-between;">
                        ...
                        <div class="col-5 text-center">
                            <h6 style="color:black;"><b><?= $label; ?></b></h6>
                        </div>
                    </div>
                    <div class="row mt-2 px-2 align-items-end" style="justify-content:space-between;">
                        <div class="col-1"></div>
...
<script>
    function proceed(ele)
    {
        ...
        let redirect = '<?= $_GET['redirect']; ?>';
        if(redirect.includes('editUnknownDetails'))
        {
