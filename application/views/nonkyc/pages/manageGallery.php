                    ...
                    Swal.fire({
                        ...
                        if(result.isConfirmed)
                        {
                            Swal.fire({
                                ...
                                html: "<div class='form-group'><h6 style='color:black;' class='text-center'><b>After Clicking on search button. You will be able to see results.</b></h6><div class='col-12 border border-5 border-dark pt-3'><img src='<?= base_url(); ?>assets/images/4thSlide.png' style='width:100%;height:auto;'></div></div>",
                                showCloseButton:true,
                                showConfirmButton:true,
