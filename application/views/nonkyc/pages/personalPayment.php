        ...
        <div class="card-header py-1">
            <div class="row align-items-center">
                ...
                <div class="col-2 text-end">
                    <button type="button" onclick="history.back();" class="btn btn-style-grey disabled-on-loading" style="background-color:transparent!important;color:black!important;border-radius:0!important;padding:0rem!important;box-shadow:0 0 0 0!important;"> <i class="fa fa-times"></i></button>  
                </div>
            </div>
        </div>
         <div class="card-body">
            ...
            success:function(rzpRes)
            {
                ...
                var options = {
                	...
                	"handler": function (response) {
                		$.ajax({
                		    url:'<?php echo base_url(); ?>user/savePersonalPayment',
                		    type:'get',
                		    success:function(res)
                		    {
                		        ...
                		        Swal.fire({
                                    ...
                                    location.href='<?php echo base_url(); ?>user/paymentExpiries?id='+paymentResponse.Id+'&redirect=<?php echo base_url(); ?>user/upload_personal_details?pn=5&type=personal';
                                })
                		    }
                		})
                	},
