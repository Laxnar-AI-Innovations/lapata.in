            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 1){ echo "d-none"; } ?>">
                        ...
                        <form id="loginForm" action="<?php echo base_url(); ?>NonKyc/postFamilyFunnelMember" method="post" class="row g-0 needs-validation1"  enctype="multipart/form-data">
                            <?php 
                                $csrf = array(
                            ...
                            <div class="card px-0">
                                <div class="hiddendiv">
                                    <div class="row align-items-center p-3">
                                        ...
                                        ?>
                                        <div class="form-floating mt-3 col-12 col-md-4" id="rel1Div">
                                            ...
                                            <label class="ms-2">Your Relation with family member <b class="text-danger">*</b></label>
                                        </div>
                                        ...
                                        <div class="form-floating mt-3 col-12 col-md-4">
                                        ...
                                        <div class="form-floating col-12 col-md-auto position-relative d-none">
                                            ...
                                            <input type="date" value="<?= $data[0]['dob']; ?>" class="form-control mt-2 custom-date-input md2" id="dob" name="dob" onchange="getAgeBand(this.value)" max="<?= date('Y-m-d') ?>">
                                ...
                                <div id="latestChild" class="accordion-collapse collapse px-0" aria-labelledby="latestHeading" data-bs-parent="#latestAccordion" style="background:aliceblue;">
                                    <div class="accordion-body py-0 pe-1 row align-items-center">
                                        <form id="step2Form" method="post" class="row g-1 mt-0 needs-validation1 w-100"  enctype="multipart/form-data">
                                            ...
                                            <?php
                                                $getLatestPhotos = $this->db->query('select * from funnelfamilyphotos where funnelId='.$data[0]['id'])->result_array();
                                                $j=0;
                                                for($i=0;$i<3;$i++)
                                                {
                                                    $j++;
                                ...
                                <div class="card-footer py-0">
                                    <div class="row justify-content-center">
                                        <div class="col-6 my-3 col-md-auto">
                                            <button type="button" onclick="location.href='<?= base_url(); ?>NonKyc/editFunnelFamilyDetails?pn=1&id=<?= $_GET['id']; ?>'" style="background:black!important;color:white!important;" class="btn w-100 btn-style-grey text-center disabled-on-loading"> Back</button>
                                        </div>
                                        <?php
                                            if($data[0]['Photo'] != NULL)
                                            {
                                        ?>
                                        <div class="col-6 my-3 col-md-auto">
                                            <button class="btn btn-primary w-100 btn-style-green disabled-on-loading" onclick="location.href='<?= base_url(); ?>NonKyc/editFunnelFamilyDetails?pn=3&id=<?= $_GET['id']; ?>'" type="button" style="background-color:  #05106c !important;">Next</button>
                                        </div>
                                        <?php }else{ ?>
                                        <div class="col-6 my-3 col-md-auto">
                    ...
                    <div id="step3" class="px-0 <?php if($pn != 3){ echo "d-none"; } ?>">
                        <?php 
                            $getPersonDetail = $this->db->query('select * from funnelfamily where id='.$data[0]['id'])->result_array();
                            $mobcount = 0;
...
<script>
            ...
            success:function(res)
            {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        location.href="<?php echo base_url(); ?>NonKyc/editFunnelFamilyDetails?id=<?php echo $data[0]['id'] ?>&pn=4";
                    }
                })
            }
        })
    ...
    {
        $(ele).attr('disabled',true);
        location.href="<?php echo base_url(); ?>NonKyc/manage_funnel_family";
    }
    ...
    function deletePhoto(crimeId,Id)
    {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                    $.ajax({
                    url:'<?php echo base_url(); ?>user/deleteFunnelFamilyPhoto/'+crimeId,
                    type:'get',
                    success:function(res)
                    {
    ...
    function uploadLatestPhoto(ele,index)
    {
        if($('#latestPhoto'+index).val() == '')
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>user/uploadFunnelFamilyPhoto',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
        ...
        if(type == 'old')
        {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url:'<?php echo base_url(); ?>NonKyc/deleteFunnelFamilyGold',
                        data:otpdata,
                        contentType: false,
                        cache: false,
                        processData:false,
    ...
    $('#btn3Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>NonKyc/editFunnelFamilyDetails?id=<?php echo $data[0]['id'] ?>&pn=2";
    })
    
    $('#btn2Next').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>NonKyc/editFunnelFamilyDetails?id=<?php echo $data[0]['Application_no'] ?>&pn=3";
    })
    ...
    function deleteFace(ele,index)
    {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                data.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
                $.ajax({
                    url:'<?php echo base_url(); ?>NonKyc/deleteFunnelFaceMatchFromFamily',
                    data:data,
                    contentType: false,
                    cache: false,
                    processData:false,
