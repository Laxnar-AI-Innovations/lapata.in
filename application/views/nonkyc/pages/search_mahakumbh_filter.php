...
<main id="main" class="main">
    <div id="coveredDiv" class="d-none w-100" style="background:transparent;position:relative;height:100vh;z-index:995;"></div>
    <?php 
        if($pn == 1)
        {
    ?>
    <div class="pagetitle">
      <h1 class="text-center"><span><img src="<?php echo base_url(); ?>assets/Prayagraj_Mahakumbh_2025_Logo-removebg-preview.png" style="width:50px;height:50px;"></span><b class="ms-3 text-danger">Enter </b>- <?php echo 'Mahakumbh'; ?> Person Details</h1>
    </div>
    <?php }else{ ?>
    <div class="pagetitle">
      <h1 class="text-start">Search General / Khoya Paya Details By Filter</h1>
    </div>
    <?php } ?>
                    ...
                    <form action="">
                        ...
                        <div class="row align-items-center">
                            <div class="form-group col-12 col-md-4 col-lg-6 mt-3 form-floating">
                                <input type="date" id="startFormDate" value="<?php echo date('Y-m-d',strtotime('-3 months')); ?>" max="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d',strtotime('-3 months')); ?>" class="form-control" name="startFormDate">
                                <label for="startFormDate" class="ms-2">From Date</label>
                            </div>
                            <div class="form-group col-12 col-md-4 col-lg-6 mt-3 form-floating">
                                <input type="date" id="endFormDate" value="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d',strtotime('-3 months')); ?>" max="<?php echo date('Y-m-d'); ?>" class="form-control" name="endFormDate">
                                <label for="endFormDate" class="ms-2">To Date</label>
                            </div>
                            <div class="form-group col-12 col-md-4 col-lg-6 mt-3 form-floating">
                            ...
                            <div class="col-md-4 col-lg-6">
                                <div class="row">
                                    <div class="form-group col-12 mt-3 form-floating">
                                        ...
                                        <label for="personFormName" class="ms-2">Enter Missing Person Name</label>
                                    </div>        
                                </div>    
                                <div class="row">
                            ...
                            <div class="col-md-4 col-lg-6">
                                ...
                                <div class="row">
                                    <div class="form-group col-12 mt-3">
                                        <select class="form-control select2" name="districtForm" id="districtForm">
    ...
    <div class="<?php if($pn != 2){ echo "d-none"; } ?>">
        <div class="row align-items-center">
            <div class="col-xl-auto col-lg-auto col-sm-12 col-8 col-md">
                <h6 class="text-center my-0"><b style="color:black;">Page:</b> <span style="color:black;"><?php echo ($_GET['pn'] == 2 ? $_GET['page'] : $_GET['page']); ?> out of <?= $last; ?></span></h6>
            </div>
        ...
        <div class="container-fluid px-0">
        	...
        	<div class="side-bar pt-1" >
             ...
             <!--   </div>-->
                ...
                <!--<hr>-->
        	    <div class="row">
        	        <h6><b class="text-danger">Enter - </b><b style="font-size:0.98rem;">KHOYA PAYA Details</b></h6>
        	        <div class="form-group col-12 col-md-12 col-lg-12 mt-0 form-floating">
                        <input type="date" id="startFilterDate" max="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d',strtotime('-3 months')); ?>" value="<?php echo $_GET['startFormDate']; ?>" class="form-control" name="startFilterDate">
                        <label for="startFilterDate" class="ms-2">Start Date</label>
                    </div>
                    <div class="form-group col-12 col-md-12 col-lg-12 mt-3 form-floating">
                        <input type="date" id="endFilterDate" max="<?php echo date('Y-m-d'); ?>" min="<?php echo date('Y-m-d',strtotime('-3 months')); ?>" value="<?php echo $_GET['endFormDate']; ?>" class="form-control" name="endFilterDate">
                    ...
                    <div class="form-floating mt-3 col-12">
                        <select class="form-control" name="gender" id="gender">
                            ...
                            <option value="Male" <?php echo (isset($_GET['genderForm']) ? ($_GET['genderForm'] == 'Male' ? 'selected' : '') : ''); ?>>Male</option>
                            <option value="Female" <?php echo (isset($_GET['genderForm']) ? ($_GET['genderForm'] == 'Female' ? 'selected' : '') : ''); ?>>Female</option>
            ...
            <div class="gallery px-0">
                <div class="image-container row" id="paginated-list">
                    <?php
                        ...
                        {
                    ?>
                        <div class="col-lg-4 col-md-6 px-0 px-md-2 col-12 col-search pb-2 pagination-items" data-matchingwords="<?= matchingCount($row['person_name'], $_GET['personFormName']); ?>" data-imageId="<?php echo $row['imageId']??"-" ?>" data-imageId1="<?php echo $row['imageId1']??"-" ?>" data-imageId2="<?php echo $row['imageId2']??"-" ?>" data-cat="<?php echo $row['DL_no']??"-" ?>" data-gender="<?php echo $row['Gender']??"" ?>" data-vehicle="<?php echo $row['vehicle_no']??"" ?>" data-aadhar="<?php echo $row['aadharNumber']??"" ?>" data-pan="<?php echo $row['PAN']??"" ?>" data-voter="<?php echo $row['voter_id']??"" ?>" data-dl="<?php echo $row['DL_no']??"" ?>" data-age="<?php echo $row['Age']??"" ?>" data-state="<?php echo $row['state']??"" ?>" data-district="<?php echo $row['district']??"" ?>" data-personname="<?php echo $row['person_name']??"" ?>"  data-search="<?php echo $row['DL_no']; ?><?php echo $row['aadharNumber']; ?><?php echo $row['PAN']; ?><?php echo $row['person_name']; ?><?php echo $row['Message']; ?>" >
                            <div class="card mb-3" >
                                ...
                                <div class="card-body px-0 h-100">
                                    <div class="row align-items-center px-0 mx-0 justify-content-center">
                                        <div class="col-9 px-1 text-center mb-2">
                                        	<?php 
		                                        if($row['uploadType'] == 'missing')
		                                        {
		                                    ?>
		                                    <h6 class="text-center text-danger mb-0">MISSING </h6>
		                                    <?php }else{ 
		                                        if($row['uploadType'] == 'general')
		                                        {
		                                    ?>
		                                    <h6 class="text-center text-danger mb-0">GENERAL</h6>
		                                    <?php }else{ ?>
		                                    <h6 class="text-center text-danger mb-0">APPEAL FOR IDENTIFICATION </h6>
		                                    <?php } } ?>
                                        </div>
                                        <div class="col-3 text-end mb-2">
                                            <button type="button" class="btn btn-primary" onclick="view('<?php echo ($row['userId'] != NULL ? 'user' : 'police'); ?>',this,'<?php echo $row['id']; ?>')" style="background:darkblue!important;color:white!important;padding:10px 15px;"><i class="fa fa-eye"></i></button>
                                        </div>
                                        <?php 
                                    	...
                                    	<?php }else{ ?>
                                    	<div class="col-10">
                                            <p class="mb-1"><b style="color:black;font-size:.8rem!important;font-weight:500;">Application No :- </b><b style="color:black;font-size:.8rem!important;"><?php echo 'MAH'.sprintf('%03d',$row['id']); ?></b></p>
                                        </div>
                                    	<?php } ?>
                                        <?php
				                            if($row['uploadType'] == 'general')
		                                ...
		                                <?php }else{ ?>
		                                <div class="col-5 ">
		                                    <img class="w-100" id="profile-pic" src="<?php echo base_url(); ?>assets/img/noimage.webp" style="height: 100px !important;" alt="">
		                                </div>
		                                <?php } ?>
                                        <div class="col-7 px-0">
                                            ...
                                            <?php if($row['AgeBnd'] != '' || $row['AgeBand'] != NULL){ ?>
                                                <p class="card-title text-start py-0 fs-6"><b style="color:black;font-size:.8rem!important;font-weight:500;">Age - </b><b style="font-size:.8rem!important;color:black;"><?php echo $row['AgeBand']??"--"?></b></p>
                                            <?php } ?>
                                        </div>
                                    </div>
...
<script>
	...
	{
	    location.href="<?php echo base_url(); ?>NonKyc/newSearchPerson";
	}
	...
	function payNow(ele)
	{
	    if($('#terms').is(':checked'))
	    {
    	    ...
    	    $.ajax({
    	        url:'<?php echo base_url(); ?>NonKyc/checkFacePayment?type=lapata',
    	        type:'get',
		                    ...
		                    $.ajax({
		                        ...
		                        success:function(rzpRes)
		                        {
		                            ...
		                            var options = {
		                            	...
		                            	"name": "Khoji",
		                            	"description": "Lapata Face Match",
		                            	"image": "<?php echo base_url(); ?>assets/images/khoji.webp",// COMPANY LOGO
		                            	"handler": function (response) {
		                            		$.ajax({
		                            		    url:'<?php echo base_url(); ?>NonKyc/saveFaceMatchPayment',
		                            		    data:{amount: parse.paymentAmount,type:'lapata','_token':'<?php echo $this->security->get_csrf_hash(); ?>'},
		                            		    type:'post',
		                            		    success:function(res)
		                            		    {
	...
	function checkFacePayment(ele)
	{
	    ...
	    $.ajax({
	        ...
	        success:function(res)
	        {
	            ...
	            if(parse.status == 'success')
	            {
	               // location.href="<?php echo base_url(); ?>NonKyc/search_person_details?pn=7&type=missing";
	               location.href="<?php echo base_url(); ?>user/manageGallery?type=missing";
	                swal.close();
	            }else{
	                $('#payModal').modal('show');
	                swal.close();
...
{
    window.open('<?php echo base_url(); ?>find-mahakumbh-special-person?id='+id,'_blank');
}
...
document.querySelector('.reset-btn .btn').onclick = () => {
	window.location.href="<?php echo base_url(); ?>NonKyc/search_mahakumbh_filter";
};
                ...
                success:function(res)
                {
                    ...
                    if(parse.status == 'success')
                    {
                        ...
                        galleryImages.forEach(img => {
                            ...
                            var filter1 = img.getAttribute('data-imageId1');
                            var filter2 = img.getAttribute('data-imageId2');
                    		if (parse.finalId.includes(filter) || parse.finalId.includes(filter1) || parse.finalId.includes(filter2)) {
                    		    count++;
