          ...
          <div class="row">
            ...
            <div class="col-xxl-3 col-md-auto">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Search By Face Photo</h5>

                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <a href="<?php echo base_url(); ?>non-kyc-funnel-facematch" onclick="checkIfFinal(this);return false;" class="text-success"><img src="<?= base_url(); ?>assets/khoyapayafront.png" class="img-fluid"></a>
                    </div>
                    <div class="ps-3">
                      <a href="<?php echo base_url(); ?>non-kyc-funnel-facematch" onclick="checkIfFinal(this);return false;" class="text-dark"><p style="font-size: 14px;font-weight: bold;">Search By Face Photo</p></a>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-xxl-3 col-md-auto">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Search By Identity</h5>

                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <a href="<?php echo base_url(); ?>NonKyc/search_person_by_identity" onclick="checkIfFinal(this);return false;" class="text-success"><img src="<?= base_url(); ?>assets/identityfront.png" class="img-fluid"></a>
                    </div>
                    <div class="ps-3">
                      <a href="<?php echo base_url(); ?>NonKyc/search_person_by_identity" onclick="checkIfFinal(this);return false;" class="text-dark"><p style="font-size: 14px;font-weight: bold;">Search By Identity</p></a>
                    </div>
                  </div>
                </div>
