...
<main id="main" class="main">
    ...
    <section class="section profile">
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body pt-3 table-responsive text-center">
                        <table class="table text-center table-bordered border border-danger table-striped datatable1 d-none">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Date</th>
                        ...
                        <h4 class="text-center text-danger mb-0"><b>This Feature is only available to KYC User.</b></h4>
                    </div>
                </div>
            </div>
        </div>
