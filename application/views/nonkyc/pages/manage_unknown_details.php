...
<main id="main" class="main">
    <div class="pagetitle row align-items-center">
        ...
        <div class="col-sm-12 text-end col-md-6 mb-3">
            <a href="<?= base_url(); ?>NonKyc/manageDraft?type=unknown" class="btn btn-primary save">Manage Draft</a>
        </div>
                            ...
                            <div class="card mb-3" >
                                <div class="card-body px-0 h-100 pb-0">
                                    ...
                                    <div class="row col-12 px-1 mx-0 pt-2 text-light" style="max-height:auto;background:green;">
                                        ...
                                        <p><b style="font-weight:500;">Want to upgrade your plan- <a href="<?php echo base_url(); ?>NonKyc/showUnknownPaymentModels?id=<?php echo $row['id']; ?>" class="text-white" style="text-decoration:underline;">Click here</a></b></p>
                                    </div>
                                    <?php }else{ ?>
                                    <div class="row col-12 px-1 mx-0 pt-2 text-light" style="max-height:auto;background:red;">
                                        ...
                                        <p><b style="font-weight:500;">Want to Renew Your Plan- <a href="<?php echo base_url(); ?>NonKyc/showUnknownPaymentModels?id=<?php echo $row['id']; ?>" class="text-white" style="text-decoration:underline;">Click here</a></b></p>
                                    </div>
                                    <?php } ?>
                                <?php }else{ ?>
                                    <?php 
...
function showColorAccordingly(isExpired,ele,id,appNo)
{
    if(ele.checked)
    {
        if(!isExpired)
        {
            ...
            location.href="<?php echo base_url(); ?>NonKyc/showUnknownPaymentModels?id="+id;
        }else{
            Swal.fire({
...
document.querySelector('#search-box').onchange = () => {
	...
	if(value != '')
	{
	    location.href="<?= base_url(); ?>NonKyc/manage_unknown_details?appNo="+value;   
	}else{
	    location.href="<?= base_url(); ?>NonKyc/manage_unknown_details";
	}
};
