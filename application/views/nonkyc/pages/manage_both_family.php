...
<main id="main" class="main">
    <div class="pagetitle row align-items-center">
        ...
        <div class="col-sm-12 text-end col-md-6 mb-3">
            <a href="<?= base_url(); ?>NonKyc/manageDraft?type=bothfamily" class="btn btn-primary save py-3">Manage Draft</a>
        </div>
    </div>
    <div>
                                        ...
                                        <div class="col-12 mb-2">
                                            <div class="row">
                                                ...
                                                <div class="col-5 col-md-6 col-lg col-xl-6 ms-auto mt-1 text-center text-md-end">
                                                    <button type="button" class="btn btn-dark" onclick="edit('<?= $row['type']; ?>',this,'<?php echo $row['id']; ?>')" style="background:black!important;color:white!important;padding:0.5rem 0.6rem;"><i class="fa fa-edit"></i></button>
                                                    ...
                                                    <button type="button" class="btn btn-primary" onclick="view('<?= $row['type']; ?>',this,'<?php echo $row['id']; ?>')" style="background:darkblue!important;color:white!important;padding:0.5rem 0.6rem;"><i class="fa fa-eye"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-5 ">
...
function showColorAccordingly(type,isExpired,ele,id,name)
{
