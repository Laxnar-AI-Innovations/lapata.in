                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 1){ echo "d-none"; } ?>">
                            ...
                            <div class="card-body mt-0">
                                <div class="row pt-0 pb-0" style="align-items:center;justify-content:space-between;">
                                    <div class="col-6 my-3">
                                        <h5 class="card-title pb-0 fs-4">Add Missing Person Details</h5>
                                    </div>
                        ...
                        <form id="loginForm" action="<?php echo base_url(); ?>user/lapatawith" method="post" class="row g-3 w-100 needs-validation1"  enctype="multipart/form-data">
                            ...
                            <div class="card mb-3 w-100 hiddendiv d-none">
                                 <div class="pt-0 pb-0">
                                    <h5 class="card-title text-center pb-0 fs-4 mb-3">Address Of Missing Person</h5>
                                </div>
                                <div class="card-body mt-0 pb-0">
                                    <div class="row align-items-center justify-content-center">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-auto col-sm-12 col-lg-auto">
                                        ...
                                        <label for="terms" style="display:inline;">
                                          ...
                                          <a href="<?= base_url(); ?>non-kyc-missing-terms" target="_blank" style="color:blue; text-decoration:underline;">Terms</a>, 
                        ...
                        <div class="card">
                            <div class="card-body py-3">
                                <div class="row mb-0 align-items-center">
                                    ...
                                    ?>
                                    <?php 
                                        $getIfAlready = $this->db->query('select * from uploadtransactions where type="lapata" and userId='.$_SESSION['user_id'].' and idNumber="'.$getPersonDetail[0]['aadharNumber'].'" and expiryDate >="'.date('Y-m-d').'"')->result_array();
                                    ?>
                                    <?php }else{ 
                                        $getIfAlready = array();
                                    } 
                                            ...
                                            <div class="col-md-12 text-center text-danger px-1 pb-3 p-3" style="font-weight:bold;">
                                                ...
                                                <div class="row justify-content-center" style="display:none;" id="shareDiv">
                                                    <div class="col-md col-sm-12 mb-3">
                                                        <button type="button" style="padding:0.5rem!important;" class="btn-style-four btn btn-primary d-block w-100 disabled-on-loading" onclick="share('without','<?= (isset($_SESSION['unknownId']) ? $getPersonDetail[0]['Application_no'] : 0); ?>')"> Share missing person detail's link without photo</button>
                                                    </div>
                                                    <div class="col-md col-sm-12 mb-3">
                                                        <button type="button" style="padding:0.5rem!important;" class="btn-style-five btn btn-primary d-block w-100 disabled-on-loading" onclick="share('with','<?= (isset($_SESSION['unknownId']) ? $getPersonDetail[0]['Application_no'] : 0); ?>')"> Share missing person detail's link with photo</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    function payNow(ele)
    {
        ...
        $.ajax({
            ...
            success:function(res)
            {
                location.href='<?php echo base_url(); ?>user/showPaymentModels?type=missing';
            }
        })
    }
