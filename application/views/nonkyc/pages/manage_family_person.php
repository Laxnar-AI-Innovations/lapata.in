...
<main id="main" class="main">
    <div class="pagetitle row align-items-center">
        ...
        <div class="col-sm-12 text-end col-md-6 mb-3">
            <a href="<?= base_url(); ?>NonKyc/manageDraft?type=family" class="btn btn-primary save py-3">Manage Draft</a>
        </div>
    </div>
    <div>
                            ...
                            <div class="card mb-3" >
                                <div class="card-body px-0">
                                    ...
                                    <div class="row col-12 px-1 mx-0 pt-2 text-light" style="max-height:auto;background:green;">
                                        ...
                                        <p><b style="font-weight:500;">Want to upgrade your plan- <a href="<?php echo base_url(); ?>NonKyc/showFamilyPaymentModels?id=<?php echo $row['id']; ?>" class="text-white" style="text-decoration:underline;">Click here</a></b></p>
                                    </div>
                                    <?php }else{ ?>
...
function showColorAccordingly(isExpired,ele,id,name)
{
    if(ele.checked)
    {
        if(!isExpired)
        {
            ...
            location.href="<?php echo base_url(); ?>NonKyc/showFamilyPaymentModels?id="+id;
        }else{
            Swal.fire({
