...
<main id="main" class="main">
    <div class="pagetitle">
        ...
        <?php }else{ 
            ...
            {
        ?>
        <h1>Search <?= ucFirst($_GET['type']) ?> Person By Face Photo</h1>
        <?php } } ?>
        <nav>
            <ol class="breadcrumb">
                <?php 
                ...
                <?php }else{ 
                    ...
                    {
                ?>
                <li class="breadcrumb-item active">Search <?= ucFirst($_GET['type']) ?> Person By Face Photo</li>
                <?php } } ?>
            </ol>
        </nav>
    </div>
    ...
    <section class="section profile">
        <div class="row justify-content-center">
                                ...
                                <div class="row">
                                    <div class="plans px-2 col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-lg-3 mt-0">
                                        <label class="plan basic-plan" for="type5">
                                            <input checked type="radio" value="5" name="type" id="type5" />
                                    ...
                                    <div class="plans px-2 px-lg-0  col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-lg-3 mt-0">
                                        <label class="plan basic-plan" for="type1">
                                            <input type="radio" value="2" name="type" id="type1" />
                                            <div class="plan-content">
                                    ...
                                    <div class="plans px-2 col-sm-12 col-md-6 col-lg-4 d-none col-xl-3 mt-lg-3 mt-0">
                                        <label class="plan basic-plan" for="appealData" style="width:100%;text-align: -webkit-center;">
                                            <input type="radio" value="appealData" name="type" id="appealData" />
                                            <div class="plan-content align-items-center" style="justify-content:space-between;">
                                                <img src="<?php echo base_url(); ?>assets_landing_page/img/missingunknown.png">
                                                <div class="plan-details">
                                                    <span style="max-width: 140px;">Search In Appeal For Identification Data</span>
                                                </div>
                                            </div>
                                        </label>
                                    </div>
                                    <div class="plans px-2 col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-lg-3 mt-0">
                                        <label class="plan basic-plan" for="type4">
                                            <input type="radio" value="lapata" name="type" id="type4" />
                                            <div class="plan-content">
                                                <img src="<?php echo base_url(); ?>assets_landing_page/img/missinglanding.png">
                                                <div class="plan-details">
                                    ...
                                    <div class="plans px-2 col-sm-12 col-md-6 col-lg-4 d-none col-xl-3 mt-lg-3 mt-0">
                                        <label class="plan basic-plan" for="typeMahakumbh" style="width:100%;">
                                            <input value="mahakumbh" type="radio" name="type" id="typeMahakumbh" />
                                            <div class="plan-content" style="justify-content:space-between;">
                                                <img src="<?php echo base_url(); ?>assets/Prayagraj_Mahakumbh_2025_Logo-removebg-preview.png">
                                                <div class="plan-details">
                                                    <span>Search Mahakumbh Filter</span>
                                                </div>
                                            </div>
                                        </label>
                                    </div>
                                    <div class="plans px-2 col-sm-12 col-md-6 d-none col-lg-4 col-xl-3 mt-lg-3 mt-0">
            ...
            <div class="col-xl-4 col-lg-4 col-sm-12 col-md-8 px-0 <?php if($pn != 2){ echo "d-none"; } ?>">
                <div class="card">
                    <div class="card-body mt-3 py-3 w-100 p-3">
                        <form class="row g-3 needs-validation <?php if($pn != 2){ echo "d-none"; } ?>" method="post" action="<?php echo base_url(); ?>NonKyc/checkPerson/step2" novalidate id="step2Form">
                            <?php 
                                $csrf = array(
            ...
            <div class="card col-lg-12 col-xl-12 col-sm-12 <?php if($pn != 5){ echo "d-none"; } ?>">
                ...
                <div class="card-body">
                    <form action="<?php echo base_url(); ?>NonKyc/filterDetailsAfterLogin" id="filterForm" method="post">
                        <div class="row mt-2">
        ...
        <form class="row g-3 needs-validation justify-content-center <?php if($pn != 7){ echo "d-none"; } ?>" method="post" action="<?php echo base_url(); ?>NonKyc/searchPersonFace" novalidate id="step7Form">
            <?php 
                $csrf = array(
                  'name' => $this->security->get_csrf_token_name(),
                  'hash' => $this->security->get_csrf_hash()
            ...
            <div class="card col-lg-4 col-md-8">
                <div class="card-header row align-items-center mx-0">
                    <div class="col-10 px-0">
                        <h6 class="headingFace text-center text-danger my-0" style="font-size:0.82rem;"><b>Upload Person's Face Photo</b></h6>
                    </div>
                    <div class="col-2">
                        <?php 
                        ...
                        <div class="text-end">
                            <?php 
                                ...
                                {
                            ?>
                            <a href="<?= base_url(); ?>non-kyc-dashboard-profile" style="padding: 1rem!important;" class="btn mt-0 btn-style-grey btn-dark disabled-on-loading"><i class="fa fa-arrow-circle-left"></i></a>
                            <?php }else{ ?>
                            <a href="<?= base_url(); ?>NonKyc/lapta_person_after_login" style="padding: 1rem!important;" class="btn mt-0 btn-style-grey btn-dark disabled-on-loading"><i class="fa fa-arrow-circle-left"></i></a>
                            <?php } ?>
                        </div>
                        <?php } ?>
                    </div>
...
<script type="text/javascript">
    ...
    $('.close1').click(function()
    {
        ...
        $('.headingFace').removeClass('d-none');
        $('#retakebtndiv').addClass('d-none');
        $('#mainPhotoUploaded').attr('src','<?php echo base_url(); ?>assets/images/faceicon.png');
    ...
    $('#filterForm').on('submit',function(e)
    {
        ...
        $.ajax({
            ...
            success:function(res)
            {
                ...
                if(parse.count > 0)
                {
                    location.href="<?php echo base_url(); ?>NonKyc/search_person_details?pn=6";   
                }else{
        ...
        if(count == 0)
        {
            ...
            $.ajax({
                ...
                success:function(res)
                {
                    ...
                    {
                        location.href="<?php echo base_url(); ?>NonKyc/search_person_details?pn=3";
                    }
                    else{
    ...
    function showAccordingly()
    {
        ...
        if(choice == undefined)
        {
            ...
            if(choice == 'appealData')
            {
                location.href="<?php echo base_url();?>NonKyc/search_person_details?pn=7&type=unknown";
            }else if(choice == 'mahakumbh')
            {
                location.href="<?php echo base_url();?>NonKyc/search_mahakumbh_filter";
            }
            ...
            {
                location.href="<?php echo base_url(); ?>NonKyc/search_vehicle_details";
                ...
                if(choice != 3)
                {
                    if(choice != 4)
                    {
                        if(choice != 5)
                        {
                            if(choice == 2)
                            {
                                location.href="<?php echo base_url(); ?>NonKyc/search_person_by_identity";         
                            }else{
                                location.href="<?php echo base_url(); ?>NonKyc/search_person_details?pn="+choice;         
                            }
                        }else{
                            if(choice == 5)
                            {
                                $.ajax({
                                    url:'<?php echo base_url(); ?>NonKyc/addFaceSearch',
                                    type:'get',
                                    success:function(res)
                                    {
                        ...
                        location.href="<?php echo base_url(); ?>NonKyc/search_person_details?pn=5";      
                    }
                }else{
                    if(choice != 4)
                    {
    ...
    }else if(gender == '')
    {
        ...
        $.ajax({
            url:'<?php echo base_url(); ?>NonKyc/filterDetailsAfterLogin',
            data:data,
            contentType: false,
            cache: false,
            processData:false,
...
<script>
    ...
    {
        resetButton.onclick = () => {
        	window.location.href="<?php echo base_url(); ?>NonKyc/search_person_details?pn=5";
        };
    }
            ...
            if($('input[name="gender"]').is(':checked'))
            {
                ...
                $.ajax({
                    <?php 
                        ...
                        {
                    ?>
                    url:'<?= base_url(); ?>NonKyc/searchPersonFaceNew',
                    <?php }else{ ?>
                    url:$(this).attr('action'),
                    <?php } ?>
                    data:data,
                            ...
                            $.ajax({
                                ...
                                success:function(res)
                                {
                                    <?php 
                                        ...
                                        {
                                    ?>
                                    location.href="<?php echo base_url(); ?>NonKyc/showPaymentGateway";      
                                    <?php }else{ ?>
                                        location.href="<?php echo base_url(); ?>NonKyc/completeFaceMatchResults?type=<?= $_GET['type']; ?>";
                                    <?php } ?>
                                }
                            })
                        }else{
