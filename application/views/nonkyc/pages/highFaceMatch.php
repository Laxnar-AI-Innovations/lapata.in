...
<main id="main" class="main">
    ...
    <div>
        <div class="container-fluid px-0">
            <form class="row g-3 needs-validation justify-content-center" method="post" action="<?php echo base_url(); ?>NonKyc/searchPersonHighUnknownFace" novalidate id="step7Form">
                <?php 
                    $csrf = array(
            ...
            if($('input[name="gender"]').is(':checked'))
            {
                ...
                $.ajax({
                    ...
                    success:function(res)
                    {
                        ...
                        {
                            location.href="<?php echo base_url(); ?>NonKyc/newHighFaceMatchResults";
                        }else{
                            $("#ajaxloader").addClass('d-none');
                            $('body').css('background-color','#fff');
                            $('body').css('visibility','visible');
