...
<main id="main" class="main px-2">
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>NonKyc">Home</a></li>
            ...
            <div class="col-xl-4 col-lg-4 col-sm-12 col-md-8 px-0 <?php if($pn != 1){ echo "d-none"; } ?>">
                <div class="card">
                    <div class="card-body mt-3 py-3 w-100 p-3">
                        <form class="row g-3 needs-validation <?php if($pn != 1){ echo "d-none"; } ?>" method="post" action="<?php echo base_url(); ?>NonKyc/checkPerson/step2" novalidate id="step2Form">
                            <?php 
                                $csrf = array(
                        ...
                        if(isset($_SESSION['searchId']))
                        {
                            ...
                            switch($checkDetail[0]['Idtype']){
                                ...
                                case 'pan' :
                                    ...
                                    $getKhoyaDetails = $this->db->query('select id from mahakumbhSpecial where isFound=0 and PAN="'.$checkDetail[0]['IdNumber'].'"')->result_array();
                                    if(count($getKhoyaDetails) > 0)
                                    {
                                        foreach($getKhoyaDetails as $k=>$v)
                                        {
                                ...
                                case 'voter' :
                                    ...
                                    $getKhoyaDetails = $this->db->query('select id from mahakumbhSpecial where isFound=0 and voter_id="'.$checkDetail[0]['IdNumber'].'"')->result_array();
                                    if(count($getKhoyaDetails) > 0)
                                    {
                                        foreach($getKhoyaDetails as $k=>$v)
                                        {
                                ...
                                case 'dl' :
                                    ...
                                    $getKhoyaDetails = $this->db->query('select id from mahakumbhSpecial where isFound=0 and DL_no="'.$checkDetail[0]['IdNumber'].'"')->result_array();
                                    if(count($getKhoyaDetails) > 0)
                                    {
                                        foreach($getKhoyaDetails as $k=>$v)
                                        {
                                ...
                                case 'vehicle' :
                                    ...
                                    $getKhoyaDetails = $this->db->query('select id from mahakumbhSpecial where isFound=0 and vehicle_no="'.$checkDetail[0]['IdNumber'].'"')->result_array();
                                    if(count($getKhoyaDetails) > 0)
                                    {
                                        foreach($getKhoyaDetails as $k=>$v)
                                        {
                                ...
                                <div class="card-header" style="background-color: white;border: 2px solid lightgrey;">
                                    <div class="row justify-content-center align-items-baseline">
                                        <div class="col-4 px-0">
                                            <h6 class="text-center text-gradient1 mb-1 fs-20" style="font-size: 0.7rem!important;">ભાદરવી પૂનમ મહામેળા</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body px-0 pt-0">
                                    ...
                                    <div class="row w-100 mx-0 mt-3 align-items-center">
                                        ...
                                        ?>
                                        <div class="col-12 ">
                                            <b style="font-size:.8rem!important;color:black;font-weight:500;">Contact To: - </b>
                                        </div>
                                        <div class="col-12 text-center">
                                            <?php 
                                                if(($row['well1'] != '' || $row['well1']!=null) || ($row['well2']!='' || $row['well2']!=null) && ($row['well3']!='' || $row['well3']!=null))
...
<script type="text/javascript">
    ...
    $('#btnInactiveSave').click(function()
    {
        if($('#mainPhotoSelected').val() != '')
        {
            ...
            if(count == 0)
            {
                ...
                $.ajax({
                    url:'<?php echo base_url(); ?>NonKyc/checkInactiveInfoAfterLogin',
                    data:data,
                    contentType: false,
                    cache: false,
                    processData:false,
    ...
    $('#step2CheckAadhar').click(function()
    {
        ...
        if(count == 0)
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>NonKyc/checkPersonIdAfterLogin',
                data:data,
                processData:false,
                cache:false,
                contentType:false,
                            ...
                            if(parse.isVisible == '1')
                            {
                                if(parse.isCriminal == 1)
                                {
                                    if(parse.isRegistered == 0 && parse.isMissing == 1)
                                    {
                                     ...
                                     }else if(parse.isRegistered == 1 && parse.isMissing == 1)
                                     {
                                        Swal.fire({
                                         ...
                                         html += '<div class="form-group mt-3 '+(parse.isCriminal ? '' : 'd-none')+'"><label style="font-weight:bolder;font-size: 17px!important;color:#D84315!important;border:1px solid;padding:10px;background:lavenderblush;border-radius:20px;" class="text-danger">Criminal Record :- <a href="<?php echo base_url(); ?>NonKyc/criminalRecordAfterLogin" class="text-success" style="text-decoration:underline;" target="_blank">View</a></label></div><div class="form-group mb-0"><label style="font-weight:bolder;font-size: 17px!important;color:red!important;" class="text-danger">'+typeLabel+'</label></div>';
                                         if(parse.personName != '')
                                         {
                                    ...
                                    if(parse.isRegistered == 0 && parse.isMissing == 1)
                                    {
                                     ...
                                     }else if(parse.isRegistered == 0 && parse.isKhoya == 1)
                                     {
                                        let typediv = '';
                                         if(typeLabel != '</b>')
                                         {
                                        ...
                                        Swal.fire({
                                            allowOutsideClick:false,
                                            html:
                                                '<div class="form-group"><img src="<?php echo base_url(); ?>assets/images/verified.webp" style="height:50px;width:100px;border: 2px solid #bdbdbd;border-radius:15px;"></div><div class="form-group"><img src="'+parse.image+'" style="height:200px;width:200px;border: 2px solid #bdbdbd;border-radius:15px;"></div>'+typediv+'<div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><i class="fa fa-check-circle text-danger"></i> <b style="color:black;">Person Name :- </b>'+parse.personName+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Aadhar :- </b>'+parse.aadhar+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;text-transform:capitalize;"><b style="color:black;">Gender :- </b>'+parse.gender+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Age :- </b>'+parse.age+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Address :- </b>'+parse.address+'</label></div><div class="form-group mb-2"><label style="font-weight:bold;color:black;">To get More Details</label></div><div class="form-group mb-2"><button type="button" class="btn btn-primary next disabled-on-loading" onclick="redirectToStep2(0,'+parse.personId+')"> Click Here</button></div>',
                                            showCloseButton: true,
                                            showCancelButton: false,
                                            focusConfirm: false,
                                            showConfirmButton:false
                                ...
                                if(parse.isWanted == 1 || parse.isCriminal == 1)
                                {
                                    if(parse.isRegistered == 0 && parse.isMissing == 1)
                                    {
                                         ...
                                         if(parse.isVerified == 1)
                                         {
                                             ...
                                             html = '<div class="form-group"><img src="'+parse.image+'" style="height:200px;width:200px;border: 2px solid #bdbdbd;border-radius:15px;"></div><div class="form-group mb-0 '+(parse.isCriminal ? '' : 'd-none')+'"><label style="font-weight:bolder;font-size: 17px!important;color:#D84315!important;border:1px solid;padding:10px;background:lavenderblush;border-radius:20px;" class="text-danger">Criminal Record :- <a href="<?php echo base_url(); ?>NonKyc/criminalRecordAfterLogin" class="text-success" style="text-decoration:underline;" target="_blank">View</a></label></div><div class="form-group mb-0"><label style="font-weight:bolder;font-size: 17px!important;color:red!important;" class="text-danger">'+typeLabel+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><i class="fa fa-check-circle text-danger"></i> <b style="color:black;">Person Name :- </b>'+parse.personName+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Aadhar :- </b>'+parse.aadhar+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;text-transform:capitalize;"><b style="color:black;">Gender :- </b>'+parse.gender+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Age :- </b>'+parse.age+'</label></div><div class="form-group mb-2"><label class="form-label" style="font-size:16px!important;"><b style="color:black;">Address :- </b>'+parse.address+'</label></div><div class="form-group mb-2"><label style="font-weight:bold;color:black;">To get More Details</label></div><div class="form-group mb-2"><button type="button" class="btn btn-primary next disabled-on-loading" onclick="openCameraPopup()"> Click Here</button></div>';
                                         }
                                         Swal.fire({
                                            allowOutsideClick:false,
                                            html: html,
        ...
        if(count == 0)
        {
            ...
            $.ajax({
                ...
                success:function(res)
                {
                    ...
                    {   
                        $('#step2CheckVehicle').removeAttr('disabled');
                        window.open('<?php echo base_url(); ?>NonKyc/search_person_by_identity?pn=2','_blank');
                    }
                    else
                    {
                        if(parse.status == 'error')
    ...
    function redirectToStep2(type,id)
    {
        if(type)
        {
            ...
            $.ajax({
                url:'<?= base_url(); ?>NonKyc/createOverallHistory',
                success:function(res)
                {
                    window.open('<?php echo base_url(); ?>NonKyc/search_person_by_identity?pn=2','_blank');      
                }
