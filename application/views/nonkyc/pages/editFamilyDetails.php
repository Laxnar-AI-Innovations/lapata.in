            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 1){ echo "d-none"; } ?>">
                        ...
                        <form id="loginForm" action="<?php echo base_url(); ?>NonKyc/postFamilyMember" method="post" class="row g-0 needs-validation1"  enctype="multipart/form-data">
                            <?php 
                                $csrf = array(
                            ...
                            <div class="row align-items-center accordion w-100 mt-1 mx-0" id="latestAccordion">
                                <div class="accordion-item px-0 mx-1">
                                    <h2 class="accordion-header" id="latestHeading">
                                        <a class="accordion-button <?= count($getLatestPhotos) > 0 ? '' : 'collapsed'; ?>" type="button" data-bs-toggle="collapse" data-bs-target="#latestChild" aria-expanded="<?= count($getLatestPhotos) == 0 ? 'false' : 'true'; ?>" style="background:white;" aria-controls="latestChild">
                                            <b>Add Other General Photos</b>
                                      </a>
                                    </h2>
                                </div>
                                <div id="latestChild" class="accordion-collapse collapse <?= count($getLatestPhotos) == 0 ? '' : 'show'; ?> px-0" aria-labelledby="latestHeading" data-bs-parent="#latestAccordion" style="background:aliceblue;">
                                                ...
                                                <div class="card-body p-4">
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-lg-4 col-sm-12 col-md-6 px-0">
                                                            ...
                                                            <div class="row mt-3 d-none justify-content-center align-items-end" id="reUploadBtn<?php echo $i; ?>">
                                ...
                                <div class="card-footer py-0">
                                    <div class="row justify-content-center">
                                        <div class="col-6 my-3 col-md-auto">
                                            <button type="button" onclick="location.href='<?= base_url(); ?>NonKyc/editFamilyDetails?pn=1&id=<?= $_GET['id']; ?>'" style="background:black!important;color:white!important;" class="btn w-100 btn-style-grey text-center disabled-on-loading"> Back</button>
                                        </div>
                                        <?php
                                            if($data[0]['Photo'] != NULL)
                                            {
                                        ?>
                                        <div class="col-6 my-3 col-md-auto">
                                            <button class="btn btn-primary w-100 btn-style-green disabled-on-loading" onclick="location.href='<?= base_url(); ?>NonKyc/editFamilyDetails?pn=3&id=<?= $_GET['id']; ?>'" type="button" style="background-color:  #05106c !important;">Next</button>
                                        </div>
                                        <?php }else{ ?>
                                        <div class="col-6 my-3 col-md-auto">
                                            ...
                                            <div class="col-md-12 text-center text-danger px-1 pb-3 p-3" style="font-weight:bold;">
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-lg-4 mb-3 col-sm-12 col-md-4">
                                                        <button type="button" class="btn-style-green btn btn-primary d-block w-100 disabled-on-loading" onclick="location.href='<?= base_url(); ?>NonKyc/add_family_member'"> Add Another Member <i class="fa fa-user-plus"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    $('#btn3Next').click(function(){
        ...
        $.ajax({
            url:'<?php echo base_url(); ?>NonKyc/familySubmit',
            type:'post',
            processData:false,
            contentType:false,
            data:data,
            ...
            success:function(res)
            {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        location.href="<?php echo base_url(); ?>NonKyc/editFamilyDetails?id=<?php echo $data[0]['id'] ?>&pn=4";
                    }
                })
            }
        })
    ...
    {
        $(ele).attr('disabled',true);
        location.href="<?php echo base_url(); ?>NonKyc/manage_both_family";
    }
                                        ...
                                        $.ajax({
                                            ...
                                            success:function(res)
                                            {
                                                ...
                                                if(parse.status == 'success')
                                                {
                                                    ...
                                                    $.ajax({
                                                        url:'<?php echo base_url(); ?>NonKyc/addFamilyFaceMatchPhoto',
                                                        data:faceData,
                                                        contentType: false,
                                                        cache: false,
                                                        processData:false,
    ...
    $('#btn3Back').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>NonKyc/editFamilyDetails?id=<?php echo $data[0]['id'] ?>&pn=2";
    })
