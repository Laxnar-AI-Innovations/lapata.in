...
<main id="main" class="main">
    <div class="pagetitle row align-items-center">
        ...
        <div class="col-sm-12 text-end col-md-6 mb-3">
            <a href="<?= base_url(); ?>NonKyc/manageDraft?type=funnelmissing" class="btn btn-primary save py-3">Manage Draft</a>
        </div>
    </div>
    <div>
            ...
            <div class="gallery px-0">
                <div class="image-container row">
                    <?php
                        foreach($data as $row)
                        {
                            $getGoldDetails = $this->db->query('select * from funnelpersongold where funnelId='.$row['id'])->result_array();
                            $goldHUID = array();
                            $goldType = array();
                            ...
                            $isActive = '';
                            $status = 'Inactive';
                            $getLastTransaction = $this->db->query('select * from funneltransactions where userId='.$_SESSION['user_id'].' and paymentType="missing" order by Id desc')->result_array();
                                        ...
                                        <div class="col mb-2">
                                            <div class="row">
                                                ...
                                                <div class="col col-md-6 col-lg col-xl-6 ms-auto mt-1">
                                                    ...
                                                    <button type="button" class="btn btn-primary" onclick="view(this,'<?php echo $row['Application_no']; ?>')" style="background:darkblue!important;color:white!important;padding:0.5rem 0.6rem;"><i class="fa fa-eye"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-10">
...
function checkApp(ele)
{
	...
	if(value != '')
	{
	    location.href="<?= base_url(); ?>NonKyc/manage_funnel_missing?appNo="+value;   
	}else{
	    location.href="<?= base_url(); ?>NonKyc/manage_funnel_missing";
	}
}
                            ...
                            <div class="card mb-3" >
                                <div class="card-body px-0">
                                    ...
                                    ?>
                                        ...
                                        <div class="row col-12 px-1 mx-0 pt-2 text-light" style="max-height:auto;background:green;">
                                            <p class="mb-1"><b style="font-weight:500;">Plan Expiring on Date- <?php echo date('d/m/Y',strtotime($getLastTransaction[0]['expiryDate'])); ?></b></p>
                                            <p><b style="font-weight:500;">Want to upgrade your plan- <a href="<?php echo base_url(); ?>NonKyc/showPaymentModels?id=<?php echo $row['id']; ?>" class="text-white" style="text-decoration:underline;">Click here</a></b></p>
                                        </div>
                                        <?php }else{ ?>
                                        <div class="row col-12 px-1 mx-0 pt-2 text-light" style="max-height:auto;background:red;">
                                            <p class="mb-1"><b style="font-weight:500;">Plan Already Expired on- <?php echo date('d/m/Y',strtotime($getLastTransaction[0]['expiryDate'])); ?></b></p>
...
function checkApp(ele)
{
	...
	if(value != '')
	{
	    location.href="<?= base_url(); ?>NonKyc/manage_lapata?appNo="+value;   
	}else{
	    location.href="<?= base_url(); ?>NonKyc/manage_lapata";
	}
}
