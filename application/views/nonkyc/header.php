...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <a class="nav-link nav-icon" href="<?= base_url(); ?>NonKyc/view_all_notifications">
            <i class="bi bi-bell"></i>
            <?php 
                $getCount = $this->db->query('select * from nonKycNotification where status="Active" and userId='.$_SESSION['user_id'])->result_array();
                $getSearchCount = $this->db->query('select * from searchnotification where status="Active" and complainantUserType="NonKyc" and complainantUserId='.$_SESSION['user_id'].' order by Id desc')->result_array();
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications" style="max-height:300px;overflow:auto;">
            <li class="dropdown-header">
              ...
              <a href="<?= base_url(); ?>NonKyc/view_all_notifications"><span class="badge rounded-pill bg-primary p-2 ms-2">View all</span></a>
            </li>
            <?php 
            ...
            <li class="dropdown-footer">
              <a href="<?= base_url(); ?>NonKyc/view_all_notifications">Show all notifications</a>
            </li>
            <?php } ?>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?php echo $getUserDetail[0]['aadharname']; ?></h6>
            </li>
            <li>
              <hr class="dropdown-divider">
            </li>
            ...
            ?>
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url(); ?>NonKyc">
            ...
            ?>
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url(); ?>NonKyc/profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url(); ?>NonKyc/view_all_notifications">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url(); ?>NonKyc/logout">
  ...
  <script>
        function openNotification(type,Id)
        {
            if(type == 'search')
            {
                location.href="<?php echo base_url(); ?>NonKyc/openSearchNotification/"+Id;      
            }else{
               location.href="<?php echo base_url(); ?>NonKyc/openNotification/"+Id;
            }
        }
  </script>