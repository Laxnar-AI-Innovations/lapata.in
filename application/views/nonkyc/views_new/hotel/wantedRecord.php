            ...
            <div class="row justify-content-center align-items-center">
                <div class="card mb-1 w-100">
                    <div class="card-body p-3">
                        <div class="pb-0">
                            <h5 class="card-title mb-0 text-center pb-0 pt-0 text-danger">Wanted Records</h5>
                        </div>
                    </div>
                </div>
                <?php 
                                ...
                                <div class="col-lg-6 col-xl-6 col-sm-12 col-md-6">
                                    ...
                                    <div class="row border border-2 border-dark mb-3">
                                        <div class="col-lg-12 col-sm-12 col-md-12">
                                            <h5 class="text-danger"><b class="text-dark">Person Name - </b><?php echo (count($getUserDetail) > 0 ? $getUserDetail[0]['aadharname'] : $v['personName']); ?></h5>
                                    ...
                                    <?php } ?>
                                    <?php 
                                        if(count($getUserDetail) > 0 || $v['rewardAmount'] != NULL)
                                        {
                                    ?>
                                    <div class="row border border-2 border-dark mb-3 py-3">
                                        <div class="col-lg-12 col-sm-12 col-md-12">
                                            <h5 class="text-danger mb-0"><b class="text-dark">Reward Amount- </b><?php echo (count($getUserDetail) > 0 ? 'Rs.'.$v['rewardAmount'] : ''); ?></h5>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    <div class="row mb-3">
