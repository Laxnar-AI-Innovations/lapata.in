...
<style>
  ...
  <main>
    <div class="container">
      ...
      <section class="section register min-vh-70 d-flex flex-column justify-content-center my-5">
        <div class="container">
                ...
                <div class="card-body">
                    ...
                    <div id="gstdiv">
                        <div class="form-floating mb-3 col-auto">
                          <input type="text" class="form-control text-uppercase" onkeydown="limit(this,'gst');" onkeyup="limit(this,'gst');" name="gstNumber" id="gstNumber" required placeholder="GST Number">
