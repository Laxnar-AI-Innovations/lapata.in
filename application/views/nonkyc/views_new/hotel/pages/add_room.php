...
<main id="main" class="main">
    ...
    <section class="section profile">
      <div class="row justify-content-center">
        ...
        <div class="col-xl-5 col-lg-5 col-sm-12 col-md-8 px-0 <?php if($pn != 2){ echo "d-none"; } ?>">
            <div class="card">
    ...
    $('#btnInactiveSave').click(function()
    {
        if($('#mainPhotoSelected').val() != '')
        {
            ...
            $.ajax({
                ...
                success:function(res)
                {
                    location.href="<?php echo base_url(); ?>hotel/hotelEntry?pn=3";
                }
            })
        }else{
        ...
        $.ajax({
            ...
            success:function(res)
            {
                Swal.fire({
                    ...
                    location.href="<?php echo base_url(); ?>hotel/hotelEntry?pn=1";
                })
            }
        })
    }
    ...
    function checkLength(val,limit)
    {
        ...
        function showAccordingly()
        {
            ...
            if(choice == undefined)
            {
                ...
                if(choice == 2)
                {
                    location.href="<?php echo base_url(); ?>hotel/hotelEntry?pn="+choice;      
                }else{
                    openCameraPopup();
                }
            }
