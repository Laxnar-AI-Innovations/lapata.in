                ...
                <div class="card-body">
                    ...
                    <div id="mobilediv">
                        ...
                        <div class="form-group col-auto">
                            <button type="button" onclick="getRegistered('mobile')" class="btn btn-primary btn-style-grey disabled w-100" id="btnmobileNext">Next <i class="fa fa-arrow-circle-right"></i></button>
                        </div>
                    </div>
