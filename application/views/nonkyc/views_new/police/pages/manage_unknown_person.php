        ...
        <div class="container-fluid px-0">
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-12">
                    <h2 class="text-center my-0 text-danger"><b><span id="personcount"><?php echo (count($data) != 0 ? ((count($data) > 1) ? (count($data).' Persons') : (count($data).' Person')) : 'NO Complaints'); ?></span> Found...</b></h2>
                </div>
            </div>
                            ...
                            <div class="card mb-3 shiva_height" >
                                <div class="card-body px-0">
                                    <div class="row align-items-center px-0 mx-0 justify-content-center">
                                        ...
                                        <div class="col mb-2">
                                            <div class="row">
                                                <div class="col col-md-auto col-lg col-xl-auto mt-3">
                                                    <div class="form-check form-switch">
                                                      <input class="form-check-input" type="checkbox" onclick="showColorAccordingly(this,<?= $row['id']; ?>)" id="<?= $row['id']; ?>" <?= $isActive; ?>>
                                                      <label class="form-check-label" for="<?= $row['id']; ?>"><b id="statusColor<?= $row['id']; ?>" class="<?php echo ($isActive == '' ? 'text-danger' : 'text-success'); ?>">Complaint Status</b></label>
                                                    </div>  
                                                </div>
                                                <div class="col col-md-auto col-lg col-xl-auto ms-auto">
                                                    <button type="button" class="btn btn-dark" onclick="edit(this,'<?php echo $row['Application_no']; ?>')" style="background:black!important;color:white!important;padding:10px 15px;"><i class="fa fa-edit"></i></button>
    ...
    function showColorAccordingly(ele,id)
    {
        if(ele.checked)
        {
            ...
            Swal.fire({
                ...
                allowOutsideClick:false,
                html:
                    '<div class="form-group mt-3"><label class="form-label" style="font-size:17px!important;">Are you sure you want to de-activate complaint?</label></div>',
                showCloseButton: true,
                showCancelButton: true,
                confirmButtonText:'Yes',
                cancelButtonText:'No',
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success:function(res)
                        {
                            toastr.success('complaint de-activated successfully');
                            setTimeout(function()
                            {
                                location.reload();
                            },2000);
