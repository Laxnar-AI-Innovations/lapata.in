...
<main id="main" class="main">
    <div class="pagetitle">
      <h1>Add Person By Filter</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>police">Home</a></li>
          <li class="breadcrumb-item active">Add Person By Filter</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 1){ echo "d-none"; } ?>">
                        <div class="card mb-3 w-100">
                            <div class="card-body mt-0">
                                <div class="pt-0 pb-0">
                                    <h5 class="card-title text-center pb-0 fs-4 mb-0">Add Person By Filter</h5>
                                </div>
                                <div>
                                    <!--Success message-->
                                    <?php 
                        ...
                        <form id="loginForm" action="<?php echo base_url(); ?>police/saveFilteredPerson" method="post" class="row g-3 needs-validation1"  enctype="multipart/form-data">
                            <?php 
                                $csrf = array(
                            ...
                            <div class="card mb-3 w-100">
                                <div class="pt-0 pb-0">
                                    <h5 class="card-title text-center pb-0 fs-4 mb-0">Upload Photo & Message </h5>
                                </div>
                                <div class="card-body mt-0 pb-0">
                                    <div class="row align-items-center justify-content-center">
                                        <div class="col-lg-4 col-md-4 my-3 col-12 text-center">
                                            <div style="position:relative;text-align:center;">
                                                <img class="w-100" id="profile-pic" src="<?php echo base_url(); ?>assets/img/logo.png" style="height: 152px!important;border: 1px solid;" alt="">
                                                <div style="position:absolute;z-index:2;box-shadow:0px 1px 1px 2px;background:black;color:white;top:0px;right:72px;padding:0.4rem 0.7rem;cursor:pointer;" class="d-none" id="crossIcon">
                                            ...
                                            <input type="file" name="Photo" id="input-file" style="display: none;" >
                                        </div>
                                        <div class="form-floating mb-3 col-12 col-md-6">
                                          <textarea class="form-control" rows="50" style="height: 96px;"  id="Message" name="Message" placeholder="Enter The Package Feture.."></textarea>
                                              <label for="pkgdur" class="ms-3">Message</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 2){ echo "d-none"; } ?>">
                        ...
                        <form id="step2Form" method="post" class="row g-1 needs-validation1 w-100"  enctype="multipart/form-data">
                            ...
                            ?>
                            <?php
                                $getLatestPhotos = $this->db->query('select * from filterphotos where unknownId='.$_SESSION['filterId'])->result_array();
                                $j=0;
                                for($i=0;$i<5;$i++)
                                {
                                    $j++;
                                        ...
                                        <div class="col-lg-4 col-sm-12 col-md-6 px-0">
                                            <div class="row border border-secondary mx-0 p-3" style="border-radius:15px;border-color:lightgrey!important;">
                                                ...
                                                <div class="col-lg-auto col px-0">
                                                    ...
                                                    <?php 
                                                        $split = explode('upload/personfilter/',$getLatestPhotos[$i]['photourl']);
                                                    ?>
                                                    <div class="row">
                                                        <div class="col-lg-12 col-sm-12 col-md-12">
                    ...
                    <div id="step3" class="<?php if($pn != 3){ echo "d-none"; } ?>">
                        <?php 
                            $getPersonDetail = $this->db->query('select * from personfilter where id='.(isset($_SESSION['filterId']) ? $_SESSION['filterId'] : 0))->result_array();
                        ?>
                        <?php 
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-0 pb-0">Add person contact number</h5>
                                <?php 
                            ...
                            <div class="card-body py-3">
                                <div class="row my-3 align-items-end">
                                    <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
                                        ...
                                        <select class="form-control select2" <?php if($getPersonDetail[0]['well'.$i] != NULL) { echo "disabled"; } ?> id="wellrel<?php echo $i; ?>" name="wellrel<?php echo $i; ?>" required>
                                            <?php 
                                            ...
                                            <?php 
                                                ...
                                                {
                                            ?>
                                            <option value="<?php echo $v['Id']; ?>" <?php if($v['Id'] == $getPersonDetail[0]['wellrel'.$i]){ echo "selected"; } ?>><?php echo $v['relationName']; ?></option>
                                            <?php } } ?>
                                        </select>
                                    </div>
                                    <div class="col-lg-auto col-md-auto col-sm-12 mb-3 <?php echo (($getPersonDetail[0]['wellrel'.$i] != 23) ? 'd-none' : '') ?>" id="otherrelationdiv<?php echo $i; ?>">
                                        <label class="form-label">Enter Other Relation</label>
                                        <input type="text" disabled value="<?php echo (($getPersonDetail[0]['wellrel'.$i] == 23) ? $getPersonDetail[0]['otherrelationname'.$i] : '') ?>" class="form-control" placeholder="Enter Other Relation" name="otherrelation<?php echo $i ?>" id="otherrelation<?php echo $i ?>">
                                    </div>
                                    ...
                                    <div class="col-lg-3 mb-2 <?php if($getPersonDetail[0]['wellrel'.$i] != NULL) { echo "d-none"; } ?>" id="sendOtpDiv<?php echo $i; ?>">
                        ...
                        <div class="card">
                            <div class="card-body py-3">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-12 mb-3" id="rel<?php echo $i; ?>Div">
                                    <label class="form-label">Select Relation</label>
                                    <select class="form-control select2" onchange="showAccordingly(this.value,<?php echo $i; ?>)" <?php if($getPersonDetail[0]['wellrel'.$i] != NULL) { echo "disabled"; } ?> id="wellrel<?php echo $i; ?>" name="wellrel<?php echo $i; ?>" required>
                                        <?php 
                                            if(count($getRelations) > 0)
                                            {
                                        ?>
                        ...
                        <div class="card">
                            <div class="card-body py-3">
                                <div class="row mb-0 align-items-center">
                                    ...
                                    <div class="col-sm-12 col-md-auto col-lg-auto mt-1 mb-1">
                                        <button type="button" id="btn3Dashboard" class="btn btn-dark disabled-on-loading w-100 btn-style-green"> Go To Dashboard</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    function uploadLatestPhoto(ele,index)
    {
        if($('#latestFile'+index).val() == '')
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>police/uploadFilteredPhoto',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
    ...
    $('#crossIcon').click(function()
    {
        ...
        profile.src='<?php echo base_url(); ?>assets/img/logo.png';
    })
    ...
    {
        if($('#Gender').val() == '' && $('#Age').val() == '' && $('#input-file')[0].files.length == 0)
        {
    ...
    $('#btn3Back').click(function(){
        ...
        location.href="<?php echo base_url(); ?>police/upload_person_filter?pn=2";
    })
    ...
    $('#btn2Next').click(function(){
        $(this).attr('disabled','disabled');
        location.href="<?php echo base_url(); ?>police/upload_person_filter?pn=3";
    })
    ...
    function verifyDeleteOtp(ele,index,setting)
    {
        ...
        if(otp != '')
        {
            ...
            data.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
            $.ajax({
                url:'<?php echo base_url(); ?>police/deleteFilterPersonMobile',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
    ...
    function resendDeleteOtp(ele,index)
    {
        ...
        $.ajax({
            url:'<?php echo base_url(); ?>police/sendDeleteFilterPersonOtp',
            data:otpdata,
            contentType: false,
            cache: false,
            processData:false,
    ...
    function deleteAlternate(ele,index,setting)
    {
        ...
        {
            Swal.fire({
                title: '<strong class="text-danger" style="font-size:20px;">Filter Person Contact</strong>',
                icon: 'error',
                allowOutsideClick:false,
                html:
                    '<div class="form-group mt-3"><label class="form-label">Are you sure you want to delete filter person mobile '+index+'?</label></div>',
                showCloseButton: true,
            ...
            Swal.fire({
                title: '<strong class="text-danger" style="font-size:20px;">Filtered Person Contact</strong>',
                icon: 'error',
                allowOutsideClick:false,
                html:
                    '<div class="form-group mt-3"><label class="form-label">Are you sure you want to delete filter person mobile '+index+'?</label></div>',
        ...
        if($('#otp'+index).val() != '')
        {
            ...
            if( relation != '')
            {
                if(relation != 23)
                {
                    ...
                    $.ajax({
                      url:'<?php echo base_url(); ?>police/verifyFilterPersonMobileOtp',
                      data:data,
                      contentType: false,
                      cache: false,
                      processData:false,
        ...
        if($('#othermob'+index).val() != '')
        {
            ...
            if( relation != '')
            {
                if(relation != 23)
                {
                    ...
                    $.ajax({
                        url:'<?php echo base_url(); ?>police/sendFilterPersonMobileOtp',
                        data:data,
                        contentType: false,
                        cache: false,
                        processData:false,
