...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Welcome, <span class="text-success"><?php echo $_SESSION['thanaName']; ?></span></h1>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 px-0">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body w-100">
              ...
              <div class=" pb-0">
                <h5 class="card-title text-center pb-0 fs-4">Your profile page</h5>
                <p class="text-center small">Enter your personal details to get verified</p>
              </div>
                <div class="tab-content">
                    <?php $getProfileDetail = $this->db->query('select * from police where police_id='.$_SESSION['police_id'])->result_array(); ?>
                    <div class="tab-pane fade profileTab active show" id="profileTab">
                       
                        <hr class="mb-4">
                        <form class="row g-3" method="post" action="<?php echo base_url(); ?>police/step2/do_register" id="registerForm">
                    <?php 
                      $csrf = array(
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
                          <label for="registration_mobile" class="form-label">S.H.O (C.U.G No.)</label>
                          <input type="text" name="registration_mobile" readonly class="form-control" id="registration_mobile" required value="<?php echo $getProfileDetail[0]['registration_mobile']; ?>">
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
                          <label for="thanaName" class="form-label">Police Thana Name</label>
                          <input type="text" name="thanaName" class="form-control" readonly id="thanaName" value="<?php echo $getProfileDetail[0]['thanaName']; ?>">
                          <div class="invalid-feedback">Please enter a valid Thana</div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 mb-3">
                          ...
                          <input type="email" name="email" class="form-control" id="email" value="<?php echo $getProfileDetail[0]['email']; ?>">
                    ...
                    <div class="row mb-3 d-none" id="other1div">
                        ...
                        <div class="form-group col-8" style="margin-top: 0.5rem;">
                            <button class="btn btn-primary btn-style-grey disabled disabled-on-loading" id="btnOtp1" onclick="sendOtp(1)" type="button"> Send OTP</button>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-10 mb-0">
                            ...
                            <input readonly value="<?php echo $getProfileDetail[0]['alternate_mobile2']; ?>" type="number" name="alternatemob2" class="form-control mb-2" id="alternatemob2">
                        </div>
                        <div class="col-2 mb-2">
                    ...
                    <div class="row mb-3 d-none" id="other2div">
                        <label for="othermob2" class="col-md-12 col-lg-12 col-form-label"><b>Enter New Mobile Number</b></label>
                        <div class="col-md-auto col-lg-auto">
                            ...
                            <div class="row d-none" id="otp2div" style="text-align: center;margin-top: 0.5rem;">
                                <div class="form-group col-12 text-right">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-auto col-6 col-sm-12">
                                            <button class="btn btn-primary d-none btn-style-five disabled-on-loading" id="btnResendOtp2" onclick="resendOtp(this,2)" type="button"> Resend OTP</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php }else{ ?>
                        <div class="col-12 gy-0">
                          <input type="checkbox" name="othershow2" value="2" id="othershow2" onclick="showOther(this,2)">
                        ...
                        <div class="row mb-3 d-none" id="other2div">
                            <label for="othermob2" class="col-md-12 col-lg-12 col-form-label"><b>Enter New Mobile Number</b></label>
                            <div class="col-md-auto col-lg-auto">
                                <input type="number" class="form-control mb-2" id="othermob2" onKeyUp="showOtpAccordingly(this.value,2)" onKeyPress="return checkLength(this.value,10)">
                            </div>
                            <div class="invalid-feedback">Please enter a valid Mobile Number</div>
                            <div class="form-group col-12">
                                <span class="text-danger">Note: Number will be verify Through OTP</span>
                    ...
                    <?php } ?>
                    <?php 
                        if($getProfileDetail[0]['alternate_mobile3'] != NULL || $getProfileDetail[0]['alternate_mobile3'] != '')
                        {
                    ?>
                    <div class="row align-items-end">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-10 mb-0">
                            <label for="alternatemob3" class="form-label">Third Contact Number</label>
                            <input readonly value="<?php echo $getProfileDetail[0]['alternate_mobile3']; ?>" type="number" name="alternatemob3" class="form-control mb-2" id="alternatemob3">
                        </div>
                        <div class="col-2 mb-2">
                    ...
                    <div class="row mb-3 d-none" id="other3div">
                        <label for="othermob3" class="col-md-12 col-lg-12 col-form-label"><b>Enter New Mobile Number</b></label>
                        <div class="col-md-auto col-lg-auto">
                            <input type="number" class="form-control mb-2" id="othermob3" onKeyPress="return checkLength(this.value,10)" onKeyUp="showOtpAccordingly(this.value,3)">
                        </div>
                        <div class="invalid-feedback">Please enter a valid Mobile Number</div>
                        <div class="form-group col-12">
                            <span class="text-danger">Note: Number will be verify Through OTP</span>
                        ...
                        <div class="form-group col-8" style="margin-top: 0.5rem;">
                            <button class="btn btn-primary btn-style-grey disabled disabled-on-loading" id="btnOtp3" onclick="sendOtp(3)" type="button"> Send OTP</button>
                        </div>
                        <div class="col-12">
                            <div class="row d-none" id="otp3div" style="text-align: center;margin-top: 0.5rem;">
                                <div class="form-group col-12 text-right">
                                    <div class="row">
                                        <div class="col-md-3 col-lg-2 col-sm-12">
                                            <input type="number" style="padding:0.8rem;" class="form-control mb-2" id="otp3" placeholder="Enter OTP">
                                        </div>
                                        <div class="col-md-4 col-lg-auto col-sm-12 col-6">
                                            <button type="button" class="btn-style-green btn btn-success d-block disabled-on-loading" id="btnVerify3" onclick="verifyOtp(this,3)"> Verify</button>      
                                        </div>
                                        <div class="col-md-4 col-lg-auto col-6 col-sm-12">
                                            <button class="btn btn-primary d-none btn-style-five disabled-on-loading" id="btnResendOtp3" onclick="resendOtp(this,3)" type="button"> Resend OTP</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php }else{ ?>
                        <div class="col-12 gy-0">
                          <input type="checkbox" name="othershow3" value="3" id="othershow3" onclick="showOther(this,3)">
                          <label for="othershow3" style="display:inline;">Add your alternate mobile number 3</label>
                        </div>
        
                        <div class="row mb-3 d-none" id="other3div">
                            <label for="othermob3" class="col-md-12 col-lg-12 col-form-label"><b>Enter New Mobile Number</b></label>
                            <div class="col-md-auto col-lg-auto">
                                <input type="number" class="form-control mb-2" id="othermob3" onKeyUp="showOtpAccordingly(this.value,3)" onKeyPress="return checkLength(this.value,10)">
                            </div>
                            <div class="invalid-feedback">Please enter a valid Mobile Number</div>
                            <div class="form-group col-12">
                                <span class="text-danger">Note: Number will be verify Through OTP</span>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-12 col-md-auto col-lg-auto mt-3">
                          <button class="save btn btn-primary w-100 disabled-on-loading" id="btnSubmit" type="submit"> Save Changes</button>
                        </div>
                        <div class="col-sm-12 col-md-auto col-lg-auto mt-3">
                          <button class="btn btn-primary w-100 next" type="button" onclick="location.href='<?php echo base_url(); ?>police'">Go To Dashboard</button>
                        </div>
                        <!--<div class="col-sm-12 col-md-auto col-lg-auto mt-3">-->
...
<script type="text/javascript">
    ...
    function verifyDeleteOtp(ele,index)
    {
        ...
        if(otp != '')
        {
            ...
            $.ajax({
                url:'<?php echo base_url(); ?>police/deleteAlternateMobile',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
    ...
    function resendDeleteOtp(ele,index)
    {
        ...
        $.ajax({
            url:'<?php echo base_url(); ?>police/sendDeleteProfileOtp',
            data:otpdata,
            contentType: false,
            cache: false,
            processData:false,
    ...
    function verifyOtp(ele,index)
    {
        if($('#otp'+index).val() != '')
        {
            ...
            $.ajax({
              url:'<?php echo base_url(); ?>police/verifyProfileMobileOtp',
              data:data,
              contentType: false,
              cache: false,
              processData:false,
    ...
    function sendOtp(index)
    {
        if($('#othermob'+index).val() != '')
        {
            if($('#othermob'+index).val().length == 10)
            {
                ...
                $.ajax({
                  url:'<?php echo base_url(); ?>police/sendProfileMobileOtp',
                  data:data,
                  contentType: false,
                  cache: false,
                  processData:false,
    ...
    function checkUsername(val)
    {
        if(val != '')
        {
            ...
            data.append('_token','<?php echo $this->security->get_csrf_hash(); ?>');
            $.ajax({
                url:'<?php echo base_url(); ?>police/checkUsername',
                data:data,
                contentType: false,
                cache: false,
                processData:false,
