                    ...
                    <div class="card-body pt-3 table-responsive">
                        <div class="row justify-content-right mb-3">
                            <div class="col-lg-8 col-sm-6 text-left">
                                <a href="javascript:void(0)" class="btn btn-default text-dark">Wanted Document Details</a>
                            </div>
                            <!-- <div class="col-lg-6 col-sm-6 text-end">
                        ...
                        <label for="faqQues" class="col-md-5 col-lg-5 col-6 col-form-label">PAN No</label>
                            <label for="faqQues" class="col-md-6 col-lg-6 col-6 col-form-label text-uppercase"><?php echo ($missingAlldetail[0]['panNumber'] != '' ? $missingAlldetail[0]['panNumber'] : '--');?></label>
                            <label for="faqQues" class="col-md-5 col-lg-5 col-6 col-form-label">DL No </label>
                            <label for="faqQues" class="col-md-6 col-lg-6 col-6 col-form-label text-uppercase"><?php echo ($missingAlldetail[0]['dlNumber'] != '' ? $missingAlldetail[0]['dlNumber'] : '--');?></label>

                            <label for="faqQues" class="col-md-5 col-lg-5 col-6 col-form-label">Voter Id </label>
                            <label for="faqQues" class="col-md-6 col-lg-6 col-6 col-form-label text-uppercase"><?php echo ($missingAlldetail[0]['voterId'] != '' ? $missingAlldetail[0]['voterId'] : '--');?></label>
                            <label for="faqQues" class="col-md-5 col-lg-5 col-6 col-form-label">Document Name</label>
                            <label for="faqQues" class="col-md-6 col-lg-6 col-6 col-form-label text-uppercase"><?php echo $docdetails[0]['documentName']??"--";?></label>

                            <label for="faqQues" class="col-md-5 col-lg-5 col-6 col-form-label">Document FIle</label>
                            <label for="faqQues" class="col-md-6 col-lg-6 col-6 col-form-label text-uppercase"><?php echo $docdetails[0]['documentFile']??"--";?>  </label>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body pt-3 table-responsive">
                        ...
                        <hr>
                        <div class="row mb-3">
                            <label for="faqQues" class="col-md-12 col-lg-12 col-form-label">Wanted Person Photos</label>
                            <?php
