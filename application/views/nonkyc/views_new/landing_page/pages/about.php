<section class="wrapper bg-soft-primary">
      <div class="container pb-20 pb-md-23 text-center">
        <div class="row">
      ...
      <div class="container pb-14 pb-md-16">
        <div class="row text-center mb-12 mb-md-15">
          <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2 mt-n18 mt-md-n22">
            <figure><img class="w-auto" src="assets_landing_page/img/illustrations/i8.png" srcset="./assets_landing_page/img/illustrations/i8@2x.png 2x" alt="" /></figure>
          </div>
          <!-- /column -->
        </div>
        <!-- /.row -->
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-6 gy-md-0 text-center">
          <div class="col-md-6 col-lg-3">
            <img src="assets_landing_page/img/icons/lineal/megaphone.svg" class="svg-inject icon-svg icon-svg-md text-blue mb-3" alt="" />
            <h4>Marketing</h4>
          ...
          <!--/column -->
          <div class="col-md-6 col-lg-3">
            <img src="assets_landing_page/img/icons/lineal/target.svg" class="svg-inject icon-svg icon-svg-md text-green mb-3" alt="" />
            <h4>Strategy</h4>
            <p class="mb-2">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget metus. Cras justo cum sociis natoque magnis.</p>
          </div>
          <!--/column -->
          <div class="col-md-6 col-lg-3">
            <img src="assets_landing_page/img/icons/lineal/settings-3.svg" class="svg-inject icon-svg icon-svg-md text-yellow mb-3" alt="" />
            <h4>Development</h4>
            <p class="mb-2">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget metus. Cras justo cum sociis natoque magnis.</p>
          </div>
          <!--/column -->
          <div class="col-md-6 col-lg-3">
            <img src="assets_landing_page/img/icons/lineal/bar-chart.svg" class="svg-inject icon-svg icon-svg-md text-orange mb-3" alt="" />
            <h4>Data Analysis</h4>
            <p class="mb-2">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget metus. Cras justo cum sociis natoque magnis.</p>
          </div>
          <!--/column -->
    ...
    <section class="wrapper bg-gray">
      <div class="container py-14 py-md-16">
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-16 align-items-center">
          <div class="col-lg-7">
            <figure><img class="w-auto" src="assets_landing_page/img/illustrations/i3.png" srcset="./assets_landing_page/img/illustrations/i3@2x.png 2x" alt="" /></figure>
          </div>
          <!--/column -->
          <div class="col-lg-5">
            ...
            <div class="d-flex flex-row mb-4">
              <div>
                <img src="assets_landing_page/img/icons/lineal/light-bulb.svg" class="svg-inject icon-svg icon-svg-sm text-blue me-4" alt="" />
              </div>
              <div>
            ...
            <div class="d-flex flex-row mb-4">
              <div>
                <img src="assets_landing_page/img/icons/lineal/pie-chart-2.svg" class="svg-inject icon-svg icon-svg-sm text-green me-4" alt="" />
              </div>
              <div>
            ...
            <div class="d-flex flex-row">
              <div>
                <img src="assets_landing_page/img/icons/lineal/design.svg" class="svg-inject icon-svg icon-svg-sm text-yellow me-4" alt="" />
              </div>
              <div>
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
          <div class="col-lg-7 order-lg-2">
            <figure><img class="w-auto" src="assets_landing_page/img/illustrations/i2.png" srcset="./assets_landing_page/img/illustrations/i2@2x.png 2x" alt="" /></figure>
          </div>
          <!--/column -->
          <div class="col-lg-5">
              ...
              <div class="swiper">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img class="rounded-circle w-20 mx-auto mb-4" src="assets_landing_page/img/avatars/t1.jpg" srcset="./assets_landing_page/img/avatars/t1@2x.jpg 2x" alt="" />
                  ...
                  <!--/.swiper-slide -->
                  <div class="swiper-slide">
                    <img class="rounded-circle w-20 mx-auto mb-4" src="assets_landing_page/img/avatars/t2.jpg" srcset="./assets_landing_page/img/avatars/t2@2x.jpg 2x" alt="" />
                  ...
                  <!--/.swiper-slide -->
                  <div class="swiper-slide">
                    <img class="rounded-circle w-20 mx-auto mb-4" src="assets_landing_page/img/avatars/t3.jpg" srcset="./assets_landing_page/img/avatars/t3@2x.jpg 2x" alt="" />
                  ...
                  <!--/.swiper-slide -->
                  <div class="swiper-slide">
                    <img class="rounded-circle w-20 mx-auto mb-4" src="assets_landing_page/img/avatars/t4.jpg" srcset="./assets_landing_page/img/avatars/t4@2x.jpg 2x" alt="" />
                  ...
                  <!--/.swiper-slide -->
                  <div class="swiper-slide">
                    <img class="rounded-circle w-20 mx-auto mb-4" src="assets_landing_page/img/avatars/t5.jpg" srcset="./assets_landing_page/img/avatars/t5@2x.jpg 2x" alt="" />
    ...
    <section class="wrapper bg-gray">
      <div class="container py-14 py-md-16">
        <div class="row gx-lg-8 gx-xl-12 gy-6 mb-15 align-items-center">
          <div class="col-lg-7 order-lg-2">
            <figure><img class="w-auto" src="assets_landing_page/img/illustrations/i4.png" srcset="./assets_landing_page/img/illustrations/i4@2x.png 2x" alt="" /></figure>
          </div>
          <!--/column -->
        ...
        <div class="px-lg-5">
          <div class="row gx-0 gx-md-8 gx-xl-12 gy-8 align-items-center">
            <div class="col-4 col-md-2">
              <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="assets_landing_page/img/brands/c1.png" alt="" /></figure>
            </div>
            <!--/column -->
            <div class="col-4 col-md-2">
              <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="assets_landing_page/img/brands/c2.png" alt="" /></figure>
            </div>
            <!--/column -->
            <div class="col-4 col-md-2">
              <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="assets_landing_page/img/brands/c3.png" alt="" /></figure>
            </div>
            <!--/column -->
            <div class="col-4 col-md-2">
              <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="assets_landing_page/img/brands/c4.png" alt="" /></figure>
            </div>
            <!--/column -->
            <div class="col-4 col-md-2">
              <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="assets_landing_page/img/brands/c5.png" alt="" /></figure>
            </div>
            <!--/column -->
            <div class="col-4 col-md-2">
              <figure class="px-5 px-md-0 px-lg-2 px-xl-3 px-xxl-4"><img src="assets_landing_page/img/brands/c6.png" alt="" /></figure>
            </div>
            <!--/column -->
          </div>
          <!--/.row -->
    ...
    <section class="wrapper bg-light">
      <div class="container py-14 py-md-16">
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
          <div class="col-lg-7">
            <figure><img class="w-auto" src="assets_landing_page/img/illustrations/i5.png" srcset="./assets_landing_page/img/illustrations/i5@2x.png 2x" alt="" /></figure>
          </div>
          <!--/column -->
          <div class="col-lg-5">
            ...
            <div class="d-flex flex-row">
              ...
              <div>
                ...
                <p class="mb-0"><a href="cdn-cgi/l/email-protection.html#780b19161c1a1700381d15191114561b1715" class="link-body"><span class="__cf_email__" data-cfemail="7300121d17111c0b33161e121a1f5d101c1e">[email&#160;protected]</span></a></p>
              </div>
            </div>
          </div>
          <!--/column -->
