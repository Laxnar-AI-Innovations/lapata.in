  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link <?php if($title == 'Dashboard'){ echo "active"; } ?> " href="<?php echo base_url(); ?>ngo">Dashboard</a>
        </li>
        <?php }else{ ?>
            <li class="nav-item">
              <a class="nav-link <?php if($title == 'Login'){ echo "active"; } ?>" aria-current="page" href="<?php echo base_url(); ?>ngo/login">Login</a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php if($title == 'Register'){ echo "active"; } ?> " href="<?php echo base_url(); ?>ngo/register">NGO KYC</a>
            </li>
        <?php } ?>
      </ul>
      <form class="d-flex">
