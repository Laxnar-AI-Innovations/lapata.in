                                ...
                                <div class="card-body px-0">
                                    <div class="row align-items-center px-0 mx-0 justify-content-center">
                                        ...
                                        <div class="col-12 text-end mb-2">
                                            <button type="button" class="btn btn-dark" onclick="share(this,'<?php echo $row['Id']; ?>')" style="background:black!important;color:white!important;"><i class="fa fa-share-alt"></i></button>
                                        </div>
                                        <div class="col-10">
...
document.querySelector('.reset-btn .btn').onclick = () => {
	window.location.href="<?php echo base_url(); ?>ngo/missing_person_filter";
};
