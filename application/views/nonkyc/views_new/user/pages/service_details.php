					...
					<div class="card-body">
						...
						<div class="service-description">
							<div class="service-images service-carousel">
								...
								<div class="item"><img src="<?php echo base_url().$image; ?>" alt="" class="img-fluid"></div>								</div>
							</div>
				...
				<div class="card provider-widget clearfix">
					<div class="card-body">
						<h5 class="card-title">Service Provider</h5>
							...
							<div class="about-provider-img">
								<div class="provider-img-wrap">
									</div>													<a href="javascript:void(0);"><img class="img-fluid rounded-circle" alt="" src="<?php echo base_url(). $service_provider_img; ?>"></a>
								</div>
							</div>
						...
						<div class="provider-info">
							<p class="mb-1"><i class="far fa-envelope"></i> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c0b0b2afb6a9a4a5b280a5b8a1adb0aca5eea3afad"><?php echo $email; ?></a></p>
