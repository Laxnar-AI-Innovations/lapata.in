                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-md-12 d-flex flex-column align-items-center justify-content-center <?php if($pn != 1){ echo "d-none"; } ?>">
                        ...
                        <form id="loginForm" action="<?php echo base_url(); ?>user/lapatawith" method="post" class="row g-3 w-100 needs-validation1"  enctype="multipart/form-data">
                                ...
                                <div class="card-body mt-0">
                                    <div class="row align-items-center">
                                        <div class="form-floating mt-3 col-10 col-md-3">
                                            ...
                                            <label for="pkgdur" class="ms-2"> Aadhaar No.* </label>
                                        </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="form-floating mt-3 col-12 col-md-auto hiddendiv d-none">
                                            ...
                                            <input type="hidden" class="Religion">
                                        </div>
                                        <div class="form-floating mt-3 col-12 col-md-auto hiddendiv d-none">
                            ...
                            <div class="card mb-3 w-100 hiddendiv d-none">
                                ...
                                <div class="card-body mt-0 pb-0">
                                    <div class="row align-items-center justify-content-center">
                                        <div class="col-lg-2 col-md-3 my-3 col-12 text-center">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div style="position:relative;text-align:center;">
                                                        <img class="w-100" id="profile-pic" src="<?php echo base_url(); ?>assets/images/facematch.webp" style="height: 152px!important;border: 1px solid;border-radius: 15px 15px;" alt="">
                                                    </div>  
                                                </div>
                                            </div>
                                            <div class="row mt-3">
                            ...
                            <div class="card mb-3 w-100 hiddendiv d-none">
                                 <div class="pt-0 pb-0">
                                    <h5 class="card-title text-center pb-0 fs-4 mb-3">Address Of लापता Person</h5>
                                </div>
                                <div class="card-body mt-0 pb-0">
                                    <div class="row align-items-center justify-content-center">
...
<script>
    ...
    function clearAadhar(ele)
    {
        Swal.fire({
            ...
            icon: 'info',
            html:'<div class="form-group mb-2">Are you sure, you want to cancel filling the लापता form?</div>',
            allowOutsideClick:true,
            showCloseButton: true,
            showCancelButton: true,
            focusConfirm: true,
                ...
                if(parse.status == 'success')
                {
                    if(parse.isRegistered == 1)
                    {
                        Swal.fire({
                            ...
                            html:'<div class="form-group mb-2" style="font-weight:bold;">Aadhaar No- '+parse.aadhar+'<br><br> Name- '+parse.personName+'</div>',
                            allowOutsideClick:false,
                            showCloseButton: true,
                            showCancelButton: true,
                            focusConfirm: true,
                    ...
                    Swal.fire({
                        icon: 'error',
                        html:'<div class="form-group mb-2">'+parse.message+'</div>',
                        allowOutsideClick:true,
                        showCloseButton: true,
                        showCancelButton: true,
                        focusConfirm: true,
