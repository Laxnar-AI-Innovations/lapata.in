                    ...
                    var t = {
                      ...
                      , e = t.exports = function() {
                        ...
                        var L = function() {
                            ...
                            ,
                            D.$set = function(t, e) {
                                var n, u = S.p(t), h = "set" + (this.$u ? "UTC" : ""), l = (n = {},
                                n[o] = h + "Date",
                                n[d] = h + "Date",
                                n[f] = h + "Month",
                                n[c] = h + "FullYear",
                            ...
                            D.diff = function(r, d, l) {
                                var $, M = S.p(d), m = w(r), D = (m.utcOffset() - this.utcOffset()) * e, v = this - m, p = S.m(this, m);
                                return p = ($ = {},
                                $[c] = p / 12,
                                $[f] = p,
                                $[h] = p / 3,
                        ...
                        [["$ms", r], ["$s", i], ["$m", s], ["$H", a], ["$W", o], ["$M", f], ["$y", c], ["$D", d]].forEach((function(t) {
                            O[t[1]] = function(e) {
        ...
        2: [function(require, module, exports) {
            ...
            class r {
                ...
                order(t) {
                    ...
                    t.forEach(( (t, i) => {
                        ...
                        e.sortable = r,
                        l[0].push(e),
                        o.hiddenColumns.includes(t) || (s = n.cloneNode(!0),
                    ...
                    o.data.forEach(( (e, s) => {
                        ...
                        t.forEach((t => {
                            ...
                            i.appendChild(h),
                            o.hiddenColumns.includes(t) || (h = e.cells[t].cloneNode(!0),
                            h.data = e.cells[t].data,
                            a.appendChild(h))
                        }
                        )),
            ...
            const h = function(t) {
              ...
              , l = {
                ...
                paging: !0,
                perPage: 50,
                perPageSelect: [50, 100, 150, 200, 500],
                nextPrev: !0,
                firstLast: !1,
                prevText: "&lsaquo;",
                nextText: "&rsaquo;",
            ...
            class o {
                ...
                render(t) {
                    ...
                    s.footer ? this.head && !this.foot && (this.foot = e("tfoot", {
                    ...
                    i += s.layout.top,
                    i += "</div>",
                    s.scrollY.length ? i += `<div class='dataTable-container' style='height: ${s.scrollY}; overflow-Y: auto;'></div>` : i += "<div class='dataTable-container'></div>",
                    i += "<div class='dataTable-bottom'>",
                    i += s.layout.bottom,
                    i += "</div>",
                    i = i.replace("{info}", s.paging ? "<div class='dataTable-info'></div>" : ""),
                ...
                export(e) {
                    ...
                    if (o.type) {
                        if ("txt" !== o.type && "csv" !== o.type || (i[0] = this.header),
                        o.selection)
                            if (isNaN(o.selection)) {
                                ...
                                i = i.concat(this.pages[o.selection - 1]);
                        else
                        ...
                        if (i.length) {
                            if ("txt" === o.type || "csv" === o.type) {
                                ...
                                for (h = `INSERT INTO \`${o.tableName}\` (`,
                                n = 0; n < s.length; n++)
                                    !o.skipColumn.includes(s[n].originalCellIndex) && this.columns(s[n].originalCellIndex).visible() && (h += `\`${s[n].textContent}\`,`);
                                for (h = h.trim().substring(0, h.length - 1),
                                h += ") VALUES ",
                                n = 0; n < i.length; n++) {
                                    for (h += "(",
                                    r = 0; r < i[n].cells.length; r++)
                                        !o.skipColumn.includes(s[r].originalCellIndex) && this.columns(s[r].originalCellIndex).visible() && (h += `"${i[n].cells[r].textContent}",`);
                                    h = h.trim().substring(0, h.length - 1),
                                    h += "),"
                                }
                                h = h.trim().substring(0, h.length - 1),
                                h += ";",
                                o.download && (h = `data:application/sql;charset=utf-8,${h}`)
                            } else if ("json" === o.type) {
                                for (r = 0; r < i.length; r++)
                                    for (a[r] = a[r] || {},
                                    n = 0; n < s.length; n++)
                                        !o.skipColumn.includes(s[n].originalCellIndex) && this.columns(s[n].originalCellIndex).visible() && (a[r][s[n].textContent] = i[r].cells[n].textContent);
                                h = JSON.stringify(a, o.replacer, o.space),
                                o.download && (h = `data:application/json;charset=utf-8,${h}`)
                            }
                            return o.download && (o.filename = o.filename || "datatable_export",
                            o.filename += `.${o.type}`,
                            h = encodeURI(h),
